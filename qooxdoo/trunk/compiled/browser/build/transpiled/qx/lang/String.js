  ...
  qx.Bootstrap.define("qx.lang.String", {
    statics: {
      ...
      camelCase: function camelCase(str) {
        var result = this.__P_30_2[str];

        if (!result) {
          result = str.replace(/\-([a-z])/g, function (match, chr) {
            return chr.toUpperCase();
          });
          this.__P_30_2[str] = result;
        }
      ...
      hyphenate: function hyphenate(str) {
        var result = this.__P_30_3[str];

        if (!result) {
          result = str.replace(/[A-Z]/g, function (match) {
            return "-" + match.charAt(0).toLowerCase();
          });
          this.__P_30_3[str] = result;
        }
      ...
      capitalize: function capitalize(str) {
        if (this.__P_30_1 === null) {
          var unicodeEscapePrefix = "\\u";
          this.__P_30_1 = new RegExp("(^|[^" + this.__P_30_0.replace(/[0-9A-F]{4}/g, function (match) {
            return unicodeEscapePrefix + match;
          }) + "])[" + this.__P_30_0.replace(/[0-9A-F]{4}/g, function (match) {
            return unicodeEscapePrefix + match;
          }) + "]", "g");
        }

        return str.replace(this.__P_30_1, function (match) {
      ...
      isUpperCase: function isUpperCase(str) {
        return qx.lang.String.__P_30_5.upper.test(str);
      },
      ...
      isLowerCase: function isLowerCase(str) {
        return qx.lang.String.__P_30_5.lower.test(str);
      },
      ...
      isLetters: function isLetters(str) {
        return qx.lang.String.__P_30_5.letter.test(str);
      },
      ...
      isDigits: function isDigits(str) {
        return qx.lang.String.__P_30_5.digit.test(str);
      },
...
//# sourceMappingURL=String.js.map?dt=1658886778965