  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.module.Manipulating", {
    statics: {
       ...
       */
      __P_5_0: function __P_5_0(property, value, duration) {
       ...
       * @internal
       */
      __P_5_2: function __P_5_2(element) {
        ...
        for (var i = 0, l = element.childNodes.length; i < l; i++) {
          if (element.childNodes[i].nodeType === 1) {
            return this.__P_5_2(element.childNodes[i]);
          }
        }
    ...
    members: {
      ...
      appendTo: function appendTo(parent) {
        parent = qx.module.Manipulating.__P_5_3(parent);
      ...
      insertBefore: function insertBefore(target) {
        target = qx.module.Manipulating.__P_5_3(target);
      ...
      wrap: function wrap(wrapper) {
        wrapper = qx.module.Manipulating.__P_5_1(wrapper);
        ...
        this._forEachElement(function (item) {
          ...
          var innermost = qx.module.Manipulating.__P_5_2(clonedwrapper[0]);
      ...
      setScrollLeft: function setScrollLeft(value, duration) {
        ...
        if (duration && qx.bom.element && qx.bom.element.AnimationJs) {
          qx.module.Manipulating.__P_5_0.bind(this, "scrollLeft", value, duration)();
        }
      ...
      setScrollTop: function setScrollTop(value, duration) {
        ...
        if (duration && qx.bom.element && qx.bom.element.AnimationJs) {
          qx.module.Manipulating.__P_5_0.bind(this, "scrollTop", value, duration)();
        }
...
//# sourceMappingURL=Manipulating.js.map?dt=1658886771763