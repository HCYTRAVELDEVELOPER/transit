  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.module.Blocker", {
    statics: {
       ...
       */
      __P_2_0: function __P_2_0(item, color, opacity, zIndex) {
        ...
        if (isDocument) {
          item.__P_2_1.div.insertBefore(qxWeb(win.document.body).getChildren(":first"));
        } else {
          item.__P_2_1.div.appendTo(win.document.body);
        }

        qx.module.Blocker.__P_2_2(item, color, opacity, zIndex, isDocument);
      },
       ...
       */
      __P_2_2: function __P_2_2(item, color, opacity, zIndex, isDocument) {
        ...
        item.__P_2_1.div.setStyles(styles);
      },
       ...
       */
      __P_2_3: function __P_2_3(item, index) {
        if (!item.__P_2_1) {
          return;
        }

        item.__P_2_1.div.remove();
      },
       ...
       */
      __P_2_4: function __P_2_4(collection) {
        var blockerElements = qxWeb();
        collection.forEach(function (item, index) {
          if (typeof item.__P_2_1 !== "undefined") {
            blockerElements = blockerElements.concat(item.__P_2_1.div);
          }
        });
    ...
    members: {
      ...
      block: function block(color, opacity, zIndex) {
        ...
        this.forEach(function (item, index) {
          qx.module.Blocker.__P_2_0(item, color, opacity, zIndex);
        });
        return this;
      },
      ...
      unblock: function unblock() {
        ...
        this.forEach(qx.module.Blocker.__P_2_3);
        return this;
      },
      ...
      getBlocker: function getBlocker() {
        ...
        var collection = qx.module.Blocker.__P_2_4(this);
...
//# sourceMappingURL=Blocker.js.map?dt=1658886770169