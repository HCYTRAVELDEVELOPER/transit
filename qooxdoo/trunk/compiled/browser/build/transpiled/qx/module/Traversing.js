  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.module.Traversing", {
    statics: {
       ...
       * @internal
       */
      __P_10_0: function __P_10_0(selector, filter) {
        var ancestors = [];
       ...
       */
      __P_10_1: function __P_10_1(arg) {
       ...
       */
      __P_10_2: function __P_10_2(arg) {
       ...
       */
      __P_10_3: function __P_10_3(node) {
        var attributes = {};
       ...
       * @internal
       */
      __P_10_4: function __P_10_4(collection, method, selector) {
      ...
      isElement: function isElement(selector) {
        return qx.dom.Node.isElement(qx.module.Traversing.__P_10_1(selector));
      },
      ...
      isNode: function isNode(selector) {
        return qx.dom.Node.isNode(qx.module.Traversing.__P_10_1(selector));
      },
      ...
      isNodeName: function isNodeName(selector, nodeName) {
        return qx.dom.Node.isNodeName(qx.module.Traversing.__P_10_1(selector), nodeName);
      },
      ...
      getWindow: function getWindow(selector) {
        return qx.dom.Node.getWindow(qx.module.Traversing.__P_10_1(selector));
      },
      ...
      getDocument: function getDocument(selector) {
        return qx.dom.Node.getDocument(qx.module.Traversing.__P_10_1(selector));
      },
      ...
      getNodeName: function getNodeName(selector) {
        return qx.dom.Node.getName(qx.module.Traversing.__P_10_1(selector));
      },
      ...
      getNodeText: function getNodeText(selector) {
        return qx.dom.Node.getText(qx.module.Traversing.__P_10_1(selector));
      },
      ...
      isBlockNode: function isBlockNode(selector) {
        return qx.dom.Node.isBlockNode(qx.module.Traversing.__P_10_1(selector));
      },
      ...
      equalNodes: function equalNodes(node1, node2) {
        node1 = qx.module.Traversing.__P_10_2(node1);
        node2 = qx.module.Traversing.__P_10_2(node2);
        ...
        if (qx.core.Environment.get("html.node.isequalnode")) {
          ...
          if (hasAttributes) {
            var node1Attributes = qx.module.Traversing.__P_10_3(node1);

            var node2Attributes = qx.module.Traversing.__P_10_3(node2);
    ...
    members: {
      ...
      getAncestors: function getAncestors(filter) {
        return this.__P_10_0(null, filter);
      },
      ...
      getAncestorsUntil: function getAncestorsUntil(selector, filter) {
        return this.__P_10_0(selector, filter);
      },
      ...
      getNextAll: function getNextAll(selector) {
        var ret = qx.module.Traversing.__P_10_4(this, "getNextSiblings", selector);
      ...
      getPrevAll: function getPrevAll(selector) {
        var ret = qx.module.Traversing.__P_10_4(this, "getPreviousSiblings", selector);
      ...
      getSiblings: function getSiblings(selector) {
        var ret = qx.module.Traversing.__P_10_4(this, "getSiblings", selector);
...
//# sourceMappingURL=Traversing.js.map?dt=1658886773073