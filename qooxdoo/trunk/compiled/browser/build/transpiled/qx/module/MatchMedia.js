  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.module.MatchMedia", {
    statics: {
       ...
       */
      __P_6_0: function __P_6_0(query, className) {
        if (query.isMatching()) {
    ...
    members: {
      ...
      mediaQueryToClass: function mediaQueryToClass(queryString, className) {
        ...
        var callback = qx.module.MatchMedia.__P_6_0.bind(this, query, className); // apply classes initially
...
//# sourceMappingURL=MatchMedia.js.map?dt=1658886771831