    ...
    statics: {
      ...
      registerInputFix: function registerInputFix(element) {
        if (element.type === "text" || element.type === "password" || element.type === "textarea") {
          if (!element.__P_11_0) {
            element.__P_11_0 = qxWeb(element).on("keyup", qx.module.event.Keyboard._inputFix);
          }
        }
      },
      ...
      unregisterInputFix: function unregisterInputFix(element) {
        if (element.__P_11_0 && !qxWeb(element).hasListener("input")) {
          qxWeb(element).off("keyup", qx.module.event.Keyboard._inputFix);
          element.__P_11_0 = null;
        }
      },
      ...
      _inputFix: function _inputFix(ev) {
        ...
        if (!target.__P_11_1 || target.__P_11_1 !== newValue) {
          target.__P_11_1 = newValue;
...
//# sourceMappingURL=Keyboard.js.map?dt=1658886773304