  ...
  qx.Bootstrap.define("qx.module.TextSelection", {
    ...
    members: {
      ...
      getTextSelection: function getTextSelection() {
        ...
        if (el) {
          if (!qx.module.TextSelection.__P_9_0(el)) {
            el = qx.module.TextSelection.__P_9_1(el);
          }
...
//# sourceMappingURL=TextSelection.js.map?dt=1658886772715