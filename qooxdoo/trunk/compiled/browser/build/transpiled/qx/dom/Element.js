    ...
    statics: {
      ...
      */
      ...
      getHelperElement: function getHelperElement(win) {
        ...
        if (!qx.dom.Element.__P_42_0[key]) {
          var helper = qx.dom.Element.__P_42_0[key] = win.document.createElement("div"); // innerHTML will only parsed correctly if element is appended to document
        ...
        return qx.dom.Element.__P_42_0[key];
      },
...
//# sourceMappingURL=Element.js.map?dt=1658886781153