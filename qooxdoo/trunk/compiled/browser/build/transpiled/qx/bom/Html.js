  ...
  qx.Bootstrap.define("qx.bom.Html", {
    ...
    */
    statics: {
       ...
       */
      __P_25_0: function __P_25_0(all, front, tag) {
      ...
      fixEmptyTags: function fixEmptyTags(html) {
        return html.replace(/(<(\w+)[^>]*?)\/>/g, this.__P_25_0);
      },
       ...
       */
      __P_25_2: function __P_25_2(html, context) {
...
//# sourceMappingURL=Html.js.map?dt=1658886777990