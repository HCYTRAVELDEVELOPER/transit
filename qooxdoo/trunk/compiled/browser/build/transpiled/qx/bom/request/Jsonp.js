  ...
  qx.Bootstrap.define("qx.bom.request.Jsonp", {
    ...
    members: {
      ...
      open: function open(method, url) {
        ...
        this.__P_40_4 = false;
        callbackParam = this.__P_40_2 || "callback";
        callbackName = this.__P_40_3 || this.__P_40_8 + "qx.bom.request.Jsonp." + this.__P_40_1 + ".callback"; // Default callback

        if (!this.__P_40_3) {
          // Store globally available reference to this object
          this.constructor[this.__P_40_1] = this; // Custom callback
        } else {
          // Dynamically create globally available callback (if it does not
          // exist yet) with user defined name. Delegate to this object’s
          // callback method.
          if (!window[this.__P_40_3]) {
            this.__P_40_5 = true;

            window[this.__P_40_3] = function (data) {
              that.callback(data);
            };
          } else {
            if (qx.core.Environment.get("qx.debug.io")) {
              qx.Bootstrap.debug(qx.bom.request.Jsonp, "Callback " + this.__P_40_3 + " already exists");
            }
          }
        }
        ...
        this.__P_40_6 = url = qx.util.Uri.appendParamsToUrl(url, query);

        this.__P_40_9("open", [method, url]);
      },
      ...
      callback: function callback(data) {
        ...
        this.__P_40_4 = true; // Sanitize and parse

        // Set response
        this.responseJson = data; // Delete global reference to this

        this.constructor[this.__P_40_1] = undefined;
      ...
      getGeneratedUrl: function getGeneratedUrl() {
        return this.__P_40_6;
      },
      dispose: function dispose() {
        // In case callback was not called
        this.__P_40_10();

        this.__P_40_9("dispose");
      },
      ...
      _onNativeLoad: function _onNativeLoad() {
        ...
        this.status = this.__P_40_4 ? 200 : 500;

        this.__P_40_9("_onNativeLoad");
      },

      /**
       *  Delete custom callback if dynamically created before.
       */
      __P_40_10: function __P_40_10() {
        if (this.__P_40_5 && window[this.__P_40_3]) {
          window[this.__P_40_3] = undefined;
          this.__P_40_5 = false;
        }
      },
       ...
       */
      __P_40_9: function __P_40_9(method, args) {
      ...
      __P_40_0: function __P_40_0() {
        ...
        this.__P_40_1 = "qx" + new Date().valueOf() + ("" + Math.random()).substring(2, 5);
      }
    }
  });
...
//# sourceMappingURL=Jsonp.js.map?dt=1658886780893