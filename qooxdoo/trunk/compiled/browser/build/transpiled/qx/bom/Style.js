  ...
  qx.Bootstrap.define("qx.bom.Style", {
    statics: {
      ...
      getCssName: function getCssName(propertyName) {
        var cssName = this.__P_57_0[propertyName];
        ...
        if (!cssName) {
          ...
          this.__P_57_0[propertyName] = cssName;
        }
      ...
      getAppliedStyle: function getAppliedStyle(element, propertyName, value, prefixed) {
        ...
        for (var i = 0, l = vendorPrefixes.length; i < l; i++) {
          ...
          if (qx.bom.Style.__P_57_1) {
            supported = qx.bom.Style.__P_57_1.call(win, cssProperty, prefixedVal);
          } else {
    ...
    defer: function defer(statics) {
      if (window.CSS && window.CSS.supports) {
        qx.bom.Style.__P_57_1 = window.CSS.supports.bind(window.CSS);
      } else if (window.supportsCSS) {
        qx.bom.Style.__P_57_1 = window.supportsCSS.bind(window);
      }
    }
  });
...
//# sourceMappingURL=Style.js.map?dt=1658886787106