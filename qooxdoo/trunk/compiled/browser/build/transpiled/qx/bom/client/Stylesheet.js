  ...
  qx.Bootstrap.define("qx.bom.client.Stylesheet", {
    statics: {
      ...
      __P_60_0: function __P_60_0() {
        if (!qx.bom.client.Stylesheet.__P_60_1) {
          qx.bom.client.Stylesheet.__P_60_1 = qx.bom.Stylesheet.createElement();
        }

        return qx.bom.client.Stylesheet.__P_60_1;
      },
      ...
      getInsertRule: function getInsertRule() {
        return typeof qx.bom.client.Stylesheet.__P_60_0().insertRule === "function";
      },
      ...
      getDeleteRule: function getDeleteRule() {
        return typeof qx.bom.client.Stylesheet.__P_60_0().deleteRule === "function";
      },
      ...
      getAddImport: function getAddImport() {
        return _typeof(qx.bom.client.Stylesheet.__P_60_0().addImport) === "object";
      },
      ...
      getRemoveImport: function getRemoveImport() {
        return _typeof(qx.bom.client.Stylesheet.__P_60_0().removeImport) === "object";
      }
    },
...
//# sourceMappingURL=Stylesheet.js.map?dt=1658886787429