  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.request.Script", {
    ...
    construct: function construct() {
      ...
      this.__P_39_1 = qx.Bootstrap.bind(this._onNativeLoad, this);
      this.__P_39_2 = qx.Bootstrap.bind(this._onNativeError, this);
      this.__P_39_3 = qx.Bootstrap.bind(this._onTimeout, this);
      this.__P_39_4 = document.head || document.getElementsByTagName("head")[0] || document.documentElement;
      ...
      this.timeout = this.__P_39_5() ? 0 : 15000;
    },
    events: {
    ...
    members: {
      ...
      setRequestHeader: function setRequestHeader(key, value) {
        ...
        param[key] = value;
        this.__P_39_9 = qx.util.Uri.appendParamsToUrl(this.__P_39_9, param);
        return this;
      },
      ...
      send: function send() {
        ...
        var script = this.__P_39_11(),
            head = this.__P_39_4,
            that = this;

        if (this.timeout > 0) {
          this.__P_39_12 = window.setTimeout(this.__P_39_3, this.timeout);
        }
      ...
      dispose: function dispose() {
        ...
        if (!this.__P_39_7) {
          ...
          if (this.__P_39_12) {
            window.clearTimeout(this.__P_39_12);
          }
      ...
      */
      ...
      _onNativeLoad: function _onNativeLoad() {
        var script = this.__P_39_14,
            determineSuccess = this.__P_39_6,
        ...
        if (this.__P_39_10("engine.name") === "mshtml" && this.__P_39_10("browser.documentmode") < 9) {
      ...
      */
       ...
       */
      __P_39_5: function __P_39_5() {
        var isLegacyIe = this.__P_39_10("engine.name") === "mshtml" && this.__P_39_10("browser.documentmode") < 9;
        var isOpera = this.__P_39_10("engine.name") === "opera";
       ...
       */
      __P_39_11: function __P_39_11() {
        var script = this.__P_39_14 = document.createElement("script");
        script.src = this.__P_39_9;
        script.onerror = this.__P_39_2;
        script.onload = this.__P_39_1; // BUGFIX: IE < 9
        // Legacy IEs do not fire the "load" event for script elements.
        // Instead, they support the "readystatechange" event

        if (this.__P_39_10("engine.name") === "mshtml" && this.__P_39_10("browser.documentmode") < 9) {
          script.onreadystatechange = this.__P_39_1;
        }
       ...
       */
      __P_39_13: function __P_39_13() {
        var script = this.__P_39_14;

        if (script && script.parentNode) {
          this.__P_39_4.removeChild(script);
        }
      },
       ...
       */
      __P_39_10: function __P_39_10(key) {
...
//# sourceMappingURL=Script.js.map?dt=1658886780775