  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.request.SimpleXhr", {
    ...
    construct: function construct(url, method) {
      ...
      this.__P_66_0 = {};
      this.__P_66_1 = this._createResponseParser();
    },
    members: {
      /*
      ---------------------------------------------------------------------------
      ...
      */
      ...
      setParser: function setParser(parser) {
        return this.__P_66_1.setParser(parser);
      },
      ...
      send: function send() {
        var curTimeout = this.getTimeout(),
            ...
            hasCacheControlHeader = this.__P_66_0.hasOwnProperty("Cache-Control"),
        ...
        for (var key in this.__P_66_0) {
          this._transport.setRequestHeader(key, this.__P_66_0[key]);
        } // send
      ...
      */
      ...
      __P_66_9: function __P_66_9() {
        ...
        if (qx.util.Request.isSuccessful(this._transport.status)) {
          ...
          this._setResponse(this.__P_66_1.parse(response, contentType));
...
//# sourceMappingURL=SimpleXhr.js.map?dt=1658886789016