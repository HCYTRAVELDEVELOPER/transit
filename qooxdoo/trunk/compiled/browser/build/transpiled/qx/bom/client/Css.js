  ...
  qx.Bootstrap.define("qx.bom.client.Css", {
    statics: {
      ...
      getLinearGradient: function getLinearGradient() {
        qx.bom.client.Css.__P_63_0 = false;
        ...
        if (!style) {
          ...
          if (style) {
            qx.bom.client.Css.__P_63_0 = true;
          }
        } // not supported
      ...
      getLegacyWebkitGradient: function getLegacyWebkitGradient() {
        if (qx.bom.client.Css.__P_63_0 === null) {
          qx.bom.client.Css.getLinearGradient();
        }

        return qx.bom.client.Css.__P_63_0;
      },
...
//# sourceMappingURL=Css.js.map?dt=1658886787930