  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.request.Xhr", {
    ...
    construct: function construct() {
      var boundFunc = qx.Bootstrap.bind(this.__P_38_0, this); // GlobalError shouldn't be included in qx.Website builds so use it
      ...
      if (qx.event && qx.event.GlobalError && qx.event.GlobalError.observeMethod) {
        this.__P_38_1 = qx.event.GlobalError.observeMethod(boundFunc);
      } else {
        this.__P_38_1 = boundFunc;
      }

      this.__P_38_2 = qx.Bootstrap.bind(this.__P_38_3, this);
      this.__P_38_4 = qx.Bootstrap.bind(this.__P_38_5, this);
      this.__P_38_6 = qx.Bootstrap.bind(this.__P_38_7, this);
      ...
      if (window.attachEvent) {
        this.__P_38_9 = qx.Bootstrap.bind(this.__P_38_10, this);
        window.attachEvent("onunload", this.__P_38_9);
      }
    },
    statics: {
      UNSENT: 0,
    ...
    members: {
      ...
      */
      ...
      open: function open(method, url, async, user, password) {
        this.__P_38_11(); // Mimick native behavior
        ...
        this.__P_38_12 = false;
        this.__P_38_13 = false;
        this.__P_38_14 = false; // Store URL for later checks
        ...
        this.__P_38_16 = async; // Default values according to spec.
        ...
        if (!this.__P_38_17() && this.readyState > qx.bom.request.Xhr.UNSENT) {
        ...
        this.__P_38_18.onreadystatechange = this.__P_38_1;
        ...
        try {
          ...
          this.__P_38_18.open(method, url, async, user, password); // BUGFIX: IE, Firefox < 3.5
          ...
          if (this.__P_38_16) {
            ...
            if (window.XDomainRequest) {
              this.readyState = 4;
              this.__P_38_18 = new window.XDomainRequest();
              this.__P_38_18.onerror = qx.Bootstrap.bind(function () {
              ...
              this.__P_38_18.open(method, url, async, user, password);
        ...
        if (qx.core.Environment.get("engine.name") === "mshtml" && qx.core.Environment.get("browser.documentmode") < 9 && this.__P_38_18.readyState > 0) {
          this.__P_38_18.setRequestHeader("If-Modified-Since", "-1");
        } // BUGFIX: Firefox
        // Firefox < 4 fails to trigger onreadystatechange OPENED for sync requests


        if (qx.core.Environment.get("engine.name") === "gecko" && parseInt(qx.core.Environment.get("engine.version"), 10) < 2 && !this.__P_38_16) {
      ...
      setRequestHeader: function setRequestHeader(key, value) {
        this.__P_38_11(); // Detect conditional requests
        ...
        this.__P_38_18.setRequestHeader(key, value);
      ...
      send: function send(data) {
        this.__P_38_11(); // BUGFIX: IE & Firefox < 3.5
        // For sync requests, some browsers throw error on open()
        // while it should be on send()
        //


        if (!this.__P_38_16 && this.__P_38_19) {
          throw this.__P_38_19;
        } // BUGFIX: Opera
        ...
        if (this.timeout > 0) {
          this.__P_38_21 = window.setTimeout(this.__P_38_6, this.timeout);
        } // BUGFIX: Firefox 2
        ...
        data = data !== null && this.__P_38_22.indexOf(dataType) === -1 ? data.toString() : data; // Some browsers may throw an error when sending of async request fails.
        ...
        try {
          ...
          if (this.__P_38_16) {
            this.__P_38_18.responseType = this.responseType;
          }

          this.__P_38_18.send(data);
        } catch (SendError) {
          if (!this.__P_38_16) {
            throw SendError;
          } // BUGFIX
        ...
        if (qx.core.Environment.get("engine.name") === "gecko" && !this.__P_38_16) {
      ...
      abort: function abort() {
        ...
        this.__P_38_18.abort();

        if (this.__P_38_18 && this.readyState !== qx.bom.request.Xhr.DONE) {
          this.readyState = this.__P_38_18.readyState;
        }
      ...
      getResponseHeader: function getResponseHeader(header) {
        ...
        if (qx.core.Environment.get("browser.documentmode") === 9 && this.__P_38_18.aborted) {
          return "";
        }

        return this.__P_38_18.getResponseHeader(header);
      },
      ...
      getAllResponseHeaders: function getAllResponseHeaders() {
        ...
        return this.__P_38_18.getAllResponseHeaders();
      },
      ...
      overrideMimeType: function overrideMimeType(mimeType) {
        ...
        if (this.__P_38_18.overrideMimeType) {
          this.__P_38_18.overrideMimeType(mimeType);
        } else {
      ...
      */
      ...
      dispose: function dispose() {
        ...
        window.clearTimeout(this.__P_38_21); // Remove unload listener in IE. Aborting on unload is no longer required
        // for this instance.

        if (window.detachEvent) {
          window.detachEvent("onunload", this.__P_38_9);
        } // May fail in IE


        try {
          this.__P_38_18.onreadystatechange;
        ...
        this.__P_38_18.onreadystatechange = noop;
        this.__P_38_18.onload = noop;
        this.__P_38_18.onerror = noop;
        this.__P_38_18.onprogress = noop; // Abort any network activity
      ...
      */
       ...
       * Init native XHR.
       */
      __P_38_8: function __P_38_8() {
        // Create native XHR or equivalent and hold reference
        this.__P_38_18 = this._createNativeXhr(); // Track native ready state changes

        this.__P_38_18.onreadystatechange = this.__P_38_1; // Track native abort, when supported

        if (qx.Bootstrap.getClass(this.__P_38_18.onabort) !== "Undefined") {
          this.__P_38_18.onabort = this.__P_38_2;
        } // Track native progress, when supported


        if (qx.Bootstrap.getClass(this.__P_38_18.onprogress) !== "Undefined") {
          this.__P_38_18.onprogress = this.__P_38_4;
          this.progress = {
        ...
        this.__P_38_20 = this.__P_38_13 = this.__P_38_12 = false; // Initialize data white list

        this.__P_38_22 = ["ArrayBuffer", "Blob", "File", "HTMLDocument", "String", "FormData"];
      },
      ...
      __P_38_0: function __P_38_0() {
        ...
        if (this.readyState === qx.bom.request.Xhr.DONE && this.__P_38_12 && !this.__P_38_13) {
          return;
        } // BUGFIX: IE
        ...
        if (!this.__P_38_16 && (nxhr.readyState == 2 || nxhr.readyState == 3)) {
          return;
      ...
      __P_38_27: function __P_38_27() {
        ...
        if (this.__P_38_24) {
          ...
          this.__P_38_24 = false; // Fire either "abort", "load" or "error"
        } else {
          if (this.__P_38_12) {
            this._emit("abort");
          } else {
      ...
      __P_38_7: function __P_38_7() {
        ...
        this.__P_38_24 = true; // No longer consider request. Abort.
      ...
      __P_38_25: function __P_38_25() {
        ...
        if (qx.core.Environment.get("engine.name") === "opera") {
          if (isDone && // Done
          this.__P_38_14 && // Conditional request
          !this.__P_38_12 && // Not aborted
...
//# sourceMappingURL=Xhr.js.map?dt=1658886780603