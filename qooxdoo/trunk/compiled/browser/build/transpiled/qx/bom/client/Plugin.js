  ...
  qx.Bootstrap.define("qx.bom.client.Plugin", {
    statics: {
      ...
      getQuicktimeVersion: function getQuicktimeVersion() {
        var entry = qx.bom.client.Plugin.__P_100_0["quicktime"];
        return qx.bom.client.Plugin.__P_100_1(entry.control, entry.plugin);
      },
      ...
      getWindowsMediaVersion: function getWindowsMediaVersion() {
        var entry = qx.bom.client.Plugin.__P_100_0["wmv"];
        return qx.bom.client.Plugin.__P_100_1(entry.control, entry.plugin, true);
      },
      ...
      getDivXVersion: function getDivXVersion() {
        var entry = qx.bom.client.Plugin.__P_100_0["divx"];
        return qx.bom.client.Plugin.__P_100_1(entry.control, entry.plugin);
      },
      ...
      getSilverlightVersion: function getSilverlightVersion() {
        var entry = qx.bom.client.Plugin.__P_100_0["silverlight"];
        return qx.bom.client.Plugin.__P_100_1(entry.control, entry.plugin);
      },
      ...
      getPdfVersion: function getPdfVersion() {
        var entry = qx.bom.client.Plugin.__P_100_0["pdf"];
        return qx.bom.client.Plugin.__P_100_1(entry.control, entry.plugin);
      },
      ...
      getQuicktime: function getQuicktime() {
        var entry = qx.bom.client.Plugin.__P_100_0["quicktime"];
        return qx.bom.client.Plugin.__P_100_2(entry.control, entry.plugin);
      },
      ...
      getWindowsMedia: function getWindowsMedia() {
        var entry = qx.bom.client.Plugin.__P_100_0["wmv"];
        return qx.bom.client.Plugin.__P_100_2(entry.control, entry.plugin, true);
      },
       ...
       */
      __P_100_1: function __P_100_1(activeXName, pluginNames, forceActiveX) {
        var available = qx.bom.client.Plugin.__P_100_2(activeXName, pluginNames, forceActiveX); // don't check if the plugin is not available
       ...
       */
      __P_100_2: function __P_100_2(activeXName, pluginNames, forceActiveX) {
        // IE checks
        if (qx.bom.client.Engine.getName() == "mshtml" && (qx.bom.client.Browser.getDocumentMode() < 11 || forceActiveX)) {
          if (!this.getActiveX()) {
            return false;
...
//# sourceMappingURL=Plugin.js.map?dt=1658886806043