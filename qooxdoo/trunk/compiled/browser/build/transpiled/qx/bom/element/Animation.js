  ...
  qx.Bootstrap.define("qx.bom.element.Animation", {
    statics: {
      ...
      animate: function animate(el, desc, duration) {
        var onlyCssKeys = qx.bom.element.Animation.__P_23_0(el, desc.keyFrames);
       ...
       */
      __P_23_0: function __P_23_0(el, keyFrames) {
        var keys = [];
...
//# sourceMappingURL=Animation.js.map?dt=1658886777845