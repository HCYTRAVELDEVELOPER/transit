  ...
  qx.Bootstrap.define("qx.bom.storage.Memory", {
    statics: {
      ...
      getLocal: function getLocal() {
        ...
        return this.__P_69_0 = new qx.bom.storage.Memory();
      },
      ...
      getSession: function getSession() {
        ...
        return this.__P_69_1 = new qx.bom.storage.Memory();
      }
    },
    ...
    members: {
      ...
      getLength: function getLength() {
        return Object.keys(this.__P_69_2).length;
      },
      ...
      getKey: function getKey(index) {
        var keys = Object.keys(this.__P_69_2);
        return keys[index];
      },
...
//# sourceMappingURL=Memory.js.map?dt=1658886789682