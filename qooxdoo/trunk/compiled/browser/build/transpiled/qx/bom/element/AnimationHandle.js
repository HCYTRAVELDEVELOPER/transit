  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.element.AnimationHandle", {
    ...
    construct: function construct() {
      ...
      this.__P_76_0 = css && css["play-state"];
      this.__P_76_1 = true;
      this.addListenerOnce("end", this.__P_76_2, this);
    },
    events: {
    ...
    members: {
      ...
      isPaused: function isPaused() {
        return this.el.style[this.__P_76_0] == "paused";
      },
      ...
      pause: function pause() {
        if (this.el) {
          this.el.style[this.__P_76_0] = "paused";
          this.el.$$animation.__P_76_1 = false; // in case the animation is based on JS
      ...
      play: function play() {
        if (this.el) {
          this.el.style[this.__P_76_0] = "running";
          this.el.$$animation.__P_76_1 = true; // in case the animation is based on JS
      ...
      stop: function stop() {
        if (this.el && qx.core.Environment.get("css.animation") && !this.jsAnimation) {
          this.el.style[this.__P_76_0] = "";
          this.el.style[qx.core.Environment.get("css.animation").name] = "";
          this.el.$$animation.__P_76_1 = false;
          this.el.$$animation.__P_76_3 = true;
...
//# sourceMappingURL=AnimationHandle.js.map?dt=1658886800394