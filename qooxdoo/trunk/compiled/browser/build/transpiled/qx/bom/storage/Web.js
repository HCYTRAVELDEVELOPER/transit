  ...
  qx.Bootstrap.define("qx.bom.storage.Web", {
    statics: {
      ...
      getLocal: function getLocal() {
        ...
        return this.__P_67_0 = new qx.bom.storage.Web("local");
      },
      ...
      getSession: function getSession() {
        ...
        return this.__P_67_1 = new qx.bom.storage.Web("session");
      }
    },
    ...
    members: {
      ...
      getStorage: function getStorage() {
        return window[this.__P_67_2 + "Storage"];
      },
      ...
      getLength: function getLength() {
        return this.getStorage(this.__P_67_2).length;
      },
      ...
      setItem: function setItem(key, value) {
        ...
        try {
          this.getStorage(this.__P_67_2).setItem(key, value);
        } catch (e) {
      ...
      getItem: function getItem(key) {
        var item = this.getStorage(this.__P_67_2).getItem(key);
      ...
      removeItem: function removeItem(key) {
        this.getStorage(this.__P_67_2).removeItem(key);
      },
      ...
      clear: function clear() {
        var storage = this.getStorage(this.__P_67_2);
      ...
      getKey: function getKey(index) {
        return this.getStorage(this.__P_67_2).key(index);
      },
...
//# sourceMappingURL=Web.js.map?dt=1658886789395