  ...
  qx.Bootstrap.define("qx.bom.client.Engine", {
    ...
    statics: {
      ...
      getVersion: function getVersion() {
        ...
        if (qx.bom.client.Engine.__P_35_0()) {
        ...
        } else if (qx.bom.client.Engine.__P_35_1()) {
        ...
        } else if (qx.bom.client.Engine.__P_35_2()) {
        ...
        } else if (qx.bom.client.Engine.__P_35_3()) {
      ...
      __P_35_0: function __P_35_0() {
        ...
        if (qx.bom.client.Engine.__P_35_4()) {
          return true;
        }
...
//# sourceMappingURL=Engine.js.map?dt=1658886779591