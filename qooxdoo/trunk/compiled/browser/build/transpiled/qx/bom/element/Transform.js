  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.element.Transform", {
    statics: {
      ...
      __P_48_0: qx.core.Environment.get("css.transform"),
      ...
      transform: function transform(el, transforms) {
        ...
        if (this.__P_48_0 != null) {
          var style = this.__P_48_0["name"];
      ...
      setOrigin: function setOrigin(el, value) {
        if (this.__P_48_0 != null) {
          el.style[this.__P_48_0["origin"]] = value;
        }
      },
      ...
      getOrigin: function getOrigin(el) {
        if (this.__P_48_0 != null) {
          return el.style[this.__P_48_0["origin"]];
        }
      ...
      setStyle: function setStyle(el, value) {
        if (this.__P_48_0 != null) {
          el.style[this.__P_48_0["style"]] = value;
        }
      },
      ...
      getStyle: function getStyle(el) {
        if (this.__P_48_0 != null) {
          return el.style[this.__P_48_0["style"]];
        }
      ...
      setPerspective: function setPerspective(el, value) {
        if (this.__P_48_0 != null) {
          el.style[this.__P_48_0["perspective"]] = value + "px";
        }
      },
      ...
      getPerspective: function getPerspective(el) {
        if (this.__P_48_0 != null) {
          return el.style[this.__P_48_0["perspective"]];
        }
      ...
      setPerspectiveOrigin: function setPerspectiveOrigin(el, value) {
        if (this.__P_48_0 != null) {
          el.style[this.__P_48_0["perspective-origin"]] = value;
        }
      },
      ...
      getPerspectiveOrigin: function getPerspectiveOrigin(el) {
        if (this.__P_48_0 != null) {
          var value = el.style[this.__P_48_0["perspective-origin"]];

          if (value != "") {
            return value;
          } else {
            var valueX = el.style[this.__P_48_0["perspective-origin"] + "X"];
            var valueY = el.style[this.__P_48_0["perspective-origin"] + "Y"];
      ...
      setBackfaceVisibility: function setBackfaceVisibility(el, value) {
        if (this.__P_48_0 != null) {
          el.style[this.__P_48_0["backface-visibility"]] = value ? "visible" : "hidden";
        }
      },
      ...
      getBackfaceVisibility: function getBackfaceVisibility(el) {
        if (this.__P_48_0 != null) {
          return el.style[this.__P_48_0["backface-visibility"]] == "visible";
        }
...
//# sourceMappingURL=Transform.js.map?dt=1658886783149