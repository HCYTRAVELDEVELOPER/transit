  ...
  qx.Class.define("qx.util.DeferredCallManager", {
    ...
    */
    members: {
      ...
      schedule: function schedule(deferredCall) {
        if (this.__P_105_4 == null) {
          this.__P_105_4 = window.setTimeout(this.__P_105_1, 0);
        }

        var callKey = deferredCall.toHashCode(); // the flush is currently running and the call is already
        // scheduled

        if (this.__P_105_5 && this.__P_105_5[callKey]) {
          return;
        }

        this.__P_105_0[callKey] = deferredCall;
        this.__P_105_3 = true;
      },
      ...
      cancel: function cancel(deferredCall) {
        ...
        if (this.__P_105_5 && this.__P_105_5[callKey]) {
          this.__P_105_5[callKey] = null;
          return;
        }

        delete this.__P_105_0[callKey]; // stop timer if no other calls are waiting

        if (qx.lang.Object.isEmpty(this.__P_105_0) && this.__P_105_4 != null) {
          window.clearTimeout(this.__P_105_4);
          this.__P_105_4 = null;
        }
      },
       ...
       * @signature function()
       */
      __P_105_2: qx.event.GlobalError.observeMethod(function () {
        this.__P_105_4 = null; // the queue may change while doing the flush so we work on a copy of
        // the queue and loop while the queue has any entries.

        while (this.__P_105_3) {
          this.__P_105_5 = qx.lang.Object.clone(this.__P_105_0);
          this.__P_105_0 = {};
          this.__P_105_3 = false;

          for (var key in this.__P_105_5) {
            var call = this.__P_105_5[key];

            if (call) {
              this.__P_105_5[key] = null;
              call.call();
            }
          }
        }
    ...
    */
    destruct: function destruct() {
      ...
      this.__P_105_1 = this.__P_105_0 = null;
    }
  });
  qx.util.DeferredCallManager.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=DeferredCallManager.js.map?dt=1658886806593