(function () {
  ...
  qx.Bootstrap.define("qx.util.Wheel", {
    statics: {
        ...
        if (axis === "y") {
          ...
          if (domEvent.wheelDelta !== undefined) {
            if (domEvent.wheelDeltaY !== undefined) {
              y = domEvent.wheelDeltaY ? this.__P_72_0(-domEvent.wheelDeltaY) : 0;
            } else {
              y = this.__P_72_0(-domEvent.wheelDelta);
            }
          } else {
            if (!(domEvent.axis && domEvent.axis == domEvent.HORIZONTAL_AXIS) && domEvent.detail !== undefined && domEvent.detail > 0) {
              y = this.__P_72_0(domEvent.detail);
            } else if (domEvent.deltaY !== undefined) {
              y = this.__P_72_0(domEvent.deltaY);
            }
          }
       ...
       */
      __P_72_0: function __P_72_0(delta) {
...
//# sourceMappingURL=Wheel.js.map?dt=1658886795767