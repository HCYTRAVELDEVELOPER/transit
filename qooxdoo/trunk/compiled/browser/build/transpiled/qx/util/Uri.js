  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.util.Uri", {
    statics: {
          ...
          if (obj.hasOwnProperty(key)) {
            ...
            if (value instanceof Array) {
              for (var i = 0; i < value.length; i++) {
                this.__P_61_0(key, value[i], parts, post);
              }
            } else {
              this.__P_61_0(key, value, parts, post);
            }
          }
        }
       ...
       * @param post {Boolean} Whether spaces should be encoded with "+".
       */
      __P_61_0: function __P_61_0(key, value, parts, post) {
...
//# sourceMappingURL=Uri.js.map?dt=1658886787504