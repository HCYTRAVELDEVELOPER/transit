    ...
    statics: {
      ...
      hexStringToRgb: function hexStringToRgb(value) {
        if (this.ishexShortString(value)) {
          return this.__P_77_2(value);
        }

        if (this.ishexLongString(value)) {
          return this.__P_77_3(value);
        }
       ...
       */
      __P_77_6: function __P_77_6(color, tuneMap, tuner, hue_tuner) {
      ...
      scale: function scale(color, scaleMap) {
        return this.__P_77_6(color, scaleMap, function (value, scale, max) {
          if (value > max) {
            value = max;
          }
      ...
      adjust: function adjust(color, adjustMap) {
        return this.__P_77_6(color, adjustMap, function (value, offset, max) {
          value += offset;
...
//# sourceMappingURL=ColorUtil.js.map?dt=1658886800591