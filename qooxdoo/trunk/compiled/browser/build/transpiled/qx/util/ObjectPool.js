  ...
  qx.Class.define("qx.util.ObjectPool", {
    ...
    members: {
      ...
      */
      ...
      getObject: function getObject(clazz) {
        ...
        var obj = null;
        var pool = this.__P_103_0[clazz.classname];
      ...
      poolObject: function poolObject(obj) {
        ...
        var pool = this.__P_103_0[classname];
    ...
    */
    destruct: function destruct() {
      ...
      delete this.__P_103_0;
    }
  });
  qx.util.ObjectPool.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=ObjectPool.js.map?dt=1658886806477