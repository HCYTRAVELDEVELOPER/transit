    ...
    members: {
      ...
      setParser: function setParser(parser) {
        ...
        if (typeof qx.util.ResponseParser.PARSER[parser] === "function") {
          return this.__P_84_0 = qx.util.ResponseParser.PARSER[parser];
        } // If parser is not a symbol, it must be a function


        return this.__P_84_0 = parser;
      },
...
//# sourceMappingURL=ResponseParser.js.map?dt=1658886801439