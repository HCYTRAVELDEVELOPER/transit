  ...
  qx.Bootstrap.define("qx.Interface", {
    statics: {
      ...
      */
       ...
       */
      __P_75_0: function __P_75_0(object, clazz, iface, wrap, shouldThrow) {
        // Validate members
        ...
        if (members) {
          for (var key in members) {
            if (qx.Bootstrap.isFunction(members[key])) {
              var isPropertyMethod = this.__P_75_1(clazz, key);
              ...
              if (shouldWrapFunction) {
                object[key] = this.__P_75_2(iface, object[key], key, members[key]);
              }
            } else {
       ...
       *   system.
       */
      __P_75_1: function __P_75_1(clazz, methodName) {
       ...
       */
      __P_75_3: function __P_75_3(clazz, iface, shouldThrow) {
        if (iface.$$properties) {
       ...
       */
      __P_75_4: function __P_75_4(clazz, iface, shouldThrow) {
        if (iface.$$events) {
      ...
      assertObject: function assertObject(object, iface) {
        ...
        this.__P_75_0(object, clazz, iface, false, true);

        this.__P_75_3(clazz, iface, true);

        this.__P_75_4(clazz, iface, true); // Validate extends, recursive
      ...
      assert: function assert(clazz, iface, wrap) {
        this.__P_75_0(clazz.prototype, clazz, iface, wrap, true);
      ...
      objectImplements: function objectImplements(object, iface) {
        ...
        if (!this.__P_75_0(object, clazz, iface) || !this.__P_75_3(clazz, iface) || !this.__P_75_4(clazz, iface)) {
          return false;
      ...
      classImplements: function classImplements(clazz, iface) {
        if (!this.__P_75_0(clazz.prototype, clazz, iface) || !this.__P_75_3(clazz, iface) || !this.__P_75_4(clazz, iface)) {
          return false;
        } // Validate extends, recursive
      ...
      */
       ...
       */
      __P_75_2: qx.core.Environment.select("qx.debug", {
      ...
      __P_75_5: qx.core.Environment.select("qx.debug", {
        "true": {
          extend: "object",
          // Interface | Interface[]
          statics: "object",
       ...
       */
      __P_75_6: qx.core.Environment.select("qx.debug", {
...
//# sourceMappingURL=Interface.js.map?dt=1658886800110