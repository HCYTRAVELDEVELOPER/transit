  ...
  qx.Bootstrap.define("qx.ui.website.DatePicker", {
    ...
    members: {
      ...
      setConfig: function setConfig(name, config) {
        if (name === "position") {
          var validPositions = qx.ui.website.DatePicker.__P_16_0;
       ...
       */
      __P_16_1: function __P_16_1(collection) {
       ...
       * @param collection {qxWeb} collection to work on
       */
      __P_16_2: function __P_16_2(collection) {
        var icon;
       ...
       * @param collection {qxWeb} collection to work on
       */
      __P_16_3: function __P_16_3(collection) {
    ...
    defer: function defer(statics) {
      ...
      statics.__P_16_0 = ["top-left", "top-center", "top-right", "bottom-left", "bottom-center", "bottom-right", "left-top", "left-middle", "left-bottom", "right-top", "right-middle", "right-bottom"];
    }
  });
  qx.ui.website.DatePicker.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=DatePicker.js.map?dt=1658886776526