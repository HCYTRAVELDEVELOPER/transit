  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.ui.website.Table", {
    ...
    statics: {
       ...
       * @return {Boolean} The result of the check
       */
      __P_18_2: function __P_18_2(val) {
        var d = new Date(val);
       ...
       */
      __P_18_3: function __P_18_3(htmlCollection, htmlElement) {
        var index = -1;
       ...
       */
      __P_18_4: function __P_18_4() {
        return (new Date().getTime() + "" + Math.floor(Math.random() * 1000000)).substr(0, 18);
      },

      /** */
      __P_18_5: ["single", "multiple", "none"],

      /** */
      __P_18_6: "qx-table-cell",

      /** */
      __P_18_7: "qx-table-header",

      /** */
      __P_18_8: "qx-table-row-selection",

      /** */
      __P_18_9: "qx-table-selection-input",

      /** */
      __P_18_10: "qx-table-all-columns",

      /** */
      __P_18_11: "data-qx-table-col-name",

      /** */
      __P_18_12: "data-qx-table-col-type",

      /** */
      __P_18_13: "data-qx-table-cell-key",

      /** */
      __P_18_14: "cellKey",

      /** */
      __P_18_15: "qx-table-input-label",

      /** */
      __P_18_16: "qx-table-row-selected",

      /** */
      __P_18_17: "qx-table-sort-asc",

      /** */
      __P_18_18: "qqx-table-sort-desc"
    },
    members: {
      __P_18_0: null,
      __P_18_19: null,
      ...
      init: function init() {
        ...
        this.__P_18_24 = "input" + qx.ui.website.Table.__P_18_4();

        this.__P_18_27(model);

        this.setModel(model);
        this.setSortingFunction(this.__P_18_28);
      ...
      setColumnType: function setColumnType(columnName, type) {
        this.__P_18_30(columnName);

        this.__P_18_19[columnName].type = type;
        return this;
      },
      ...
      getColumnType: function getColumnType(columnName) {
        this.eq(0).__P_18_30(columnName);

        return this.eq(0).__P_18_19[columnName].type;
      },
      ...
      getCell: function getCell(row, col) {
        return qxWeb(this.eq(0).__P_18_31().rows.item(row).cells.item(col));
      },
      ...
      getRows: function getRows() {
        return qxWeb(this.eq(0).__P_18_31().rows);
      },
      ...
      setColumnFilter: function setColumnFilter(columnName, func) {
        ...
        this.__P_18_22[columnName] = func;
        return this;
      },
      ...
      getColumnFilter: function getColumnFilter(columnName) {
        if (this.__P_18_22) {
          return this.__P_18_22[columnName];
        }
      ...
      sort: function sort(columnName, dir) {
        ...
        this.__P_18_33(this.__P_18_34(columnName, dir));
      ...
      filter: function filter(keyword, columnName) {
        if (columnName) {
          ...
          columnName = qx.ui.website.Table.__P_18_10;
        }
        ...
        if (this.__P_18_23[columnName]) {
          this.__P_18_23[columnName].keyword = keyword;

          this.__P_18_31().appendChild(this.__P_18_23[columnName].rows);
        } else {
          this.__P_18_23[columnName] = {
            keyword: keyword,
            rows: document.createDocumentFragment()
          };
        }

        this.__P_18_35(keyword, columnName);
      ...
      resetFilter: function resetFilter(columnName) {
        var filters = null;
        filters = this.__P_18_23;

        if (filters) {
          if (columnName) {
            this.__P_18_31().appendChild(filters[columnName].rows);
          } else {
            for (var col in filters) {
              this.__P_18_31().appendChild(filters[col].rows);
            }
          }
        }
      ...
      setContent: function setContent(tableData) {
        var rows = this.__P_18_36(tableData);
       ...
       */
      __P_18_36: function __P_18_36(data) {
        var rows = qxWeb();
       ...
       * @return {qx.ui.website.Table} <code>this</code> reference for chaining.
       */
      __P_18_35: function __P_18_35(keyword, columnName) {
        var colIndex = this.__P_18_37(columnName);

        var filterFunc = columnName == qx.ui.website.Table.__P_18_10 ? this.getRowFilter() : this.getColumnFilter(columnName);
        filterFunc = filterFunc || this.__P_18_32;

        var rows = this.__P_18_38(),
            data = {};
        ...
        for (var i = 0; i < rows.length; i++) {
          ...
          if (!filterFunc.bind(this)(data)) {
            this.__P_18_23[columnName].rows.appendChild(rows[i]);
          }
        }
      ...
      render: function render() {
        ...
        this.__P_18_39(this.__P_18_0);

        if (qx.ui.website.Table.__P_18_5.indexOf(rowSelection) != -1) {
          this.__P_18_40(rowSelection);
        }

        if (sortingData) {
          this.__P_18_33(this.__P_18_34(sortingData.columnName, sortingData.direction));
        }
       ...
       * @return {qx.ui.website.Table} <code>this</code> reference for chaining.
       */
      __P_18_40: function __P_18_40(rowSelection) {
        switch (rowSelection) {
          case "none":
            qxWeb("." + qx.ui.website.Table.__P_18_8).remove();
            break;

          case "multiple":
          case "single":
            this.__P_18_41("checkbox");

            break;

          case "single":
            this.__P_18_41("radio");
       ...
       * @return {qx.ui.website.Table} <code>this</code> reference for chaining.
       */
      __P_18_41: function __P_18_41(type) {
        this.__P_18_42(this.__P_18_43(), type);

        var rows = this.find("tbody")[0].getElementsByTagName("tr");

        for (var i = 0; i < rows.length; i++) {
          this.__P_18_42(rows.item(i), type);
        }
       ...
       */
      __P_18_42: function __P_18_42(row, type, nodeName) {
        var cssPrefix = this.getCssPrefix();
        var clazz = qx.ui.website.Table;
        var headerInput = qxWeb("." + clazz.__P_18_7 + " input");
        ...
        var inputName = this.__P_18_24;
        var className = nodeName == "th" ? clazz.__P_18_8 + " " + clazz.__P_18_7 : clazz.__P_18_8;
        var currentInput = qxWeb(row).find("." + clazz.__P_18_8);
        ...
        if (currentInput.length > 0) {
          ...
          var id = qx.ui.website.Table.__P_18_4();

          var inputNode = qxWeb.create("<" + nodeName + " class='" + className + "'><input id='" + id + "' name='" + inputName + "' " + checked + " class='" + cssPrefix + "-" + type + " " + clazz.__P_18_9 + "' type='" + type + "' /><label class='" + clazz.__P_18_15 + "' for='" + id + "'></label></" + nodeName + ">");
       ...
       */
      __P_18_30: function __P_18_30(columnName) {
        var data = this.__P_18_19;
       ...
       * @return {qx.ui.website.Table} <code>this</code> reference for chaining.
       */
      __P_18_27: function __P_18_27(model) {
        this.__P_18_44(this[0].tHead);

        this.__P_18_44(this[0].tFoot);
        ...
        var headerRow = this.__P_18_43();

        cells = headerRow.cells;

        for (var i = 0, l = cells.length; i < l; i++) {
          cell = qxWeb(cells.item(i));
          colName = this.__P_18_45(cell[0]) || qx.ui.website.Table.__P_18_4();

          if (!cell[0].getAttribute(qx.ui.website.Table.__P_18_11)) {
            cell.setAttribute(qx.ui.website.Table.__P_18_11, colName);
          }

          data[colName] = {
            type: cell[0].getAttribute(qx.ui.website.Table.__P_18_12) || "String",
            name: colName
          };
        }
       ...
       * @return {qx.ui.website.Table} <code>this</code> reference for chaining.
       */
      __P_18_44: function __P_18_44(footOrHead) {
        if (footOrHead && footOrHead.rows.length > 0) {
          if (footOrHead.rows.item(0).cells.length > 0) {
            var row = this.__P_18_43();

            if (!qxWeb(row.cells.item(0)).hasClass(qx.ui.website.Table.__P_18_7)) {
              qxWeb(row.cells).addClass(qx.ui.website.Table.__P_18_7);
            }
          }
        }
       ...
       * @return {qx.ui.website.Table} <code>this</code> reference for chaining.
       */
      __P_18_33: function __P_18_33(dataRows) {
        for (var i = 0, l = dataRows.length; i < l; i++) {
          if (i) {
            qxWeb(dataRows[i]).insertAfter(dataRows[i - 1]);
          } else {
            qxWeb(dataRows[i]).insertBefore(qxWeb(this.__P_18_31().rows.item(0)));
          }
        }
       ...
       * @return {qx.ui.website.Table} <code>this</code> reference for chaining.
       */
      __P_18_29: function __P_18_29() {
        this.on("tap", this.__P_18_46);
        this.on("cellClick", function (data) {
          if (data.cell && data.cell.hasClass(qx.ui.website.Table.__P_18_7)) {
            this.__P_18_20.bind(this)(data);
          }
        }, this);
        this.on("pointerover", this.__P_18_47, this);
        this.on("pointerout", this.__P_18_48, this);
        return this;
      },
       ...
       */
      __P_18_49: function __P_18_49() {
        return qxWeb("." + qx.ui.website.Table.__P_18_8).length > 0;
      },
       ...
       * @return {qx.ui.website.Table} <code>this</code> reference for chaining.
       */
      __P_18_50: function __P_18_50(cell) {
        var clazz = qx.ui.website.Table;
        var inputs = qxWeb("." + clazz.__P_18_9);
        ...
        if (selectionMode == "multiple") {
          if (cell.hasClass(clazz.__P_18_7)) {
        ...
        qxWeb("." + clazz.__P_18_16).removeClass(clazz.__P_18_16);
        selectedRows.addClass(clazz.__P_18_16);
       ...
       */
      __P_18_51: function __P_18_51(eventType, cell, target) {
        var row = cell[0].parentNode,
            cells = row.cells;

        var colNumber = qx.ui.website.Table.__P_18_3(cells, cell[0]);

        var tHead = this.__P_18_43();

        var headCell = tHead.cells.item(colNumber);

        var colName = this.__P_18_45(headCell);

        var columnIndex = this.getConfig("rowSelection") != "none" ? this.__P_18_37(colName) - 1 : this.__P_18_37(colName);
        var data = {
          cell: qxWeb(cell),
          row: qxWeb(row),
          target: target,
       ...
       * @return {qx.ui.website.Table} <code>this</code> reference for chaining.
       */
      __P_18_46: function __P_18_46(e) {
        var target = e.getTarget();
        var cell = qxWeb(target);
        var clazz = qx.ui.website.Table;

        while (!(cell.hasClass(clazz.__P_18_6) || cell.hasClass(clazz.__P_18_7) || cell.hasClass(clazz.__P_18_8))) {
        ...
        if (cell.hasClass(clazz.__P_18_8)) {
          window.setTimeout(function () {
            this.__P_18_50(cell);
          }.bind(this), 5);
        } else {
          if (cell && cell.length > 0) {
            this.__P_18_51("cellClick", cell, target);
          }
        }
       ...
       */
      __P_18_47: function __P_18_47(e) {
        var target = e.getTarget();
        var cell = qxWeb(target);
        var hovered = this.__P_18_25;
        ...
        if (cell && cell.length > 0 && (hovered && hovered.cell[0] != cell[0] || !hovered) && !cell.hasClass("qx-table-row-selection")) {
          ...
          this.__P_18_25 = this.__P_18_51("cellHover", cell, target);
        }
      },
       ...
       * @return {qx.ui.website.Table} <code>this</code> reference for chaining.
       */
      __P_18_39: function __P_18_39(model) {
        if (model && model.length > 0) {
          ...
          if (this.__P_18_31().rows.length > model.length) {
            this.__P_18_52(model.length);
          }
          ...
          for (var i = 0, rowCount = model.length; i < rowCount; i++) {
            ...
            if (!this.__P_18_53(i)) {
              createdRow = this.__P_18_31().insertRow(i);

              if (this.__P_18_49()) {
                this.__P_18_42(createdRow, inputType, "td");
              }
            }

            for (var j = 0, colCount = row.length; j < colCount; j++) {
              renderedColIndex = this.__P_18_49() ? j + 1 : j;
              colName = this.__P_18_45(tHead.cells.item(renderedColIndex));
              colMeta = this.__P_18_54(colName);
              coltemplate = this.getTemplate(colName) || coltemplate;
              renderedRow = this.__P_18_31().rows.item(i);
              ...
              if (!this.__P_18_55(i, renderedColIndex)) {
       ...
       * @return {qx.ui.website.Table} <code>this</code> reference for chaining.
       */
      __P_18_52: function __P_18_52(rowCount) {
        var renderedRows = this.__P_18_31().rows;
       ...
       */
      __P_18_54: function __P_18_54(columName) {
        return this.__P_18_19[columName];
      },
       ...
       * @return {Boolean} The result of the check
       */
      __P_18_53: function __P_18_53(index) {
        if (this.__P_18_31().rows.item(index)) {
          return true;
        }
       ...
       * @return {Boolean} The result of the check
       */
      __P_18_55: function __P_18_55(rowIndex, colIndex) {
        if (!this.__P_18_53(rowIndex)) {
          return false;
        }

        if (this.__P_18_31().rows.item(rowIndex).cells.item(colIndex)) {
          return true;
        }
      ...
      setSortingClass: function setSortingClass(columnName, dir) {
        ...
        this.__P_18_56(this[0].tHead, columnName, dir);
      },
       ...
       * @param dir {String} The sorting direction
       */
      __P_18_56: function __P_18_56(HeaderOrFooter, columnName, dir) {
        var rows = this.__P_18_43();

        if (HeaderOrFooter && rows) {
          qxWeb(rows.cells).removeClasses(["qx-table-sort-asc", "qx-table-sort-desc"]);
          var cell = qxWeb("[" + qx.ui.website.Table.__P_18_11 + "='" + columnName + "'], #" + columnName);
       ...
       */
      __P_18_34: function __P_18_34(columnName, direction) {
        var meta = this.__P_18_54(columnName);
        ...
        var model = this.__P_18_38();

        var columnIndex = this.__P_18_37(columnName);

        return model.sort(function (a, b) {
          var x = this.__P_18_57(qxWeb(a.cells.item(columnIndex)));

          var y = this.__P_18_57(qxWeb(b.cells.item(columnIndex)));
      ...
      _compareNumber: function _compareNumber(x, y, direction) {
        x = qx.ui.website.Table.__P_18_1(x) ? Number(x) : 0;
        y = qx.ui.website.Table.__P_18_1(y) ? Number(y) : 0;
       ...
       */
      __P_18_45: function __P_18_45(headerCell) {
        return headerCell.getAttribute(qx.ui.website.Table.__P_18_11) || headerCell.getAttribute("id");
      },
      ...
      _compareDate: function _compareDate(x, y, direction) {
        x = qx.ui.website.Table.__P_18_2(x) ? new Date(x) : new Date(0);
        y = qx.ui.website.Table.__P_18_2(y) ? new Date(y) : new Date(0);
       ...
       */
      __P_18_57: function __P_18_57(cell) {
        return cell.getAttribute(qx.ui.website.Table.__P_18_13) || this.__P_18_58(cell);
      },
       ...
       */
      __P_18_58: function __P_18_58(cell) {
      ...
      __P_18_38: function __P_18_38() {
        ...
        for (var i = 0, l = rows.length; i < l; i++) {
          ...
          for (var j = 0, len = cells.length; j < len; j++) {
            ...
            if (!cell.hasClass(qx.ui.website.Table.__P_18_6)) {
              cell.addClass(qx.ui.website.Table.__P_18_6);
            }
          }
       ...
       */
      __P_18_28: function __P_18_28(data) {
        var dir = "asc";
       ...
       */
      __P_18_32: function __P_18_32(data) {
        var caseSensitive = this.getConfig("caseSensitive");
        var cell = data.columnName == qx.ui.website.Table.__P_18_10 ? data.row : data.cell;

        var cellValue = this.__P_18_58(cell);
       ...
       */
      __P_18_37: function __P_18_37(columnName) {
        var tHead = this.__P_18_43();

        var cells = tHead.cells;

        for (var i = 0; i < cells.length; i++) {
          if (columnName == this.__P_18_45(cells.item(i))) {
            return i;
          }
        }
...
//# sourceMappingURL=Table.js.map?dt=1658886777167