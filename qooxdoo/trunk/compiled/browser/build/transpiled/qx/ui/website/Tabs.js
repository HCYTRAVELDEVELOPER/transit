    ...
    members: {
      ...
      init: function init() {
        ...
        if (active.length > 0) {
          ...
          this.__P_19_1(activePage);

          this._showPage(active, null);

          this.__P_19_2(activePage);
        }
       ...
       */
      __P_19_1: function __P_19_1(elem) {
       ...
       * @param elem {qxWeb} Element
       */
      __P_19_2: function __P_19_2(elem) {
...
//# sourceMappingURL=Tabs.js.map?dt=1658886777325