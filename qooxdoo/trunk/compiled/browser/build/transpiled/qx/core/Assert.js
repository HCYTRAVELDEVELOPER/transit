  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.core.Assert", {
    statics: {
       ...
       *
       */
      __P_95_1: function __P_95_1(comment, msgvarargs) {
        ...
        for (var i = 1, l = arguments.length; i < l; i++) {
          msg = msg + this.__P_95_2(arguments[i] === undefined ? "'undefined'" : arguments[i]);
        }
       ...
       */
      __P_95_2: function __P_95_2(value) {
        var stringValue;
      ...
      assert: function assert(condition, msg) {
        condition == true || this.__P_95_1(msg || "", "Called assert with 'false'");
      },
      ...
      assertTrue: function assertTrue(value, msg) {
        value === true || this.__P_95_1(msg || "", "Called assertTrue with '", value, "'");
      },
      ...
      assertFalse: function assertFalse(value, msg) {
        value === false || this.__P_95_1(msg || "", "Called assertFalse with '", value, "'");
      },
      ...
      assertEquals: function assertEquals(expected, found, msg) {
        expected == found || this.__P_95_1(msg || "", "Expected '", expected, "' but found '", found, "'!");
      },
      ...
      assertNotEquals: function assertNotEquals(expected, found, msg) {
        expected != found || this.__P_95_1(msg || "", "Expected '", expected, "' to be not equal with '", found, "'!");
      },
      ...
      assertEqualsFloat: function assertEqualsFloat(expected, found, msg) {
        ...
        qx.lang.Number.equals(expected, found) || this.__P_95_1(msg || "", "Expected '", expected, "' to be equal with '", found, "'!");
      },
      ...
      assertNotEqualsFloat: function assertNotEqualsFloat(expected, found, msg) {
        this.assertNumber(expected);
        this.assertNumber(found);
        !qx.lang.Number.equals(expected, found) || this.__P_95_1(msg || "", "Expected '", expected, "' to be not equal with '", found, "'!");
      },
      ...
      assertIdentical: function assertIdentical(expected, found, msg) {
        expected === found || this.__P_95_1(msg || "", "Expected '", expected, "' (identical) but found '", found, "'!");
      },
      ...
      assertNotIdentical: function assertNotIdentical(expected, found, msg) {
        expected !== found || this.__P_95_1(msg || "", "Expected '", expected, "' to be not identical with '", found, "'!");
      },
      ...
      assertNotUndefined: function assertNotUndefined(value, msg) {
        value !== undefined || this.__P_95_1(msg || "", "Expected value not to be undefined but found undefined!");
      },
      ...
      assertUndefined: function assertUndefined(value, msg) {
        value === undefined || this.__P_95_1(msg || "", "Expected value to be undefined but found ", value, "!");
      },
      ...
      assertNotNull: function assertNotNull(value, msg) {
        value !== null || this.__P_95_1(msg || "", "Expected value not to be null but found null!");
      },
      ...
      assertNull: function assertNull(value, msg) {
        value === null || this.__P_95_1(msg || "", "Expected value to be null but found ", value, "!");
      },
      ...
      assertMatch: function assertMatch(str, re, msg) {
        ...
        str.search(re) >= 0 || this.__P_95_1(msg || "", "The String '", str, "' does not match the regular expression '", re.toString(), "'!");
      },
      ...
      assertArgumentsCount: function assertArgumentsCount(args, minCount, maxCount, msg) {
        ...
        argCount >= minCount && argCount <= maxCount || this.__P_95_1(msg || "", "Wrong number of arguments given. Expected '", minCount, "' to '", maxCount, "' arguments but found '", argCount, "' arguments.");
      },
      ...
      assertEventFired: function assertEventFired(obj, event, invokeFunc, listenerFunc, msg) {
        ...
        called === true || this.__P_95_1(msg || "", "Event (", event, ") not fired.");
      },
      ...
      assertEventNotFired: function assertEventNotFired(obj, event, invokeFunc, msg) {
        ...
        invokeFunc.call();
        called === false || this.__P_95_1(msg || "", "Event (", event, ") was fired.");
        obj.removeListenerById(id);
      },
      ...
      assertException: function assertException(callback, exception, re, msg) {
        ...
        if (error == null) {
          this.__P_95_1(msg || "", "The function did not raise an exception!");
        }

        error instanceof exception || this.__P_95_1(msg || "", "The raised exception does not have the expected type! ", exception, " != ", error);
      ...
      assertInArray: function assertInArray(value, array, msg) {
        array.indexOf(value) !== -1 || this.__P_95_1(msg || "", "The value '", value, "' must have any of the values defined in the array '", array, "'");
      },
      ...
      assertNotInArray: function assertNotInArray(value, array, msg) {
        array.indexOf(value) === -1 || this.__P_95_1(msg || "", qx.lang.String.format("The value '%1' must not have any of the values defined in the array '%2'", [value, array]));
      },
      ...
      assertKeyInMap: function assertKeyInMap(value, map, msg) {
        map[value] !== undefined || this.__P_95_1(msg || "", "The value '", value, "' must must be a key of the map '", map, "'");
      },
      ...
      assertFunction: function assertFunction(value, msg) {
        qx.lang.Type.isFunction(value) || this.__P_95_1(msg || "", "Expected value to be typeof function but found ", value, "!");
      },
      ...
      assertFunctionOrAsyncFunction: function assertFunctionOrAsyncFunction(value, msg) {
        qx.lang.Type.isFunctionOrAsyncFunction(value) || this.__P_95_1(msg || "", "Expected value to be typeof function or typeof async function but found ", value, "!");
      },
      ...
      assertString: function assertString(value, msg) {
        qx.lang.Type.isString(value) || this.__P_95_1(msg || "", "Expected value to be a string but found ", value, "!");
      },
      ...
      assertBoolean: function assertBoolean(value, msg) {
        qx.lang.Type.isBoolean(value) || this.__P_95_1(msg || "", "Expected value to be a boolean but found ", value, "!");
      },
      ...
      assertNumber: function assertNumber(value, msg) {
        qx.lang.Type.isNumber(value) && isFinite(value) || this.__P_95_1(msg || "", "Expected value to be a number but found ", value, "!");
      },
      ...
      assertPositiveNumber: function assertPositiveNumber(value, msg) {
        qx.lang.Type.isNumber(value) && isFinite(value) && value >= 0 || this.__P_95_1(msg || "", "Expected value to be a number >= 0 but found ", value, "!");
      },
      ...
      assertInteger: function assertInteger(value, msg) {
        qx.lang.Type.isNumber(value) && isFinite(value) && value % 1 === 0 || this.__P_95_1(msg || "", "Expected value to be an integer but found ", value, "!");
      },
      ...
      assertPositiveInteger: function assertPositiveInteger(value, msg) {
        ...
        condition || this.__P_95_1(msg || "", "Expected value to be an integer >= 0 but found ", value, "!");
      },
      ...
      assertInRange: function assertInRange(value, min, max, msg) {
        value >= min && value <= max || this.__P_95_1(msg || "", qx.lang.String.format("Expected value '%1' to be in the range '%2'..'%3'!", [value, min, max]));
      },
      ...
      assertObject: function assertObject(value, msg) {
        ...
        condition || this.__P_95_1(msg || "", "Expected value to be typeof object but found ", value, "!");
      },
      ...
      assertArray: function assertArray(value, msg) {
        qx.lang.Type.isArray(value) || this.__P_95_1(msg || "", "Expected value to be an array but found ", value, "!");
      },
      ...
      assertMap: function assertMap(value, msg) {
        qx.lang.Type.isObject(value) || this.__P_95_1(msg || "", "Expected value to be a map but found ", value, "!");
      },
      ...
      assertRegExp: function assertRegExp(value, msg) {
        qx.lang.Type.isRegExp(value) || this.__P_95_1(msg || "", "Expected value to be a regular expression but found ", value, "!");
      },
      ...
      assertType: function assertType(value, type, msg) {
        ...
        _typeof(value) === type || this.__P_95_1(msg || "", "Expected value to be typeof '", type, "' but found ", value, "!");
      },
      ...
      assertInstance: function assertInstance(value, clazz, msg) {
        ...
        value instanceof clazz || this.__P_95_1(msg || "", "Expected value to be instanceof '", className, "' but found ", value, "!");
      },
      ...
      assertInterface: function assertInterface(value, iface, msg) {
        qx.Class && qx.Class.implementsInterface(value, iface) || this.__P_95_1(msg || "", "Expected object '", value, "' to implement the interface '", iface, "'!");
      },
      ...
      assertCssColor: function assertCssColor(expected, value, msg) {
        ...
        try {
          ...
          this.__P_95_1(msg || "", "Expected value to be the CSS color '", expected, "' (rgb(", expectedRgb.join(","), ")), but found value '", value, "', which cannot be converted to a CSS color!");
        }

        var condition = expectedRgb[0] == valueRgb[0] && expectedRgb[1] == valueRgb[1] && expectedRgb[2] == valueRgb[2];
        condition || this.__P_95_1(msg || "", "Expected value to be the CSS color '", expectedRgb, "' (rgb(", expectedRgb.join(","), ")), but found value '", value, "' (rgb(", valueRgb.join(","), "))!");
      },
      ...
      assertElement: function assertElement(value, msg) {
        ...
        !!(value && value.nodeType === 1) || this.__P_95_1(msg || "", "Expected value to be a DOM element but found  '", value, "'!");
      },
      ...
      assertQxObject: function assertQxObject(value, msg) {
        this.__P_95_3(value, "qx.core.Object") || this.__P_95_1(msg || "", "Expected value to be a qooxdoo object but found ", value, "!");
      },
      ...
      assertQxWidget: function assertQxWidget(value, msg) {
        this.__P_95_3(value, "qx.ui.core.Widget") || this.__P_95_1(msg || "", "Expected value to be a qooxdoo widget but found ", value, "!");
      },
       ...
       * class
       */
      __P_95_3: function __P_95_3(object, classname) {
        if (!object) {
          return false;
        }
...
//# sourceMappingURL=Assert.js.map?dt=1658886803414