  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.core.GlobalError", {
    ...
    construct: function construct(exc, args) {
      ...
      this.__P_87_0 = "GlobalError: " + (exc && exc.message ? exc.message : exc);
      var inst = Error.call(this, this.__P_87_0); // map stack trace properties since they're not added by Error's constructor
...
//# sourceMappingURL=GlobalError.js.map?dt=1658886801684