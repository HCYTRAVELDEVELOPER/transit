    ...
    members: {
      ...
      _applyQxObjectId: function _applyQxObjectId(value, oldValue) {
        if (!this.__P_92_1) {
          ...
          if (owner) {
            owner.__P_92_2(this, value, oldValue);
          }
       ...
       */
      __P_92_2: function __P_92_2(obj, newId, oldId) {
        delete this.__P_92_0[oldId];
        this.__P_92_0[newId] = obj;
      },
      ...
      _cascadeQxObjectIdChanges: function _cascadeQxObjectIdChanges() {
        ...
        if (this.__P_92_0) {
          for (var name in this.__P_92_0) {
            var obj = this.__P_92_0[name];
       ...
       */
      __P_92_3: function __P_92_3(obj) {
        if (obj !== null) {
      ...
      getOwnedQxObjects: function getOwnedQxObjects() {
        return this.__P_92_0 ? Object.values(this.__P_92_0) : [];
      }
    }
  });
...
//# sourceMappingURL=MObjectId.js.map?dt=1658886802483