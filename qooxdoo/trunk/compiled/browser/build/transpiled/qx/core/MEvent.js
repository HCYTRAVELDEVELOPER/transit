  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.core.MEvent", {
    members: {
      ...
      __P_91_0: qx.event.Registration,
      ...
      addListener: function addListener(type, listener, self, capture) {
        if (!this.$$disposed) {
          return this.__P_91_0.addListener(this, type, listener, self, capture);
        }
      ...
      removeListener: function removeListener(type, listener, self, capture) {
        if (!this.$$disposed) {
          ...
          return this.__P_91_0.removeListener(this, type, listener, self, capture);
        }
      ...
      removeListenerById: function removeListenerById(id) {
        if (!this.$$disposed) {
          return this.__P_91_0.removeListenerById(this, id);
        }
      ...
      hasListener: function hasListener(type, capture) {
        return this.__P_91_0.hasListener(this, type, capture);
      },
      ...
      dispatchEvent: function dispatchEvent(evt) {
        if (!this.$$disposed) {
          return this.__P_91_0.dispatchEvent(this, evt);
        }
      ...
      fireEvent: function fireEvent(type, clazz, args) {
        if (!this.$$disposed) {
          return this.__P_91_0.fireEvent(this, type, clazz, args);
        }
      ...
      fireEventAsync: function fireEventAsync(type, clazz, args) {
        if (!this.$$disposed) {
          return this.__P_91_0.fireEventAsync(this, type, clazz, args);
        }
      ...
      fireNonBubblingEvent: function fireNonBubblingEvent(type, clazz, args) {
        if (!this.$$disposed) {
          return this.__P_91_0.fireNonBubblingEvent(this, type, clazz, args);
        }
      ...
      fireNonBubblingEventAsync: function fireNonBubblingEventAsync(type, clazz, args) {
        if (!this.$$disposed) {
          return this.__P_91_0.fireNonBubblingEventAsync(this, type, clazz, args);
        }
      ...
      fireDataEvent: function fireDataEvent(type, data, oldData, cancelable) {
        if (!this.$$disposed) {
          ...
          return this.__P_91_0.fireEvent(this, type, qx.event.type.Data, [data, oldData, !!cancelable]);
        }
      ...
      fireDataEventAsync: function fireDataEventAsync(type, data, oldData, cancelable) {
        if (!this.$$disposed) {
          ...
          return this.__P_91_0.fireEventAsync(this, type, qx.event.type.Data, [data, oldData, !!cancelable]);
        }
...
//# sourceMappingURL=MEvent.js.map?dt=1658886802312