  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.core.Property", {
    statics: {
       ...
       */
      __P_89_3: function __P_89_3(clazz) {
        var inheritables = this.__P_89_4(clazz);

        if (!inheritables.length) {
          var refresher = function refresher() {};
        } else {
          refresher = this.__P_89_5(inheritables);
        }
       ...
       */
      __P_89_4: function __P_89_4(clazz) {
        var inheritable = [];
       ...
       */
      __P_89_5: function __P_89_5(inheritables) {
      ...
      attachRefreshInheritables: function attachRefreshInheritables(clazz) {
        clazz.prototype.$$refreshInheritables = function () {
          qx.core.Property.__P_89_3(clazz);
      ...
      attachMethods: function attachMethods(clazz, name, config) {
        ...
        config.group ? this.__P_89_6(clazz, config, name) : this.__P_89_7(clazz, config, name);
      },
       ...
       */
      __P_89_6: function __P_89_6(clazz, config, name) {
       ...
       * @param name {String} Name of the property
       */
      __P_89_7: function __P_89_7(clazz, config, name) {
        var upname = qx.Bootstrap.firstUp(name);
        var members = clazz.prototype;

        // Fill dispose value
        if (config.dereference === undefined && typeof config.check === "string") {
          config.dereference = this.__P_89_8(config.check);
        }
        ...
        members[method.get[name]].$$install = function () {
          qx.core.Property.__P_89_9(clazz, name, "get", arguments);

          if (config.async) {
            qx.core.Property.__P_89_9(clazz, name, "getAsync", arguments);
          }
        };
        ...
        members[setName].$$install = function () {
          qx.core.Property.__P_89_10(clazz, name, "set");

          qx.core.Property.__P_89_10(clazz, name, "setImpl");

          if (config.async) {
            qx.core.Property.__P_89_10(clazz, name, "setAsync");
          }
        };
        ...
        members[method.reset[name]].$$install = function () {
          qx.core.Property.__P_89_10(clazz, name, "reset");
        };
       ...
       */
      __P_89_8: function __P_89_8(check) {
        return !!this.__P_89_2[check];
      },
      ...
      error: function error(obj, id, property, variant, value) {
        ...
        throw new Error(msg + (this.__P_89_11[id] || "Unknown reason: " + id));
      },
       ...
       */
      __P_89_12: function __P_89_12(instance, members, name, variant, code, args) {
        var fn = this.__P_89_13(instance.constructor, name, variant, code, args); // Executing new function
       ...
       * @return {var} Return value of the generated function
       */
      __P_89_13: function __P_89_13(clazz, name, variant, code, args) {
      ...
      executeOptimizedGetter: function executeOptimizedGetter(instance, clazz, name, variant) {
        var code = this.__P_89_14(clazz, name, variant);

        var members = clazz.prototype;
        return this.__P_89_12(instance, members, name, variant, code);
      },
       ...
       * @param variant {String} Method variant.
       */
      __P_89_9: function __P_89_9(clazz, name, variant) {
        var code = this.__P_89_14(clazz, name, variant);

        this.__P_89_13(clazz, name, variant, code);
      },
       ...
       */
      __P_89_14: function __P_89_14(clazz, name, variant) {
      ...
      executeOptimizedSetter: function executeOptimizedSetter(instance, clazz, name, variant, args) {
        var code = this.__P_89_15(clazz, name, variant);

        var members = clazz.prototype;
        return this.__P_89_12(instance, members, name, variant, code, args);
      },
       ...
       * @return {var} Return value of the generated function
       */
      __P_89_10: function __P_89_10(clazz, name, variant) {
        var code = this.__P_89_15(clazz, name, variant);

        return this.__P_89_13(clazz, name, variant, code);
      },
       ...
       * @return {String[]} the string builder array
       */
      __P_89_15: function __P_89_15(clazz, name, variant) {
        var config = clazz.$$properties[name];
        var members = clazz.prototype;
        var code = [];
        ...
        var store = this.__P_89_16(variant, name);

        this.__P_89_17(code, clazz, config, name);

        this.__P_89_18(code, config, name, variant, incomingValue);

        if (incomingValue || hasCallback) {
          this.__P_89_19(code, config, name);
        }

        if (incomingValue) {
          this.__P_89_20(code, clazz, config, name);
        }

        if (hasCallback) {
          this.__P_89_21(code, incomingValue, store, variant);
        }
        ...
        if (!hasCallback) {
          this.__P_89_22(code, name, variant, incomingValue);
        } else {
          this.__P_89_23(code, config, name, variant, incomingValue);
        }

        if (config.inheritable) {
          this.__P_89_24(code, config, name, variant);
        } else if (hasCallback) {
          this.__P_89_25(code, config, name, variant);
        }

        if (hasCallback) {
          // Emit callback and event firing; Refreshing children (5th parameter) requires the parent/children interface
          this.__P_89_26(code, config, name, variant, !!(config.inheritable && members._getChildren));
        } // Return value
       ...
       */
      __P_89_16: function __P_89_16(variant, name) {
       ...
       * @param name {String} name of the property
       */
      __P_89_17: function __P_89_17(code, clazz, config, name) {
        code.push("var equ=");
       ...
       */
      __P_89_18: function __P_89_18(code, config, name, variant, incomingValue) {
        {
       ...
       * @param name {String} name of the property
       */
      __P_89_20: function __P_89_20(code, clazz, config, name) {
       ...
       * @param variant {String} Method variant.
       */
      __P_89_21: function __P_89_21(code, incomingValue, store, variant) {
       ...
       * @param variant {String} Method variant.
       */
      __P_89_27: qx.core.Environment.select("qx.debug", {
        "true": function _true(code, config, clazz, name, variant) {
          ...
          if (config.check !== undefined) {
            ...
            if (this.__P_89_1[config.check] !== undefined) {
              code.push("!(", this.__P_89_1[config.check], ")");
       ...
       * @param incomingValue {Boolean} Whether the setter has an incoming value
       */
      __P_89_22: function __P_89_22(code, name, variant, incomingValue) {
       ...
       * @param incomingValue {Boolean} Whether the setter has an incoming value
       */
      __P_89_23: function __P_89_23(code, config, name, variant, incomingValue) {
       ...
       * @param name {String} name of the property
       */
      __P_89_19: function __P_89_19(code, config, name) {
        if (config.inheritable) {
       ...
       * @param variant {String} Method variant.
       */
      __P_89_24: function __P_89_24(code, config, name, variant) {
       ...
       * @param variant {String} Method variant.
       */
      __P_89_25: function __P_89_25(code, config, name, variant) {
       ...
       */
      __P_89_26: function __P_89_26(code, config, name, variant, refresh) {
...
//# sourceMappingURL=Property.js.map?dt=1658886802146