  ...
  qx.Bootstrap.define("qx.core.Environment", {
    statics: {
      ...
      get: function get(key) {
        // check the cache
        if (this.__P_33_0[key] != undefined) {
      ...
      getAsync: function getAsync(key, callback, self) {
        ...
        if (this.__P_33_0[key] != undefined) {
          ...
          window.setTimeout(function () {
            callback.call(self, env.__P_33_0[key]);
          }, 0);
          return;
        }
      ...
      select: function select(key, values) {
        return this.__P_33_1(this.get(key), values);
      },
      ...
      selectAsync: function selectAsync(key, values, self) {
        this.getAsync(key, function (result) {
          var value = this.__P_33_1(key, values);
       ...
       */
      __P_33_1: function __P_33_1(key, values) {
      ...
      add: function add(key, check) {
        ...
        if (this._checks[key] == undefined) {
          ...
          if (check instanceof Function) {
            ...
            this._checks[key] = this.__P_33_2(check);
          }
        }
      },
       ...
       */
      __P_33_2: function __P_33_2(value) {
    ...
    defer: function defer(statics) {
      ...
      statics.__P_33_3(); // load the checks from the url
...
//# sourceMappingURL=Environment.js.map?dt=1658886779434