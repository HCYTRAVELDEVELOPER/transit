  ...
  qx.Class.define("qx.data.SingleValueBinding", {
    statics: {
      ...
      bind: function bind(sourceObject, sourcePropertyChain, targetObject, targetPropertyChain, options) {
        ...
        var targetListenerMap = this.__P_98_2(sourceObject, sourcePropertyChain, targetObject, targetPropertyChain, options); // get the property names


        var propertyNames = sourcePropertyChain.split("."); // stuff that's needed to store for the listener function

        var arrayIndexValues = this.__P_98_3(propertyNames);
        ...
        try {
          ...
          for (var i = 0; i < propertyNames.length; i++) {
            ...
            if (arrayIndexValues[i] !== "") {
              ...
              var eventName = this.__P_98_4(source, propertyName);
              ...
              if (!eventName) {
                ...
                initialPromise = this.__P_98_5(undefined, targetObject, targetPropertyChain, options, sourceObject);
                break;
              }
            ...
            if (i == propertyNames.length - 1) {
              ...
              if (arrayIndexValues[i] !== "") {
                ...
                initialPromise = this.__P_98_5(currentValue, targetObject, targetPropertyChain, options, sourceObject); // bind the event

                listenerIds[i] = this.__P_98_6(source, eventNames[i], targetObject, targetPropertyChain, options, arrayIndexValues[i]);
              } else {
                ...
                if (propertyNames[i] != null && source["get" + qx.lang.String.firstUp(propertyNames[i])] != null) {
                  ...
                  initialPromise = this.__P_98_5(currentValue, targetObject, targetPropertyChain, options, sourceObject);
                } // bind the property


                listenerIds[i] = this.__P_98_6(source, eventNames[i], targetObject, targetPropertyChain, options);
              ...
              var listener = qx.lang.Function.bind(this.__P_98_7, this, context); // store the listener for further processing
            ...
            if (!source) {
              ...
              this.__P_98_5(source, targetObject, targetPropertyChain, options, sourceObject);
        ...
        this.__P_98_8(id, sourceObject, sourcePropertyChain, targetObject, targetPropertyChain);
       ...
       */
      __P_98_7: function __P_98_7(context) {
        ...
        for (var j = context.index + 1; j < context.propertyNames.length; j++) {
          ...
          if (!source) {
            ...
            if (context.options && context.options.converter) {
              ...
              if (!ignoreConverter) {
                this.__P_98_9(context.targetObject, context.targetPropertyChain, context.options.converter());
              } else {
                this.__P_98_10(context.targetObject, context.targetPropertyChain);
              }
            } else {
              this.__P_98_10(context.targetObject, context.targetPropertyChain);
            }
          ...
          if (j == context.propertyNames.length - 1) {
            ...
            if (qx.Class.implementsInterface(source, qx.data.IListData) && context.arrayIndexValues[j] !== "") {
              ...
              this.__P_98_5(currentValue, context.targetObject, context.targetPropertyChain, context.options, context.sources[context.index]); // bind the item event to the new target


              context.listenerIds[j] = this.__P_98_6(source, "change", context.targetObject, context.targetPropertyChain, context.options, context.arrayIndexValues[j]);
            } else {
              if (context.propertyNames[j] != null && source["get" + qx.lang.String.firstUp(context.propertyNames[j])] != null) {
                ...
                this.__P_98_5(currentValue, context.targetObject, context.targetPropertyChain, context.options, context.sources[context.index]);
              }

              var eventName = this.__P_98_4(source, context.propertyNames[j]);
              ...
              context.listenerIds[j] = this.__P_98_6(source, eventName, context.targetObject, context.targetPropertyChain, context.options);
            }
          } else {
       ...
       */
      __P_98_2: function __P_98_2(sourceObject, sourcePropertyChain, targetObject, targetPropertyChain, options) {
        ...
        for (var i = 0; i < propertyNames.length - 1; i++) {
          ...
          if (arrayIndexValues[i] !== "") {
            ...
            var eventName = this.__P_98_4(target, propertyNames[i]);
          ...
          var listener = function listener() {
            ...
            for (var j = i + 1; j < propertyNames.length - 1; j++) {
              ...
              if (qx.Class.implementsInterface(target, qx.data.IListData)) {
                ...
                var eventName = qx.data.SingleValueBinding.__P_98_4(target, propertyNames[j]);
      ...
      updateTarget: function updateTarget(sourceObject, sourcePropertyChain, targetObject, targetPropertyChain, options) {
        ...
        value = qx.data.SingleValueBinding.__P_98_11(value, targetObject, targetPropertyChain, options, sourceObject);

        this.__P_98_9(targetObject, targetPropertyChain, value);
      },
      ...
      resolvePropertyChain: function resolvePropertyChain(o, propertyChain) {
        var properties = this.__P_98_12(propertyChain);

        return this.__P_98_13(o, properties, properties.length);
      },
       ...
       */
      __P_98_4: function __P_98_4(source, propertyName) {
        // get the current event name from the property definition
        var eventName = this.__P_98_14(source, propertyName); // if no event name could be found
       ...
       */
      __P_98_10: function __P_98_10(targetObject, targetPropertyChain) {
        // get the last target object of the chain
        var properties = this.__P_98_12(targetPropertyChain);

        var target = this.__P_98_13(targetObject, properties);
        ...
        if (target != null) {
          ...
          var index = this.__P_98_15(lastProperty);

          if (index) {
            this.__P_98_9(targetObject, targetPropertyChain, null);
       ...
       */
      __P_98_9: function __P_98_9(targetObject, targetPropertyChain, value) {
        // get the last target object of the chain
        var properties = this.__P_98_12(targetPropertyChain);
       ...
       */
      __P_98_15: function __P_98_15(propertyName) {
        var arrayExp = /^\[(\d+|last)\]$/;
       ...
       */
      __P_98_12: function __P_98_12(targetPropertyChain) {
       ...
       *   should be set.
       */
      __P_98_13: function __P_98_13(targetObject, targetProperties, index) {
        ...
        for (var i = 0; target !== null && i < index; i++) {
          try {
            ...
            var arrIndex = this.__P_98_15(property);
       ...
       */
      __P_98_5: function __P_98_5(value, targetObject, targetPropertyChain, options, sourceObject) {
        // first convert the initial value
        value = this.__P_98_11(value, targetObject, targetPropertyChain, options, sourceObject); // check if the converted value is undefined

        if (value === undefined) {
          this.__P_98_10(targetObject, targetPropertyChain);
        } // only set the initial value if one is given (may be null)


        if (value !== undefined) {
          try {
            var result = this.__P_98_9(targetObject, targetPropertyChain, value); // tell the user that the setter was invoked probably
       ...
       */
      __P_98_3: function __P_98_3(propertyNames) {
       ...
       *   property.
       */
      __P_98_6: function __P_98_6(sourceObject, sourceEvent, targetObject, targetProperty, options, arrayIndex) {
        // checks
        var bindListener = function bindListener(arrayIndex, e) {
          ...
          if (arrayIndex !== "") {
            ...
            if (data === undefined) {
              qx.data.SingleValueBinding.__P_98_10(targetObject, targetProperty);
          ...
          // convert the data
          data = qx.data.SingleValueBinding.__P_98_11(data, targetObject, targetProperty, options, sourceObject); // debug message
          ...
          try {
            if (data !== undefined) {
              result = qx.data.SingleValueBinding.__P_98_9(targetObject, targetProperty, data);
            } else {
              result = qx.data.SingleValueBinding.__P_98_10(targetObject, targetProperty);
       ...
       *   object.
       */
      __P_98_8: function __P_98_8(id, sourceObject, sourceEvent, targetObject, targetProperty) {
        var hash; // add the listener id to the internal registry

        hash = sourceObject.toHashCode();

        if (this.__P_98_0[hash] === undefined) {
          this.__P_98_0[hash] = [];
        }

        var binding = [id, sourceObject, sourceEvent, targetObject, targetProperty];

        this.__P_98_0[hash].push(binding); // add same binding data indexed by target object


        hash = targetObject.toHashCode();

        if (this.__P_98_1[hash] === undefined) {
          this.__P_98_1[hash] = [];
        }

        this.__P_98_1[hash].push(binding);
      },
       ...
       */
      __P_98_11: function __P_98_11(value, targetObject, targetPropertyChain, options, sourceObject) {
        ...
        if (options && options.converter) {
          ...
          return this.__P_98_16(value, check);
        }
      },
       ...
       */
      __P_98_14: function __P_98_14(sourceObject, sourceProperty) {
        // get the event name
       ...
       */
      __P_98_16: function __P_98_16(data, targetCheck) {
        ...
        if (bindings != undefined) {
          for (var i = 0; i < bindings.length; i++) {
            if (bindings[i][0] == id) {
              ...
              if (this.__P_98_1[target.toHashCode()]) {
                qx.lang.Array.remove(this.__P_98_1[target.toHashCode()], bindings[i]);
              } // remove binding data from internal reference indexed by source object


              var source = bindings[i][1];

              if (this.__P_98_0[source.toHashCode()]) {
                qx.lang.Array.remove(this.__P_98_0[source.toHashCode()], bindings[i]);
              }
      ...
      removeAllBindingsForObject: function removeAllBindingsForObject(object) {
        ...
        delete this.__P_98_0[hash];
        delete this.__P_98_1[hash];
      },
      ...
      getAllBindingsForObject: function getAllBindingsForObject(object) {
        ...
        var sourceBindings = this.__P_98_0[hash]; // get all bindings of object as target

        var targetBindings = this.__P_98_1[hash];
      ...
      showBindingInLog: function showBindingInLog(object, id) {
        ...
        for (var i = 0; i < this.__P_98_0[object.toHashCode()].length; i++) {
          // the first array item is the id
          if (this.__P_98_0[object.toHashCode()][i][0] == id) {
            binding = this.__P_98_0[object.toHashCode()][i];
            break;
          }
        }
      ...
      showAllBindingsInLog: function showAllBindingsInLog() {
        ...
        for (var hash in this.__P_98_0) {
          ...
          if (object) {
            for (var i = 0; i < this.__P_98_0[hash].length; i++) {
              this.showBindingInLog(object, this.__P_98_0[hash][i][0]);
            }
          }
        }
      }
...
//# sourceMappingURL=SingleValueBinding.js.map?dt=1658886805336