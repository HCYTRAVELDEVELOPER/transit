    ...
    members: {
      ...
      _registerEventChaining: function _registerEventChaining(value, old, name) {
        ...
        if (value instanceof qx.core.Object && qx.Class.hasMixin(value.constructor, qx.data.marshal.MEventBubbling)) {
          // create the listener
          var listener = qx.lang.Function.bind(this.__P_82_0, this, name); // add the listener
       ...
       *   change.
       */
      __P_82_0: function __P_82_0(name, e) {
        var data = e.getData();
...
//# sourceMappingURL=MEventBubbling.js.map?dt=1658886801232