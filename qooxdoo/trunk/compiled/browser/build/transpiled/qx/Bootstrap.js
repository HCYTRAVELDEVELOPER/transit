  ...
  qx.Bootstrap.define("qx.Bootstrap", {
    statics: {
      ...
      executePendingDefers: function executePendingDefers(dbClassInfo) {
        ...
        if (!dbClassInfo) {
          var pendingDefers = this.__P_22_0;
          this.__P_22_0 = [];
      ...
      */
       ...
       * @type {String[]}
       */
      __P_22_1: ["isPrototypeOf", "hasOwnProperty", "toLocaleString", "toString", "valueOf", "propertyIsEnumerable", "constructor"],
      ...
      keys: {
        ...
        BROKEN_IE: function BROKEN_IE(map) {
          ...
          var shadowedKeys = qx.Bootstrap.__P_22_1;
      ...
      */
      ...
      getClass: function getClass(value) {
        ...
        return qx.Bootstrap.__P_22_2[classString] || classString.slice(8, -1);
      },
...
//# sourceMappingURL=Bootstrap.js.map?dt=1658886777779