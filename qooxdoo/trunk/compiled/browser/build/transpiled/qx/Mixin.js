  ...
  qx.Bootstrap.define("qx.Mixin", {
    statics: {
      ...
      */
      ...
      __P_88_0: qx.core.Environment.select("qx.debug", {
        "true": {
          include: "object",
          // Mixin | Mixin[]
          statics: "object",
       ...
       */
      __P_88_1: qx.core.Environment.select("qx.debug", {
        "true": function _true(name, config) {
          // Validate keys
          var allowed = this.__P_88_0;
...
//# sourceMappingURL=Mixin.js.map?dt=1658886801798