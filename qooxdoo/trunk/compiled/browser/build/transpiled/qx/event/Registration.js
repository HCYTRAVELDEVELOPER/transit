    ...
    */
    statics: {
      ...
      getManager: function getManager(target) {
        ...
        var manager = this.__P_93_0[hash];

        if (!manager) {
          manager = new qx.event.Manager(target, this);
          this.__P_93_0[hash] = manager;
        }
       ...
       * @see #createEvent
       */
      __P_93_1: function __P_93_1(target, type, clazz, args) {
       ...
       * @see #createEvent
       */
      __P_93_2: function __P_93_2(target, type, clazz, args) {
      ...
      fireNonBubblingEvent: function fireNonBubblingEvent(target, type, clazz, args) {
        var evt = this.__P_93_2.apply(this, arguments);
      ...
      */
      ...
      addHandler: function addHandler(handler) {
        // Append to list
        this.__P_93_3.push(handler); // Re-sort list


        this.__P_93_3.sort(function (a, b) {
      ...
      */
      ...
      addDispatcher: function addDispatcher(dispatcher, priority) {
        // Append to list
        this.__P_93_4.push(dispatcher); // Re-sort list


        this.__P_93_4.sort(function (a, b) {
          return a.PRIORITY - b.PRIORITY;
        });
      },
...
//# sourceMappingURL=Registration.js.map?dt=1658886802936