  ...
  qx.Class.define("qx.event.Manager", {
    ...
    */
    ...
    construct: function construct(win, registration) {
      ...
      this.__P_99_0 = win;
      this.__P_99_1 = qx.core.ObjectRegistry.toHashCode(win);
      this.__P_99_2 = registration; // Register to the page unload event.
      ...
      this.__P_99_3 = {}; // The handler and dispatcher instances

      this.__P_99_4 = {};
      this.__P_99_5 = {};
      this.__P_99_6 = {};
      this.__P_99_7 = new qx.util.DeferredCall(function () {
        this.__P_99_8 = null;
      }, this);
      this.__P_99_7.$$blackListCleaner = true;
    },
    ...
    */
    statics: {
      ...
      removeGlobalEventMonitor: function removeGlobalEventMonitor(fn) {
        qx.core.Assert.assertFunction(fn);
        qx.lang.Array.remove(this.__P_99_10, fn);
      },
    ...
    members: {
      ...
      */
      ...
      getHandler: function getHandler(clazz) {
        var handler = this.__P_99_4[clazz.classname];

        if (handler) {
          return handler;
        }

        return this.__P_99_4[clazz.classname] = new clazz(this);
      },
      ...
      getDispatcher: function getDispatcher(clazz) {
        var dispatcher = this.__P_99_5[clazz.classname];

        if (dispatcher) {
          return dispatcher;
        }

        return this.__P_99_5[clazz.classname] = new clazz(this, this.__P_99_2);
      },
      ...
      */
      ...
      getListeners: function getListeners(target, type, capture) {
        ...
        var targetMap = this.__P_99_3[targetKey];
      ...
      toggleAttachedEvents: function toggleAttachedEvents(target, enable) {
        ...
        if (targetMap) {
          ...
          for (var entryKey in targetMap) {
            ...
            if (enable) {
              this.__P_99_12(target, type, capture);
            } else {
              this.__P_99_13(target, type, capture);
            }
          }
        }
      },
      ...
      importListeners: function importListeners(target, list) {
        ...
        for (var listKey in list) {
          ...
          if (!entryList) {
            ...
            this.__P_99_12(target, item.type, item.capture);
          ...
          entryList.push({
            ...
            context: item.self,
            unique: item.unique || clazz.__P_99_9++ + ""
          });
        }
      },
      ...
      addListener: function addListener(target, type, listener, self, capture) {
        ...
        if (!targetMap) {
          targetMap = this.__P_99_3[targetKey] = {};
        }
        ...
        var unique = qx.event.Manager.__P_99_9++ + "";
        var entry = {
          handler: listener,
          context: self,
          unique: unique
      ...
      findHandler: function findHandler(target, type) {
        ...
        var cache = this.__P_99_6;

        if (cache[key]) {
          return cache[key];
        }

        var classes = this.__P_99_2.getHandlers();
       ...
       */
      __P_99_12: function __P_99_12(target, type, capture) {
      ...
      removeAllListeners: function removeAllListeners(target) {
        ...
        delete this.__P_99_3[targetKey];
        return true;
      },
       ...
       * @throws {Error} if there is no handler for the event
       */
      __P_99_13: function __P_99_13(target, type, capture) {
        var handler = this.findHandler(target, type);
      ...
      */
      ...
      dispatchEvent: function dispatchEvent(target, event) {
        ...
        var monitors = qx.event.Manager.__P_99_10;
        ...
        var classes = this.__P_99_2.getDispatchers();
      ...
      dispose: function dispose() {
        ...
        this.__P_99_2.removeManager(this);

        qx.util.DisposeUtil.disposeMap(this, "__P_99_4");
        qx.util.DisposeUtil.disposeMap(this, "__P_99_5"); // Dispose data fields

        this.__P_99_3 = this.__P_99_0 = this.__P_99_11 = null;
        this.__P_99_2 = this.__P_99_6 = null;
      },
       ...
       */
      __P_99_14: function __P_99_14(uid) {
        if (this.__P_99_8 === null) {
          this.__P_99_8 = {};

          this.__P_99_7.schedule();
        }

        this.__P_99_8[uid] = true;
      },
      ...
      isBlacklisted: function isBlacklisted(uid) {
        return this.__P_99_8 !== null && this.__P_99_8[uid] === true;
      }
    }
  });
...
//# sourceMappingURL=Manager.js.map?dt=1658886805773