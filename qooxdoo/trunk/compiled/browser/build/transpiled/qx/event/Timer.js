  ...
  qx.Class.define("qx.event.Timer", {
    ...
    */
    statics: {
      ...
      once: function once(func, obj, timeout) {
        ...
        timer.__P_73_1 = func; // Add event listener to interval

        timer.addListener("interval", function (e) {
          timer.stop();
          func.call(obj, e);
          delete timer.__P_73_1;
          timer.dispose();
          obj = null;
    ...
    members: {
      ...
      */
      ...
      _applyEnabled: function _applyEnabled(value, old) {
        if (old) {
          window.clearInterval(this.__P_73_2);
          this.__P_73_2 = null;
        } else if (value) {
          this.__P_73_2 = window.setInterval(this.__P_73_0, this.getInterval());
        }
      },
    ...
    */
    destruct: function destruct() {
      ...
      this.__P_73_2 = this.__P_73_0 = null;
    }
  });
  qx.event.Timer.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Timer.js.map?dt=1658886795833