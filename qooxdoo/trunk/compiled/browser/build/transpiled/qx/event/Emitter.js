  ...
  qx.Bootstrap.define("qx.event.Emitter", {
    ...
    members: {
      ...
      on: function on(name, listener, ctx) {
        var id = qx.event.Emitter.__P_37_0.length;

        this.__P_37_3(name).push({
          listener: listener,
          ctx: ctx,
          id: id,
          name: name
        ...
        qx.event.Emitter.__P_37_0.push({
          name: name,
          listener: listener,
          ctx: ctx
        });
      ...
      off: function off(name, listener, ctx) {
        var storage = this.__P_37_3(name);
        ...
        for (var i = storage.length - 1; i >= 0; i--) {
          ...
          if (entry.listener == listener && entry.ctx == ctx) {
            storage.splice(i, 1);
            qx.event.Emitter.__P_37_0[entry.id] = null;
            return entry.id;
          }
        }
      ...
      offById: function offById(id) {
        var entry = qx.event.Emitter.__P_37_0[id];
      ...
      emit: function emit(name, data) {
        var storage = this.__P_37_3(name).concat();
      ...
      getEntryById: function getEntryById(id) {
        for (var name in this.__P_37_1) {
          var store = this.__P_37_1[name];
       ...
       */
      __P_37_3: function __P_37_3(name) {
        if (this.__P_37_1 == null) {
          this.__P_37_1 = {};
        }

        if (this.__P_37_1[name] == null) {
          this.__P_37_1[name] = [];
        }

        return this.__P_37_1[name];
      }
    }
  });
...
//# sourceMappingURL=Emitter.js.map?dt=1658886780424