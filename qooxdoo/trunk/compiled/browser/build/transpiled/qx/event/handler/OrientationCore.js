  ...
  qx.Bootstrap.define("qx.event.handler.OrientationCore", {
    ...
    members: {
      ...
      */
      ...
      _initObserver: function _initObserver() {
        this.__P_51_1 = qx.lang.Function.listener(this._onNative, this); // Handle orientation change event for Android devices by the resize event.
        // See http://stackoverflow.com/questions/1649086/detect-rotation-of-android-phone-in-the-browser-with-javascript
        // for more information.

        this.__P_51_2 = qx.bom.Event.supportsEvent(this._window, "orientationchange") ? "orientationchange" : "resize";
        qx.bom.Event.addNativeListener(this._window, this.__P_51_2, this.__P_51_1);
      },
      ...
      */
      ...
      _stopObserver: function _stopObserver() {
        qx.bom.Event.removeNativeListener(this._window, this.__P_51_2, this.__P_51_1);
      },
      ...
      */
      ...
      _onNative: function _onNative(domEvent) {
        ...
        if (this._currentOrientation != orientation) {
          ...
          if (this.__P_51_0) {
            this.__P_51_0.emit("orientationchange", domEvent);
          }
        }
      }
    },
    ...
    */
    destruct: function destruct() {
      ...
      this.__P_51_3 = this.__P_51_0 = null;
    }
  });
  qx.event.handler.OrientationCore.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=OrientationCore.js.map?dt=1658886784409