  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.event.Utils", {
    ...
    statics: {
       ...
       */
      __P_74_0: function __P_74_0(tracker, newPromise) {
        ...
        "true": function _true(tracker, fn) {
          ...
          if (tracker.promise) {
            if (qx.lang.Type.isPromise(fn)) {
              this.__P_74_0(tracker, tracker.promise.then(fn));
            } else {
              var self = this;

              this.__P_74_0(tracker, tracker.promise.then(function (result) {
                if (tracker.rejected) {
                  return null;
                }
            ...
            this.__P_74_1(tracker);

            return tracker.promise;
          }

          if (qx.lang.Type.isPromise(fn)) {
            return this.__P_74_2(tracker, fn);
          }

          var result = fn(tracker.result);

          if (qx.lang.Type.isPromise(result)) {
            return this.__P_74_2(tracker, result);
          }
       ...
       * @return {qx.Promise} the new promise
       */
      __P_74_2: function __P_74_2(tracker, newPromise) {
        if (tracker.promise) {
          this.__P_74_0(tracker, tracker.promise.then(function () {
            return newPromise;
          }));
        } else {
          this.__P_74_0(tracker, newPromise);
        }
      ...
      reject: function reject(tracker) {
        ...
        var result = this.__P_74_3(tracker);
       ...
       * @param tracker {Object} the tracker object
       */
      __P_74_1: function __P_74_1(tracker) {
        if (tracker.promise && tracker["catch"]) {
          if (!tracker.promise["qx.event.Utils.hasCatcher"]) {
            this.__P_74_0(tracker, tracker.promise["catch"](this.__P_74_3.bind(this, tracker)));
       ...
       * @param tracker {Object} the tracker object
       */
      __P_74_3: function __P_74_3(tracker, err) {
...
//# sourceMappingURL=Utils.js.map?dt=1658886795941