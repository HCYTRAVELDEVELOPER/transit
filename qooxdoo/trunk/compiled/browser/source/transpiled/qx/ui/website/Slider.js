    ...
    members: {
      ...
      setValue(value) {
        ...
        if (qxWeb.type.get(step) != "Array" || step.indexOf(value) != -1) {
          this.__valueToPosition__P_17_1(value);
      ...
      _onPointerDown(e) {
        ...
        if (this.__dragMode__P_17_0) {
          return;
        }

        this.__dragMode__P_17_0 = true;
       ...
       */
      _onDocPointerUp(e) {
        if (this.__dragMode__P_17_0 === true) {
          // Cleanup status flags
          delete this.__dragMode__P_17_0;

          this.__valueToPosition__P_17_1(this.getValue());
      ...
      _onWindowResize() {
        ...
        this.__valueToPosition__P_17_1(this._value);
      },
       ...
       */
      __valueToPosition__P_17_1(value) {
        var pixels = this._getPixels();
...
//# sourceMappingURL=Slider.js.map?dt=1658886713281