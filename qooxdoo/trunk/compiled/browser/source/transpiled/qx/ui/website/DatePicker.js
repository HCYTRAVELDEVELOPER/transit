  ...
  qx.Bootstrap.define("qx.ui.website.DatePicker", {
    ...
    members: {
      ...
      init(date) {
        ...
        this.__setReadOnly__P_16_1(this);

        this.__setIcon__P_16_2(this);

        this.__addInputListener__P_16_3(this);
      ...
      setConfig(name, config) {
        if (name === "position") {
          var validPositions = qx.ui.website.DatePicker.__validPositions__P_16_0;
       ...
       */
      __setReadOnly__P_16_1(collection) {
       ...
       * @param collection {qxWeb} collection to work on
       */
      __addInputListener__P_16_3(collection) {
    ...
    defer(statics) {
      ...
      statics.__validPositions__P_16_0 = ["top-left", "top-center", "top-right", "bottom-left", "bottom-center", "bottom-right", "left-top", "left-middle", "left-bottom", "right-top", "right-middle", "right-bottom"];
    }
...
//# sourceMappingURL=DatePicker.js.map?dt=1658886713044