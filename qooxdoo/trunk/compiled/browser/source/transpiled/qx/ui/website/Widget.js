  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.ui.website.Widget", {
    ...
    members: {
       ...
       */
      getCssPrefix() {
        if (!this.__cssPrefix__P_20_0) {
          var split = this.classname.split(".");
          this.__cssPrefix__P_20_0 = "qx-" + split[split.length - 1].toLowerCase();
        }

        return this.__cssPrefix__P_20_0;
      },
...
//# sourceMappingURL=Widget.js.map?dt=1658886713757