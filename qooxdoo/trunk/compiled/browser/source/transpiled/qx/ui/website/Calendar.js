    ...
    members: {
      ...
      setValue(value) {
        ...
        if (this.getConfig("selectionMode") == "single") {
          ...
          if (!this.__range__P_14_0) {
            this.__range__P_14_0 = value.map(function (val) {
      ...
      _selectDay(e) {
        ...
        if (this.getConfig("selectionMode") == "range") {
          var range = this.__range__P_14_0.slice(0);
        ...
        for (var week = 0; week < 6; week++) {
          ...
          for (var i = 0; i < 7; i++) {
            ...
            if (this.getConfig("selectionMode") == "range" && qx.Bootstrap.isArray(this._value)) {
              ...
              var range = this.__range__P_14_0;
...
//# sourceMappingURL=Calendar.js.map?dt=1658886712748