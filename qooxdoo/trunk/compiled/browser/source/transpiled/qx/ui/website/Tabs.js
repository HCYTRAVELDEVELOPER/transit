(function () {
  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.ui.website.Tabs", {
    ...
    members: {
      __mediaQueryListener__P_19_0: null,
      ...
      init() {
        ...
        buttons._forEachElementWrapped(function (button) {
          ...
          if (page.length > 0) {
            ...
            if (orientation == "vertical") {
              this.__deactivateTransition__P_19_1(page);
          ...
          this.__activateTransition__P_19_2(page);
        }.bind(this));
        ...
        if (active.length > 0) {
          ...
          this.__deactivateTransition__P_19_1(activePage);

          this._showPage(active, null);

          this.__activateTransition__P_19_2(activePage);
        }
      ...
      _initMediaQueryListener(mediaQuery) {
        var mql = this.__mediaQueryListener__P_19_0;

        if (!mql) {
          mql = q.matchMedia(mediaQuery);
          this.__mediaQueryListener__P_19_0 = mql;
       ...
       */
      __deactivateTransition__P_19_1(elem) {
       ...
       * @param elem {qxWeb} Element
       */
      __activateTransition__P_19_2(elem) {
      ...
      dispose() {
        this.__mediaQueryListener__P_19_0 = undefined;
...
//# sourceMappingURL=Tabs.js.map?dt=1658886713718