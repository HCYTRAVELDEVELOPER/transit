  ...
  qx.Bootstrap.define("qx.Mixin", {
    statics: {
      ...
      */
      ...
      define(name, config) {
        if (config) {
          ...
          {
            this.__validateConfig__P_91_0(name, config);
      ...
      baseClassMethod(clazz, mixin, methodName) {
        {
          ...
          if (fn) {
            ...
            throw new Error("Cannot find base class method called " + methodName + " for mixin " + mixin.name + ", when viewed from " + clazz.classname);
          }
      ...
      */
      ...
      __allowedKeys__P_91_1: qx.core.Environment.select("qx.debug", {
        true: {
          include: "object",
          // Mixin | Mixin[]
          statics: "object",
       ...
       */
      __validateConfig__P_91_0: qx.core.Environment.select("qx.debug", {
        true(name, config) {
          // Validate keys
          var allowed = this.__allowedKeys__P_91_1;
...
//# sourceMappingURL=Mixin.js.map?dt=1658886731710