(function () {
  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.dev.FakeServer", {
    ...
    members: {
      __sinon__P_49_1: null,
      __fakeServer__P_49_2: null,
      __responses__P_49_0: null,
      __filter__P_49_3: null,
      ...
      configure(responseData) {
        responseData.forEach(function (item) {
          ...
          for (var i = 0, l = this.__responses__P_49_0.length; i < l; i++) {
            var old = this.__responses__P_49_0[i];
            hasResponse = old[0] == response[0] && old[1] == response[1];
          }

          if (!hasResponse) {
            this.__responses__P_49_0.push(response);
          }

          this.respondWith(item.method, urlRegExp, item.response);
        }.bind(this));

        var filter = this.__filter__P_49_3 = this.__getCombinedFilter__P_49_4();
      ...
      addFilter(filter) {
        ...
        this.__sinon__P_49_1.FakeXMLHttpRequest.addFilter(filter);
      },
       ...
       */
      removeFilter(filter) {
        qx.lang.Array.remove(this.__sinon__P_49_1.FakeXMLHttpRequest.filters, filter);
      },
      ...
      removeResponse(method, url) {
        qx.lang.Array.remove(this.__sinon__P_49_1.FakeXMLHttpRequest.filters, this.__filter__P_49_3);
        var urlRegExp = url instanceof RegExp ? url : this._getRegExp(url);
        this.__responses__P_49_0 = this.__responses__P_49_0.filter(function (response) {
          return response[0] != method || response[1].toString() != urlRegExp.toString();
        });
        this.__fakeServer__P_49_2.responses = this.__fakeServer__P_49_2.responses.filter(function (response) {
          return response.method != method || response.url.toString() != urlRegExp.toString();
        });
        this.removeFilter(this.__filter__P_49_3);
        this.__filter__P_49_3 = this.__getCombinedFilter__P_49_4();
        this.addFilter(this.__filter__P_49_3);
      },
       ...
       */
      getFakeServer() {
        if (!this.__fakeServer__P_49_2) {
          var sinon = this.__sinon__P_49_1 = qx.dev.unit.Sinon.getSinon();
          sinon.FakeXMLHttpRequest.useFilters = true;
          this.__fakeServer__P_49_2 = sinon.sandbox.useFakeServer();
          this.__fakeServer__P_49_2.autoRespond = true;
        }

        return this.__fakeServer__P_49_2;
      },
      ...
      restore() {
        this.__responses__P_49_0 = [];
        this.removeFilter(this.__filter__P_49_3);
        this.__filter__P_49_3 = null;

        this.__fakeServer__P_49_2.restore();

        this.__fakeServer__P_49_2 = null;
      },
       ...
       */
      __getCombinedFilter__P_49_4() {
        var responses = this.__responses__P_49_0;
    ...
    destruct() {
      this.restore();
      this.__fakeServer__P_49_2 = this.__sinon__P_49_1 = null;
    }
...
//# sourceMappingURL=FakeServer.js.map?dt=1658886718299