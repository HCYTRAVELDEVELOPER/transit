  ...
  qx.Bootstrap.define("qx.Class", {
    statics: {
      ...
      */
      ...
      define(name, config) {
        try {
          return this.__defineImpl__P_82_1(name, config);
        } catch (ex) {
       ...
       * @returns  @see `define()`
       */
      __defineImpl__P_82_1(name, config) {
        if (!config) {
          config = {};
        ...
        {
          try {
            this.__validateConfig__P_82_2(name, config);
          } catch (ex) {
            if (implicitType) {
        ...
        var clazz = this.__createClass__P_82_3(name, config.type, config.extend, config.statics, config.construct, config.destruct, config.include); // Initialise class and constructor/destructor annotations


        ["@", "@construct", "@destruct"].forEach(function (id) {
          this.__attachAnno__P_82_4(clazz, id, null, config[id]);
        }, this); // Members, properties, events and mixins are only allowed for non-static classes

        if (config.extend) {
          // Attach properties
          if (config.properties) {
            this.__addProperties__P_82_5(clazz, config.properties, true);
          } // Attach members


          if (config.members) {
            this.__addMembers__P_82_6(clazz, config.members, true, true, false);
          } // Process events


          if (config.events) {
            this.__addEvents__P_82_7(clazz, config.events, true);
          } // Include mixins
          ...
          if (config.include) {
            for (var i = 0, l = config.include.length; i < l; i++) {
              this.__addMixin__P_82_8(clazz, config.include[i], false);
            }
          }
        ...
        if (config.implement) {
          for (var i = 0, l = config.implement.length; i < l; i++) {
            this.__addInterface__P_82_9(clazz, config.implement[i]);
          }
        }

        {
          this.__validateAbstractInterfaces__P_82_10(clazz);
        } // Process defer
          ...
          qx.Bootstrap.addPendingDefer(clazz, function () {
            ...
            config.defer(clazz, clazz.prototype, {
              add(name, config) {
                ...
                qx.Class.__addProperties__P_82_5(clazz, properties, true);
              }
      ...
      include(clazz, mixin) {
        ...
        qx.Class.__addMixin__P_82_8(clazz, mixin, false);
      },
      ...
      patch(clazz, mixin) {
        ...
        qx.Class.__addMixin__P_82_8(clazz, mixin, true);
      ...
      */
      ...
      __allowedKeys__P_82_11: qx.core.Environment.select("qx.debug", {
        true: {
          "@": "object",
          "@construct": "object",
          "@destruct": "object",
      ...
      __staticAllowedKeys__P_82_12: qx.core.Environment.select("qx.debug", {
        true: {
          "@": "object",
          type: "string",
          // String
       ...
       */
      __validateConfig__P_82_2: qx.core.Environment.select("qx.debug", {
        true(name, config) {
          // Validate type
          ...
          var allowed = config.type === "static" ? this.__staticAllowedKeys__P_82_12 : this.__allowedKeys__P_82_11;
       ...
       */
      __validateAbstractInterfaces__P_82_10: qx.core.Environment.select("qx.debug", {
        true(clazz) {
       ...
       */
      __attachAnno__P_82_4(clazz, group, key, anno) {
        if (anno !== undefined) {
       ...
       */
      __createClass__P_82_3(name, type, extend, statics, construct, destruct, mixins) {
        ...
        if (!extend && true) {
          ...
          if (extend) {
            ...
            if (!construct) {
              construct = this.__createDefaultConstructor__P_82_13();
            }

            clazz = this.__wrapConstructor__P_82_14(construct, name, type); // Add singleton getInstance()
          ...
          if (statics) {
            ...
            for (var i = 0, a = Object.keys(statics), l = a.length; i < l; i++) {
              ...
              this.__attachAnno__P_82_4(clazz, "statics", key, statics["@" + key]);
            }
          }
        } // Create namespace
      ...
      */
       ...
       */
      __addEvents__P_82_7(clazz, events, patch) {
        {
       ...
       */
      __addProperties__P_82_5(clazz, properties, patch) {
        ...
        for (var name in properties) {
          ...
          {
            this.__validateProperty__P_82_15(clazz, name, config, patch);
          ...
          if (config.event !== undefined) {
            ...
            this.__addEvents__P_82_7(clazz, event, patch);
          } // Remember inheritable properties


          if (config.inheritable) {
            this.__Property__P_82_0.$$inheritable[name] = true;

            if (!proto.$$refreshInheritables) {
              this.__Property__P_82_0.attachRefreshInheritables(clazz);
            }
          }

          if (!config.refine) {
            this.__Property__P_82_0.attachMethods(clazz, name, config);
          } // Add annotations


          this.__attachAnno__P_82_4(clazz, "properties", name, config["@"]);
        }
      },
       ...
       */
      __validateProperty__P_82_15: qx.core.Environment.select("qx.debug", {
        true(clazz, name, config, patch) {
          ...
          var allowed = config.group ? this.__Property__P_82_0.$$allowedGroupKeys : this.__Property__P_82_0.$$allowedKeys;
       ...
       */
      __addMembers__P_82_6(clazz, members, patch, base, wrap) {
        var proto = clazz.prototype;
        var key, member;
        ...
        for (var i = 0, a = Object.keys(members), l = a.length; i < l; i++) {
          ...
          if (key.charAt(0) === "@") {
            ...
            if (members[annoKey] === undefined) {
              this.__attachAnno__P_82_4(clazz, "members", annoKey, members[key]);
            }
          ...
          this.__attachAnno__P_82_4(clazz, "members", key, members["@" + key]);
        }
      },
       ...
       */
      __addInterface__P_82_9(clazz, iface) {
        {
          if (!clazz || !iface) {
       ...
       */
      __addMixin__P_82_8(clazz, mixin, patch) {
        {
          if (!clazz || !mixin) {
            throw new Error("Incomplete parameters!");
          }
        ...
        for (var i = 0, l = list.length; i < l; i++) {
          ...
          if (entry.$$events) {
            this.__addEvents__P_82_7(clazz, entry.$$events, patch);
          } // Attach properties (Properties are already readonly themselves, no patch handling needed)


          if (entry.$$properties) {
            this.__addProperties__P_82_5(clazz, entry.$$properties, patch);
          } // Attach members (Respect patch setting, but dont apply base variables)


          if (entry.$$members) {
            this.__addMembers__P_82_6(clazz, entry.$$members, patch, patch, patch);
          }
      ...
      */
       ...
       */
      __createDefaultConstructor__P_82_13() {
       ...
       */
      __wrapConstructor__P_82_14(construct, name, type) {
...
//# sourceMappingURL=Class.js.map?dt=1658886731094