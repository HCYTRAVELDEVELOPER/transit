    ...
    statics: {
      ...
      getDelta(domEvent, axis) {
        ...
        if (axis === undefined) {
          ...
          return this.__normalize__P_73_0(delta);
        ...
        if (axis === "x") {
          ...
          if (domEvent.wheelDelta !== undefined) {
            if (domEvent.wheelDeltaX !== undefined) {
              x = domEvent.wheelDeltaX ? this.__normalize__P_73_0(-domEvent.wheelDeltaX) : 0;
            }
          } else {
            if (domEvent.axis && domEvent.axis == domEvent.HORIZONTAL_AXIS && domEvent.detail !== undefined && domEvent.detail > 0) {
              x = this.__normalize__P_73_0(domEvent.detail);
            } else if (domEvent.deltaX !== undefined) {
              x = this.__normalize__P_73_0(domEvent.deltaX);
            }
          }
        ...
        if (axis === "y") {
          ...
          if (domEvent.wheelDelta !== undefined) {
            if (domEvent.wheelDeltaY !== undefined) {
              y = domEvent.wheelDeltaY ? this.__normalize__P_73_0(-domEvent.wheelDeltaY) : 0;
            } else {
              y = this.__normalize__P_73_0(-domEvent.wheelDelta);
            }
          } else {
            if (!(domEvent.axis && domEvent.axis == domEvent.HORIZONTAL_AXIS) && domEvent.detail !== undefined && domEvent.detail > 0) {
              y = this.__normalize__P_73_0(domEvent.detail);
            } else if (domEvent.deltaY !== undefined) {
              y = this.__normalize__P_73_0(domEvent.deltaY);
            }
          }
      ...
      __normalize__P_73_0(delta) {
        ...
        if (qx.util.Wheel.MINSCROLL == null || qx.util.Wheel.MINSCROLL > absDelta) {
          ...
          this.__recalculateMultiplicator__P_73_1();
        } // store the max value
       ...
       */
      __recalculateMultiplicator__P_73_1() {
...
//# sourceMappingURL=Wheel.js.map?dt=1658886726714