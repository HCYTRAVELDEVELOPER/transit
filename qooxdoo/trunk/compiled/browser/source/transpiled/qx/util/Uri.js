  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.util.Uri", {
    statics: {
          ...
          if (obj.hasOwnProperty(key)) {
            ...
            if (value instanceof Array) {
              for (var i = 0; i < value.length; i++) {
                this.__toParameterPair__P_62_0(key, value[i], parts, post);
              }
            } else {
              this.__toParameterPair__P_62_0(key, value, parts, post);
            }
          }
        }
       ...
       * @param post {Boolean} Whether spaces should be encoded with "+".
       */
      __toParameterPair__P_62_0(key, value, parts, post) {
...
//# sourceMappingURL=Uri.js.map?dt=1658886721060