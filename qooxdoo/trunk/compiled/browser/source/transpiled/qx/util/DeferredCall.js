  ...
  qx.Class.define("qx.util.DeferredCall", {
    ...
    */
    ...
    construct(callback, context) {
      ...
      this.__callback__P_103_0 = callback;
      this.__context__P_103_1 = context || null;
      this.__manager__P_103_2 = qx.util.DeferredCallManager.getInstance();
    },
    ...
    */
    members: {
      __callback__P_103_0: null,
      __context__P_103_1: null,
      __manager__P_103_2: null,

      /**
       * Prevent the callback from being called.
       */
      cancel() {
        this.__manager__P_103_2.cancel(this);
      },
       ...
       */
      schedule() {
        this.__manager__P_103_2.schedule(this);
      },
      ...
      call() {
        {
          ...
          var context = this.__context__P_103_1;
        ...
        this.__context__P_103_1 ? this.__callback__P_103_0.apply(this.__context__P_103_1) : this.__callback__P_103_0();
      }
    ...
    */
    destruct() {
      this.cancel();
      this.__context__P_103_1 = this.__callback__P_103_0 = this.__manager__P_103_2 = null;
    }
...
//# sourceMappingURL=DeferredCall.js.map?dt=1658886735013