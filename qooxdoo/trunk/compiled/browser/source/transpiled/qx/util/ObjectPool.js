    ...
    members: {
      ...
      */
      ...
      getObject(clazz) {
        ...
        var obj = null;
        var pool = this.__pool__P_104_0[clazz.classname];
      ...
      poolObject(obj) {
        // Dispose check
        if (!this.__pool__P_104_0) {
          return;
        }

        var classname = obj.classname;
        var pool = this.__pool__P_104_0[classname];
        ...
        if (!pool) {
          this.__pool__P_104_0[classname] = pool = [];
...
//# sourceMappingURL=ObjectPool.js.map?dt=1658886735049