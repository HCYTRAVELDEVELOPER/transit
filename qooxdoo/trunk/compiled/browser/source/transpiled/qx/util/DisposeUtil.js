    ...
    statics: {
      ...
      destroyContainer(container) {
        {
          if (qx.ui.mobile && container instanceof qx.ui.mobile.core.Widget) {
            qx.core.Assert.assertTrue(this.__isChildrenContainer__P_97_0(container), "Container must be an instance of qx.ui.mobile.container.Composite.");
          } else {
            qx.core.Assert.assertQxWidget(container, "First argument must be a container widget!");
            qx.core.Assert.assertTrue(this.__isChildrenContainer__P_97_0(container), "Container must be an instance of qx.ui.container.Composite or qx.ui.container.Scroll or qx.ui.container.Resizer or qx.ui.container.SlideBar or qx.ui.container.Stack!");
          }
        }
        var arr = [];
      ...
      _collectContainerChildren(container, arr) {
        ...
        for (var i = 0; i < children.length; i++) {
          ...
          if (this.__isChildrenContainer__P_97_0(item)) {
       ...
       * child widgets
       */
      __isChildrenContainer__P_97_0(obj) {
        var classes = [];
...
//# sourceMappingURL=DisposeUtil.js.map?dt=1658886732829