      ...
      create(func, options) {
...

        {
          function testSelf(self) {
            if (qx.core.Object && self && qx.Bootstrap.isObject(self) && self.isDisposed && qx.Bootstrap.isFunction(self.isDisposed)) {
              if (self.isDisposed()) {
                qx.core.Assert && qx.core.Assert.fail("Trying to call a bound function with a disposed object as context: " + self.toString() + " :: " + qx.lang.Function.getName(func));
              }
            }
          }
        }
...
//# sourceMappingURL=Function.js.map?dt=1658886721160