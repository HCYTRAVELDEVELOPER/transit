  ...
  qx.Bootstrap.define("qx.Interface", {
    statics: {
      ...
      */
      ...
      define(name, config) {
        if (config) {
          ...
          {
            this.__validateConfig__P_76_0(name, config);
       ...
       */
      __checkMembers__P_76_1(object, clazz, iface, wrap, shouldThrow) {
        // Validate members
        ...
        if (members) {
          for (var key in members) {
            if (qx.Bootstrap.isFunction(members[key])) {
              var isPropertyMethod = this.__isPropertyMethod__P_76_2(clazz, key);
              ...
              if (shouldWrapFunction) {
                object[key] = this.__wrapInterfaceMember__P_76_3(iface, object[key], key, members[key]);
              }
            } else {
       ...
       *   system.
       */
      __isPropertyMethod__P_76_2(clazz, methodName) {
       ...
       */
      __checkProperties__P_76_4(clazz, iface, shouldThrow) {
        if (iface.$$properties) {
       ...
       */
      __checkEvents__P_76_5(clazz, iface, shouldThrow) {
        if (iface.$$events) {
      ...
      assertObject(object, iface) {
        ...
        this.__checkMembers__P_76_1(object, clazz, iface, false, true);

        this.__checkProperties__P_76_4(clazz, iface, true);

        this.__checkEvents__P_76_5(clazz, iface, true); // Validate extends, recursive
      ...
      assert(clazz, iface, wrap) {
        this.__checkMembers__P_76_1(clazz.prototype, clazz, iface, wrap, true);
      ...
      objectImplements(object, iface) {
        ...
        if (!this.__checkMembers__P_76_1(object, clazz, iface) || !this.__checkProperties__P_76_4(clazz, iface) || !this.__checkEvents__P_76_5(clazz, iface)) {
          return false;
      ...
      classImplements(clazz, iface) {
        if (!this.__checkMembers__P_76_1(clazz.prototype, clazz, iface) || !this.__checkProperties__P_76_4(clazz, iface) || !this.__checkEvents__P_76_5(clazz, iface)) {
          return false;
        } // Validate extends, recursive
      ...
      */
       ...
       */
      __wrapInterfaceMember__P_76_3: qx.core.Environment.select("qx.debug", {
      ...
      __allowedKeys__P_76_6: qx.core.Environment.select("qx.debug", {
        true: {
          extend: "object",
          // Interface | Interface[]
          statics: "object",
       ...
       */
      __validateConfig__P_76_0: qx.core.Environment.select("qx.debug", {
        true(name, config) {
          {
            // Validate keys
            var allowed = this.__allowedKeys__P_76_6;
...
//# sourceMappingURL=Interface.js.map?dt=1658886730264