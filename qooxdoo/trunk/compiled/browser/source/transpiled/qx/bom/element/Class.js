  ...
  qx.Bootstrap.define("qx.bom.element.Class", {
    ...
    */
    statics: {
      ...
      __splitter__P_32_0: /\s+/g,

      /** @type {RegExp} String trim regular expression. */
      __trim__P_32_1: /^\s+|\s+$/g,
      ...
      addClasses: {
        ...
        default(element, classes) {
          ...
          if (old) {
            result = old.split(this.__splitter__P_32_0);
      ...
      removeClasses: {
        ...
        default(element, classes) {
          ...
          return element.className = element.className.replace(reg, "").replace(this.__trim__P_32_1, "").replace(this.__splitter__P_32_0, " ");
        }
...
//# sourceMappingURL=Class.js.map?dt=1658886715262