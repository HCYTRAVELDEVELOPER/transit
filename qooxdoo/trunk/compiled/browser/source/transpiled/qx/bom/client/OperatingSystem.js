  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.client.OperatingSystem", {
    statics: {
       ...
       */
      getVersion() {
        var version = qx.bom.client.OperatingSystem.__getVersionForDesktopOs__P_60_1(navigator.userAgent);

        if (version == null) {
          version = qx.bom.client.OperatingSystem.__getVersionForMobileOs__P_60_2(navigator.userAgent);
        }
       ...
       */
      __getVersionForDesktopOs__P_60_1(userAgent) {
        var str = [];

        for (var key in qx.bom.client.OperatingSystem.__ids__P_60_0) {
          str.push(key);
        }
        ...
        if (match && match[1]) {
          return qx.bom.client.OperatingSystem.__ids__P_60_0[match[1]];
        }
       ...
       * @return {String} version number as string or null.
       */
      __getVersionForMobileOs__P_60_2(userAgent) {
...
//# sourceMappingURL=OperatingSystem.js.map?dt=1658886720762