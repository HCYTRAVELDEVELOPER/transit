  ...
  qx.Bootstrap.define("qx.bom.element.BoxSizing", {
    ...
    */
    statics: {
       ...
       */
      __usesNativeBorderBox__P_63_1(element) {
        var map = this.__nativeBorderBox__P_63_0;
      ...
      get(element) {
        ...
        if (qx.bom.Document.isStandardMode(qx.dom.Node.getWindow(element))) {
          if (!this.__usesNativeBorderBox__P_63_1(element)) {
            return "content-box";
          }
        }
...
//# sourceMappingURL=BoxSizing.js.map?dt=1658886721093