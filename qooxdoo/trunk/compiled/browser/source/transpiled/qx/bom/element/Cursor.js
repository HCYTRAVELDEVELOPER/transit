  ...
  qx.Bootstrap.define("qx.bom.element.Cursor", {
    ...
    */
    statics: {
       ...
       */
      compile(cursor) {
        return "cursor:" + (this.__map__P_65_0[cursor] || cursor) + ";";
      },
       ...
       */
      set(element, value) {
        element.style.cursor = this.__map__P_65_0[value] || value;
      },
    ...
    defer(statics) {
      ...
      if (qx.core.Environment.get("engine.name") == "mshtml" && (parseFloat(qx.core.Environment.get("engine.version")) < 9 || qx.core.Environment.get("browser.documentmode") < 9) && !qx.core.Environment.get("browser.quirksmode")) {
        statics.__map__P_65_0["nesw-resize"] = "ne-resize";
        statics.__map__P_65_0["nwse-resize"] = "nw-resize";
      }
    }
...
//# sourceMappingURL=Cursor.js.map?dt=1658886721438