  ...
  qx.Bootstrap.define("qx.bom.element.Animation", {
    statics: {
      ...
      animate(el, desc, duration) {
        var onlyCssKeys = qx.bom.element.Animation.__hasOnlyCssKeys__P_23_0(el, desc.keyFrames);
       ...
       */
      __hasOnlyCssKeys__P_23_0(el, keyFrames) {
        var keys = [];
...
//# sourceMappingURL=Animation.js.map?dt=1658886714044