  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.element.AnimationHandle", {
    ...
    construct() {
      ...
      this.__playState__P_78_0 = css && css["play-state"];
      this.__playing__P_78_1 = true;
      this.addListenerOnce("end", this.__setEnded__P_78_2, this);
    },
    ...
    members: {
      __playState__P_78_0: null,
      __playing__P_78_1: false,
      __ended__P_78_3: false,
       ...
       */
      isPaused() {
        return this.el.style[this.__playState__P_78_0] == "paused";
      },
      ...
      pause() {
        if (this.el) {
          this.el.style[this.__playState__P_78_0] = "paused";
          this.el.$$animation.__playing__P_78_1 = false; // in case the animation is based on JS
      ...
      play() {
        if (this.el) {
          this.el.style[this.__playState__P_78_0] = "running";
          this.el.$$animation.__playing__P_78_1 = true; // in case the animation is based on JS
      ...
      stop() {
        if (this.el && qx.core.Environment.get("css.animation") && !this.jsAnimation) {
          this.el.style[this.__playState__P_78_0] = "";
          this.el.style[qx.core.Environment.get("css.animation").name] = "";
          this.el.$$animation.__playing__P_78_1 = false;
          this.el.$$animation.__ended__P_78_3 = true;
       ...
       */
      __setEnded__P_78_2() {
        this.__playing__P_78_1 = false;
        this.__ended__P_78_3 = true;
      }
...
//# sourceMappingURL=AnimationHandle.js.map?dt=1658886730553