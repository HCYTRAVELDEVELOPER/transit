  ...
  qx.Bootstrap.define("qx.bom.request.Jsonp", {
    ...
    members: {
      ...
      open(method, url) {
        ...
        this.__callbackCalled__P_40_4 = false;
        callbackParam = this.__callbackParam__P_40_2 || "callback";
        callbackName = this.__callbackName__P_40_3 || this.__prefix__P_40_8 + "qx.bom.request.Jsonp." + this.__id__P_40_1 + ".callback"; // Default callback

        if (!this.__callbackName__P_40_3) {
          // Store globally available reference to this object
          this.constructor[this.__id__P_40_1] = this; // Custom callback
        } else {
          // Dynamically create globally available callback (if it does not
          // exist yet) with user defined name. Delegate to this object’s
          // callback method.
          if (!window[this.__callbackName__P_40_3]) {
            this.__customCallbackCreated__P_40_5 = true;

            window[this.__callbackName__P_40_3] = function (data) {
              that.callback(data);
            };
          } else {
            if (qx.core.Environment.get("qx.debug.io")) {
              qx.Bootstrap.debug(qx.bom.request.Jsonp, "Callback " + this.__callbackName__P_40_3 + " already exists");
            }
          }
        }
        ...
        this.__generatedUrl__P_40_6 = url = qx.util.Uri.appendParamsToUrl(url, query);

        this.__callBase__P_40_9("open", [method, url]);
      },
      ...
      callback(data) {
        ...
        this.__callbackCalled__P_40_4 = true; // Sanitize and parse
        ...
        this.constructor[this.__id__P_40_1] = undefined;

        this.__deleteCustomCallback__P_40_10();
      },
      ...
      setCallbackParam(param) {
        this.__callbackParam__P_40_2 = param;
        return this;
      },
      ...
      setCallbackName(name) {
        this.__callbackName__P_40_3 = name;
        return this;
      },
       ...
       */
      getGeneratedUrl() {
        return this.__generatedUrl__P_40_6;
      },
      ...
      dispose() {
        ...
        this.__callBase__P_40_9("dispose");
      },
      ...
      _onNativeLoad() {
        ...
        this.status = this.__callbackCalled__P_40_4 ? 200 : 500;

        this.__callBase__P_40_9("_onNativeLoad");
      },

      /**
       *  Delete custom callback if dynamically created before.
       */
      __deleteCustomCallback__P_40_10() {
        if (this.__customCallbackCreated__P_40_5 && window[this.__callbackName__P_40_3]) {
          window[this.__callbackName__P_40_3] = undefined;
          this.__customCallbackCreated__P_40_5 = false;
        }
      },
       ...
       */
      __callBase__P_40_9(method, args) {
...
//# sourceMappingURL=Jsonp.js.map?dt=1658886716424