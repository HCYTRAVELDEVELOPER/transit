  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.element.Transform", {
    statics: {
      ...
      __cssKeys__P_48_0: qx.core.Environment.get("css.transform"),
      ...
      transform(el, transforms) {
        ...
        if (this.__cssKeys__P_48_0 != null) {
          var style = this.__cssKeys__P_48_0["name"];
      ...
      setOrigin(el, value) {
        if (this.__cssKeys__P_48_0 != null) {
          el.style[this.__cssKeys__P_48_0["origin"]] = value;
        }
      },
      ...
      getOrigin(el) {
        if (this.__cssKeys__P_48_0 != null) {
          return el.style[this.__cssKeys__P_48_0["origin"]];
        }
      ...
      setStyle(el, value) {
        if (this.__cssKeys__P_48_0 != null) {
          el.style[this.__cssKeys__P_48_0["style"]] = value;
        }
      },
      ...
      getStyle(el) {
        if (this.__cssKeys__P_48_0 != null) {
          return el.style[this.__cssKeys__P_48_0["style"]];
        }
      ...
      setPerspective(el, value) {
        if (this.__cssKeys__P_48_0 != null) {
          el.style[this.__cssKeys__P_48_0["perspective"]] = value + "px";
        }
      },
      ...
      getPerspective(el) {
        if (this.__cssKeys__P_48_0 != null) {
          return el.style[this.__cssKeys__P_48_0["perspective"]];
        }
      ...
      setPerspectiveOrigin(el, value) {
        if (this.__cssKeys__P_48_0 != null) {
          el.style[this.__cssKeys__P_48_0["perspective-origin"]] = value;
        }
      },
      ...
      getPerspectiveOrigin(el) {
        if (this.__cssKeys__P_48_0 != null) {
          var value = el.style[this.__cssKeys__P_48_0["perspective-origin"]];

          if (value != "") {
            return value;
          } else {
            var valueX = el.style[this.__cssKeys__P_48_0["perspective-origin"] + "X"];
            var valueY = el.style[this.__cssKeys__P_48_0["perspective-origin"] + "Y"];
      ...
      setBackfaceVisibility(el, value) {
        if (this.__cssKeys__P_48_0 != null) {
          el.style[this.__cssKeys__P_48_0["backface-visibility"]] = value ? "visible" : "hidden";
        }
      },
      ...
      getBackfaceVisibility(el) {
        if (this.__cssKeys__P_48_0 != null) {
          return el.style[this.__cssKeys__P_48_0["backface-visibility"]] == "visible";
        }
...
//# sourceMappingURL=Transform.js.map?dt=1658886717752