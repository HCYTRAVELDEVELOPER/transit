  ...
  qx.Bootstrap.define("qx.bom.client.Engine", {
    ...
    statics: {
      ...
      getVersion() {
        ...
        if (qx.bom.client.Engine.__isMshtml__P_35_0()) {
        ...
        } else if (qx.bom.client.Engine.__isOpera__P_35_1()) {
        ...
        } else if (qx.bom.client.Engine.__isWebkit__P_35_2()) {
        ...
        } else if (qx.bom.client.Engine.__isGecko__P_35_3()) {
      ...
      __isMshtml__P_35_0() {
        ...
        if (qx.bom.client.Engine.__isWindowsPhone__P_35_4()) {
          return true;
        }
...
//# sourceMappingURL=Engine.js.map?dt=1658886715525