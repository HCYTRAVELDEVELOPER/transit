  ...
  qx.Bootstrap.define("qx.bom.Html", {
    ...
    */
    statics: {
       ...
       */
      fixEmptyTags(html) {
        return html.replace(/(<(\w+)[^>]*?)\/>/g, this.__fixNonDirectlyClosableHelper__P_25_0);
      },
       ...
       */
      __convertHtmlString__P_25_2(html, context) {
      ...
      clean(objs, context, fragment) {
        ...
        for (var i = 0, l = objs.length; i < l; i++) {
          ...
          if (typeof obj === "string") {
            obj = this.__convertHtmlString__P_25_2(obj, context);
...
//# sourceMappingURL=Html.js.map?dt=1658886714169