  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.rest.Resource", {
    ...
    construct(description) {
      this.__requests__P_45_0 = {};
      this.__routes__P_45_1 = {};
      this.__pollTimers__P_45_2 = {};
      this.__longPollHandlers__P_45_3 = {};
      ...
      try {
        if (typeof description !== "undefined") {
          ...
          this.__mapFromDescription__P_45_4(description);
        }
      } catch (e) {
        this.dispose();
        throw e;
    ...
    members: {
      __requests__P_45_0: null,
      __routes__P_45_1: null,
      __baseUrl__P_45_5: null,
      __pollTimers__P_45_2: null,
      __longPollHandlers__P_45_3: null,
      __configureRequestCallback__P_45_6: null,

      /**
       * @type {Map} Request callbacks for 'onsuccess', 'onfail' and 'onloadend' - see {@link #setRequestHandler}.
       */
      __requestHandler__P_45_7: null,

      /**
       * @type {Function} Function which returns instances from {@link qx.io.request.AbstractRequest}.
       */
      __begetRequest__P_45_8: null,
      ...
      setRequestFactory(fn) {
        this.__begetRequest__P_45_8 = fn;
      },
      ...
      setRequestHandler(handler) {
        this.__requestHandler__P_45_7 = handler;
      },
       ...
       */
      _getRequestHandler() {
        return this.__requestHandler__P_45_7 === null ? {
          onsuccess: {
            callback(req, action) {
              return function () {
                var response = {
      ...
      getRequestsByAction(action) {
        var hasRequests = this.__requests__P_45_0 !== null && action in this.__requests__P_45_0;
        return hasRequests ? this.__requests__P_45_0[action] : null;
      },
      ...
      configureRequest(callback) {
        this.__configureRequestCallback__P_45_6 = callback;
      },
       ...
       */
      _getRequest() {
        return this.__begetRequest__P_45_8 === null ? new qx.bom.request.SimpleXhr() : this.__begetRequest__P_45_8();
      },
       ...
       * @return {qx.bom.request.SimpleXhr|qx.io.request.AbstractRequest} Request object
       */
      __createRequest__P_45_9(action) {
        var req = this._getRequest();

        if (!qx.lang.Type.isArray(this.__requests__P_45_0[action])) {
          this.__requests__P_45_0[action] = [];
        }

        qx.core.ObjectRegistry.register(req);

        this.__requests__P_45_0[action].push(req);
      ...
      map(action, method, url, check) {
        this.__routes__P_45_1[action] = [method, url, check]; // Track requests

        this.__requests__P_45_0[action] = []; // Undefine generic getter when action is named "get"
        ...
        this.__declareEvent__P_45_10(action + "Success");

        this.__declareEvent__P_45_10(action + "Error");
      ...
      invoke(action, params, data) {
        var req = this.__createRequest__P_45_9(action),
            params = params == null ? {} : params,
            config = this._getRequestConfig(action, params); // Cache parameters


        this.__routes__P_45_1[action].params = params; // Check parameters

        this.__checkParameters__P_45_11(params, config.check); // Configure request


        this.__configureRequest__P_45_12(req, config, data); // Run configuration callback, passing in pre-configured request


        if (this.__configureRequestCallback__P_45_6) {
          this.__configureRequestCallback__P_45_6.call(this, req, action, params, data);
        } // Configure JSON request (content type may have been set in configuration callback)


        this.__configureJsonRequest__P_45_13(req, config, data);
       ...
       */
      setBaseUrl(baseUrl) {
        this.__baseUrl__P_45_5 = baseUrl;
      },
       ...
       */
      __checkParameters__P_45_11(params, check) {
       ...
       * @param data {Map} Data.
       */
      __configureRequest__P_45_12(req, config, data) {
       ...
       * @param data {Map} Data.
       */
      __configureJsonRequest__P_45_13(req, config, data) {
        if (data) {
      ...
      abort(varargs) {
        if (qx.lang.Type.isNumber(varargs)) {
          ...
          var action = varargs;
          var reqs = this.__requests__P_45_0[action];

          if (this.__requests__P_45_0[action]) {
       ...
       */
      refresh(action) {
        this.invoke(action, this.__routes__P_45_1[action].params);
      },
      ...
      poll(action, interval, params, immediately) {
        ...
        if (this.__pollTimers__P_45_2[action]) {
          this.stopPollByAction(action);
        } // Fallback to previous params


        if (typeof params == "undefined") {
          params = this.__routes__P_45_1[action].params;
        } // Invoke immediately
        ...
        var intervalListener = function (scope) {
          return function () {
            var req = scope.__requests__P_45_0[action][0];
      ...
      _startPoll(action, listener, interval) {
        this.__pollTimers__P_45_2[action] = {
      ...
      stopPollByAction(action) {
        if (action in this.__pollTimers__P_45_2) {
          var intervalId = this.__pollTimers__P_45_2[action].id;
      ...
      restartPollByAction(action) {
        if (action in this.__pollTimers__P_45_2) {
          var timer = this.__pollTimers__P_45_2[action];
          this.stopPollByAction(action);
      ...
      longPoll(action) {
        ...
        var handlerId = this.__longPollHandlers__P_45_3[action] = this.addListener(action + "Success", function longPollHandler() {
          if (res.isDisposed()) {
            return;
          }
      ...
      _getRequestConfig(action, params) {
        var route = this.__routes__P_45_1[action]; // Not modify original params
        ...
        var method = route[0],
            url = this.__baseUrl__P_45_5 !== null ? this.__baseUrl__P_45_5 + route[1] : route[1],
            check = route[2],
       ...
       */
      __mapFromDescription__P_45_4(description) {
      ...
      */
      ...
      destruct() {
        ...
        for (action in this.__requests__P_45_0) {
          if (this.__requests__P_45_0[action]) {
            this.__requests__P_45_0[action].forEach(function (req) {
              req.dispose();
            });
          }
        }

        if (this.__pollTimers__P_45_2) {
          for (action in this.__pollTimers__P_45_2) {
            this.stopPollByAction(action);
          }
        }

        if (this.__longPollHandlers__P_45_3) {
          for (action in this.__longPollHandlers__P_45_3) {
            var id = this.__longPollHandlers__P_45_3[action];
            this.removeListenerById(id);
          }
        }

        this.__requests__P_45_0 = this.__routes__P_45_1 = this.__pollTimers__P_45_2 = null;
      }
...
//# sourceMappingURL=Resource.js.map?dt=1658886717404