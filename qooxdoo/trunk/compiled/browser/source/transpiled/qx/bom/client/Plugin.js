    ...
    statics: {
      ...
      getActiveX() {
        ...
        try {
          ...
          // still be created
          return window.ActiveXObject !== undefined && (typeof new window.ActiveXObject("Microsoft.XMLHTTP") === "object" || typeof new window.ActiveXObject("MSXML2.DOMDocument.6.0") === "object");
        } catch (ex) {
          return false;
        }
      },
       ...
       */
      getQuicktimeVersion() {
        var entry = qx.bom.client.Plugin.__db__P_102_0["quicktime"];
        return qx.bom.client.Plugin.__getVersion__P_102_1(entry.control, entry.plugin);
      },
      ...
      getWindowsMediaVersion() {
        var entry = qx.bom.client.Plugin.__db__P_102_0["wmv"];
        return qx.bom.client.Plugin.__getVersion__P_102_1(entry.control, entry.plugin, true);
      },
       ...
       */
      getDivXVersion() {
        var entry = qx.bom.client.Plugin.__db__P_102_0["divx"];
        return qx.bom.client.Plugin.__getVersion__P_102_1(entry.control, entry.plugin);
      },
      ...
      getSilverlightVersion() {
        var entry = qx.bom.client.Plugin.__db__P_102_0["silverlight"];
        return qx.bom.client.Plugin.__getVersion__P_102_1(entry.control, entry.plugin);
      },
       ...
       */
      getPdfVersion() {
        var entry = qx.bom.client.Plugin.__db__P_102_0["pdf"];
        return qx.bom.client.Plugin.__getVersion__P_102_1(entry.control, entry.plugin);
      },
      ...
      getQuicktime() {
        var entry = qx.bom.client.Plugin.__db__P_102_0["quicktime"];
        return qx.bom.client.Plugin.__isAvailable__P_102_2(entry.control, entry.plugin);
      },
      ...
      getWindowsMedia() {
        var entry = qx.bom.client.Plugin.__db__P_102_0["wmv"];
        return qx.bom.client.Plugin.__isAvailable__P_102_2(entry.control, entry.plugin, true);
      },
       ...
       */
      __getVersion__P_102_1(activeXName, pluginNames, forceActiveX) {
        var available = qx.bom.client.Plugin.__isAvailable__P_102_2(activeXName, pluginNames, forceActiveX); // don't check if the plugin is not available
       ...
       */
      __isAvailable__P_102_2(activeXName, pluginNames, forceActiveX) {
        // IE checks
        if (qx.bom.client.Engine.getName() == "mshtml" && (qx.bom.client.Browser.getDocumentMode() < 11 || forceActiveX)) {
          if (!this.getActiveX()) {
            return false;
...
//# sourceMappingURL=Plugin.js.map?dt=1658886734901