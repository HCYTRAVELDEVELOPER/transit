(function () {
  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.client.Css", {
    statics: {
      __WEBKIT_LEGACY_GRADIENT__P_64_0: null,
       ...
       */
      getLinearGradient() {
        qx.bom.client.Css.__WEBKIT_LEGACY_GRADIENT__P_64_0 = false;
        ...
        if (!style) {
          ...
          if (style) {
            qx.bom.client.Css.__WEBKIT_LEGACY_GRADIENT__P_64_0 = true;
          }
        } // not supported
      ...
      getLegacyWebkitGradient() {
        if (qx.bom.client.Css.__WEBKIT_LEGACY_GRADIENT__P_64_0 === null) {
          qx.bom.client.Css.getLinearGradient();
        }

        return qx.bom.client.Css.__WEBKIT_LEGACY_GRADIENT__P_64_0;
      },
...
//# sourceMappingURL=Css.js.map?dt=1658886721345