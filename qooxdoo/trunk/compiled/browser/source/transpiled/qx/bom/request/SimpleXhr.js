  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.request.SimpleXhr", {
    ...
    construct(url, method) {
      ...
      this.__requestHeaders__P_67_0 = {};
      this.__parser__P_67_1 = this._createResponseParser();
    },
    ...
    members: {
      ...
      */
      ...
      setRequestHeader(key, value) {
        this.__requestHeaders__P_67_0[key] = value;
        return this;
      },
      ...
      getRequestHeader(key) {
        return this.__requestHeaders__P_67_0[key];
      },
      ...
      setRequestData(data) {
        if (qx.lang.Type.isString(data) || qx.lang.Type.isObject(data) || ["ArrayBuffer", "Blob", "FormData"].indexOf(qx.lang.Type.getClass(data)) !== -1) {
          this.__requestData__P_67_4 = data;
        }
       ...
       */
      getRequestData() {
        return this.__requestData__P_67_4;
      },
       ...
       */
      getResponse() {
        if (this.__response__P_67_5 !== null) {
          return this.__response__P_67_5;
        } else {
       ...
       */
      setParser(parser) {
        return this.__parser__P_67_1.setParser(parser);
      },
       ...
       */
      isDisposed() {
        return !!this.__disposed__P_67_8;
      },
      ...
      send() {
        var curTimeout = this.getTimeout(),
            ...
            hasCacheControlHeader = this.__requestHeaders__P_67_0.hasOwnProperty("Cache-Control"),
        ...
        for (var key in this.__requestHeaders__P_67_0) {
          this._transport.setRequestHeader(key, this.__requestHeaders__P_67_0[key]);
        } // send
      ...
      dispose() {
        if (this._transport.dispose()) {
          this.__parser__P_67_1 = null;
          this.__disposed__P_67_8 = true;
          return true;
        }
      ...
      */
      ...
      _setResponse(response) {
        this.__response__P_67_5 = response;
      },
      ...
      */
       ...
       */
      __requestHeaders__P_67_0: null,

      /**
       * {Object} Request data (i.e. body).
       */
      __requestData__P_67_4: null,
      ...
      */
      ...
      _onReadyStateChange() {
        ...
        if (this.isDone()) {
          this.__onReadyStateDone__P_67_9();
        }
      },
      ...
      __onReadyStateDone__P_67_9() {
        ...
        if (qx.util.Request.isSuccessful(this._transport.status)) {
          ...
          this._setResponse(this.__parser__P_67_1.parse(response, contentType));
...
//# sourceMappingURL=SimpleXhr.js.map?dt=1658886722468