(function () {
  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.request.Script", {
    ...
    construct() {
      this.__initXhrProperties__P_39_0();

      this.__onNativeLoadBound__P_39_1 = qx.Bootstrap.bind(this._onNativeLoad, this);
      this.__onNativeErrorBound__P_39_2 = qx.Bootstrap.bind(this._onNativeError, this);
      this.__onTimeoutBound__P_39_3 = qx.Bootstrap.bind(this._onTimeout, this);
      this.__headElement__P_39_4 = document.head || document.getElementsByTagName("head")[0] || document.documentElement;
      ...
      this.timeout = this.__supportsErrorHandler__P_39_5() ? 0 : 15000;
    },
    ...
    members: {
       ...
       */
      __determineSuccess__P_39_6: null,
      ...
      open(method, url) {
        ...
        this.__abort__P_39_8 = null;
        this.__url__P_39_9 = url;

        if (this.__environmentGet__P_39_10("qx.debug.io")) {
      ...
      setRequestHeader(key, value) {
        ...
        param[key] = value;
        this.__url__P_39_9 = qx.util.Uri.appendParamsToUrl(this.__url__P_39_9, param);
        return this;
      },
      ...
      send() {
        ...
        var script = this.__createScriptElement__P_39_11(),
            head = this.__headElement__P_39_4,
            that = this;

        if (this.timeout > 0) {
          this.__timeoutId__P_39_12 = window.setTimeout(this.__onTimeoutBound__P_39_3, this.timeout);
        }
      ...
      abort() {
        ...
        this.__abort__P_39_8 = true;

        this.__disposeScriptElement__P_39_13();
      ...
      getResponseHeader(key) {
        ...
        if (this.__environmentGet__P_39_10("qx.debug")) {
      ...
      setDetermineSuccess(check) {
        this.__determineSuccess__P_39_6 = check;
      },
       ...
       */
      dispose() {
        var script = this.__scriptElement__P_39_14;
        ...
        if (!this.__disposed__P_39_7) {
          ...
          if (this.__timeoutId__P_39_12) {
            window.clearTimeout(this.__timeoutId__P_39_12);
          }

          this.__disposed__P_39_7 = true;
        }
      },
       ...
       */
      isDisposed() {
        return !!this.__disposed__P_39_7;
      },
      ...
      */
       ...
       */
      _getScriptElement() {
        return this.__scriptElement__P_39_14;
      },
       ...
       */
      _onTimeout() {
        this.__failure__P_39_15();

        if (!this.__supportsErrorHandler__P_39_5()) {
          this._emit("error");
        }
      ...
      _onNativeLoad() {
        var script = this.__scriptElement__P_39_14,
            determineSuccess = this.__determineSuccess__P_39_6,
            that = this; // Aborted request must not fire load

        if (this.__abort__P_39_8) {
          return;
        } // BUGFIX: IE < 9
        ...
        if (this.__environmentGet__P_39_10("engine.name") === "mshtml" && this.__environmentGet__P_39_10("browser.documentmode") < 9) {
      ...
      */
       ...
       */
      __scriptElement__P_39_14: null,

      /**
       * @type {Element} Head element
       */
      __headElement__P_39_4: null,
      ...
      */
       ...
       */
      __supportsErrorHandler__P_39_5() {
        var isLegacyIe = this.__environmentGet__P_39_10("engine.name") === "mshtml" && this.__environmentGet__P_39_10("browser.documentmode") < 9;
        var isOpera = this.__environmentGet__P_39_10("engine.name") === "opera";
       ...
       */
      __createScriptElement__P_39_11() {
        var script = this.__scriptElement__P_39_14 = document.createElement("script");
        script.src = this.__url__P_39_9;
        script.onerror = this.__onNativeErrorBound__P_39_2;
        script.onload = this.__onNativeLoadBound__P_39_1; // BUGFIX: IE < 9
        // Legacy IEs do not fire the "load" event for script elements.
        // Instead, they support the "readystatechange" event

        if (this.__environmentGet__P_39_10("engine.name") === "mshtml" && this.__environmentGet__P_39_10("browser.documentmode") < 9) {
          script.onreadystatechange = this.__onNativeLoadBound__P_39_1;
        }
       ...
       */
      __disposeScriptElement__P_39_13() {
        var script = this.__scriptElement__P_39_14;

        if (script && script.parentNode) {
          this.__headElement__P_39_4.removeChild(script);
        }
      },
...
//# sourceMappingURL=Script.js.map?dt=1658886716357