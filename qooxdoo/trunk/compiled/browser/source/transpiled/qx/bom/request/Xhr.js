(function () {
  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.request.Xhr", {
    ...
    construct() {
      var boundFunc = qx.Bootstrap.bind(this.__onNativeReadyStateChange__P_38_0, this); // GlobalError shouldn't be included in qx.Website builds so use it
      ...
      if (qx.event && qx.event.GlobalError && qx.event.GlobalError.observeMethod) {
        this.__onNativeReadyStateChangeBound__P_38_1 = qx.event.GlobalError.observeMethod(boundFunc);
      } else {
        this.__onNativeReadyStateChangeBound__P_38_1 = boundFunc;
      }

      this.__onNativeAbortBound__P_38_2 = qx.Bootstrap.bind(this.__onNativeAbort__P_38_3, this);
      this.__onNativeProgressBound__P_38_4 = qx.Bootstrap.bind(this.__onNativeProgress__P_38_5, this);
      this.__onTimeoutBound__P_38_6 = qx.Bootstrap.bind(this.__onTimeout__P_38_7, this);

      this.__initNativeXhr__P_38_8();

      this._emitter = new qx.event.Emitter(); // BUGFIX: IE
      // IE keeps connections alive unless aborted on unload

      if (window.attachEvent) {
        this.__onUnloadBound__P_38_9 = qx.Bootstrap.bind(this.__onUnload__P_38_10, this);
        window.attachEvent("onunload", this.__onUnloadBound__P_38_9);
      }
    },
    ...
    members: {
      ...
      */
      ...
      open(method, url, async, user, password) {
        this.__checkDisposed__P_38_11(); // Mimick native behavior
        ...
        this.__abort__P_38_12 = false;
        this.__send__P_38_13 = false;
        this.__conditional__P_38_14 = false; // Store URL for later checks

        this.__url__P_38_15 = url;

        if (typeof async == "undefined") {
          async = true;
        }

        this.__async__P_38_16 = async; // Default values according to spec.
        ...
        if (!this.__supportsManyRequests__P_38_17() && this.readyState > qx.bom.request.Xhr.UNSENT) {
        ...
        this.__nativeXhr__P_38_18.onreadystatechange = this.__onNativeReadyStateChangeBound__P_38_1;
        ...
        try {
          ...
          this.__nativeXhr__P_38_18.open(method, url, async, user, password); // BUGFIX: IE, Firefox < 3.5
          ...
          if (!this.__async__P_38_16) {
            this.__openError__P_38_19 = OpenError;
          }
          ...
          if (this.__async__P_38_16) {
            ...
            if (window.XDomainRequest) {
              this.readyState = 4;
              this.__nativeXhr__P_38_18 = new window.XDomainRequest();
              this.__nativeXhr__P_38_18.onerror = qx.Bootstrap.bind(function () {
              ...
              this.__nativeXhr__P_38_18.open(method, url, async, user, password);
        ...
        if (qx.core.Environment.get("engine.name") === "mshtml" && qx.core.Environment.get("browser.documentmode") < 9 && this.__nativeXhr__P_38_18.readyState > 0) {
          this.__nativeXhr__P_38_18.setRequestHeader("If-Modified-Since", "-1");
        } // BUGFIX: Firefox
        // Firefox < 4 fails to trigger onreadystatechange OPENED for sync requests


        if (qx.core.Environment.get("engine.name") === "gecko" && parseInt(qx.core.Environment.get("engine.version"), 10) < 2 && !this.__async__P_38_16) {
      ...
      setRequestHeader(key, value) {
        this.__checkDisposed__P_38_11(); // Detect conditional requests


        if (key == "If-Match" || key == "If-Modified-Since" || key == "If-None-Match" || key == "If-Range") {
          this.__conditional__P_38_14 = true;
        }

        this.__nativeXhr__P_38_18.setRequestHeader(key, value);
       ...
       */
      send(data) {
        this.__checkDisposed__P_38_11(); // BUGFIX: IE & Firefox < 3.5
        // For sync requests, some browsers throw error on open()
        // while it should be on send()
        //


        if (!this.__async__P_38_16 && this.__openError__P_38_19) {
          throw this.__openError__P_38_19;
        } // BUGFIX: Opera
        ...
        if (this.timeout > 0) {
          this.__timerId__P_38_21 = window.setTimeout(this.__onTimeoutBound__P_38_6, this.timeout);
        } // BUGFIX: Firefox 2
        ...
        data = data !== null && this.__dataTypeWhiteList__P_38_22.indexOf(dataType) === -1 ? data.toString() : data; // Some browsers may throw an error when sending of async request fails.
        ...
        try {
          ...
          if (this.__async__P_38_16) {
            this.__nativeXhr__P_38_18.responseType = this.responseType;
          }

          this.__nativeXhr__P_38_18.send(data);
        } catch (SendError) {
          if (!this.__async__P_38_16) {
            throw SendError;
          } // BUGFIX
          ...
          if (this._getProtocol() === "file:") {
            ...
            this.__readyStateChange__P_38_23();

            var that = this;
            window.setTimeout(function () {
              if (that.__disposed__P_38_20) {
                return;
              }

              that.readyState = 3;

              that.__readyStateChange__P_38_23();
        ...
        if (qx.core.Environment.get("engine.name") === "gecko" && !this.__async__P_38_16) {
          // Properties all set, only missing native readystatechange event
          this.__onNativeReadyStateChange__P_38_0();
        } // Set send flag


        this.__send__P_38_13 = true;
        return this;
      },
       ...
       */
      abort() {
        this.__checkDisposed__P_38_11();

        this.__abort__P_38_12 = true;

        this.__nativeXhr__P_38_18.abort();

        if (this.__nativeXhr__P_38_18 && this.readyState !== qx.bom.request.Xhr.DONE) {
          this.readyState = this.__nativeXhr__P_38_18.readyState;
        }
      ...
      getResponseHeader(header) {
        ...
        if (qx.core.Environment.get("browser.documentmode") === 9 && this.__nativeXhr__P_38_18.aborted) {
          return "";
        }

        return this.__nativeXhr__P_38_18.getResponseHeader(header);
      },
      ...
      getAllResponseHeaders() {
        ...
        return this.__nativeXhr__P_38_18.getAllResponseHeaders();
      },
      ...
      overrideMimeType(mimeType) {
        ...
        if (this.__nativeXhr__P_38_18.overrideMimeType) {
          this.__nativeXhr__P_38_18.overrideMimeType(mimeType);
        } else {
       ...
       */
      getRequest() {
        return this.__nativeXhr__P_38_18;
      },
      ...
      */
      ...
      dispose() {
        ...
        window.clearTimeout(this.__timerId__P_38_21); // Remove unload listener in IE. Aborting on unload is no longer required
        // for this instance.

        if (window.detachEvent) {
          window.detachEvent("onunload", this.__onUnloadBound__P_38_9);
        } // May fail in IE


        try {
          this.__nativeXhr__P_38_18.onreadystatechange;
        ...
        this.__nativeXhr__P_38_18.onreadystatechange = noop;
        this.__nativeXhr__P_38_18.onload = noop;
        this.__nativeXhr__P_38_18.onerror = noop;
        this.__nativeXhr__P_38_18.onprogress = noop; // Abort any network activity

        this.abort(); // Remove reference to native XHR

        this.__nativeXhr__P_38_18 = null;
        this.responseText = null;
        this.__disposed__P_38_20 = true;
        return true;
      },
       ...
       */
      isDisposed() {
        return !!this.__disposed__P_38_20;
      },
      ...
      */
       ...
       */
      __abort__P_38_12: null,

      /**
       * @type {Boolean} Timeout flag
       */
      __timeout__P_38_24: null,

      /**
       * @type {Boolean} Whether object has been disposed.
       */
      __disposed__P_38_20: null,

      /**
       * @type {Number} ID of timeout timer.
       */
      __timerId__P_38_21: null,

      /**
       * @type {Error} Error thrown on open, if any.
       */
      __openError__P_38_19: null,

      /**
       * @type {Boolean} Conditional get flag
       */
      __conditional__P_38_14: null,

      /**
       * @type {Array} Whitelist with all allowed data types for the request payload
       */
      __dataTypeWhiteList__P_38_22: null,

      /**
       * Init native XHR.
       */
      __initNativeXhr__P_38_8() {
        // Create native XHR or equivalent and hold reference
        this.__nativeXhr__P_38_18 = this._createNativeXhr(); // Track native ready state changes

        this.__nativeXhr__P_38_18.onreadystatechange = this.__onNativeReadyStateChangeBound__P_38_1; // Track native abort, when supported

        if (qx.Bootstrap.getClass(this.__nativeXhr__P_38_18.onabort) !== "Undefined") {
          this.__nativeXhr__P_38_18.onabort = this.__onNativeAbortBound__P_38_2;
        } // Track native progress, when supported


        if (qx.Bootstrap.getClass(this.__nativeXhr__P_38_18.onprogress) !== "Undefined") {
          this.__nativeXhr__P_38_18.onprogress = this.__onNativeProgressBound__P_38_4;
          this.progress = {
        ...
        this.__disposed__P_38_20 = this.__send__P_38_13 = this.__abort__P_38_12 = false; // Initialize data white list

        this.__dataTypeWhiteList__P_38_22 = ["ArrayBuffer", "Blob", "File", "HTMLDocument", "String", "FormData"];
      },
       ...
       */
      __onNativeReadyStateChange__P_38_0() {
        var nxhr = this.__nativeXhr__P_38_18,
        ...
        if (this.readyState === qx.bom.request.Xhr.DONE && this.__abort__P_38_12 && !this.__send__P_38_13) {
          return;
        } // BUGFIX: IE
        ...
        if (!this.__async__P_38_16 && (nxhr.readyState == 2 || nxhr.readyState == 3)) {
          return;
        ...
        if (this.readyState >= qx.bom.request.Xhr.HEADERS_RECEIVED) {
          ...
          if (propertiesReadable) {
            this.__normalizeStatus__P_38_25();

            this.__normalizeResponseXML__P_38_26();
          }
        }

        this.__readyStateChange__P_38_23(); // BUGFIX: IE
      ...
      __readyStateChange__P_38_23() {
        ...
        if (this.readyState === qx.bom.request.Xhr.DONE) {
          this.__readyStateChangeDone__P_38_27();
        }
      },
       ...
       */
      __readyStateChangeDone__P_38_27() {
        // Fire "timeout" if timeout flag is set
        if (this.__timeout__P_38_24) {
          ...
          this.__timeout__P_38_24 = false; // Fire either "abort", "load" or "error"
        } else {
          if (this.__abort__P_38_12) {
            this._emit("abort");
          } else {
            if (this.__isNetworkError__P_38_28()) {
              this._emit("error");
            } else {
              this._emit("load");
            }
      ...
      __onTimeout__P_38_7() {
        ...
        this.__timeout__P_38_24 = true; // No longer consider request. Abort.
      ...
      __normalizeStatus__P_38_25() {
        ...
        if (qx.core.Environment.get("engine.name") === "opera") {
          if (isDone && // Done
          this.__conditional__P_38_14 && // Conditional request
          !this.__abort__P_38_12 && // Not aborted
       ...
       */
      __normalizeResponseXML__P_38_26() {
        // BUGFIX: IE
       ...
       */
      __supportsManyRequests__P_38_17() {
...
//# sourceMappingURL=Xhr.js.map?dt=1658886716227