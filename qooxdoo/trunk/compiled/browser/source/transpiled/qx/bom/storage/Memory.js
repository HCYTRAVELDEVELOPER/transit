(function () {
  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.storage.Memory", {
    statics: {
      __local__P_70_0: null,
      __session__P_70_1: null,
       ...
       */
      getLocal() {
        if (this.__local__P_70_0) {
          return this.__local__P_70_0;
        }

        return this.__local__P_70_0 = new qx.bom.storage.Memory();
      },
       ...
       */
      getSession() {
        if (this.__session__P_70_1) {
          return this.__session__P_70_1;
        }

        return this.__session__P_70_1 = new qx.bom.storage.Memory();
      }

    },

    construct() {
      this.__storage__P_70_2 = {};
    },

    members: {
      __storage__P_70_2: null,
       ...
       */
      getLength() {
        return Object.keys(this.__storage__P_70_2).length;
      },
      ...
      setItem(key, value) {
        ...
        this.__storage__P_70_2[key] = value;
      },
       ...
       */
      getItem(key) {
        var item = this.__storage__P_70_2[key];
       ...
       */
      removeItem(key) {
        delete this.__storage__P_70_2[key];
      },
       ...
       */
      getKey(index) {
        var keys = Object.keys(this.__storage__P_70_2);
        return keys[index];
      },
...
//# sourceMappingURL=Memory.js.map?dt=1658886722678