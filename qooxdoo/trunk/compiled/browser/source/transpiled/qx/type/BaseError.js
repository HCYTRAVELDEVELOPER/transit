  ...
  qx.Bootstrap.define("qx.type.BaseError", {
    ...
    */
    ...
    construct(comment, failMessage) {
      ...
      this.__comment__P_87_0 = comment || ""; // opera 10 crashes if the message is an empty string!!!?!?!
    ...
    */
    members: {
      __sTrace__P_87_1: null,
      __comment__P_87_0: null,
       ...
       */
      toString() {
        return this.__comment__P_87_0 + (this.message ? ": " + this.message : "");
      }
...
//# sourceMappingURL=BaseError.js.map?dt=1658886731474