  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.module.Blocker", {
    statics: {
       ...
       */
      __attachBlocker__P_2_0(item, color, opacity, zIndex) {
        ...
        if (!item.__blocker__P_2_1) {
          item.__blocker__P_2_1 = {
            div: qxWeb.create("<div class='qx-blocker' />")
          };
        }

        if (isDocument) {
          item.__blocker__P_2_1.div.insertBefore(qxWeb(win.document.body).getChildren(":first"));
        } else {
          item.__blocker__P_2_1.div.appendTo(win.document.body);
        }

        qx.module.Blocker.__styleBlocker__P_2_2(item, color, opacity, zIndex, isDocument);
      },
       ...
       */
      __styleBlocker__P_2_2(item, color, opacity, zIndex, isDocument) {
        ...
        item.__blocker__P_2_1.div.setStyles(styles);
      },
       ...
       */
      __detachBlocker__P_2_3(item, index) {
        if (!item.__blocker__P_2_1) {
          return;
        }

        item.__blocker__P_2_1.div.remove();
      },
       ...
       */
      __getBlocker__P_2_4(collection) {
        var blockerElements = qxWeb();
        collection.forEach(function (item, index) {
          if (typeof item.__blocker__P_2_1 !== "undefined") {
            blockerElements = blockerElements.concat(item.__blocker__P_2_1.div);
          }
        });
    ...
    members: {
      ...
      block(color, opacity, zIndex) {
        ...
        this.forEach(function (item, index) {
          qx.module.Blocker.__attachBlocker__P_2_0(item, color, opacity, zIndex);
        });
        return this;
      },
      ...
      unblock() {
        ...
        this.forEach(qx.module.Blocker.__detachBlocker__P_2_3);
        return this;
      },
      ...
      getBlocker() {
        ...
        var collection = qx.module.Blocker.__getBlocker__P_2_4(this);
...
//# sourceMappingURL=Blocker.js.map?dt=1658886707829