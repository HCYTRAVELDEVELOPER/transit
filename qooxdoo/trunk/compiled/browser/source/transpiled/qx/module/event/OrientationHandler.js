  ...
  qx.Bootstrap.define("qx.module.event.OrientationHandler", {
    statics: {
      ...
      register(element) {
        ...
        if (!element.__orientationHandler__P_12_0) {
          if (!element.$$emitter) {
            element.$$emitter = new qx.event.Emitter();
          }

          element.__orientationHandler__P_12_0 = new qx.event.handler.OrientationCore(element, element.$$emitter);
        }
      },
      ...
      unregister(element) {
        if (element.__orientationHandler__P_12_0) {
          if (!element.$$emitter) {
            element.__orientationHandler__P_12_0 = null;
          } else {
...
//# sourceMappingURL=OrientationHandler.js.map?dt=1658886710937