  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.module.Manipulating", {
    statics: {
       ...
       */
      __animateScroll__P_5_0(property, value, duration) {
       ...
       * @internal
       */
      __getCollectionFromArgument__P_5_1(arg) {
       ...
       * @internal
       */
      __getInnermostElement__P_5_2(element) {
        ...
        for (var i = 0, l = element.childNodes.length; i < l; i++) {
          if (element.childNodes[i].nodeType === 1) {
            return this.__getInnermostElement__P_5_2(element.childNodes[i]);
          }
        }
    ...
    members: {
       ...
       */
      appendTo(parent) {
        parent = qx.module.Manipulating.__getElementArray__P_5_3(parent);
       ...
       */
      insertBefore(target) {
        target = qx.module.Manipulating.__getElementArray__P_5_3(target);
       ...
       */
      wrap(wrapper) {
        wrapper = qx.module.Manipulating.__getCollectionFromArgument__P_5_1(wrapper);
        ...
        this._forEachElement(function (item) {
          ...
          var innermost = qx.module.Manipulating.__getInnermostElement__P_5_2(clonedwrapper[0]);
      ...
      setScrollLeft(value, duration) {
        ...
        if (duration && qx.bom.element && qx.bom.element.AnimationJs) {
          qx.module.Manipulating.__animateScroll__P_5_0.bind(this, "scrollLeft", value, duration)();
        }
      ...
      setScrollTop(value, duration) {
        ...
        if (duration && qx.bom.element && qx.bom.element.AnimationJs) {
          qx.module.Manipulating.__animateScroll__P_5_0.bind(this, "scrollTop", value, duration)();
        }
...
//# sourceMappingURL=Manipulating.js.map?dt=1658886709357