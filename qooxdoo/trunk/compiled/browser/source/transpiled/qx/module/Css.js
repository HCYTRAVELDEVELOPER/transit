  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.module.Css", {
    statics: {
        ...
        if (elem) {
          if (qx.dom.Node.isElement(elem)) {
            ...
            if (force) {
              ...
              elementHeight = qx.module.Css.__swap__P_3_0(elem, stylesToSwap, "_getHeight", this);
            } else {
        ...
        if (elem) {
          if (qx.dom.Node.isElement(elem)) {
            ...
            if (force) {
              ...
              elementWidth = qx.module.Css.__swap__P_3_0(elem, stylesToSwap, "_getWidth", this);
            } else {
      ...
      _getContentHeight(force) {
        ...
        if (qx.dom.Node.isElement(obj)) {
          ...
          if (force) {
            ...
            contentHeight = qx.module.Css.__swap__P_3_0(obj, stylesToSwap, "_getContentHeight", this);
          } else {
      ...
      _getContentWidth(force) {
        ...
        if (qx.dom.Node.isElement(obj)) {
          ...
          if (force) {
            ...
            contentWidth = qx.module.Css.__swap__P_3_0(obj, stylesToSwap, "_getContentWidth", this);
          } else {
       ...
       * or <code>block</code>
       */
      __getDisplayDefault__P_3_2(tagName, doc) {
        var defaults = qx.module.Css.__displayDefaults__P_3_1;
       ...
       */
      __swap__P_3_0(element, styles, methodName, context) {
        ...
        this._forEachElementWrapped(function (item) {
          ...
          if (currentVal == "none") {
            if (prevVal && prevVal != "none") {
              ...
              newVal = qx.module.Css.__getDisplayDefault__P_3_2(item[0].tagName, doc);
            }
...
//# sourceMappingURL=Css.js.map?dt=1658886708481