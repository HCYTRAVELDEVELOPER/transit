  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.module.MatchMedia", {
    statics: {
       ...
       */
      __applyClass__P_6_0(query, className) {
        if (query.isMatching()) {
    ...
    members: {
      ...
      mediaQueryToClass(queryString, className) {
        ...
        var callback = qx.module.MatchMedia.__applyClass__P_6_0.bind(this, query, className); // apply classes initially
...
//# sourceMappingURL=MatchMedia.js.map?dt=1658886709408