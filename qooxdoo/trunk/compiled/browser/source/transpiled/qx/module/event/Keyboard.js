    ...
    statics: {
      ...
      registerInputFix(element) {
        if (element.type === "text" || element.type === "password" || element.type === "textarea") {
          if (!element.__inputFix__P_11_0) {
            element.__inputFix__P_11_0 = qxWeb(element).on("keyup", qx.module.event.Keyboard._inputFix);
          }
        }
      },
      ...
      unregisterInputFix(element) {
        if (element.__inputFix__P_11_0 && !qxWeb(element).hasListener("input")) {
          qxWeb(element).off("keyup", qx.module.event.Keyboard._inputFix);
          element.__inputFix__P_11_0 = null;
        }
      },
      ...
      _inputFix(ev) {
        ...
        if (!target.__oldInputValue__P_11_1 || target.__oldInputValue__P_11_1 !== newValue) {
          target.__oldInputValue__P_11_1 = newValue;
...
//# sourceMappingURL=Keyboard.js.map?dt=1658886710663