  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.module.event.TouchHandler", {
    statics: {
       ...
       */
      register(element) {
        if (!element.__touchHandler__P_13_0) {
          if (!element.$$emitter) {
            element.$$emitter = new qx.event.Emitter();
          }

          element.__touchHandler__P_13_0 = new qx.event.handler.TouchCore(element, element.$$emitter);
        }
      },
      ...
      unregister(element) {
        if (element.__touchHandler__P_13_0) {
          if (!element.$$emitter) {
            element.__touchHandler__P_13_0 = null;
          } else {
...
//# sourceMappingURL=TouchHandler.js.map?dt=1658886711557