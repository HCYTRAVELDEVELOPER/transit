  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.module.Traversing", {
    statics: {
       ...
       * @internal
       */
      __getAncestors__P_10_0(selector, filter) {
        var ancestors = [];
       ...
       */
      __getElementFromArgument__P_10_1(arg) {
       ...
       */
      __getNodeFromArgument__P_10_2(arg) {
       ...
       * @internal
       */
      __hierarchyHelper__P_10_4(collection, method, selector) {
       ...
       */
      isElement(selector) {
        return qx.dom.Node.isElement(qx.module.Traversing.__getElementFromArgument__P_10_1(selector));
      },
       ...
       */
      isNode(selector) {
        return qx.dom.Node.isNode(qx.module.Traversing.__getElementFromArgument__P_10_1(selector));
      },
      ...
      isNodeName(selector, nodeName) {
        return qx.dom.Node.isNodeName(qx.module.Traversing.__getElementFromArgument__P_10_1(selector), nodeName);
      },
       ...
       */
      getWindow(selector) {
        return qx.dom.Node.getWindow(qx.module.Traversing.__getElementFromArgument__P_10_1(selector));
      },
      ...
      getDocument(selector) {
        return qx.dom.Node.getDocument(qx.module.Traversing.__getElementFromArgument__P_10_1(selector));
      },
      ...
      getNodeName(selector) {
        return qx.dom.Node.getName(qx.module.Traversing.__getElementFromArgument__P_10_1(selector));
      },
      ...
      getNodeText(selector) {
        return qx.dom.Node.getText(qx.module.Traversing.__getElementFromArgument__P_10_1(selector));
      },
      ...
      isBlockNode(selector) {
        return qx.dom.Node.isBlockNode(qx.module.Traversing.__getElementFromArgument__P_10_1(selector));
      },
      ...
      equalNodes(node1, node2) {
        node1 = qx.module.Traversing.__getNodeFromArgument__P_10_2(node1);
        node2 = qx.module.Traversing.__getNodeFromArgument__P_10_2(node2);
        ...
        if (qx.core.Environment.get("html.node.isequalnode")) {
          ...
          if (hasAttributes) {
            var node1Attributes = qx.module.Traversing.__getAttributes__P_10_3(node1);

            var node2Attributes = qx.module.Traversing.__getAttributes__P_10_3(node2);
    ...
    members: {
       ...
       */
      getAncestors(filter) {
        return this.__getAncestors__P_10_0(null, filter);
      },
      ...
      getAncestorsUntil(selector, filter) {
        return this.__getAncestors__P_10_0(selector, filter);
      },
       ...
       */
      getNextAll(selector) {
        var ret = qx.module.Traversing.__hierarchyHelper__P_10_4(this, "getNextSiblings", selector);
       ...
       */
      getPrevAll(selector) {
        var ret = qx.module.Traversing.__hierarchyHelper__P_10_4(this, "getPreviousSiblings", selector);
      ...
      getSiblings(selector) {
        var ret = qx.module.Traversing.__hierarchyHelper__P_10_4(this, "getSiblings", selector);
    ...
    defer(statics) {
      ...
      qxWeb.$attach({
        __getAncestors__P_10_0: statics.__getAncestors__P_10_0
      });
    }
...
//# sourceMappingURL=Traversing.js.map?dt=1658886710490