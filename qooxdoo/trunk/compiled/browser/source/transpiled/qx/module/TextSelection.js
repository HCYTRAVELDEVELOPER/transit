  ...
  qx.Bootstrap.define("qx.module.TextSelection", {
    ...
    members: {
      ...
      getTextSelection() {
        ...
        if (el) {
          if (!qx.module.TextSelection.__isInput__P_9_0(el)) {
            el = qx.module.TextSelection.__getTextNode__P_9_1(el);
          }
...
//# sourceMappingURL=TextSelection.js.map?dt=1658886710260