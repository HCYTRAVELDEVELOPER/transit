  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.module.Placeholder", {
    statics: {
       ...
       */
      __createPlaceholderElement__P_7_1(item) {
      ...
      updatePlaceholder() {
        ...
        if (!qxWeb.env.get("css.placeholder")) {
          for (var i = 0; i < this.length; i++) {
            ...
            if (!placeholderEl) {
              placeholderEl = qx.module.Placeholder.__createPlaceholderElement__P_7_1(item);
            ...
            qx.module.Placeholder.__syncStyles__P_7_0(item);
          }
        }
...
//# sourceMappingURL=Placeholder.js.map?dt=1658886709535