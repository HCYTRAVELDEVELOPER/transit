  ...
  qx.Bootstrap = {
    ...
    define(name, config) {
      ...
      if (config.members || config.extend) {
        ...
        let construct = config.construct; // Object methods include the method name as part of the signature (eg `construct() {}`),
    ...
    statics: {
      ...
      addPendingDefer(clazz, cb) {
        if (qx.$$loader && qx.$$loader.delayDefer) {
          this.__pendingDefers__P_22_0.push(clazz);
      ...
      executePendingDefers(dbClassInfo) {
        ...
        if (!dbClassInfo) {
          var pendingDefers = this.__pendingDefers__P_22_0;
          this.__pendingDefers__P_22_0 = [];
      ...
      */
       ...
       * @type {String[]}
       */
      __shadowedKeys__P_22_1: ["isPrototypeOf", "hasOwnProperty", "toLocaleString", "toString", "valueOf", "propertyIsEnumerable", "constructor"],
      ...
      keys: {
        ...
        BROKEN_IE(map) {
          ...
          var shadowedKeys = qx.Bootstrap.__shadowedKeys__P_22_1;
      ...
      */
      ...
      getClass(value) {
        ...
        return qx.Bootstrap.__classToTypeMap__P_22_2[classString] || classString.slice(8, -1);
      },
...
//# sourceMappingURL=Bootstrap.js.map?dt=1658886713998