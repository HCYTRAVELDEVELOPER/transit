  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.core.Property", {
    statics: {
       ...
       */
      __executeOptimizedRefresh__P_92_3(clazz) {
        var inheritables = this.__getInheritablesOfClass__P_92_4(clazz);

        if (!inheritables.length) {
          var refresher = function refresher() {};
        } else {
          refresher = this.__createRefresher__P_92_5(inheritables);
        }
       ...
       */
      __getInheritablesOfClass__P_92_4(clazz) {
        var inheritable = [];
       ...
       */
      __createRefresher__P_92_5(inheritables) {
      ...
      attachRefreshInheritables(clazz) {
        clazz.prototype.$$refreshInheritables = function () {
          qx.core.Property.__executeOptimizedRefresh__P_92_3(clazz);
      ...
      attachMethods(clazz, name, config) {
        ...
        config.group ? this.__attachGroupMethods__P_92_6(clazz, config, name) : this.__attachPropertyMethods__P_92_7(clazz, config, name);
      },
       ...
       */
      __attachGroupMethods__P_92_6(clazz, config, name) {
       ...
       * @param name {String} Name of the property
       */
      __attachPropertyMethods__P_92_7(clazz, config, name) {
        var upname = qx.Bootstrap.firstUp(name);
        var members = clazz.prototype;
        {
          if (0 > 1) {
        ...
        if (config.dereference === undefined && typeof config.check === "string") {
          config.dereference = this.__shouldBeDereferenced__P_92_8(config.check);
        }
        ...
        members[method.get[name]].$$install = function () {
          qx.core.Property.__installOptimizedGetter__P_92_9(clazz, name, "get", arguments);

          if (config.async) {
            qx.core.Property.__installOptimizedGetter__P_92_9(clazz, name, "getAsync", arguments);
          }
        };
        ...
        members[setName].$$install = function () {
          qx.core.Property.__installOptimizedSetter__P_92_10(clazz, name, "set");

          qx.core.Property.__installOptimizedSetter__P_92_10(clazz, name, "setImpl");

          if (config.async) {
            qx.core.Property.__installOptimizedSetter__P_92_10(clazz, name, "setAsync");
          }
        };
        ...
        members[method.reset[name]].$$install = function () {
          qx.core.Property.__installOptimizedSetter__P_92_10(clazz, name, "reset");
        };
       ...
       */
      __shouldBeDereferenced__P_92_8(check) {
        return !!this.__dereference__P_92_2[check];
      },
      ...
      error(obj, id, property, variant, value) {
        ...
        throw new Error(msg + (this.__errors__P_92_11[id] || "Unknown reason: " + id));
      },
       ...
       */
      __unwrapFunctionFromCode__P_92_12(instance, members, name, variant, code, args) {
        var fn = this.__installFunctionFromCode__P_92_13(instance.constructor, name, variant, code, args); // Executing new function
       ...
       * @return {var} Return value of the generated function
       */
      __installFunctionFromCode__P_92_13(clazz, name, variant, code, args) {
      ...
      executeOptimizedGetter(instance, clazz, name, variant) {
        var code = this.__compileGetter__P_92_14(clazz, name, variant);

        var members = clazz.prototype;
        return this.__unwrapFunctionFromCode__P_92_12(instance, members, name, variant, code);
      },
       ...
       * @param variant {String} Method variant.
       */
      __installOptimizedGetter__P_92_9(clazz, name, variant) {
        var code = this.__compileGetter__P_92_14(clazz, name, variant);

        this.__installFunctionFromCode__P_92_13(clazz, name, variant, code);
      },
       ...
       */
      __compileGetter__P_92_14(clazz, name, variant) {
      ...
      executeOptimizedSetter(instance, clazz, name, variant, args) {
        var code = this.__compileSetter__P_92_15(clazz, name, variant);

        var members = clazz.prototype;
        return this.__unwrapFunctionFromCode__P_92_12(instance, members, name, variant, code, args);
      },
       ...
       * @return {var} Return value of the generated function
       */
      __installOptimizedSetter__P_92_10(clazz, name, variant) {
        var code = this.__compileSetter__P_92_15(clazz, name, variant);

        return this.__installFunctionFromCode__P_92_13(clazz, name, variant, code);
      },
       ...
       * @return {String[]} the string builder array
       */
      __compileSetter__P_92_15(clazz, name, variant) {
        var config = clazz.$$properties[name];
        var members = clazz.prototype;
        var code = [];
        ...
        var store = this.__getStore__P_92_16(variant, name);

        this.__emitIsEqualFunction__P_92_17(code, clazz, config, name);

        this.__emitSetterPreConditions__P_92_18(code, config, name, variant, incomingValue);

        if (incomingValue || hasCallback) {
          this.__emitOldValue__P_92_19(code, config, name);
        }

        if (incomingValue) {
          this.__emitIncomingValueTransformation__P_92_20(code, clazz, config, name);
        }

        if (hasCallback) {
          this.__emitOldNewComparison__P_92_21(code, incomingValue, store, variant);
        }
        ...
        {
          if (incomingValue) {
            this.__emitIncomingValueValidation__P_92_22(code, config, clazz, name, variant);
          }
        }

        if (!hasCallback) {
          this.__emitStoreValue__P_92_23(code, name, variant, incomingValue);
        } else {
          this.__emitStoreComputedValue__P_92_24(code, config, name, variant, incomingValue);
        }

        if (config.inheritable) {
          this.__emitStoreInheritedPropertyValue__P_92_25(code, config, name, variant);
        } else if (hasCallback) {
          this.__emitNormalizeUndefinedValues__P_92_26(code, config, name, variant);
        }

        if (hasCallback) {
          // Emit callback and event firing; Refreshing children (5th parameter) requires the parent/children interface
          this.__emitCallCallback__P_92_27(code, config, name, variant, !!(config.inheritable && members._getChildren));
        } // Return value
       ...
       */
      __getStore__P_92_16(variant, name) {
       ...
       * @param name {String} name of the property
       */
      __emitIsEqualFunction__P_92_17(code, clazz, config, name) {
        code.push("var equ=");
       ...
       */
      __emitSetterPreConditions__P_92_18(code, config, name, variant, incomingValue) {
        {
       ...
       * @param name {String} name of the property
       */
      __emitIncomingValueTransformation__P_92_20(code, clazz, config, name) {
       ...
       * @param variant {String} Method variant.
       */
      __emitOldNewComparison__P_92_21(code, incomingValue, store, variant) {
       ...
       * @param variant {String} Method variant.
       */
      __emitIncomingValueValidation__P_92_22: qx.core.Environment.select("qx.debug", {
        true(code, config, clazz, name, variant) {
          ...
          if (config.check !== undefined) {
            ...
            if (this.__checks__P_92_1[config.check] !== undefined) {
              code.push("!(", this.__checks__P_92_1[config.check], ")");
       ...
       * @param incomingValue {Boolean} Whether the setter has an incoming value
       */
      __emitStoreValue__P_92_23(code, name, variant, incomingValue) {
       ...
       * @param incomingValue {Boolean} Whether the setter has an incoming value
       */
      __emitStoreComputedValue__P_92_24(code, config, name, variant, incomingValue) {
       ...
       * @param name {String} name of the property
       */
      __emitOldValue__P_92_19(code, config, name) {
        if (config.inheritable) {
       ...
       * @param variant {String} Method variant.
       */
      __emitStoreInheritedPropertyValue__P_92_25(code, config, name, variant) {
       ...
       * @param variant {String} Method variant.
       */
      __emitNormalizeUndefinedValues__P_92_26(code, config, name, variant) {
       ...
       */
      __emitCallCallback__P_92_27(code, config, name, variant, refresh) {
...
//# sourceMappingURL=Property.js.map?dt=1658886732023