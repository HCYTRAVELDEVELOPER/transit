(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.core.Object", {
    ...
    */
    members: {
      __Property__P_83_0: true ? qx.core.Property : null,
      ...
      */
      ...
      clone() {
        ...
        var user = this.__Property__P_83_0.$$store.user;
        var setter = this.__Property__P_83_0.$$method.set;
      ...
      */
      ...
      setUserData(key, value) {
        if (!this.__userData__P_83_1) {
          this.__userData__P_83_1 = {};
        }

        this.__userData__P_83_1[key] = value;
      },
      ...
      getUserData(key) {
        ...
        var data = this.__userData__P_83_1[key];
    ...
    */
    destruct() {
      ...
      this.__userData__P_83_1 = null; // only of properties are available

      {
        // Cleanup properties
        var clazz = this.constructor;
        var properties;
        var store = this.__Property__P_83_0.$$store;
...
//# sourceMappingURL=Object.js.map?dt=1658886731213