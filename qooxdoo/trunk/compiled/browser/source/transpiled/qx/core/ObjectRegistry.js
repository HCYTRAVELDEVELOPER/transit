  ...
  qx.Bootstrap.define("qx.core.ObjectRegistry", {
    ...
    */
    statics: {
       ...
       */
      register(obj) {
        var registry = this.__registry__P_85_0;
       ...
       */
      createHashCode() {
        var hash = String(this.__nextHash__P_85_1++ + this.__postId__P_85_2);
        return hash;
      },
      ...
      fromHashCode(hash, suppressWarnings) {
        var obj = this.__registry__P_85_0[hash] || null;
       ...
       */
      hasHashCode(hash) {
        return !!this.__registry__P_85_0[hash];
      },
      ...
      shutdown() {
        ...
        delete this.__registry__P_85_0;
      },
       ...
       */
      getRegistry() {
        return this.__registry__P_85_0;
      },
       ...
       */
      getNextHash() {
        return this.__nextHash__P_85_1;
      },
       ...
       */
      getStackTraces() {
        return this.__stackTraces__P_85_3;
      }
    ...
    defer(statics) {
      if (window && window.top) {
        ...
        for (var i = 0; i < frames.length; i++) {
          if (frames[i] === window) {
            statics.__postId__P_85_2 = "-" + (i + 1);
            return;
          }
        }
      }

      statics.__postId__P_85_2 = "-0";
    }
...
//# sourceMappingURL=ObjectRegistry.js.map?dt=1658886731373