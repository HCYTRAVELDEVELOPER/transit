  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.core.Environment", {
    statics: {
      ...
      get(key) {
        // check the cache
        if (this.__cache__P_33_0[key] != undefined) {
          return this.__cache__P_33_0[key];
        ...
        if (check) {
          ...
          var value = check();
          this.__cache__P_33_0[key] = value;
          return value;
        } // try class lookup
      ...
      getAsync(key, callback, self) {
        ...
        if (this.__cache__P_33_0[key] != undefined) {
          ...
          window.setTimeout(function () {
            callback.call(self, env.__cache__P_33_0[key]);
          }, 0);
          return;
        }
        ...
        if (check) {
          check(function (result) {
            env.__cache__P_33_0[key] = result;
       ...
       */
      select(key, values) {
        return this.__pickFromValues__P_33_1(this.get(key), values);
      },
      ...
      selectAsync(key, values, self) {
        this.getAsync(key, function (result) {
          var value = this.__pickFromValues__P_33_1(key, values);
       ...
       */
      __pickFromValues__P_33_1(key, values) {
      ...
      invalidateCacheKey(key) {
        delete this.__cache__P_33_0[key];
      },
      ...
      add(key, check) {
        ...
        if (this._checks[key] == undefined) {
          ...
          if (check instanceof Function) {
            ...
            this._checks[key] = this.__createCheck__P_33_2(check);
          }
        }
      },
       ...
       */
      __importFromGenerator__P_33_3() {
        // import the environment map
        if (qx && qx.$$environment) {
          for (var key in qx.$$environment) {
            var value = qx.$$environment[key];
            this._checks[key] = this.__createCheck__P_33_2(value);
          }
        }
      },
    ...
    defer(statics) {
      ...
      statics.__importFromGenerator__P_33_3(); // load the checks from the url


      if (statics.get("qx.allowUrlSettings") === true) {
        statics.__importFromUrl__P_33_4();
      }
    }
...
//# sourceMappingURL=Environment.js.map?dt=1658886715424