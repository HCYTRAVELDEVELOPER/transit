(function () {
  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.event.Messaging", {
    construct() {
      this._listener = {};
      this.__listenerIdCount__P_44_0 = 0;
      this.__channelToIdMapping__P_44_1 = {};
    },

    members: {
      _listener: null,
      __listenerIdCount__P_44_0: null,
      __channelToIdMapping__P_44_1: null,
      ...
      _addListener(channel, type, handler, scope) {
        ...
        var id = this.__listenerIdCount__P_44_0++;
        var params = [];
        ...
        this.__channelToIdMapping__P_44_1[id] = channel;
        return id;
      },
       ...
       */
      remove(id) {
        var channel = this.__channelToIdMapping__P_44_1[id];
        var listener = this._listener[channel];
        delete listener[id];
        delete this.__channelToIdMapping__P_44_1[id];
      },
...
//# sourceMappingURL=Messaging.js.map?dt=1658886716690