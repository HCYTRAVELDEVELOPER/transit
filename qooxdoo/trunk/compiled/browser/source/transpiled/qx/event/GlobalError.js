(function () {
  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.event.GlobalError", {
    statics: {
      __callback__P_81_0: null,
      __originalOnError__P_81_1: null,
      __context__P_81_2: null,

      /**
       * Little helper to check if the global error handling is enabled.
       * @return {Boolean} <code>true</code>, if it is enabled.
       */
      __isGlobalErrorHandlingEnabled__P_81_3() {
      ...
      setErrorHandler(callback, context) {
        this.__callback__P_81_0 = callback || null;
        this.__context__P_81_2 = context || window;

        if (this.__isGlobalErrorHandlingEnabled__P_81_3()) {
          // wrap the original onerror
          if (callback && window.onerror) {
            var wrappedHandler = qx.Bootstrap.bind(this.__onErrorWindow__P_81_4, this);

            if (this.__originalOnError__P_81_1 == null) {
              this.__originalOnError__P_81_1 = window.onerror;
            }

            var self = this;

            window.onerror = function (msg, uri, lineNumber) {
              self.__originalOnError__P_81_1(msg, uri, lineNumber);
          ...
          if (callback && !window.onerror) {
            window.onerror = qx.Bootstrap.bind(this.__onErrorWindow__P_81_4, this);
          } // reset


          if (this.__callback__P_81_0 == null) {
            if (this.__originalOnError__P_81_1 != null) {
              window.onerror = this.__originalOnError__P_81_1;
              this.__originalOnError__P_81_1 = null;
            } else {
              window.onerror = null;
            }
          }
       ...
       */
      __onErrorWindow__P_81_4(msg, uri, lineNumber, columnNumber, exception) {
        if (this.__callback__P_81_0) {
      ...
      handleError(ex) {
        if (this.__callback__P_81_0) {
          this.__callback__P_81_0.call(this.__context__P_81_2, ex);
        }
      }
...
//# sourceMappingURL=GlobalError.js.map?dt=1658886730900