  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.event.Utils", {
    ...
    statics: {
       ...
       */
      __push__P_75_0(tracker, newPromise) {
        {
        ...
        true(tracker, fn) {
          ...
          if (tracker.promise) {
            if (qx.lang.Type.isPromise(fn)) {
              this.__push__P_75_0(tracker, tracker.promise.then(fn));
            } else {
              var self = this;

              this.__push__P_75_0(tracker, tracker.promise.then(function (result) {
                if (tracker.rejected) {
                  return null;
                }
            ...
            this.__addCatcher__P_75_1(tracker);

            return tracker.promise;
          }

          if (qx.lang.Type.isPromise(fn)) {
            return this.__thenPromise__P_75_2(tracker, fn);
          }

          var result = fn(tracker.result);

          if (qx.lang.Type.isPromise(result)) {
            return this.__thenPromise__P_75_2(tracker, result);
          }
       ...
       * @return {qx.Promise} the new promise
       */
      __thenPromise__P_75_2(tracker, newPromise) {
        if (tracker.promise) {
          this.__push__P_75_0(tracker, tracker.promise.then(function () {
            return newPromise;
          }));
        } else {
          this.__push__P_75_0(tracker, newPromise);
        }
      ...
      reject(tracker) {
        ...
        var result = this.__catcher__P_75_3(tracker);
       ...
       * @param tracker {Object} the tracker object
       */
      __addCatcher__P_75_1(tracker) {
        if (tracker.promise && tracker.catch) {
          if (!tracker.promise["qx.event.Utils.hasCatcher"]) {
            this.__push__P_75_0(tracker, tracker.promise.catch(this.__catcher__P_75_3.bind(this, tracker)));
...
//# sourceMappingURL=Utils.js.map?dt=1658886726824