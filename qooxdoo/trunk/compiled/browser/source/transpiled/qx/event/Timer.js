  ...
  qx.Class.define("qx.event.Timer", {
    ...
    */
    ...
    construct(interval) {
      ...
      this.__oninterval__P_74_0 = function () {
    ...
    */
    statics: {
      ...
      once(func, obj, timeout) {
        ...
        timer.__onceFunc__P_74_1 = func; // Add event listener to interval

        timer.addListener("interval", function (e) {
          timer.stop();
          func.call(obj, e);
          delete timer.__onceFunc__P_74_1;
          timer.dispose();
          obj = null;
    ...
    */
    members: {
      __intervalHandler__P_74_2: null,
      __oninterval__P_74_0: null,
      ...
      */
      ...
      _applyEnabled(value, old) {
        if (old) {
          window.clearInterval(this.__intervalHandler__P_74_2);
          this.__intervalHandler__P_74_2 = null;
        } else if (value) {
          this.__intervalHandler__P_74_2 = window.setInterval(this.__oninterval__P_74_0, this.getInterval());
        }
      },
    ...
    */
    destruct() {
      if (this.__intervalHandler__P_74_2) {
        window.clearInterval(this.__intervalHandler__P_74_2);
      }

      this.__intervalHandler__P_74_2 = this.__oninterval__P_74_0 = null;
    }
...
//# sourceMappingURL=Timer.js.map?dt=1658886726764