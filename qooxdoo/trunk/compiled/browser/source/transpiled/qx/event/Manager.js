  ...
  qx.Class.define("qx.event.Manager", {
    ...
    */
    ...
    construct(win, registration) {
      ...
      this.__window__P_101_0 = win;
      this.__windowId__P_101_1 = qx.core.ObjectRegistry.toHashCode(win);
      this.__registration__P_101_2 = registration; // Register to the page unload event.
      ...
      this.__listeners__P_101_3 = {}; // The handler and dispatcher instances

      this.__handlers__P_101_4 = {};
      this.__dispatchers__P_101_5 = {};
      this.__handlerCache__P_101_6 = {};
      this.__clearBlackList__P_101_7 = new qx.util.DeferredCall(function () {
        this.__blacklist__P_101_8 = null;
      }, this);
      this.__clearBlackList__P_101_7.$$blackListCleaner = true;
    },
    ...
    */
    statics: {
       ...
       */
      getNextUniqueId() {
        return this.__lastUnique__P_101_9++ + "";
      },

      /**
       * @type {Array} private list of global event monitor functions
       */
      __globalEventMonitors__P_101_10: [],
      ...
      addGlobalEventMonitor(fn, context) {
        ...
        this.__globalEventMonitors__P_101_10.push(fn);
      },
      ...
      removeGlobalEventMonitor(fn) {
        qx.core.Assert.assertFunction(fn);
        qx.lang.Array.remove(this.__globalEventMonitors__P_101_10, fn);
      },
      ...
      resetGlobalEventMonitors() {
        qx.event.Manager.__globalEventMonitors__P_101_10 = [];
      },
      ...
      getGlobalEventMonitor() {
        return this.__globalEventMonitors__P_101_10[0];
      },
      ...
      setGlobalEventMonitor(fn) {
        qx.core.Assert.assertFunction(fn);
        this.__globalEventMonitors__P_101_10[0] = fn;
      }
    ...
    */
    members: {
      __registration__P_101_2: null,
      __listeners__P_101_3: null,
      __dispatchers__P_101_5: null,
      __disposeWrapper__P_101_11: null,
      __handlers__P_101_4: null,
      __handlerCache__P_101_6: null,
      __window__P_101_0: null,
      __windowId__P_101_1: null,
      __blacklist__P_101_8: null,
      __clearBlackList__P_101_7: null,
      ...
      */
       ...
       */
      getWindowId() {
        return this.__windowId__P_101_1;
      },
       ...
       */
      getHandler(clazz) {
        var handler = this.__handlers__P_101_4[clazz.classname];

        if (handler) {
          return handler;
        }

        return this.__handlers__P_101_4[clazz.classname] = new clazz(this);
      },
       ...
       */
      getDispatcher(clazz) {
        var dispatcher = this.__dispatchers__P_101_5[clazz.classname];

        if (dispatcher) {
          return dispatcher;
        }

        return this.__dispatchers__P_101_5[clazz.classname] = new clazz(this, this.__registration__P_101_2);
      },
      ...
      */
      ...
      getListeners(target, type, capture) {
        ...
        var targetMap = this.__listeners__P_101_3[targetKey];
       ...
       */
      getAllListeners() {
        return this.__listeners__P_101_3;
      },
      ...
      toggleAttachedEvents(target, enable) {
        ...
        if (targetMap) {
          ...
          for (var entryKey in targetMap) {
            ...
            if (enable) {
              this.__registerAtHandler__P_101_12(target, type, capture);
            } else {
              this.__unregisterAtHandler__P_101_13(target, type, capture);
            }
          }
        }
      },
      ...
      importListeners(target, list) {
        ...
        for (var listKey in list) {
          ...
          if (!entryList) {
            ...
            this.__registerAtHandler__P_101_12(target, item.type, item.capture);
          ...
          entryList.push({
            ...
            context: item.self,
            unique: item.unique || clazz.__lastUnique__P_101_9++ + ""
          });
        }
      },
      ...
      addListener(target, type, listener, self, capture) {
        ...
        if (!targetMap) {
          targetMap = this.__listeners__P_101_3[targetKey] = {};
        }
        ...
        var unique = qx.event.Manager.__lastUnique__P_101_9++ + "";
        var entry = {
          handler: listener,
          context: self,
          unique: unique
      ...
      findHandler(target, type) {
        ...
        else if (target == this.__window__P_101_0) {
          isWindow = true;
          key = "WIN_" + type;
        ...
        var cache = this.__handlerCache__P_101_6;

        if (cache[key]) {
          return cache[key];
        }

        var classes = this.__registration__P_101_2.getHandlers();
       ...
       */
      __registerAtHandler__P_101_12(target, type, capture) {
      ...
      removeListener(target, type, listener, self, capture) {
        ...
        for (var i = 0, l = entryList.length; i < l; i++) {
          ...
          if (entry.handler === listener && entry.context === self) {
            ...
            this.__addToBlacklist__P_101_14(entry.unique);
      ...
      removeAllListeners(target) {
        ...
        delete this.__listeners__P_101_3[targetKey];
        return true;
      },
       ...
       * @throws {Error} if there is no handler for the event
       */
      __unregisterAtHandler__P_101_13(target, type, capture) {
        var handler = this.findHandler(target, type);
      ...
      */
      ...
      dispatchEvent(target, event) {
        ...
        var monitors = qx.event.Manager.__globalEventMonitors__P_101_10;
        ...
        var classes = this.__registration__P_101_2.getDispatchers();
      ...
      dispose() {
        ...
        this.__registration__P_101_2.removeManager(this);

        qx.util.DisposeUtil.disposeMap(this, "__handlers__P_101_4");
        qx.util.DisposeUtil.disposeMap(this, "__dispatchers__P_101_5"); // Dispose data fields

        this.__listeners__P_101_3 = this.__window__P_101_0 = this.__disposeWrapper__P_101_11 = null;
        this.__registration__P_101_2 = this.__handlerCache__P_101_6 = null;
      },
       ...
       */
      __addToBlacklist__P_101_14(uid) {
        if (this.__blacklist__P_101_8 === null) {
          this.__blacklist__P_101_8 = {};

          this.__clearBlackList__P_101_7.schedule();
        }

        this.__blacklist__P_101_8[uid] = true;
      },
       ...
       */
      isBlacklisted(uid) {
        return this.__blacklist__P_101_8 !== null && this.__blacklist__P_101_8[uid] === true;
      }
...
//# sourceMappingURL=Manager.js.map?dt=1658886734619