  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.event.handler.TouchCore", {
    ...
    construct(target, emitter) {
      this.__target__P_53_0 = target;
      this.__emitter__P_53_1 = emitter;

      this._initTouchObserver();

      this.__pointers__P_53_2 = [];
      this.__touchStartPosition__P_53_3 = {};
    },

    members: {
      __target__P_53_0: null,
      __emitter__P_53_1: null,
      __onTouchEventWrapper__P_53_4: null,
      __originalTarget__P_53_5: null,
      __touchStartPosition__P_53_3: null,
      __startTime__P_53_6: null,
      __beginScalingDistance__P_53_7: null,
      __beginRotation__P_53_8: null,
      __pointers__P_53_2: null,
      __touchEventNames__P_53_9: null,
      ...
      */
       ...
       */
      _initTouchObserver() {
        this.__onTouchEventWrapper__P_53_4 = qx.lang.Function.listener(this._onTouchEvent, this);
        this.__touchEventNames__P_53_9 = ["touchstart", "touchmove", "touchend", "touchcancel"];
        ...
        if (qx.core.Environment.get("event.mspointer")) {
          ...
          if (engineVersion == 10) {
            // IE 10
            this.__touchEventNames__P_53_9 = ["MSPointerDown", "MSPointerMove", "MSPointerUp", "MSPointerCancel"];
          } else {
            // IE 11+
            this.__touchEventNames__P_53_9 = ["pointerdown", "pointermove", "pointerup", "pointercancel"];
          }
        }

        for (var i = 0; i < this.__touchEventNames__P_53_9.length; i++) {
          qx.bom.Event.addNativeListener(this.__target__P_53_0, this.__touchEventNames__P_53_9[i], this.__onTouchEventWrapper__P_53_4);
        }
      },
      ...
      */
      ...
      _stopTouchObserver() {
        for (var i = 0; i < this.__touchEventNames__P_53_9.length; i++) {
          qx.bom.Event.removeNativeListener(this.__target__P_53_0, this.__touchEventNames__P_53_9[i], this.__onTouchEventWrapper__P_53_4);
        }
      },
      ...
      */
      ...
      _calcSingleTouchDelta(touch) {
        if (this.__touchStartPosition__P_53_3.hasOwnProperty(touch.identifier)) {
          var touchStartPosition = this.__touchStartPosition__P_53_3[touch.identifier];
      ...
      _commonTouchEventHandler(domEvent, type) {
        ...
        if (type == "touchstart") {
          this.__originalTarget__P_53_5 = this._getTarget(domEvent);

          if (domEvent.touches && domEvent.touches.length > 1) {
            this.__beginScalingDistance__P_53_7 = this._getScalingDistance(domEvent.touches[0], domEvent.touches[1]);
            this.__beginRotation__P_53_8 = this._getRotationAngle(domEvent.touches[0], domEvent.touches[1]);
          }

          for (var i = 0; i < domEvent.changedTouches.length; i++) {
            var touch = domEvent.changedTouches[i];
            this.__touchStartPosition__P_53_3[touch.identifier] = [touch.clientX, touch.clientY];
          }
        }
        ...
        if (type == "touchmove") {
          ...
          if (typeof domEvent.scale == "undefined" && domEvent.targetTouches.length > 1) {
            ...
            domEvent.scale = currentScalingDistance / this.__beginScalingDistance__P_53_7;
          ...
          if ((typeof domEvent.rotation == "undefined" || qx.core.Environment.get("event.mspointer")) && domEvent.targetTouches.length > 1) {
            ...
            domEvent._rotation = currentRotation - this.__beginRotation__P_53_8;
          }

          domEvent.delta = this._calcTouchesDelta(domEvent.targetTouches);
        }

        this._fireEvent(domEvent, type, this.__originalTarget__P_53_5);

        if (qx.core.Environment.get("event.mspointer")) {
          if (type == "touchend" || type == "touchcancel") {
            delete this.__pointers__P_53_2[domEvent.pointerId];
          }
        }

        if ((type == "touchend" || type == "touchcancel") && domEvent.changedTouches[0]) {
          delete this.__touchStartPosition__P_53_3[domEvent.changedTouches[0].identifier];
        }
      },
      ...
      _detectTouchesByPointer(domEvent, type) {
        ...
        if (type == "touchstart") {
          this.__pointers__P_53_2[domEvent.pointerId] = domEvent;
        } else if (type == "touchmove") {
          this.__pointers__P_53_2[domEvent.pointerId] = domEvent;
        }

        for (var pointerId in this.__pointers__P_53_2) {
          var pointer = this.__pointers__P_53_2[pointerId];
      ...
      _getTarget(domEvent) {
        ...
        if (qx.core.Environment.get("engine.name") == "webkit") {
          ...
          //
          var targetForIE = this.__evaluateTarget__P_53_10(domEvent);
       ...
       */
      __evaluateTarget__P_53_10(domEvent) {
        var clientX = null;
        var clientY = null;
      ...
      _fireEvent(domEvent, type, target) {
        ...
        if (target && target.nodeType && this.__emitter__P_53_1) {
          this.__emitter__P_53_1.emit(type, domEvent);
        }
      },
      ...
      dispose() {
        ...
        this.__originalTarget__P_53_5 = this.__target__P_53_0 = this.__touchEventNames__P_53_9 = this.__pointers__P_53_2 = this.__emitter__P_53_1 = this.__beginScalingDistance__P_53_7 = this.__beginRotation__P_53_8 = null;
      }
...
//# sourceMappingURL=TouchCore.js.map?dt=1658886719000