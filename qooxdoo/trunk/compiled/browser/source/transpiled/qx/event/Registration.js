    ...
    */
    statics: {
      ...
      getManager(target) {
        ...
        var manager = this.__managers__P_96_0[hash];

        if (!manager) {
          manager = new qx.event.Manager(target, this);
          this.__managers__P_96_0[hash] = manager;
        }
      ...
      removeManager(mgr) {
        ...
        delete this.__managers__P_96_0[id];
      },
       ...
       * @see #createEvent
       */
      __fireEvent__P_96_1(target, type, clazz, args) {
        {
       ...
       * @see #createEvent
       */
      __fireNonBubblingEvent__P_96_2(target, type, clazz, args) {
        {
          if (arguments.length > 2 && clazz === undefined && args !== undefined) {
            throw new Error("Create event of type " + type + " with undefined class. Please use null to explicit fallback to default event type!");
          }
      ...
      fireNonBubblingEvent(target, type, clazz, args) {
        var evt = this.__fireNonBubblingEvent__P_96_2.apply(this, arguments);
      ...
      */
      ...
      addHandler(handler) {
        ...
        this.__handlers__P_96_3.push(handler); // Re-sort list


        this.__handlers__P_96_3.sort(function (a, b) {
       ...
       */
      getHandlers() {
        return this.__handlers__P_96_3;
      },
      ...
      */
      ...
      addDispatcher(dispatcher, priority) {
        ...
        this.__dispatchers__P_96_4.push(dispatcher); // Re-sort list


        this.__dispatchers__P_96_4.sort(function (a, b) {
          return a.PRIORITY - b.PRIORITY;
        });
      },
       ...
       */
      getDispatchers() {
        return this.__dispatchers__P_96_4;
      }
...
//# sourceMappingURL=Registration.js.map?dt=1658886732778