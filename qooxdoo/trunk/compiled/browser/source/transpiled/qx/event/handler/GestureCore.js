  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.event.handler.GestureCore", {
    ...
    construct(target, emitter) {
      this.__defaultTarget__P_50_0 = target;
      this.__emitter__P_50_1 = emitter;
      this.__gesture__P_50_2 = {};
      this.__lastTap__P_50_3 = {};
      this.__stopMomentum__P_50_4 = {};
      this.__momentum__P_50_5 = {};
      this.__rollEvents__P_50_6 = [];

      this._initObserver();
    },

    members: {
      __defaultTarget__P_50_0: null,
      __emitter__P_50_1: null,
      __gesture__P_50_2: null,
      __eventName__P_50_7: null,
      __primaryTarget__P_50_8: null,
      __isMultiPointerGesture__P_50_9: null,
      __initialAngle__P_50_10: null,
      __lastTap__P_50_3: null,
      __rollImpulseId__P_50_11: null,
      __stopMomentum__P_50_4: null,
      __initialDistance__P_50_12: null,
      __momentum__P_50_5: null,
      __rollEvents__P_50_6: null,
      __rollEventsCountStart__P_50_13: 0,
      __rollEventsCount__P_50_14: 0,
      __touchPadDetectionPerformed__P_50_15: false,
      __lastRollEventTime__P_50_16: 0,
      ...
      _initObserver() {
        qx.event.handler.GestureCore.GESTURE_EVENTS.forEach(function (gestureType) {
          qxWeb(this.__defaultTarget__P_50_0).on(gestureType, this.checkAndFireGesture, this);
        }.bind(this));

        if (qx.core.Environment.get("engine.name") == "mshtml" && qx.core.Environment.get("browser.documentmode") < 9) {
          qxWeb(this.__defaultTarget__P_50_0).on("dblclick", this._onDblClick, this);
      ...
      _stopObserver() {
        qx.event.handler.GestureCore.GESTURE_EVENTS.forEach(function (pointerType) {
          qxWeb(this.__defaultTarget__P_50_0).off(pointerType, this.checkAndFireGesture, this);
        }.bind(this));

        if (qx.core.Environment.get("engine.name") == "mshtml" && qx.core.Environment.get("browser.documentmode") < 9) {
          qxWeb(this.__defaultTarget__P_50_0).off("dblclick", this._onDblClick, this);
        }
      ...
      gestureBegin(domEvent, target) {
        if (this.__gesture__P_50_2[domEvent.pointerId]) {
          this.__stopLongTapTimer__P_50_17(this.__gesture__P_50_2[domEvent.pointerId]);

          delete this.__gesture__P_50_2[domEvent.pointerId];
        }
        /*
        ...
        this.__gesture__P_50_2[domEvent.pointerId] = {
          ...
          longTapTimer: window.setTimeout(this.__fireLongTap__P_50_18.bind(this, domEvent, target), qx.event.handler.GestureCore.LONGTAP_TIME)
        };

        if (domEvent.isPrimary) {
          this.__isMultiPointerGesture__P_50_9 = false;
          this.__primaryTarget__P_50_8 = target;

          this.__fireTrack__P_50_19("trackstart", domEvent, target);
        } else {
          this.__isMultiPointerGesture__P_50_9 = true;

          if (Object.keys(this.__gesture__P_50_2).length === 2) {
            this.__initialAngle__P_50_10 = this._calcAngle();
            this.__initialDistance__P_50_12 = this._calcDistance();
          }
        }
      },
      ...
      gestureMove(domEvent, target) {
        var gesture = this.__gesture__P_50_2[domEvent.pointerId];
        ...
        if (gesture) {
          ...
          if (Object.keys(this.__gesture__P_50_2).length === 2) {
            this.__fireRotate__P_50_20(domEvent, gesture.target);

            this.__firePinch__P_50_21(domEvent, gesture.target);
          }

          if (!this.__isMultiPointerGesture__P_50_9) {
            this.__fireTrack__P_50_19("track", domEvent, gesture.target);
          ...
          if (gesture.isTap) {
            ...
            if (!gesture.isTap) {
              this.__stopLongTapTimer__P_50_17(gesture);
            }
          }
        }
      },
      ...
      _hasIntermediaryHandler(target) {
        while (target && target !== this.__defaultTarget__P_50_0) {
      ...
      gestureFinish(domEvent, target) {
        ...
        var gesture = this.__gesture__P_50_2[domEvent.pointerId]; // delete the long tap
        ...
        this.__handleRollImpulse__P_50_22(gesture.velocityX, gesture.velocityY, domEvent, gesture.target);

        this.__fireTrack__P_50_19("trackend", domEvent, gesture.target);
        ...
        if (gesture.isTap) {
          ...
          if (Object.keys(this.__lastTap__P_50_3).length > 0) {
            // delete old tap entries
            var limit = Date.now() - qx.event.handler.GestureCore.DOUBLETAP_TIME;

            for (var time in this.__lastTap__P_50_3) {
              if (time < limit) {
                delete this.__lastTap__P_50_3[time];
              } else {
                var lastTap = this.__lastTap__P_50_3[time];

                var isBelowDoubleTapDistance = this.__isBelowDoubleTapDistance__P_50_23(lastTap.x, lastTap.y, domEvent.clientX, domEvent.clientY, domEvent.getPointerType());
          ...
          if (!isDblTap) {
            this.__lastTap__P_50_3[Date.now()] = {
              x: domEvent.clientX,
              y: domEvent.clientY,
          ...
          var swipe = this.__getSwipeGesture__P_50_24(domEvent, target);
       ...
       */
      stopMomentum(id) {
        this.__stopMomentum__P_50_4[id] = true;
      },
       ...
       */
      gestureCancel(id) {
        if (this.__gesture__P_50_2[id]) {
          this.__stopLongTapTimer__P_50_17(this.__gesture__P_50_2[id]);

          delete this.__gesture__P_50_2[id];
        }

        if (this.__momentum__P_50_5[id]) {
          this.stopMomentum(this.__momentum__P_50_5[id]);
          delete this.__momentum__P_50_5[id];
        }
      },
      ...
      updateGestureTarget(id, target) {
        this.__gesture__P_50_2[id].target = target;
      },
       ...
       */
      __handleRollImpulse__P_50_22(deltaX, deltaY, domEvent, target, time) {
        var oldTimeoutId = domEvent.timeoutId;

        if (!time && this.__momentum__P_50_5[domEvent.pointerId]) {
          // new roll impulse started, stop the old one
          this.stopMomentum(this.__momentum__P_50_5[domEvent.pointerId]);
        } // do nothing if we don't need to scroll


        if (Math.abs(deltaY) < 1 && Math.abs(deltaX) < 1 || this.__stopMomentum__P_50_4[oldTimeoutId] || !this.getWindow()) {
          delete this.__stopMomentum__P_50_4[oldTimeoutId];
          delete this.__momentum__P_50_5[domEvent.pointerId];
          return;
        }
        ...
        var timeoutId = qx.bom.AnimationFrame.request(qx.lang.Function.bind(function (deltaX, deltaY, domEvent, target, time) {
          this.__handleRollImpulse__P_50_22(deltaX, deltaY, domEvent, target, time);
        ...
        this.__momentum__P_50_5[domEvent.pointerId] = timeoutId;
      ...
      _calcAngle() {
        ...
        for (var pointerId in this.__gesture__P_50_2) {
          var gesture = this.__gesture__P_50_2[pointerId];
       ...
       */
      __isBelowDoubleTapDistance__P_50_23(x1, y1, x2, y2, type) {
      ...
      _fireEvent(domEvent, type, target) {
        ...
        if (!this.__defaultTarget__P_50_0) {
          return;
        }
        ...
        if (qx.core.Environment.get("event.dispatchevent")) {
        ...
        } else if (this.__emitter__P_50_1) {
          evt = new qx.event.type.dom.Custom(type, domEvent, {
            target: this.__defaultTarget__P_50_0,
            currentTarget: this.__defaultTarget__P_50_0,
            srcElement: this.__defaultTarget__P_50_0,
            swipe: domEvent.swipe,
            scale: domEvent.scale,
            angle: domEvent.angle,
            delta: domEvent.delta,
          ...
          this.__emitter__P_50_1.emit(type, domEvent);
        }
      },
       ...
       */
      __getSwipeGesture__P_50_24(domEvent, target) {
        var gesture = this.__gesture__P_50_2[domEvent.pointerId];
       ...
       * @param target {Element} event target
       */
      __fireTrack__P_50_19(type, domEvent, target) {
       ...
       */
      __fireRollEvent__P_50_25(domEvent, target, rollFactor) {
        domEvent.delta = {
       ...
       * @param target {Element} event target
       */
      __performAdaptativeRollScrolling__P_50_26(target) {
        ...
        this.__lastRollEventTime__P_50_16 = new Date().getTime();
        var reLength = this.__rollEvents__P_50_6.length;

        for (var i = 0; i < reLength; i++) {
          var domEvent = this.__rollEvents__P_50_6[i];

          this.__fireRollEvent__P_50_25(domEvent, target, rollFactor);
        }
       ...
       */
      __endTouchPadDetection__P_50_27() {
        if (this.__rollEvents__P_50_6.length > qx.event.handler.GestureCore.TOUCHPAD_WHEEL_EVENTS_THRESHOLD) {
          qx.util.Wheel.IS_TOUCHPAD = true;
        } else {
          qx.util.Wheel.IS_TOUCHPAD = false;
        }

        this.__touchPadDetectionPerformed__P_50_15 = true;
      },
      ...
      _fireRoll(domEvent, type, target) {
        ...
        if (domEvent.type === qx.core.Environment.get("event.mousewheel").type) {
          if (this._isTouchPadDetectionEnabled()) {
            ...
            if (this.__lastRollEventTime__P_50_16 > 0 && now - this.__lastRollEventTime__P_50_16 > detectionTimeout) {
              // The detection timeout was reached. A new detection step should occur.
              this.__touchPadDetectionPerformed__P_50_15 = false;
              this.__rollEvents__P_50_6 = [];
              this.__lastRollEventTime__P_50_16 = 0;
            }

            if (!this.__touchPadDetectionPerformed__P_50_15) {
              ...
              if (this.__rollEvents__P_50_6.length === 0) {
                // detection starts
                this.__rollEventsCountStart__P_50_13 = now;
                qx.event.Timer.once(function () {
                  if (!this.__touchPadDetectionPerformed__P_50_15) {
                    ...
                    this.__endTouchPadDetection__P_50_27();

                    this.__performAdaptativeRollScrolling__P_50_26(target);
                  }
                }, this, qx.event.handler.GestureCore.TOUCHPAD_WHEEL_EVENTS_PERIOD + 50);
              }

              this.__rollEvents__P_50_6.push(domEvent);

              this.__rollEventsCount__P_50_14++;

              if (now - this.__rollEventsCountStart__P_50_13 > qx.event.handler.GestureCore.TOUCHPAD_WHEEL_EVENTS_PERIOD) {
                this.__endTouchPadDetection__P_50_27();
              }
            }
            ...
            this.__fireRollEvent__P_50_25(domEvent, target, qx.event.handler.GestureCore.ROLL_FACTOR);
          }
        } else {
          var gesture = this.__gesture__P_50_2[domEvent.pointerId];
          domEvent.delta = {
       ...
       * @param target {Element} event target
       */
      __fireRotate__P_50_20(domEvent, target) {
        if (!domEvent.isPrimary) {
          var angle = this._calcAngle();

          domEvent.angle = Math.round((angle - this.__initialAngle__P_50_10) % 360);

          this._fireEvent(domEvent, "rotate", this.__primaryTarget__P_50_8);
        }
      },
       ...
       * @param target {Element} event target
       */
      __firePinch__P_50_21(domEvent, target) {
        if (!domEvent.isPrimary) {
          var distance = this._calcDistance();

          var scale = distance / this.__initialDistance__P_50_12;
          domEvent.scale = Math.round(scale * 100) / 100;

          this._fireEvent(domEvent, "pinch", this.__primaryTarget__P_50_8);
        }
      },
       ...
       * @param target {Element} event target
       */
      __fireLongTap__P_50_18(domEvent, target) {
        var gesture = this.__gesture__P_50_2[domEvent.pointerId];
       ...
       */
      __stopLongTapTimer__P_50_17(gesture) {
       ...
       */
      dispose() {
        for (var gesture in this.__gesture__P_50_2) {
          this.__stopLongTapTimer__P_50_17(gesture);
        }

        this._stopObserver();

        this.__defaultTarget__P_50_0 = this.__emitter__P_50_1 = null;
      }
...
//# sourceMappingURL=GestureCore.js.map?dt=1658886718510