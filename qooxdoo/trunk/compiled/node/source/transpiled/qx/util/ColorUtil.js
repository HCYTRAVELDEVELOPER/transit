    ...
    statics: {
      ...
      cssStringToRgb(str) {
        ...
        if (this.isNamedColor(str)) {
          ...
          color = this.__rgbaStringToRgb__P_126_0(str);
        } else if (this.isRgbString(str)) {
          color = this.__rgbStringToRgb__P_126_1();
        } else if (this.ishexShortString(str)) {
          color = this.__hexShortStringToRgb__P_126_2();
        } else if (this.ishexLongString(str)) {
          color = this.__hexLongStringToRgb__P_126_3();
        }
       ...
       * @return {Array} an array with red, green, blue
       */
      __hexShortStringToRgb__P_126_2() {
      ...
      hex3StringToRgb(value) {
        if (this.isHex3String(value)) {
          return this.__hex3StringToRgb__P_126_4(value);
        }
      ...
      hex6StringToRgb(value) {
        if (this.isHex6String(value)) {
          return this.__hex6StringToRgb__P_126_5(value);
        }
      ...
      hexStringToRgb(value) {
        if (this.ishexShortString(value)) {
          return this.__hexShortStringToRgb__P_126_2(value);
        }

        if (this.ishexLongString(value)) {
          return this.__hexLongStringToRgb__P_126_3(value);
        }
       ...
       */
      __tuner__P_126_6(color, tuneMap, tuner, hue_tuner) {
      ...
      scale(color, scaleMap) {
        return this.__tuner__P_126_6(color, scaleMap, function (value, scale, max) {
          if (value > max) {
            value = max;
          }
      ...
      adjust(color, adjustMap) {
        return this.__tuner__P_126_6(color, adjustMap, function (value, offset, max) {
          value += offset;
