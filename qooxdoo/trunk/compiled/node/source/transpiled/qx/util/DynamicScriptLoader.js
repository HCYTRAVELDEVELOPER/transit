  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.util.DynamicScriptLoader", {
    ...
    construct(scriptArr) {
      ...
      this.__started__P_130_0 = false;
      this.__QUEUE__P_130_1 = qx.lang.Type.isString(scriptArr) ? [scriptArr] : qx.lang.Array.clone(scriptArr);
    },
    ...
    */
    members: {
       ...
       */
      __QUEUE__P_130_1: null,

      /**
       * True if start has been called.
       */
      __started__P_130_0: null,
      ...
      start: qx.core.Environment.select("qx.promise", {
        true() {
          return new qx.Promise(function (resolve, reject) {
            ...
            if (this.__started__P_130_0) {
              reject(new Error("you can only call start once per instance"));
            }

            this.__started__P_130_0 = true;

            this.__loadScripts__P_130_4();
          }, this);
        },
      ...
      __loadScripts__P_130_4() {
        ...
        var uri;
        var loader;
        script = this.__QUEUE__P_130_1.shift();
        ...
        if (DynamicScriptLoader.__LOADED__P_130_3[script]) {
        ...
        dynLoader = DynamicScriptLoader.__IN_PROGRESS__P_130_2[script];
        ...
        loader.on("load", function (request) {
          ...
          DynamicScriptLoader.__LOADED__P_130_3[script] = true;
          delete DynamicScriptLoader.__IN_PROGRESS__P_130_2[script];
          this.fireDataEvent("loaded", {
            script: script,
        ...
        loader.open("GET", uri);
        DynamicScriptLoader.__IN_PROGRESS__P_130_2[script] = this;
        loader.send();
      }
    ...
    destruct() {
      ...
      for (var key in DynamicScriptLoader.__IN_PROGRESS__P_130_2) {
        if (DynamicScriptLoader.__IN_PROGRESS__P_130_2[key] === this) {
          delete DynamicScriptLoader.__IN_PROGRESS__P_130_2[key];
        }
      }

      this.__QUEUE__P_130_1 = undefined;
    }
