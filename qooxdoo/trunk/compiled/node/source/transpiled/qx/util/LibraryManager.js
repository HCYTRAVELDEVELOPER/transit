  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.util.LibraryManager", {
    ...
    members: {
       ...
       */
      has(namespace) {
        return !!qx.util.LibraryManager.__libs__P_132_0[namespace];
      },
       ...
       */
      get(namespace, key) {
        return qx.util.LibraryManager.__libs__P_132_0[namespace][key] ? qx.util.LibraryManager.__libs__P_132_0[namespace][key] : null;
      },
      ...
      set(namespace, key, value) {
        qx.util.LibraryManager.__libs__P_132_0[namespace][key] = value;
      }
