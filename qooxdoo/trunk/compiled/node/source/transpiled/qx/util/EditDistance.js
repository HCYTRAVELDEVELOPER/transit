  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.util.EditDistance", {
    statics: {
       ...
       */
      __computeLevenshteinDistance__P_131_0(dataA, dataB) {
       ...
       */
      __computeEditOperations__P_131_1(distance, dataA, dataB) {
        var operations = [];
      ...
      getEditOperations(dataA, dataB) {
        var distance = this.__computeLevenshteinDistance__P_131_0(dataA, dataB);

        var operations = this.__computeEditOperations__P_131_1(distance, dataA, dataB);
