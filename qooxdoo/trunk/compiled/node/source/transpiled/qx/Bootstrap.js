    ...
    statics: {
      ...
      addPendingDefer(clazz, cb) {
        if (qx.$$loader && qx.$$loader.delayDefer) {
          this.__pendingDefers__P_149_0.push(clazz);
      ...
      executePendingDefers(dbClassInfo) {
        ...
        if (!dbClassInfo) {
          var pendingDefers = this.__pendingDefers__P_149_0;
          this.__pendingDefers__P_149_0 = [];
      ...
      */
       ...
       * @type {String[]}
       */
      __shadowedKeys__P_149_1: ["isPrototypeOf", "hasOwnProperty", "toLocaleString", "toString", "valueOf", "propertyIsEnumerable", "constructor"],
      ...
      keys: {
        ...
        BROKEN_IE(map) {
          ...
          var shadowedKeys = qx.Bootstrap.__shadowedKeys__P_149_1;
      ...
      */
      ...
      getClass(value) {
        ...
        return qx.Bootstrap.__classToTypeMap__P_149_2[classString] || classString.slice(8, -1);
      },
