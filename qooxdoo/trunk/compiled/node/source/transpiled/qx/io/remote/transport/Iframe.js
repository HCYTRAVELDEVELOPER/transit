  ...
  qx.Class.define("qx.io.remote.transport.Iframe", {
    ...
    */
    construct() {
      ...
      this.__frame__P_99_0 = qx.bom.Iframe.create({
        id: vFrameName,
        name: vFrameName,
        src: vFrameSource
      });
      qx.bom.element.Style.set(this.__frame__P_99_0, "display", "none"); // Create form element with textarea as conduit for request data.
      ...
      this.__form__P_99_1 = qx.dom.Element.create("form", {
        id: vFormName,
        name: vFormName,
        target: vFrameName
      });
      qx.bom.element.Style.set(this.__form__P_99_1, "display", "none");
      qx.dom.Element.insertEnd(this.__form__P_99_1, qx.dom.Node.getBodyElement(document));
      this.__data__P_99_2 = qx.dom.Element.create("textarea", {
        id: "_data_",
        name: "_data_"
      });
      qx.dom.Element.insertEnd(this.__data__P_99_2, this.__form__P_99_1); // Finally, attach iframe to DOM and add listeners

      qx.dom.Element.insertEnd(this.__frame__P_99_0, qx.dom.Node.getBodyElement(document));
      qx.event.Registration.addListener(this.__frame__P_99_0, "load", this._onload, this); // qx.event.handler.Iframe does not yet support the readystatechange event

      this.__onreadystatechangeWrapper__P_99_3 = qx.lang.Function.listener(this._onreadystatechange, this);
      qx.bom.Event.addNativeListener(this.__frame__P_99_0, "readystatechange", this.__onreadystatechangeWrapper__P_99_3);
    },
    ...
    */
    members: {
      __data__P_99_2: null,
      __lastReadyState__P_99_4: 0,
      __form__P_99_1: null,
      __frame__P_99_0: null,
      __onreadystatechangeWrapper__P_99_3: null,
      ...
      */
      ...
      send() {
        ...
        for (var vId in vFormFields) {
          ...
          this.__form__P_99_1.appendChild(vField);
        } // --------------------------------------
        //   Preparing form
        // --------------------------------------


        this.__form__P_99_1.action = vUrl;
        this.__form__P_99_1.method = vMethod; // --------------------------------------
        //   Sending data
        // --------------------------------------

        this.__data__P_99_2.appendChild(document.createTextNode(this.getData()));

        this.__form__P_99_1.submit();
      ...
      _onreadystatechange: qx.event.GlobalError.observeMethod(function (e) {
        this._switchReadyState(qx.io.remote.transport.Iframe._numericMap[this.__frame__P_99_0.readyState]);
      }),
      ...
      _switchReadyState(vReadyState) {
        ...
        while (this.__lastReadyState__P_99_4 < vReadyState) {
          this.setState(qx.io.remote.Exchange._nativeMap[++this.__lastReadyState__P_99_4]);
        }
      },
      ...
      */
       ...
       */
      getIframeWindow() {
        return qx.bom.Iframe.getWindow(this.__frame__P_99_0);
      },
       ...
       */
      getIframeDocument() {
        return qx.bom.Iframe.getDocument(this.__frame__P_99_0);
      },
       ...
       */
      getIframeBody() {
        return qx.bom.Iframe.getBody(this.__frame__P_99_0);
      },
    ...
    */
    destruct() {
      if (this.__frame__P_99_0) {
        qx.event.Registration.removeListener(this.__frame__P_99_0, "load", this._onload, this);
        qx.bom.Event.removeNativeListener(this.__frame__P_99_0, "readystatechange", this.__onreadystatechangeWrapper__P_99_3); // Reset source to a blank image for gecko
        // Otherwise it will switch into a load-without-end behaviour

        if (qx.core.Environment.get("engine.name") == "gecko") {
          this.__frame__P_99_0.src = qx.util.ResourceManager.getInstance().toUri("qx/static/blank.gif");
        } // Finally, remove element node


        qx.dom.Element.remove(this.__frame__P_99_0);
      }

      if (this.__form__P_99_1) {
        qx.dom.Element.remove(this.__form__P_99_1);
      }

      this.__frame__P_99_0 = this.__form__P_99_1 = this.__data__P_99_2 = null;
    }
