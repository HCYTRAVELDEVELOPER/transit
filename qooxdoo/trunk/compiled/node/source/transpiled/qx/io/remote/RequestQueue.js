  ...
  qx.Class.define("qx.io.remote.RequestQueue", {
    ...
    */
    construct() {
      ...
      this.__active__P_96_1 = [];
      this.__totalRequests__P_96_2 = 0; // timeout handling

      this.__timer__P_96_3 = new qx.event.Timer(500);

      this.__timer__P_96_3.addListener("interval", this._oninterval, this);
    },
    ...
    */
    members: {
      __queue__P_96_0: null,
      __active__P_96_1: null,
      __totalRequests__P_96_2: null,
      __timer__P_96_3: null,
      ...
      */
      ...
      _debug() {
        if (qx.core.Environment.get("qx.debug")) {
          if (qx.core.Environment.get("qx.debug.io.remote")) {
            // Debug output
            var vText = this.__active__P_96_1.length + "/" + (this.__queue__P_96_0.length + this.__active__P_96_1.length);
      ...
      _check() {
        ...
        if (this.__active__P_96_1.length == 0 && this.__queue__P_96_0.length == 0) {
          this.__timer__P_96_3.stop();
        } // Checking if enabled
        ...
        if (this.__queue__P_96_0.length == 0 || this.__queue__P_96_0[0].isAsynchronous() && this.__active__P_96_1.length >= this.getMaxConcurrentRequests()) {
          return;
        } // Checking number of total requests


        if (this.getMaxTotalRequests() != null && this.__totalRequests__P_96_2 >= this.getMaxTotalRequests()) {
          return;
        }

        var vRequest = this.__queue__P_96_0.shift();

        var vTransport = new qx.io.remote.Exchange(vRequest); // Increment counter

        this.__totalRequests__P_96_2++; // Add to active queue

        this.__active__P_96_1.push(vTransport); // Debug output
        ...
        if (this.__queue__P_96_0.length > 0) {
          this._check();
        }
      },
      ...
      _remove(vTransport) {
        ...
        qx.lang.Array.remove(this.__active__P_96_1, vTransport); // Dispose transport object
      ...
      */
      ...
      _onsending(e) {
        if (qx.core.Environment.get("qx.debug")) {
          if (qx.core.Environment.get("qx.debug.io.remote")) {
            this.__activeCount__P_96_4++;
            e.getTarget()._counted = true;
            this.debug("ActiveCount: " + this.__activeCount__P_96_4);
          }
        }
      ...
      */
       ...
       */
      _oninterval(e) {
        var vActive = this.__active__P_96_1;
      ...
      */
      ...
      _applyEnabled(value, old) {
        ...
        this.__timer__P_96_3.setEnabled(value);
      },
      ...
      */
      ...
      add(vRequest) {
        ...
        if (vRequest.isAsynchronous()) {
          this.__queue__P_96_0.push(vRequest);
        } else {
          this.__queue__P_96_0.unshift(vRequest);
        }

        this._check();

        if (this.getEnabled()) {
          this.__timer__P_96_3.start();
        }
      },
      ...
      abort(vRequest) {
        ...
        if (vTransport) {
          vTransport.abort();
        } else if (this.__queue__P_96_0.includes(vRequest)) {
          qx.lang.Array.remove(this.__queue__P_96_0, vRequest);
        }
      }
    ...
    */
    destruct() {
      this._disposeArray("__active__P_96_1");

      this._disposeObjects("__timer__P_96_3");

      this.__queue__P_96_0 = null;
    }
