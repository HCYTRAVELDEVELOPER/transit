(function () {
  ...
  qx.Class.define("qx.io.transport.Websocket", {
    ...
    members: {
       ...
       */
      getTransportImpl() {
        if (!this.__tranportImpl__P_108_0) {
          this.__tranportImpl__P_108_0 = this._createTransportImpl();
        }

        return this.__tranportImpl__P_108_0;
      },
    ...
    destruct() {
      this.__tranportImpl__P_108_0.close();

      this.__tranportImpl__P_108_0 = null;
    },
