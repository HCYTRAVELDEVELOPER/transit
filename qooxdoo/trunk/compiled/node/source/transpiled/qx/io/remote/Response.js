    ...
    members: {
      ...
      */
      ...
      getResponseHeader(vHeader) {
        if (this.__lowerHeaders__P_97_0) {
          return this.__lowerHeaders__P_97_0[vHeader.toLowerCase()] || null;
        }
      ...
      _applyResponseHeaders(value, old) {
        ...
        if (value !== null) {
          ...
          this.__lowerHeaders__P_97_0 = lowerHeaders;
        }
      }
