  ...
  qx.Class.define("qx.io.remote.transport.Script", {
    ...
    */
    construct() {
      ...
      var vUniqueId = ++qx.io.remote.transport.Script.__uniqueId__P_100_0;

      if (vUniqueId >= 2000000000) {
        qx.io.remote.transport.Script.__uniqueId__P_100_0 = vUniqueId = 1;
      }

      this.__element__P_100_1 = null;
      this.__uniqueId__P_100_0 = vUniqueId;
    },
    ...
    */
    members: {
      __lastReadyState__P_100_2: 0,
      __element__P_100_1: null,
      __uniqueId__P_100_0: null,
      ...
      */
      ...
      send() {
        ...
        vUrl += (vUrl.indexOf("?") >= 0 ? "&" : "?") + qx.io.remote.transport.Script.ScriptTransport_ID_PARAM + "=" + this.__uniqueId__P_100_0;
        ...
        qx.io.remote.transport.Script._instanceRegistry[this.__uniqueId__P_100_0] = this;
        this.__element__P_100_1 = document.createElement("script"); // IE needs this (it ignores the
        // encoding from the header sent by the
        // server for dynamic script tags)

        this.__element__P_100_1.charset = "utf-8";
        this.__element__P_100_1.src = vUrl;
        ...
        document.body.appendChild(this.__element__P_100_1);
      },
      ...
      _switchReadyState(vReadyState) {
        ...
        while (this.__lastReadyState__P_100_2 < vReadyState) {
          this.setState(qx.io.remote.Exchange._nativeMap[++this.__lastReadyState__P_100_2]);
        }
      },
    ...
    */
    destruct() {
      if (this.__element__P_100_1) {
        delete qx.io.remote.transport.Script._instanceRegistry[this.__uniqueId__P_100_0];
        document.body.removeChild(this.__element__P_100_1);
      }

      this.__element__P_100_1 = this._responseContent = null;
    }
