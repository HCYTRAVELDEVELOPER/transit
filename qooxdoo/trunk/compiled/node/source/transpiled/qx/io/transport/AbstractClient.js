  ...
  qx.Class.define("qx.io.transport.AbstractClient", {
    ...
    statics: {
      ...
      registerTransport(uriRegExp, transportClass) {
        if (!this.constructor.__transports__P_106_0) {
          this.constructor.__transports__P_106_0 = [];
        }
        ...
        this.constructor.__transports__P_106_0.push({
          uriRegExp,
    ...
    members: {
      ...
      selectTransport(transportOrUri) {
        ...
        if (qx.lang.Type.isString(transportOrUri)) {
          ...
          for (let registeredTransport of this.constructor.__transports__P_106_0.reverse()) {
