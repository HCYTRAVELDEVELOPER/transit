  ...
  qx.Class.define("qx.io.remote.transport.XmlHttp", {
    ...
    */
    statics: {
       ...
       */
      setTimeout(timeout) {
        this.__timeout__P_101_0 = timeout;
      },
       ...
       */
      getTimeout() {
        return this.__timeout__P_101_0;
      }
    ...
    */
    members: {
      ...
      ---------------------------------------------------------------------------
      */
      __localRequest__P_101_1: false,
      __lastReadyState__P_101_2: 0,
      __request__P_101_3: null,
       ...
       */
      getRequest() {
        if (this.__request__P_101_3 === null) {
          this.__request__P_101_3 = qx.io.remote.transport.XmlHttp.createRequestObject();
          this.__request__P_101_3.onreadystatechange = qx.lang.Function.bind(this._onreadystatechange, this);
        }

        return this.__request__P_101_3;
      },
      ...
      */
       ...
       */
      send() {
        this.__lastReadyState__P_101_2 = 0;
        ...
        this.__localRequest__P_101_1 = vLocalRequest; // --------------------------------------
      ...
      */
      ...
      _onreadystatechange: qx.event.GlobalError.observeMethod(function (e) {
        ...
        if (vReadyState == 4) {
          ...
          if (!qx.io.remote.Exchange.wasSuccessful(this.getStatusCode(), vReadyState, this.__localRequest__P_101_1)) {
            // Fix for bug #2272
        ...
        if (vReadyState == 3 && this.__lastReadyState__P_101_2 == 1) {
          this.setState(qx.io.remote.Exchange._nativeMap[++this.__lastReadyState__P_101_2]);
        } // Updating internal state


        while (this.__lastReadyState__P_101_2 < vReadyState) {
          this.setState(qx.io.remote.Exchange._nativeMap[++this.__lastReadyState__P_101_2]);
        }
      }),
      ...
      */
      ...
      getResponseXml() {
        ...
        if (qx.io.remote.Exchange.wasSuccessful(vStatus, vReadyState, this.__localRequest__P_101_1)) {
          try {
