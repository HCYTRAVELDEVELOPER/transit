  ...
  qx.Bootstrap.define("qx.io.part.ClosurePart", {
    ...
    members: {
      ...
      load(callback, self) {
        ...
        this.__packagesToLoad__P_91_0 = this._packages.length;
        ...
        for (var i = 0; i < this._packages.length; i++) {
          ...
          if (pkgReadyState == "initialized" || pkgReadyState == "loading") {
            ...
            // "complete" and "cached"
            this.__packagesToLoad__P_91_0--;
          }
        } // execute closures in case everything is already loaded/cached


        if (this.__packagesToLoad__P_91_0 <= 0) {
          this.__executePackages__P_91_1();
        }
      },
...
//# sourceMappingURL=ClosurePart.js.map