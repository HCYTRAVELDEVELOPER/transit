  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.io.part.Package", {
    ...
    construct(urls, id, loaded) {
      this.__readyState__P_92_0 = loaded ? "complete" : "initialized";
      this.__urls__P_92_1 = urls;
      this.__id__P_92_2 = id;
    },

    members: {
      __readyState__P_92_0: null,
      __urls__P_92_1: null,
      __id__P_92_2: null,
      __closure__P_92_3: null,
      __loadWithClosure__P_92_4: null,
      __timeoutId__P_92_5: null,
      __notifyPackageResult__P_92_6: null,
       ...
       */
      getReadyState() {
        return this.__readyState__P_92_0;
      },
       ...
       */
      saveClosure(closure) {
        if (this.__readyState__P_92_0 == "error") {
          return;
        }

        this.__closure__P_92_3 = closure;

        if (!this.__loadWithClosure__P_92_4) {
          this.execute();
        } else {
          clearTimeout(this.__timeoutId__P_92_5);
          this.__readyState__P_92_0 = "cached";

          this.__notifyPackageResult__P_92_6(this);
        }
      },
       ...
       */
      execute() {
        if (this.__closure__P_92_3) {
          this.__closure__P_92_3();

          delete this.__closure__P_92_3;
        }

        if (qx.$$packageData[this.__id__P_92_2]) {
          this.__importPackageData__P_92_7(qx.$$packageData[this.__id__P_92_2]);

          delete qx.$$packageData[this.__id__P_92_2];
        }

        this.__readyState__P_92_0 = "complete";
      },
      ...
      loadClosure(notifyPackageResult, self) {
        if (this.__readyState__P_92_0 !== "initialized") {
          return;
        }

        this.__loadWithClosure__P_92_4 = true;
        this.__readyState__P_92_0 = "loading";
        this.__notifyPackageResult__P_92_6 = qx.Bootstrap.bind(notifyPackageResult, self);

        this.__loadScriptList__P_92_8(this.__urls__P_92_1, function () {}, function () {
          this.__readyState__P_92_0 = "error";
          notifyPackageResult.call(self, this);
        }, this);

        var pkg = this;
        this.__timeoutId__P_92_5 = setTimeout(function () {
          pkg.__readyState__P_92_0 = "error";
      ...
      load(notifyPackageResult, self) {
        ...
        this.__loadWithClosure__P_92_4 = false;
        this.__readyState__P_92_0 = "loading";

        this.__loadScriptList__P_92_8(this.__urls__P_92_1, function () {
          this.__readyState__P_92_0 = "complete";
          this.execute();
          notifyPackageResult.call(self, this);
        }, function () {
       ...
       */
      __loadScriptList__P_92_8(urlList, callback, errBack, self) {
        if (urlList.length == 0) {
          callback.call(self);
          return;
        }
        ...
        var loadScripts = function (urls) {
          ...
          loader.onerror = function () {
            if (self.__readyState__P_92_0 == "loading") {
              clearTimeout(self.__timeoutId__P_92_5);
              loader.dispose();
       ...
       */
      __importPackageData__P_92_7: qx.$$loader.importPackageData
    }
  });
