  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.io.jsonrpc.protocol.Request", {
    ...
    statics: {
       ...
       */
      __current_request_id__P_90_0: 0,

      getCurrentId() {
        return qx.io.jsonrpc.protocol.Request.__current_request_id__P_90_0;
      },

      resetId() {
        qx.io.jsonrpc.protocol.Request.__current_request_id__P_90_0 = 0;
      }
    ...
    construct(method, params, id) {
      ...
      if (id === undefined) {
        id = ++qx.io.jsonrpc.protocol.Request.__current_request_id__P_90_0;
      }

      this.set({
        id
      });
      this.__promise__P_90_1 = new qx.Promise();
    },

    members: {
      __promise__P_90_1: null,
