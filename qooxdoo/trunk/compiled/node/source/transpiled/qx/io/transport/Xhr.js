(function () {
  ...
  qx.Class.define("qx.io.transport.Xhr", {
    ...
    members: {
       ...
       */
      getTransportImpl() {
        this.__tranportImpl__P_109_0 = this._createTransportImpl();
        return this.__tranportImpl__P_109_0;
      },
      ...
      async send(message) {
        ...
        const req = this.__tranportImpl__P_109_0 || this.getTransportImpl();
        req.setRequestData(message);
        this.__tranportImpl__P_109_0 = null; // free the internal reference for the next request
