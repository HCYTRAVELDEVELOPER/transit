(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.io.remote.Rpc", {
    ...
    */
    ...
    construct(url, serviceName) {
      ...
      if (qx.core.ServerSettings) {
        this.__currentServerSuffix__P_98_0 = qx.core.ServerSettings.serverPathSuffix;
      }
    },
    ...
    */
    members: {
      __previousServerSuffix__P_98_1: null,
      __currentServerSuffix__P_98_0: null,
        ...
        req.addListener("completed", function (evt) {
          ...
          if (exTest != null) {
            ...
            if (refreshSession) {
              ...
              if (self.__currentServerSuffix__P_98_0 != newSuffix) {
                self.__previousServerSuffix__P_98_1 = self.__currentServerSuffix__P_98_0;
                self.__currentServerSuffix__P_98_0 = newSuffix;
              }
       ...
       */
      fixUrl(url) {
        if (this.__previousServerSuffix__P_98_1 == null || this.__currentServerSuffix__P_98_0 == null || this.__previousServerSuffix__P_98_1 == "" || this.__previousServerSuffix__P_98_1 == this.__currentServerSuffix__P_98_0) {
          return url;
        }

        var index = url.indexOf(this.__previousServerSuffix__P_98_1);

        if (index == -1) {
          return url;
        }

        return url.substring(0, index) + this.__currentServerSuffix__P_98_0 + url.substring(index + this.__previousServerSuffix__P_98_1.length);
      },
