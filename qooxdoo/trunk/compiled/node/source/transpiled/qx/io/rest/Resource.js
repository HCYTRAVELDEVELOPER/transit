  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.io.rest.Resource", {
    ...
    construct(description) {
      ...
      this.__longPollHandlers__P_105_0 = {};
      this.__pollTimers__P_105_1 = {};
      this.__routes__P_105_2 = {};
      ...
      try {
        if (typeof description !== "undefined") {
          ...
          this.__mapFromDescription__P_105_3(description);
        }
      } catch (e) {
        this.dispose();
        throw e;
    ...
    members: {
      _resource: null,
      __longPollHandlers__P_105_0: null,
      __pollTimers__P_105_1: null,
      __routes__P_105_2: null,
      ...
      map(action, method, url, check) {
        ...
        this.__addAction__P_105_4(action, method, url, check);
       ...
       *   <code>qx.io.rest.Resource.REQUIRED</code> (to verify existence).
       */
      __addAction__P_105_4(action, method, url, check) {
        this.__routes__P_105_2[action] = [method, url, check]; // Undefine generic getter when action is named "get"
        ...
        this.__declareEvent__P_105_5(action + "Success");

        this.__declareEvent__P_105_5(action + "Error");
      ...
      invoke(action, params, data) {
        ...
        this.__routes__P_105_2[action].params = params;
      ...
      poll(action, interval, params, immediately) {
        ...
        if (this.__pollTimers__P_105_1[action]) {
          this.__pollTimers__P_105_1[action].dispose();
        } // Fallback to previous params


        if (typeof params == "undefined") {
          params = this.__routes__P_105_2[action].params;
        } // Invoke immediately
        ...
        var timer = this.__pollTimers__P_105_1[action] = new qx.event.Timer(interval);
      ...
      longPoll(action) {
        ...
        var handlerId = this.__longPollHandlers__P_105_0[action] = this.addListener(action + "Success", function longPollHandler() {
          if (res.isDisposed()) {
            return;
          }
       ...
       */
      __mapFromDescription__P_105_3(description) {
    ...
    destruct() {
      ...
      if (this.__pollTimers__P_105_1) {
        for (action in this.__pollTimers__P_105_1) {
          var timer = this.__pollTimers__P_105_1[action];
          timer.stop();
          timer.dispose();
        }
      }

      if (this.__longPollHandlers__P_105_0) {
        for (action in this.__longPollHandlers__P_105_0) {
          var id = this.__longPollHandlers__P_105_0[action];
      ...
      this._resource = this.__routes__P_105_2 = this.__pollTimers__P_105_1 = this.__longPollHandlers__P_105_0 = null;
    }
