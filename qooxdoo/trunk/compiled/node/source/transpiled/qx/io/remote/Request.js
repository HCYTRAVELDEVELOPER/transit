  ...
  qx.Class.define("qx.io.remote.Request", {
    ...
    */
    ...
    construct(vUrl, vMethod, vResponseType) {
      ...
      this.__requestHeaders__P_95_0 = {};
      this.__urlParameters__P_95_1 = {};
      this.__dataParameters__P_95_2 = {};
      this.__formFields__P_95_3 = {};
      ...
      this.__seqNum__P_95_4 = ++qx.io.remote.Request.__seqNum__P_95_4;
    },
    ...
    */
    members: {
      __requestHeaders__P_95_0: null,
      __urlParameters__P_95_1: null,
      __dataParameters__P_95_2: null,
      __formFields__P_95_3: null,
      __seqNum__P_95_4: null,
      ...
      */
       ...
       */
      __forwardEvent__P_95_5: qx.event.GlobalError.observeMethod(function (e) {
      ...
      _oncompleted(e) {
        ...
        this.__forwardEvent__P_95_5(e); // Automatically dispose after event completion
      ...
      */
      ...
      setRequestHeader(vId, vValue) {
        this.__requestHeaders__P_95_0[vId] = vValue;
      },
      ...
      removeRequestHeader(vId) {
        delete this.__requestHeaders__P_95_0[vId];
      },
      ...
      getRequestHeader(vId) {
        return this.__requestHeaders__P_95_0[vId] || null;
      },
       ...
       */
      getRequestHeaders() {
        return this.__requestHeaders__P_95_0;
      },
      ...
      */
      ...
      setParameter(vId, vValue, bAsData) {
        if (bAsData) {
          this.__dataParameters__P_95_2[vId] = vValue;
        } else {
          this.__urlParameters__P_95_1[vId] = vValue;
        }
      },
      ...
      removeParameter(vId, bFromData) {
        if (bFromData) {
          delete this.__dataParameters__P_95_2[vId];
        } else {
          delete this.__urlParameters__P_95_1[vId];
        }
      },
      ...
      getParameter(vId, bFromData) {
        if (bFromData) {
          return this.__dataParameters__P_95_2[vId] || null;
        } else {
          return this.__urlParameters__P_95_1[vId] || null;
        }
      },
      ...
      getParameters(bFromData) {
        return bFromData ? this.__dataParameters__P_95_2 : this.__urlParameters__P_95_1;
      },
      ...
      */
      ...
      setFormField(vId, vValue) {
        this.__formFields__P_95_3[vId] = vValue;
      },
       ...
       */
      removeFormField(vId) {
        delete this.__formFields__P_95_3[vId];
      },
       ...
       */
      getFormField(vId) {
        return this.__formFields__P_95_3[vId] || null;
      },
       ...
       */
      getFormFields() {
        return this.__formFields__P_95_3;
      },
    ...
    */
    destruct() {
      ...
      this.__requestHeaders__P_95_0 = this.__urlParameters__P_95_1 = this.__dataParameters__P_95_2 = this.__formFields__P_95_3 = null;
    }
