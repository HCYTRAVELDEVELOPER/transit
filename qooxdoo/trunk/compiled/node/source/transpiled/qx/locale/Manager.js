  ...
  qx.Class.define("qx.locale.Manager", {
    ...
    */
    construct() {
      ...
      this.__translations__P_114_0 = qx.$$translations || {};
      this.__locales__P_114_1 = qx.$$locales || {};
      this.initLocale();
      this.__clientLocale__P_114_2 = this.getLocale();
    },
    ...
    */
    members: {
      __defaultLocale__P_114_3: qx.core.Environment.get("locale.default"),
      __locale__P_114_4: null,
      __language__P_114_5: null,
      __translations__P_114_0: null,
      __locales__P_114_1: null,
      __clientLocale__P_114_2: null,
       ...
       */
      getLanguage() {
        return this.__language__P_114_5;
      },
      ...
      getAvailableLocales(includeNonloaded) {
        ...
        for (var locale in this.__locales__P_114_1) {
          if (locale != this.__defaultLocale__P_114_3) {
            if (this.__locales__P_114_1[locale] === null && !includeNonloaded) {
       ...
       */
      __extractLanguage__P_114_6(locale) {
        var language;
      ...
      _applyLocale(value, old) {
        if (qx.core.Environment.get("qx.debug")) {
          if (!(value in this.__locales__P_114_1 || value == this.__clientLocale__P_114_2)) {
            qx.log.Logger.warn("Locale: " + value + " not available.");
          }
        }

        this.__locale__P_114_4 = value;
        this.__language__P_114_5 = this.__extractLanguage__P_114_6(value);
      },
      ...
      addTranslation(languageCode, translationMap) {
        var catalog = this.__translations__P_114_0;
      ...
      addLocale(localeCode, localeMap) {
        var catalog = this.__locales__P_114_1;
      ...
      translate(messageId, args, locale) {
        var catalog = this.__translations__P_114_0;
        return this.__lookupAndExpand__P_114_7(catalog, messageId, args, locale);
      },
       ...
       * @return {String | LocalizedString} translated message or localized string
       */
      __lookupAndExpand__P_114_7(catalog, messageId, args, locale) {
        if (qx.core.Environment.get("qx.debug")) {
        ...
        if (locale) {
          var language = this.__extractLanguage__P_114_6(locale);
        } else {
          locale = this.__locale__P_114_4;
          language = this.__language__P_114_5;
        } // e.g. DE_at
        ...
        if (!txt && catalog[this.__defaultLocale__P_114_3]) {
          txt = catalog[this.__defaultLocale__P_114_3][messageId];
        }
        ...
        {
          txt = new qx.locale.LocalizedString(txt, messageId, args, catalog === this.__locales__P_114_1);
        }
        return txt;
      }
