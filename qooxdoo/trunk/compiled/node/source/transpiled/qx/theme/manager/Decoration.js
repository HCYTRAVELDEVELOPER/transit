  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.theme.manager.Decoration", {
    ...
    construct() {
      ...
      this.__rules__P_231_0 = [];
      this.__legacyIe__P_231_1 = qx.core.Environment.get("engine.name") == "mshtml" && qx.core.Environment.get("browser.documentmode") < 9;
    },
    ...
    */
    members: {
      __dynamic__P_231_2: null,
      __rules__P_231_0: null,
      __legacyIe__P_231_1: false,
      ...
      addCssClass(value) {
        ...
        Object.keys(styles).sort().forEach(function (key) {
          ...
          if (qx.Bootstrap.isObject(styles[key])) {
            ...
            var innerSelector = this.__legacyIe__P_231_1 ? selector : selector + (inner ? ":" : "");

            this.__rules__P_231_0.push(innerSelector + key);
        ...
        if (css) {
          ...
          this.__rules__P_231_0.push(selector);
        }
      ...
      removeAllCssClasses() {
        // remove old rules
        for (var i = 0; i < this.__rules__P_231_0.length; i++) {
          var selector = this.__rules__P_231_0[i];
      ...
      resolve(value) {
        ...
        var cache = this.__dynamic__P_231_2;

        if (!cache) {
          cache = this.__dynamic__P_231_2 = {};
        }
       ...
       */
      isCached(decorator) {
        return !this.__dynamic__P_231_2 ? false : qx.lang.Object.contains(this.__dynamic__P_231_2, decorator);
      },
      ...
      _applyTheme(value, old) {
        ...
        this._disposeMap("__dynamic__P_231_2");

        this.__dynamic__P_231_2 = {};
      },
