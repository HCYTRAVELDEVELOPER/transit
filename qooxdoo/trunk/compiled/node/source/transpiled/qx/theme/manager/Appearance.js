  ...
  qx.Class.define("qx.theme.manager.Appearance", {
    ...
    */
    construct() {
      ...
      this.__styleCache__P_234_0 = {};
      this.__aliasMap__P_234_1 = {};
    },
    ...
    */
    ...
    members: {
       ...
       */
      __defaultStates__P_234_2: {},
      __styleCache__P_234_0: null,
      __aliasMap__P_234_1: null,
      ...
      */
       ...
       */
      __resolveId__P_234_3(id, theme, defaultId, chain) {
        ...
        if (!entry) {
          ...
          while (!entry && splitted.length > 0) {
            ...
            if (entry) {
              ...
              if (typeof alias === "string") {
                ...
                return this.__resolveId__P_234_3(mapped, theme, defaultId, chainCopy);
              }
            }
          ...
          for (var i = 0; i < end.length - 1; i++) {
            ...
            var resolved = this.__resolveId__P_234_3(subId, theme, null, chainCopy);
          ...
          if (defaultId != null) {
            return this.__resolveId__P_234_3(defaultId, theme, null, chainCopy);
          ...
          return this.__resolveId__P_234_3(entry, theme, defaultId, chainCopy);
        } else if (entry.include && !entry.style) {
          return this.__resolveId__P_234_3(entry.include, theme, defaultId, chainCopy);
        }
      ...
      styleFrom(id, states, theme, defaultId) {
        ...
        var aliasMap = this.__aliasMap__P_234_1;
        ...
        if (!resolved) {
          resolved = aliasMap[theme.name][id] = this.__resolveId__P_234_3(id, theme, defaultId);
        } // Query theme for ID
        ...
        var cache = this.__styleCache__P_234_0;
        ...
        if (!states) {
          states = this.__defaultStates__P_234_2;
