    ...
    members: {
      ...
      resolve(value) {
        ...
        if (theme !== null && theme.fonts[value]) {
          var font = this.__getFontClass__P_236_0(theme.fonts[value]);
        ...
        if (qx.core.Environment.get("qx.debug")) {
          if (theme) {
            if (!this.__warnedMissingFonts__P_236_1) {
              this.__warnedMissingFonts__P_236_1 = {};
            }

            if (!this.__warnedMissingFonts__P_236_1[value]) {
              this.__warnedMissingFonts__P_236_1[value] = true;
       ...
       */
      __resolveInclude__P_236_2(fonts, fontName) {
        if (fonts[fontName].include) {
          ...
          this.__resolveInclude__P_236_2(fonts, fontName);
        }
      },
        ...
        if (value) {
          ...
          for (var key in source) {
            if (source[key].include && source[source[key].include]) {
              this.__resolveInclude__P_236_2(source, key);
            }

            var font = this.__getFontClass__P_236_0(source[key]);
       ...
       * @return {Class}
       */
      __getFontClass__P_236_0(config) {
        if (config.sources) {
