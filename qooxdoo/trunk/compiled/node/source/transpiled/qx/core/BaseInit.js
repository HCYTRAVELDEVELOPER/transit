  ...
  qx.Class.define("qx.core.BaseInit", {
    ...
    */
    statics: {
       ...
       */
      getApplication() {
        return this.__application__P_2_0 || null;
      },
      ...
      ready() {
        ...
        if (clazz) {
          this.__application__P_2_0 = new clazz();
          var start = new Date();

          this.__application__P_2_0.main();
          ...
          this.__application__P_2_0.finalize();
       ...
       */
      __close__P_2_1(e) {
        var app = this.__application__P_2_0;
...
//# sourceMappingURL=BaseInit.js.map