  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.core.Assert", {
    statics: {
       ...
       *
       */
      __fail__P_60_1(comment, msgvarargs) {
        ...
        for (var i = 1, l = arguments.length; i < l; i++) {
          msg = msg + this.__toString__P_60_2(arguments[i] === undefined ? "'undefined'" : arguments[i]);
        }
      ...
      assert(condition, msg) {
        condition == true || this.__fail__P_60_1(msg || "", "Called assert with 'false'");
      },
      ...
      fail(msg, compact) {
        ...
        this.__fail__P_60_1(msg || "", msgvarargs);
      },
      ...
      assertTrue(value, msg) {
        value === true || this.__fail__P_60_1(msg || "", "Called assertTrue with '", value, "'");
      },
      ...
      assertFalse(value, msg) {
        value === false || this.__fail__P_60_1(msg || "", "Called assertFalse with '", value, "'");
      },
      ...
      assertEquals(expected, found, msg) {
        expected == found || this.__fail__P_60_1(msg || "", "Expected '", expected, "' but found '", found, "'!");
      },
      ...
      assertNotEquals(expected, found, msg) {
        expected != found || this.__fail__P_60_1(msg || "", "Expected '", expected, "' to be not equal with '", found, "'!");
      },
      ...
      assertEqualsFloat(expected, found, msg) {
        ...
        qx.lang.Number.equals(expected, found) || this.__fail__P_60_1(msg || "", "Expected '", expected, "' to be equal with '", found, "'!");
      },
      ...
      assertNotEqualsFloat(expected, found, msg) {
        this.assertNumber(expected);
        this.assertNumber(found);
        !qx.lang.Number.equals(expected, found) || this.__fail__P_60_1(msg || "", "Expected '", expected, "' to be not equal with '", found, "'!");
      },
      ...
      assertIdentical(expected, found, msg) {
        expected === found || this.__fail__P_60_1(msg || "", "Expected '", expected, "' (identical) but found '", found, "'!");
      },
      ...
      assertNotIdentical(expected, found, msg) {
        expected !== found || this.__fail__P_60_1(msg || "", "Expected '", expected, "' to be not identical with '", found, "'!");
      },
      ...
      assertNotUndefined(value, msg) {
        value !== undefined || this.__fail__P_60_1(msg || "", "Expected value not to be undefined but found undefined!");
      },
      ...
      assertUndefined(value, msg) {
        value === undefined || this.__fail__P_60_1(msg || "", "Expected value to be undefined but found ", value, "!");
      },
      ...
      assertNotNull(value, msg) {
        value !== null || this.__fail__P_60_1(msg || "", "Expected value not to be null but found null!");
      },
      ...
      assertNull(value, msg) {
        value === null || this.__fail__P_60_1(msg || "", "Expected value to be null but found ", value, "!");
      },
      ...
      assertMatch(str, re, msg) {
        ...
        str.search(re) >= 0 || this.__fail__P_60_1(msg || "", "The String '", str, "' does not match the regular expression '", re.toString(), "'!");
      },
      ...
      assertArgumentsCount(args, minCount, maxCount, msg) {
        ...
        argCount >= minCount && argCount <= maxCount || this.__fail__P_60_1(msg || "", "Wrong number of arguments given. Expected '", minCount, "' to '", maxCount, "' arguments but found '", argCount, "' arguments.");
      },
      ...
      assertEventFired(obj, event, invokeFunc, listenerFunc, msg) {
        ...
        called === true || this.__fail__P_60_1(msg || "", "Event (", event, ") not fired.");
      },
      ...
      assertEventNotFired(obj, event, invokeFunc, msg) {
        ...
        invokeFunc.call();
        called === false || this.__fail__P_60_1(msg || "", "Event (", event, ") was fired.");
        obj.removeListenerById(id);
      },
      ...
      assertException(callback, exception, re, msg) {
        ...
        try {
          this.__logError__P_60_0 = false;
          callback();
        } catch (ex) {
          error = ex;
        } finally {
          this.__logError__P_60_0 = true;
        }

        if (error == null) {
          this.__fail__P_60_1(msg || "", "The function did not raise an exception!");
        }

        error instanceof exception || this.__fail__P_60_1(msg || "", "The raised exception does not have the expected type! ", exception, " != ", error);
      ...
      assertInArray(value, array, msg) {
        array.indexOf(value) !== -1 || this.__fail__P_60_1(msg || "", "The value '", value, "' must have any of the values defined in the array '", array, "'");
      },
      ...
      assertNotInArray(value, array, msg) {
        array.indexOf(value) === -1 || this.__fail__P_60_1(msg || "", qx.lang.String.format("The value '%1' must not have any of the values defined in the array '%2'", [value, array]));
      },
      ...
      assertKeyInMap(value, map, msg) {
        map[value] !== undefined || this.__fail__P_60_1(msg || "", "The value '", value, "' must must be a key of the map '", map, "'");
      },
      ...
      assertFunction(value, msg) {
        qx.lang.Type.isFunction(value) || this.__fail__P_60_1(msg || "", "Expected value to be typeof function but found ", value, "!");
      },
      ...
      assertFunctionOrAsyncFunction(value, msg) {
        qx.lang.Type.isFunctionOrAsyncFunction(value) || this.__fail__P_60_1(msg || "", "Expected value to be typeof function or typeof async function but found ", value, "!");
      },
      ...
      assertString(value, msg) {
        qx.lang.Type.isString(value) || this.__fail__P_60_1(msg || "", "Expected value to be a string but found ", value, "!");
      },
      ...
      assertBoolean(value, msg) {
        qx.lang.Type.isBoolean(value) || this.__fail__P_60_1(msg || "", "Expected value to be a boolean but found ", value, "!");
      },
      ...
      assertNumber(value, msg) {
        qx.lang.Type.isNumber(value) && isFinite(value) || this.__fail__P_60_1(msg || "", "Expected value to be a number but found ", value, "!");
      },
      ...
      assertPositiveNumber(value, msg) {
        qx.lang.Type.isNumber(value) && isFinite(value) && value >= 0 || this.__fail__P_60_1(msg || "", "Expected value to be a number >= 0 but found ", value, "!");
      },
      ...
      assertInteger(value, msg) {
        qx.lang.Type.isNumber(value) && isFinite(value) && value % 1 === 0 || this.__fail__P_60_1(msg || "", "Expected value to be an integer but found ", value, "!");
      },
      ...
      assertPositiveInteger(value, msg) {
        ...
        condition || this.__fail__P_60_1(msg || "", "Expected value to be an integer >= 0 but found ", value, "!");
      },
      ...
      assertInRange(value, min, max, msg) {
        value >= min && value <= max || this.__fail__P_60_1(msg || "", qx.lang.String.format("Expected value '%1' to be in the range '%2'..'%3'!", [value, min, max]));
      },
      ...
      assertObject(value, msg) {
        ...
        condition || this.__fail__P_60_1(msg || "", "Expected value to be typeof object but found ", value, "!");
      },
      ...
      assertArray(value, msg) {
        qx.lang.Type.isArray(value) || this.__fail__P_60_1(msg || "", "Expected value to be an array but found ", value, "!");
      },
       ...
       */
      assertMap(value, msg) {
        qx.lang.Type.isObject(value) || this.__fail__P_60_1(msg || "", "Expected value to be a map but found ", value, "!");
      },
      ...
      assertRegExp(value, msg) {
        qx.lang.Type.isRegExp(value) || this.__fail__P_60_1(msg || "", "Expected value to be a regular expression but found ", value, "!");
      },
      ...
      assertType(value, type, msg) {
        ...
        typeof value === type || this.__fail__P_60_1(msg || "", "Expected value to be typeof '", type, "' but found ", value, "!");
      },
      ...
      assertInstance(value, clazz, msg) {
        ...
        value instanceof clazz || this.__fail__P_60_1(msg || "", "Expected value to be instanceof '", className, "' but found ", value, "!");
      },
      ...
      assertInterface(value, iface, msg) {
        qx.Class && qx.Class.implementsInterface(value, iface) || this.__fail__P_60_1(msg || "", "Expected object '", value, "' to implement the interface '", iface, "'!");
      },
      ...
      assertCssColor(expected, value, msg) {
        ...
        try {
          ...
          this.__fail__P_60_1(msg || "", "Expected value to be the CSS color '", expected, "' (rgb(", expectedRgb.join(","), ")), but found value '", value, "', which cannot be converted to a CSS color!");
        }

        var condition = expectedRgb[0] == valueRgb[0] && expectedRgb[1] == valueRgb[1] && expectedRgb[2] == valueRgb[2];
        condition || this.__fail__P_60_1(msg || "", "Expected value to be the CSS color '", expectedRgb, "' (rgb(", expectedRgb.join(","), ")), but found value '", value, "' (rgb(", valueRgb.join(","), "))!");
      },
      ...
      assertElement(value, msg) {
        ...
        !!(value && value.nodeType === 1) || this.__fail__P_60_1(msg || "", "Expected value to be a DOM element but found  '", value, "'!");
      },
      ...
      assertQxObject(value, msg) {
        this.__isQxInstance__P_60_3(value, "qx.core.Object") || this.__fail__P_60_1(msg || "", "Expected value to be a qooxdoo object but found ", value, "!");
      },
      ...
      assertQxWidget(value, msg) {
        this.__isQxInstance__P_60_3(value, "qx.ui.core.Widget") || this.__fail__P_60_1(msg || "", "Expected value to be a qooxdoo widget but found ", value, "!");
      },
       ...
       * class
       */
      __isQxInstance__P_60_3(object, classname) {
        if (!object) {
          return false;
        }
