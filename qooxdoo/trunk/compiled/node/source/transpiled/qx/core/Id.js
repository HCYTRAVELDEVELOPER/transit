(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.core.Id", {
    ...
    type: "singleton",
    members: {
      __registeredObjects__P_64_0: null,
      __registeredIdHashes__P_64_1: null,
      ...
      _createQxObjectImpl(id) {
        if (this.__registeredObjects__P_64_0) {
          var obj = this.__registeredObjects__P_64_0[id];
      ...
      getAbsoluteIdOf(obj, suppressWarnings) {
        if (this.__registeredIdHashes__P_64_1 && this.__registeredIdHashes__P_64_1[obj.toHashCode()]) {
        ...
        while (obj) {
          ...
          if (owner) {
            ...
            if (owner === application) {
              ...
              ownerId = this.__registeredIdHashes__P_64_1 && this.__registeredIdHashes__P_64_1[owner.toHashCode()] || null;
      ...
      register(obj, id) {
        if (!this.__registeredObjects__P_64_0) {
          this.__registeredObjects__P_64_0 = {};
          this.__registeredIdHashes__P_64_1 = {};
        }
        ...
        this.__registeredObjects__P_64_0[id] = obj;
        this.__registeredIdHashes__P_64_1[obj.toHashCode()] = id;
      ...
      unregister(data) {
        ...
        if (typeof data == "string") {
          ...
          id = this.__registeredIdHashes__P_64_1[hash];
        ...
        if (obj) {
          delete this.__registeredObjects__P_64_0[id];
          delete this.__registeredIdHashes__P_64_1[obj.toHashCode()];
      ...
      getRegisteredObjects() {
        return this.__registeredObjects__P_64_0;
      }
