  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.dev.unit.TestCase", {
    ...
    members: {
       ...
       */
      addAutoDispose(obj) {
        if (!this.__autoDispose__P_214_0) {
          this.__autoDispose__P_214_0 = [];
        }

        this.__autoDispose__P_214_0.push(obj);
      },
      ...
      doAutoDispose() {
        if (this.__autoDispose__P_214_0) {
          this.__autoDispose__P_214_0.forEach(function (obj) {
            if (!obj.isDisposed()) {
          ...
          this.__autoDispose__P_214_0 = null;
        }
      }
