  ...
  qx.Class.define("qx.dev.unit.RequirementError", {
    ...
    */
    ...
    construct(requirement, message) {
      this.__message__P_243_0 = message || "Requirement not met";
      this.__requirement__P_243_1 = requirement;
      var inst = Error.call(this, this.__message__P_243_0); // map stack trace properties since they're not added by Error's constructor
    ...
    */
    members: {
      __message__P_243_0: null,
      __requirement__P_243_1: null,
       ...
       */
      getRequirement() {
        return this.__requirement__P_243_1;
      },
       ...
       */
      toString() {
        var msg = this.__message__P_243_0;

        if (this.__requirement__P_243_1) {
          msg += ": " + this.__requirement__P_243_1;
        }
...
//# sourceMappingURL=RequirementError.js.map