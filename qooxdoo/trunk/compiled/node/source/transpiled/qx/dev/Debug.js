    ...
    statics: {
      ...
      startDisposeProfiling: qx.core.Environment.select("qx.debug.dispose", {
        true() {
          ...
          this.__nextHashFirst__P_216_0 = qx.core.ObjectRegistry.getNextHash();
          return this.__nextHashFirst__P_216_0;
        },
      ...
      stopDisposeProfiling: qx.core.Environment.select("qx.debug.dispose", {
        true(checkFunction, startHandle) {
          if (!this.__nextHashFirst__P_216_0) {
          ...
          var undisposedObjects = this.showDisposeProfiling(checkFunction, startHandle || this.__nextHashFirst__P_216_0);
          delete this.__nextHashFirst__P_216_0;
      ...
      showDisposeProfiling: qx.core.Environment.select("qx.debug.dispose", {
        true(checkFunction) {
          ...
          for (var hash = this.__nextHashFirst__P_216_0; hash < nextHashLast; hash++) {
