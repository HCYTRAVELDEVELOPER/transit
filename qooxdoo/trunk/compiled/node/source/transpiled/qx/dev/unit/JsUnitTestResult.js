  ...
  qx.Class.define("qx.dev.unit.JsUnitTestResult", {
    ...
    */
    construct() {
      ...
      this.__testFunctionNames__P_187_0 = [];
    },
    ...
    */
    members: {
      __testFunctionNames__P_187_0: null,
      ...
      run(test, testFunction) {
        ...
        this.__testFunctionNames__P_187_0.push(testFunctionName);
      ...
      exportToJsUnit() {
        ...
        window.exposeTestFunctionNames = function () {
          return self.__testFunctionNames__P_187_0;
        }; // global
...
//# sourceMappingURL=JsUnitTestResult.js.map