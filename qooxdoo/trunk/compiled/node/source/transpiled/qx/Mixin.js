  ...
  qx.Bootstrap.define("qx.Mixin", {
    statics: {
      ...
      define(name, config) {
        if (config) {
          ...
          if (qx.core.Environment.get("qx.debug")) {
            this.__validateConfig__P_157_0(name, config);
      ...
      */
      ...
      __allowedKeys__P_157_1: qx.core.Environment.select("qx.debug", {
        true: {
          include: "object",
          // Mixin | Mixin[]
          statics: "object",
       ...
       */
      __validateConfig__P_157_0: qx.core.Environment.select("qx.debug", {
        true(name, config) {
          // Validate keys
          var allowed = this.__allowedKeys__P_157_1;
