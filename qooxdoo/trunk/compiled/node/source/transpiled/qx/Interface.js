  ...
  qx.Bootstrap.define("qx.Interface", {
    statics: {
      ...
      */
      ...
      define(name, config) {
        if (config) {
          ...
          if (qx.core.Environment.get("qx.debug")) {
            this.__validateConfig__P_154_0(name, config);
       ...
       */
      __checkMembers__P_154_1(object, clazz, iface, wrap, shouldThrow) {
        // Validate members
        ...
        if (members) {
          for (var key in members) {
            if (qx.Bootstrap.isFunction(members[key])) {
              var isPropertyMethod = this.__isPropertyMethod__P_154_2(clazz, key);
              ...
              if (shouldWrapFunction) {
                object[key] = this.__wrapInterfaceMember__P_154_3(iface, object[key], key, members[key]);
              }
            } else {
       ...
       *   system.
       */
      __isPropertyMethod__P_154_2(clazz, methodName) {
       ...
       */
      __checkProperties__P_154_4(clazz, iface, shouldThrow) {
        if (iface.$$properties) {
       ...
       */
      __checkEvents__P_154_5(clazz, iface, shouldThrow) {
        if (iface.$$events) {
      ...
      assertObject(object, iface) {
        ...
        this.__checkMembers__P_154_1(object, clazz, iface, false, true);

        this.__checkProperties__P_154_4(clazz, iface, true);

        this.__checkEvents__P_154_5(clazz, iface, true); // Validate extends, recursive
      ...
      assert(clazz, iface, wrap) {
        this.__checkMembers__P_154_1(clazz.prototype, clazz, iface, wrap, true);
      ...
      objectImplements(object, iface) {
        ...
        if (!this.__checkMembers__P_154_1(object, clazz, iface) || !this.__checkProperties__P_154_4(clazz, iface) || !this.__checkEvents__P_154_5(clazz, iface)) {
          return false;
      ...
      classImplements(clazz, iface) {
        if (!this.__checkMembers__P_154_1(clazz.prototype, clazz, iface) || !this.__checkProperties__P_154_4(clazz, iface) || !this.__checkEvents__P_154_5(clazz, iface)) {
          return false;
        } // Validate extends, recursive
      ...
      */
       ...
       */
      __wrapInterfaceMember__P_154_3: qx.core.Environment.select("qx.debug", {
      ...
      __allowedKeys__P_154_6: qx.core.Environment.select("qx.debug", {
        true: {
          extend: "object",
          // Interface | Interface[]
          statics: "object",
       ...
       */
      __validateConfig__P_154_0: qx.core.Environment.select("qx.debug", {
        true(name, config) {
          if (qx.core.Environment.get("qx.debug")) {
            // Validate keys
            var allowed = this.__allowedKeys__P_154_6;
