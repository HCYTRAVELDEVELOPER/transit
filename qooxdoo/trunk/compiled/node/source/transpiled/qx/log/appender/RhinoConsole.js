  ...
  qx.Class.define("qx.log.appender.RhinoConsole", {
    statics: {
      ...
      log(logMessage, level) {
        if (level == "error") {
          this.__ERR__P_119_1.println(logMessage);
        } else {
          this.__OUT__P_119_0.println(logMessage);
        }
      },
    ...
    defer() {
      if (typeof java !== "undefined" && typeof java.lang !== "undefined") {
        qx.log.appender.RhinoConsole.__OUT__P_119_0 = java.lang.System.out;
        qx.log.appender.RhinoConsole.__ERR__P_119_1 = java.lang.System.err;
      }
    }
...
//# sourceMappingURL=RhinoConsole.js.map