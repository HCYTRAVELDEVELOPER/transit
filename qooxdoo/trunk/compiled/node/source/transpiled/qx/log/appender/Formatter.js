  ...
  qx.Class.define("qx.log.appender.Formatter", {
    ...
    members: {
      ...
      formatEntryTime(entry) {
        ...
        if (!qx.log.appender.Formatter.__DATETIME_FORMAT__P_117_0) {
          qx.log.appender.Formatter.__DATETIME_FORMAT__P_117_0 = new qx.util.format.DateFormat("YYYY-MM-dd HH:mm:ss");
        }

        return qx.log.appender.Formatter.__DATETIME_FORMAT__P_117_0.format(entry.time);
      },
    ...
    statics: {
      ...
      __DATETIME_FORMAT__P_117_0: null,

      /** @type {qx.log.appender.Formatter} the default instance */
      __defaultFormatter__P_117_1: null,
       ...
       */
      getFormatter() {
        if (!qx.log.appender.Formatter.__defaultFormatter__P_117_1) {
          qx.log.appender.Formatter.__defaultFormatter__P_117_1 = new qx.log.appender.Formatter();
        }

        return qx.log.appender.Formatter.__defaultFormatter__P_117_1;
      },
      ...
      setFormatter(instance) {
        qx.log.appender.Formatter.__defaultFormatter__P_117_1 = instance;
      },
       ...
       */
      escapeHTML(value) {
        return String(value).replace(/[<>&"']/g, qx.log.appender.Formatter.__escapeHTMLReplace__P_117_2);
      },
       ...
       */
      __escapeHTMLReplace__P_117_2(ch) {
        var map = {
          "<": "&lt;",
          ">": "&gt;",
          "&": "&amp;",
