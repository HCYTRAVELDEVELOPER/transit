  ...
  qx.Class.define("qx.log.appender.RhinoFile", {
    statics: {
      ...
      log(logMessage, level) {
        if (!qx.log.appender.RhinoFile.__FILEHANDLE__P_120_0) {
          qx.log.appender.RhinoFile.create();
        }

        var logFile = qx.log.appender.RhinoFile.__FILEHANDLE__P_120_0;
      ...
      create() {
        if (qx.log.appender.RhinoFile.__FILEHANDLE__P_120_0) {
          qx.log.appender.RhinoFile.__FILEHANDLE__P_120_0.close();
        }
        ...
        qx.log.appender.RhinoFile.__FILEHANDLE__P_120_0 = new java.io.BufferedWriter(fstream);
      }
