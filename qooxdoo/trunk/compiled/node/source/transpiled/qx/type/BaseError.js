  ...
  qx.Bootstrap.define("qx.type.BaseError", {
    ...
    */
    ...
    construct(comment, failMessage) {
      ...
      this.__comment__P_122_0 = comment || ""; // opera 10 crashes if the message is an empty string!!!?!?!
    ...
    */
    members: {
      __sTrace__P_122_1: null,
      __comment__P_122_0: null,
       ...
       */
      getComment() {
        return this.__comment__P_122_0;
      },
       ...
       */
      toString() {
        return this.__comment__P_122_0 + (this.message ? ": " + this.message : "");
      }
