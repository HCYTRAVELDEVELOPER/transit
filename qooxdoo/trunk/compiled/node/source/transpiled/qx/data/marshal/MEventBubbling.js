    ...
    members: {
      ...
      _registerEventChaining(value, old, name) {
        ...
        if (value instanceof qx.core.Object && qx.Class.hasMixin(value.constructor, qx.data.marshal.MEventBubbling)) {
          // create the listener
          var listener = qx.lang.Function.bind(this.__changePropertyListener__P_83_0, this, name); // add the listener
       ...
       *   change.
       */
      __changePropertyListener__P_83_0(name, e) {
        var data = e.getData();
...
//# sourceMappingURL=MEventBubbling.js.map