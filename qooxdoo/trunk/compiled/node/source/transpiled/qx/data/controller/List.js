  ...
  qx.Class.define("qx.data.controller.List", {
    ...
    */
    ...
    construct(model, target, labelPath) {
      ...
      this.__lookupTable__P_77_0 = []; // register for bound target properties and onUpdate methods
      // from the binding options

      this.__boundProperties__P_77_1 = [];
      this.__boundPropertiesReverse__P_77_2 = [];
      this.__onUpdate__P_77_3 = {};
    ...
    */
    members: {
      // private members
      __changeModelListenerId__P_77_4: null,
      __lookupTable__P_77_0: null,
      __onUpdate__P_77_3: null,
      __boundProperties__P_77_1: null,
      __boundPropertiesReverse__P_77_2: null,
      __syncTargetSelection__P_77_5: null,
      __syncModelSelection__P_77_6: null,
      ...
      */
       ...
       */
      update() {
        this.__changeModelLength__P_77_7();

        this.__renewBindings__P_77_8();
      ...
      */
      ...
      _applyModel(value, old) {
        ...
        if (old != undefined) {
          if (this.__changeModelListenerId__P_77_4 != undefined) {
            old.removeListenerById(this.__changeModelListenerId__P_77_4);
          }
        ...
        if (value != null) {
          // add a new listener
          this.__changeModelListenerId__P_77_4 = value.addListener("change", this.__changeModel__P_77_10, this); // renew the index lookup table

          this.__buildUpLookupTable__P_77_11(); // check for the new length


          this.__changeModelLength__P_77_7(); // as we only change the labels of the items, the selection change event
          ...
          if (old == null) {
            ...
            this.__syncTargetSelection__P_77_5 = true;
      ...
      _applyTarget(value, old) {
        ...
        if (value != null) {
          if (this.getModel() != null) {
            ...
            for (var i = 0; i < this.__lookupTable__P_77_0.length; i++) {
              this.__addItem__P_77_13(this.__lookup__P_77_14(i));
            }
          }
        }
      },
      ...
      */
       ...
       */
      __inChangeModel__P_77_15: false,

      /**
       * Event handler for the changeModel of the model. Updates the controller.
       */
      __changeModel__P_77_10() {
        if (this.__inChangeModel__P_77_15) {
          return;
        }

        this.__inChangeModel__P_77_15 = true; // need an asynchronous selection update because the bindings have to be
        // executed to update the selection probably (using the widget queue)
        // this.__syncTargetSelection = true;

        this.__syncModelSelection__P_77_6 = true;
        qx.ui.core.queue.Widget.add(this); // update on filtered lists... (bindings need to be renewed)

        this.update();
        this.__inChangeModel__P_77_15 = false;
      },
       ...
       */
      syncWidget() {
        if (this.__syncTargetSelection__P_77_5) {
          this._changeTargetSelection();
        }

        if (this.__syncModelSelection__P_77_6) {
          this._updateSelection();
        }

        this.__syncModelSelection__P_77_6 = this.__syncTargetSelection__P_77_5 = null;
      },
      ...
      __changeModelLength__P_77_7() {
        ...
        this.__buildUpLookupTable__P_77_11(); // get the length


        var newLength = this.__lookupTable__P_77_0.length;
        var currentLength = this.getTarget().getChildren().length; // if there are more item

        if (newLength > currentLength) {
          // add the new elements
          for (var j = currentLength; j < newLength; j++) {
            this.__addItem__P_77_13(this.__lookup__P_77_14(j));
        ...
        this.__buildUpLookupTable__P_77_11(); // sync the target selection in case someone deleted a item in
       ...
       */
      __moveChangeListenerAtTheEnd__P_77_16() {
        ...
        if (model != null) {
          model.removeListenerById(this.__changeModelListenerId__P_77_4);
          this.__changeModelListenerId__P_77_4 = model.addListener("change", this.__changeModel__P_77_10, this);
        }
      },
      ...
      */
      ...
      bindProperty(sourcePath, targetProperty, options, targetWidget, index) {
        ...
        if (options != null) {
          ...
          this.__onUpdate__P_77_3[targetProperty] = options.onUpdate;
          delete options.onUpdate;
        } else {
          options = {};
          this.__onUpdate__P_77_3[targetProperty] = null;
        }
        ...
        if (!this.__boundProperties__P_77_1.includes(targetProperty)) {
          this.__boundProperties__P_77_1.push(targetProperty);
        }
      },
      ...
      bindPropertyReverse(targetPath, sourcePath, options, sourceWidget, index) {
        ...
        if (!this.__boundPropertiesReverse__P_77_2.includes(targetPath)) {
          this.__boundPropertiesReverse__P_77_2.push(targetPath);
        }
      },
      ...
      _onBindingSet(index, sourceObject, targetObject) {
        ...
        for (var i = 0; i < this.__boundProperties__P_77_1.length; i++) {
          // if there is an onUpdate for one of it, invoke it
          if (this.__onUpdate__P_77_3[this.__boundProperties__P_77_1[i]] != null) {
            this.__onUpdate__P_77_3[this.__boundProperties__P_77_1[i]]();
          }
        }
      },
      ...
      _removeBindingsFrom(item) {
        ...
        for (var i = 0; i < this.__boundProperties__P_77_1.length; i++) {
          ...
          var id = item.getUserData(this.__boundProperties__P_77_1[i] + "BindingId");

          if (id != null) {
            this.removeBinding(id);
            item.setUserData(this.__boundProperties__P_77_1[i] + "BindingId", null);
          }
        } // go through all reverse bound properties


        for (var i = 0; i < this.__boundPropertiesReverse__P_77_2.length; i++) {
          // get the binding id and remove it, if possible
          var id = item.getUserData(this.__boundPropertiesReverse__P_77_2[i] + "ReverseBindingId");

          if (id != null) {
            item.removeBinding(id);
            item.getUserData(this.__boundPropertiesReverse__P_77_2[i] + "ReverseBindingId", null);
          }
        }
      },
      ...
      __renewBindings__P_77_8() {
        ...
        for (var i = 0; i < items.length; i++) {
          ...
          this._bindListItem(items[i], this.__lookup__P_77_14(i));
        } // move the controllers change handler for the model to the end of the
        // listeners queue


        this.__moveChangeListenerAtTheEnd__P_77_16();
      },
      ...
      */
      ...
      _setFilter(value, old) {
        ...
        var oldTable = this.__lookupTable__P_77_0; // generate a new lookup table

        this.__buildUpLookupTable__P_77_11(); // if there are lesser items


        if (oldTable.length > this.__lookupTable__P_77_0.length) {
          // remove the unnecessary items
          for (var j = oldTable.length; j > this.__lookupTable__P_77_0.length; j--) {
            this.getTarget().removeAt(j - 1).destroy();
          } // if there are more items

        } else if (oldTable.length < this.__lookupTable__P_77_0.length) {
          // add the new elements
          for (var j = oldTable.length; j < this.__lookupTable__P_77_0.length; j++) {
        ...
        for (var i = 0; i < listItems.length; i++) {
          this._bindListItem(listItems[i], this.__lookup__P_77_14(i));
        } // move the controllers change handler for the model to the end of the
        // listeners queue
       ...
       */
      __removeFilter__P_77_17() {
        // renew the index lookup table
        this.__buildUpLookupTable__P_77_11(); // check for the new length


        this.__changeModelLength__P_77_7(); // renew the bindings


        this.__renewBindings__P_77_8(); // need an asynchronous selection update because the bindings have to be
        // executed to update the selection probably (using the widget queue)
      ...
      */
      ...
      __buildUpLookupTable__P_77_11() {
        ...
        this.__lookupTable__P_77_0 = []; // -1 is a special lookup value, to represent the "null" option

        if (this.isAllowNull()) {
          this.__lookupTable__P_77_0.push(-1);
        }

        for (var i = 0; i < model.getLength(); i++) {
          if (filter == null || filter(model.getItem(i))) {
            this.__lookupTable__P_77_0.push(i);
          }
        }
      },
       ...
       */
      __lookup__P_77_14(index) {
        return this.__lookupTable__P_77_0[index];
      }
     ...
     */
    destruct() {
      this.__lookupTable__P_77_0 = this.__onUpdate__P_77_3 = this.__boundProperties__P_77_1 = null;
      this.__boundPropertiesReverse__P_77_2 = null; // remove yourself from the widget queue
