(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.data.store.Offline", {
     ...
     */
    construct(key, storage, delegate) {
      ...
      this._storeModel = qx.util.Function.debounce(this.__storeModel__P_85_0.bind(this), qx.data.store.Offline.STORE_MODEL_DELAY);
    ...
    members: {
      ...
      _applyModel(value, old) {
        ...
        if (old) {
          old.removeListenerById(this.__modelListenerId__P_85_1);
          old.dispose();
          this.__modelListenerId__P_85_1 = null;
        }

        if (value) {
          this.__modelListenerId__P_85_1 = value.addListener("changeBubble", this._storeModel, this);
