  ...
  qx.Class.define("qx.data.controller.CheckedList", {
    ...
    members: {
      _applyChecked(value, oldValue) {
        if (oldValue) {
          oldValue.removeListener("change", this.__onCheckedChange__P_75_1, this);
        }

        if (value) {
          value.addListener("change", this.__onCheckedChange__P_75_1, this);
        }
      ...
      _setFilter(value, old) {
        ...
        this.__syncModelChecked__P_75_2 = true;
      ...
      syncWidget() {
        ...
        if (this.__syncModelChecked__P_75_2) {
          this._updateChecked();
        }

        this.__syncModelChecked__P_75_2 = null;
      },
      ...
      _applyTarget(value, oldValue) {
        ...
        if (oldValue) {
          oldValue.removeListener("changeChecked", this.__onTargetCheckedChange__P_75_3, this);

          if (qx.Class.supportsEvent(oldValue.constructor, "attachResultsTag")) {
            oldValue.removeListener("attachResultsTag", this.__onTargetAttachResultsTag__P_75_4, this);
            oldValue.removeListener("detachResultsTag", this.__onTargetDetachResultsTag__P_75_5, this);
          }
        }

        if (value) {
          value.addListener("changeChecked", this.__onTargetCheckedChange__P_75_3, this);

          if (qx.Class.supportsEvent(value.constructor, "attachResultsTag")) {
            value.addListener("attachResultsTag", this.__onTargetAttachResultsTag__P_75_4, this);
            value.addListener("detachResultsTag", this.__onTargetDetachResultsTag__P_75_5, this);
          }
        }
      },
       ...
       */
      __onTargetCheckedChange__P_75_3(evt) {
        if (this.__inUpdateChecked__P_75_6) {
          return;
        }
       ...
       */
      __onTargetAttachResultsTag__P_75_4(evt) {
        let {
          tagWidget,
          item
        } = evt.getData();
        ...
        this.__attachTag__P_75_7(tagWidget, item);
      },

      /**
       * Event handler for changes in the target widget's `detachResults` property
       */
      __onTargetDetachResultsTag__P_75_5(evt) {
        let {
          tagWidget,
          item
        } = evt.getData();

        this.__detachTag__P_75_8(tagWidget, item);
       ...
       */
      __attachTag__P_75_7(tagWidget, item) {
        let itemModel = item.getModel();
        let bindData = {};
       ...
       * @param item {qx.ui.core.Widget} the list item that lists the model item that this tag is for
       */
      __detachTag__P_75_8(tagWidget, item) {
        let itemModel = item.getModel();
      ...
      _updateChecked() {
        ...
        this.__inUpdateChecked__P_75_6 = true;
        ...
        try {
          ...
          this.__inUpdateChecked__P_75_6 = false;
        }
      }
