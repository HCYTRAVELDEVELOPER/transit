  ...
  qx.Class.define("qx.data.store.Rest", {
    ...
    construct(resource, actionName, delegate) {
      ...
      if (delegate && qx.lang.Type.isFunction(delegate.configureRequest)) {
        this.__configureRequest__P_86_0();
      }

      this.__onActionSuccessBound__P_86_1 = qx.lang.Function.bind(this.__onActionSuccess__P_86_2, this);

      this.__addListeners__P_86_3();
    },
    ...
    members: {
      _marshaler: null,
      _delegate: null,
      __onActionSuccessBound__P_86_1: null,

      /**
       * Configure the resource's request by processing the delegate.
       */
      __configureRequest__P_86_0() {
       ...
       */
      __addListeners__P_86_3() {
        var resource = this.getResource(),
            actionName = this.getActionName();

        if (resource && actionName) {
          resource.addListener(this.getActionName() + "Success", this.__onActionSuccessBound__P_86_1);
        }
      },
