  ...
  qx.Mixin.define("qx.data.controller.MSelection", {
    ...
    */
    construct() {
      ...
      if (this.getSelection() == null) {
        this.__ownSelection__P_78_0 = new qx.data.Array();
        this.setSelection(this.__ownSelection__P_78_0);
      }
    },
    ...
    */
    members: {
      ...
      __selectionListenerId__P_78_1: null,
      __selectionArrayListenerId__P_78_2: null,
      __ownSelection__P_78_0: null,
      ...
      */
      ...
      _applySelection(value, old) {
        ...
        if (this.__selectionArrayListenerId__P_78_2 != undefined && old != undefined) {
          old.removeListenerById(this.__selectionArrayListenerId__P_78_2);
          this.__selectionArrayListenerId__P_78_2 = null;
        } // add a new change listener to the changeArray


        if (value) {
          this.__selectionArrayListenerId__P_78_2 = value.addListener("change", this.__changeSelectionArray__P_78_3, this);
      ...
      */
       ...
       * invoked.
       */
      __changeSelectionArray__P_78_3() {
        this._updateSelection();
      },
      ...
      _changeTargetSelection() {
        ...
        if (!this.__targetSupportsMultiSelection__P_78_4() && !this.__targetSupportsSingleSelection__P_78_5()) {
          return;
        ...
        if (selection == null) {
          ...
          this.__ownSelection__P_78_0 = selection;
          this.setSelection(selection);
      ...
      */
      ...
      _addChangeTargetListener(value, old) {
        ...
        if (this.__selectionListenerId__P_78_1 != undefined && old != undefined) {
          old.removeListenerById(this.__selectionListenerId__P_78_1);
        }
        ...
        if (value != null) {
          ...
          if (this.__targetSupportsMultiSelection__P_78_4() || this.__targetSupportsSingleSelection__P_78_5()) {
            ...
            this.__selectionListenerId__P_78_1 = value.addListener("changeSelection", this._changeTargetSelection, this);
          }
        }
      },
      ...
      _updateSelection() {
        ...
        if (this.__targetSupportsMultiSelection__P_78_4()) {
          ...
          for (var i = 0; i < this.getSelection().length; i++) {
            ...
            var selectable = this.__getSelectableForModel__P_78_6(model);
        ...
        } else if (this.__targetSupportsSingleSelection__P_78_5()) {
          ...
          if (item !== undefined) {
            ...
            this.__selectItem__P_78_7(item); // remove the other items from the selection data array and get
       ...
       */
      __targetSupportsMultiSelection__P_78_4() {
       ...
       */
      __targetSupportsSingleSelection__P_78_5() {
        var targetClass = this.getTarget().constructor;
       ...
       */
      __selectItem__P_78_7(item) {
        var selectable = this.__getSelectableForModel__P_78_6(item); // if no selectable could be found, just return
       ...
       */
      __getSelectableForModel__P_78_6(model) {
        // get all list items
    ...
    */
    destruct() {
      if (this.__ownSelection__P_78_0) {
        this.__ownSelection__P_78_0.dispose();
      }
    }
...
//# sourceMappingURL=MSelection.js.map