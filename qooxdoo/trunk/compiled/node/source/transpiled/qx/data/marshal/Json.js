  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.data.marshal.Json", {
    ...
    construct(delegate) {
      ...
      this.__delegate__P_82_0 = delegate;
    },
    ...
    members: {
       ...
       */
      __jsonToHash__P_82_1(data, includeBubbleEvents) {
        if (this.__delegate__P_82_0 && this.__delegate__P_82_0.getJsonHash) {
          return this.__delegate__P_82_0.getJsonHash(data, includeBubbleEvents);
        }
       ...
       * @return {String} The hash representation of the given JavaScript object.
       */
      __jsonToBestHash__P_82_2(data, includeBubbleEvents) {
        // forced mode?
        //
        if (includeBubbleEvents === true) {
          return this.__jsonToHash__P_82_1(data, true);
        }

        if (includeBubbleEvents === false) {
          return this.__jsonToHash__P_82_1(data, false);
        } // automatic mode!
        //


        var hash = this.__jsonToHash__P_82_1(data); // without bubble event feature
      ...
      toClass(data, includeBubbleEvents) {
        this.__toClass__P_82_3(data, includeBubbleEvents, null, 0);
      },
       ...
       */
      __toClass__P_82_3(data, includeBubbleEvents, parentProperty, depth) {
        ...
        data instanceof qx.core.Object) {
          ...
          if (data instanceof Array || qx.Bootstrap.getClass(data) == "Array") {
            for (var i = 0; i < data.length; i++) {
              this.__toClass__P_82_3(data[i], includeBubbleEvents, parentProperty + "[" + i + "]", depth + 1);
            }
        ...
        var hash = this.__jsonToHash__P_82_1(data, includeBubbleEvents); // ignore rules


        if (this.__ignore__P_82_4(hash, parentProperty, depth)) {
          return;
        } // check for the possible child classes


        for (var key in data) {
          this.__toClass__P_82_3(data[key], includeBubbleEvents, key, depth + 1);
        ...
        if (this.__delegate__P_82_0 && this.__delegate__P_82_0.getModelClass && this.__delegate__P_82_0.getModelClass(hash, data, parentProperty, depth) != null) {
          return;
        ...
        var members = {
          __disposeItem__P_82_5: this.__disposeItem__P_82_5
        };

        for (var key in data) {
          // apply the property names mapping
          if (this.__delegate__P_82_0 && this.__delegate__P_82_0.getPropertyMapping) {
            key = this.__delegate__P_82_0.getPropertyMapping(key, hash);
          ...
          if (this.__delegate__P_82_0 && this.__delegate__P_82_0.getValidationRule) {
            var rule = this.__delegate__P_82_0.getValidationRule(hash, key);
        ...
        if (this.__delegate__P_82_0 && this.__delegate__P_82_0.getModelSuperClass) {
          var superClass = this.__delegate__P_82_0.getModelSuperClass(hash, parentProperty, depth) || qx.core.Object;
        } else {
        ...
        if (this.__delegate__P_82_0 && this.__delegate__P_82_0.getModelMixins) {
          var delegateMixins = this.__delegate__P_82_0.getModelMixins(hash, parentProperty, depth); // check if its an array
       ...
       * @return {qx.core.Object} An instance of the corresponding class.
       */
      __createInstance__P_82_6(hash, data, parentProperty, depth) {
        var delegateClass; // get the class from the delegate

        if (this.__delegate__P_82_0 && this.__delegate__P_82_0.getModelClass) {
          delegateClass = this.__delegate__P_82_0.getModelClass(hash, data, parentProperty, depth);
        }
       ...
       */
      __ignore__P_82_4(hash, parentProperty, depth) {
        var del = this.__delegate__P_82_0;
      ...
      toModel(data, includeBubbleEvents) {
        return this.__toModel__P_82_7(data, includeBubbleEvents, null, 0);
      },
       ...
       * @return {qx.core.Object} The created model object.
       */
      __toModel__P_82_7(data, includeBubbleEvents, parentProperty, depth) {
        ...
        data instanceof qx.core.Object) {
        ...
        } else if (this.__ignore__P_82_4(this.__jsonToBestHash__P_82_2(data, includeBubbleEvents), parentProperty, depth)) {
          return data;
        } else if (isArray) {
          var arrayClass = qx.data.Array;

          if (this.__delegate__P_82_0 && this.__delegate__P_82_0.getArrayClass) {
            var customArrayClass = this.__delegate__P_82_0.getArrayClass(parentProperty, depth);
          ...
          for (var i = 0; i < data.length; i++) {
            array.push(this.__toModel__P_82_7(data[i], includeBubbleEvents, parentProperty + "[" + i + "]", depth + 1));
          }

          return array;
        } else if (isObject) {
          // create an instance for the object
          var hash = this.__jsonToBestHash__P_82_2(data, includeBubbleEvents);

          var model = this.__createInstance__P_82_6(hash, data, parentProperty, depth); // go threw all element in the data
          ...
          for (var key in data) {
            ...
            if (this.__delegate__P_82_0 && this.__delegate__P_82_0.getPropertyMapping) {
              propertyName = this.__delegate__P_82_0.getPropertyMapping(key, hash);
            }

            var propertyNameReplaced = propertyName.replace(/-|\.|\s+/g, ""); // warn if there has been a replacement

            if (qx.core.Environment.get("qx.debug") && false) {
            ...
            if (model[setterName]) {
              model[setterName](this.__toModel__P_82_7(data[key], includeBubbleEvents, key, depth + 1));
            }
          }
