(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.data.controller.website.List", {
    ...
    members: {
      __changeModelListenerId__P_81_0: null,
      __changeBubbleModelListenerId__P_81_1: null,

      // property apply
      _applyModel(value, old) {
        // remove the old listener
        if (old != undefined) {
          if (this.__changeModelListenerId__P_81_0 != undefined) {
            old.removeListenerById(this.__changeModelListenerId__P_81_0);
          }

          if (this.__changeBubbleModelListenerId__P_81_1 != undefined) {
            old.removeListenerById(this.__changeBubbleModelListenerId__P_81_1);
          }
        } // if a model is set
        ...
        if (value != null) {
          ...
          if (value instanceof qx.core.Object) {
            // add new listeners
            this.__changeModelListenerId__P_81_0 = value.addListener("change", this.update, this);
            this.__changeBubbleModelListenerId__P_81_1 = value.addListener("changeBubble", this.update, this);
          }
        } else {
          var target = this.getTarget(); // if the model is set to null, we should remove all items in the target

          if (target != null) {
            this.__emptyTarget__P_81_2();
          }
        }
      ...
      update() {
        ...
        this.__emptyTarget__P_81_2(); // delegate methods
