  ...
  qx.Class.define("qx.data.controller.Tree", {
    ...
    */
    ...
    construct(model, target, childPath, labelPath) {
      ...
      this.__bindings__P_80_0 = {};
      this.__boundProperties__P_80_1 = []; // reference to the child

      this.__childrenRef__P_80_2 = {
        a: 1
      };
    ...
    */
    members: {
      // private members
      __childrenRef__P_80_2: null,
      __bindings__P_80_0: null,
      __boundProperties__P_80_1: null,
      __oldChildrenPath__P_80_3: null,
      ...
      */
      ...
      _applyTarget(value, old) {
        ...
        if (old != undefined) {
          this.__emptyTarget__P_80_5(old);
        } // if a model is set


        if (this.getModel() != null) {
          // build up the tree
          this.__buildTree__P_80_6();
      ...
      _applyChildPath(value, old) {
        ...
        this.__oldChildrenPath__P_80_3 = old;

        this.__buildTree__P_80_6(); // reset the old name


        this.__oldChildrenPath__P_80_3 = null;
      },
      ...
      */
       ...
       */
      __changeModelChildren__P_80_7(ev) {
        // get the stored data
        var children = ev.getTarget();
        qx.core.ObjectRegistry.register(children);

        var treeNode = this.__childrenRef__P_80_2[children.toHashCode()].treeNode;

        var modelNode = this.__childrenRef__P_80_2[children.toHashCode()].modelNode; // update the subtree


        this.__updateTreeChildren__P_80_8(treeNode, modelNode); // update the selection in case a selected element has been removed
       ...
       */
      __changeChildrenArray__P_80_9(e) {
        var children = e.getData();
        var oldChildren = e.getOldData(); // get the old ref and delete it

        var oldRef = this.__childrenRef__P_80_2[oldChildren.toHashCode()];
        ...
        delete this.__childrenRef__P_80_2[oldChildren.toHashCode()]; // remove the old change listener for the children
        ...
        var changeChildernListenerId = modelNode.addListener(eventName, this.__changeChildrenArray__P_80_9, this); // add the new ref

        var treeNode = oldRef.treeNode;
        this.debug("1: adding children=" + children.toHashCode() + " to this=" + this.toHashCode());
        this.__childrenRef__P_80_2[children.toHashCode()] = {
          modelNode: modelNode,
          treeNode: treeNode,
      ...
      */
      ...
      __buildTree__P_80_6() {
        ...
        this.__emptyTarget__P_80_5(); // only build up a new tree if a model is given
        ...
        if (this.getModel() != null) {
          ...
          this.__addBinding__P_80_10(this.getModel(), rootNode);

          this.__updateTreeChildren__P_80_8(rootNode, this.getModel()); // assign the new root once the tree has been built
       ...
       */
      __updateTreeChildren__P_80_8(rootNode, modelNode) {
        ...
        if (this.__childrenRef__P_80_2[children.toHashCode()] == undefined) {
          // add the listener for the change
          var changeListenerId = children.addListener("change", this.__changeModelChildren__P_80_7, this); // add a listener for the change of the children array itself

          var property = qx.Class.getPropertyDefinition(modelNode.constructor, this.getChildPath());
          var eventName = property.event;
          var changeChildernListenerId = modelNode.addListener(eventName, this.__changeChildrenArray__P_80_9, this);
        ...
        for (var i = 0; i < children.length; i++) {
          ...
          if (rootNode.getChildren()[i] == null || children.getItem(i) != rootNode.getChildren()[i].getModel()) {
            ...
            if (oldIndex != undefined) {
              ...
              this.__addBinding__P_80_10(children.getItem(i), treeNode); // add all children recursive


              this.__updateTreeChildren__P_80_8(treeNode, children.getItem(i));
            }
          }
        ...
        for (var i = rootNode.getChildren().length - 1; i >= children.length; i--) {
          ...
          this.__removeFolder__P_80_11(treeFolder, rootNode);
        }
      },
      ...
      __emptyTarget__P_80_5(tree) {
        ...
        if (root != null) {
          ...
          this.__removeAllFolders__P_80_12(root);

          var model = root.getModel();

          if (model) {
            this.__removeBinding__P_80_13(model);
          }
       ...
       */
      __removeAllFolders__P_80_12(node) {
        var children = node.getChildren() || []; // remove all subchildren

        for (var i = children.length - 1; i >= 0; i--) {
          if (children[i].getChildren().length > 0) {
            this.__removeAllFolders__P_80_12(children[i]);
          }

          this.__removeFolder__P_80_11(children[i], node);
        }
      },
       ...
       *   treeFolder.
       */
      __removeFolder__P_80_11(treeFolder, rootNode) {
        // get the model
        var model = treeFolder.getModel();
        var childPath = this.__oldChildrenPath__P_80_3 || this.getChildPath();
        ...
        if (model[childrenGetterName] != undefined) {
          ...
          var oldRef = this.__childrenRef__P_80_2[children.toHashCode()];
          ...
          this.__removeAllFolders__P_80_12(treeFolder); // delete the model reference


          delete this.__childrenRef__P_80_2[children.toHashCode()];
        } // get the binding and remove it


        this.__removeBinding__P_80_13(model); // remove the folder from the tree
      ...
      */
      ...
      bindProperty(sourcePath, targetPath, options, targetWidget, modelNode) {
        ...
        if (this.__bindings__P_80_0[targetPath] == null) {
          this.__bindings__P_80_0[targetPath] = {};
        } // store the binding reference


        var storage = this.__bindings__P_80_0[targetPath];
        ...
        if (!this.__boundProperties__P_80_1.includes(targetPath)) {
          this.__boundProperties__P_80_1.push(targetPath);
        }
      },
       ...
       * @param modelNode {var} The model node which should be bound to the target.
       */
      bindPropertyReverse(targetPath, sourcePath, options, sourceWidget, modelNode) {
        // set up the binding
        var id = sourceWidget.bind(sourcePath, modelNode, targetPath, options); // check for the storage for the references

        if (this.__bindings__P_80_0[sourcePath] == null) {
          this.__bindings__P_80_0[sourcePath] = {};
        } // check if there is already a stored item


        var storage = this.__bindings__P_80_0[sourcePath];
        qx.core.ObjectRegistry.register(modelNode);
        ...
        if (!this.__boundProperties__P_80_1.includes(sourcePath)) {
          this.__boundProperties__P_80_1.push(sourcePath);
        }
      },
       ...
       * paths.
       */
      __renewBindings__P_80_4() {
        // get the first bound property
        var firstProp;

        for (var key in this.__bindings__P_80_0) {
          firstProp = key;
          break;
        ...
        for (var hash in this.__bindings__P_80_0[firstProp]) {
          // get the data
          var treeNode = this.__bindings__P_80_0[firstProp][hash].treeNode;
          var modelNode = qx.core.ObjectRegistry.fromHashCode(hash); // remove the old bindings

          this.__removeBinding__P_80_13(modelNode); // add the new bindings


          this.__addBinding__P_80_10(modelNode, treeNode);
        }
      },
       ...
       *   to the model node.
       */
      __addBinding__P_80_10(modelNode, treeNode) {
       ...
       *   should be removed.
       */
      __removeBinding__P_80_13(modelNode) {
        for (var i = 0; i < this.__boundProperties__P_80_1.length; i++) {
          var property = this.__boundProperties__P_80_1[i];

          var bindingsMap = this.__bindings__P_80_0[property][modelNode.toHashCode()];
          ...
          if (bindingsMap != null) {
            ...
            delete this.__bindings__P_80_0[property][modelNode.toHashCode()];
          }
        }
      },
    ...
    destruct() {
      ...
      this.__bindings__P_80_0 = this.__childrenRef__P_80_2 = this.__boundProperties__P_80_1 = null;
    }
