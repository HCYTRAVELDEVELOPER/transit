  ...
  qx.Class.define("qx.data.SingleValueBinding", {
    statics: {
      ...
      bind(sourceObject, sourcePropertyChain, targetObject, targetPropertyChain, options) {
        ...
        var targetListenerMap = this.__setUpTargetBinding__P_74_2(sourceObject, sourcePropertyChain, targetObject, targetPropertyChain, options); // get the property names


        var propertyNames = sourcePropertyChain.split("."); // stuff that's needed to store for the listener function

        var arrayIndexValues = this.__checkForArrayInPropertyChain__P_74_3(propertyNames);
        ...
        try {
          ...
          for (var i = 0; i < propertyNames.length; i++) {
            ...
            if (arrayIndexValues[i] !== "") {
              ...
              var eventName = this.__getEventNameForProperty__P_74_4(source, propertyName);
              ...
              if (!eventName) {
                ...
                initialPromise = this.__setInitialValue__P_74_5(undefined, targetObject, targetPropertyChain, options, sourceObject);
                break;
              }
            ...
            if (i == propertyNames.length - 1) {
              ...
              if (arrayIndexValues[i] !== "") {
                ...
                initialPromise = this.__setInitialValue__P_74_5(currentValue, targetObject, targetPropertyChain, options, sourceObject); // bind the event

                listenerIds[i] = this.__bindEventToProperty__P_74_6(source, eventNames[i], targetObject, targetPropertyChain, options, arrayIndexValues[i]);
              } else {
                ...
                if (propertyNames[i] != null && source["get" + qx.lang.String.firstUp(propertyNames[i])] != null) {
                  ...
                  initialPromise = this.__setInitialValue__P_74_5(currentValue, targetObject, targetPropertyChain, options, sourceObject);
                } // bind the property


                listenerIds[i] = this.__bindEventToProperty__P_74_6(source, eventNames[i], targetObject, targetPropertyChain, options);
              ...
              var listener = qx.lang.Function.bind(this.__chainListener__P_74_7, this, context); // store the listener for further processing
            ...
            if (!source) {
              ...
              this.__setInitialValue__P_74_5(source, targetObject, targetPropertyChain, options, sourceObject);
        ...
        this.__storeBinding__P_74_8(id, sourceObject, sourcePropertyChain, targetObject, targetPropertyChain);
       ...
       */
      __chainListener__P_74_7(context) {
        ...
        for (var j = context.index + 1; j < context.propertyNames.length; j++) {
          ...
          if (!source) {
            ...
            if (context.options && context.options.converter) {
              ...
              if (!ignoreConverter) {
                this.__setTargetValue__P_74_9(context.targetObject, context.targetPropertyChain, context.options.converter());
              } else {
                this.__resetTargetValue__P_74_10(context.targetObject, context.targetPropertyChain);
              }
            } else {
              this.__resetTargetValue__P_74_10(context.targetObject, context.targetPropertyChain);
            }
          ...
          if (j == context.propertyNames.length - 1) {
            ...
            if (qx.Class.implementsInterface(source, qx.data.IListData) && context.arrayIndexValues[j] !== "") {
              ...
              this.__setInitialValue__P_74_5(currentValue, context.targetObject, context.targetPropertyChain, context.options, context.sources[context.index]); // bind the item event to the new target


              context.listenerIds[j] = this.__bindEventToProperty__P_74_6(source, "change", context.targetObject, context.targetPropertyChain, context.options, context.arrayIndexValues[j]);
            } else {
              if (context.propertyNames[j] != null && source["get" + qx.lang.String.firstUp(context.propertyNames[j])] != null) {
                ...
                this.__setInitialValue__P_74_5(currentValue, context.targetObject, context.targetPropertyChain, context.options, context.sources[context.index]);
              }

              var eventName = this.__getEventNameForProperty__P_74_4(source, context.propertyNames[j]);
              ...
              context.listenerIds[j] = this.__bindEventToProperty__P_74_6(source, eventName, context.targetObject, context.targetPropertyChain, context.options);
            }
          } else {
       ...
       */
      __setUpTargetBinding__P_74_2(sourceObject, sourcePropertyChain, targetObject, targetPropertyChain, options) {
        ...
        for (var i = 0; i < propertyNames.length - 1; i++) {
          ...
          if (arrayIndexValues[i] !== "") {
            ...
            var eventName = this.__getEventNameForProperty__P_74_4(target, propertyNames[i]);
          ...
          var listener = function () {
            ...
            for (var j = i + 1; j < propertyNames.length - 1; j++) {
              ...
              if (qx.Class.implementsInterface(target, qx.data.IListData)) {
                ...
                var eventName = qx.data.SingleValueBinding.__getEventNameForProperty__P_74_4(target, propertyNames[j]);
      ...
      updateTarget(sourceObject, sourcePropertyChain, targetObject, targetPropertyChain, options) {
        ...
        value = qx.data.SingleValueBinding.__convertValue__P_74_11(value, targetObject, targetPropertyChain, options, sourceObject);

        this.__setTargetValue__P_74_9(targetObject, targetPropertyChain, value);
      },
      ...
      resolvePropertyChain(o, propertyChain) {
        var properties = this.__getPropertyChainArray__P_74_12(propertyChain);

        return this.__getTargetFromChain__P_74_13(o, properties, properties.length);
      },
       ...
       */
      __getEventNameForProperty__P_74_4(source, propertyName) {
        // get the current event name from the property definition
        var eventName = this.__getEventForProperty__P_74_14(source, propertyName); // if no event name could be found
       ...
       */
      __resetTargetValue__P_74_10(targetObject, targetPropertyChain) {
        // get the last target object of the chain
        var properties = this.__getPropertyChainArray__P_74_12(targetPropertyChain);

        var target = this.__getTargetFromChain__P_74_13(targetObject, properties);
        ...
        if (target != null) {
          ...
          var index = this.__getArrayIndex__P_74_15(lastProperty);

          if (index) {
            this.__setTargetValue__P_74_9(targetObject, targetPropertyChain, null);
       ...
       */
      __setTargetValue__P_74_9(targetObject, targetPropertyChain, value) {
        // get the last target object of the chain
        var properties = this.__getPropertyChainArray__P_74_12(targetPropertyChain);
       ...
       */
      __getArrayIndex__P_74_15(propertyName) {
        var arrayExp = /^\[(\d+|last)\]$/;
       ...
       */
      __getPropertyChainArray__P_74_12(targetPropertyChain) {
       ...
       *   should be set.
       */
      __getTargetFromChain__P_74_13(targetObject, targetProperties, index) {
        ...
        for (var i = 0; target !== null && i < index; i++) {
          try {
            ...
            var arrIndex = this.__getArrayIndex__P_74_15(property);
       ...
       */
      __setInitialValue__P_74_5(value, targetObject, targetPropertyChain, options, sourceObject) {
        // first convert the initial value
        value = this.__convertValue__P_74_11(value, targetObject, targetPropertyChain, options, sourceObject); // check if the converted value is undefined

        if (value === undefined) {
          this.__resetTargetValue__P_74_10(targetObject, targetPropertyChain);
        } // only set the initial value if one is given (may be null)


        if (value !== undefined) {
          try {
            var result = this.__setTargetValue__P_74_9(targetObject, targetPropertyChain, value); // tell the user that the setter was invoked probably
       ...
       */
      __checkForArrayInPropertyChain__P_74_3(propertyNames) {
       ...
       *   property.
       */
      __bindEventToProperty__P_74_6(sourceObject, sourceEvent, targetObject, targetProperty, options, arrayIndex) {
        // checks
        if (qx.core.Environment.get("qx.debug")) {
        ...
        var bindListener = function (arrayIndex, e) {
          ...
          if (arrayIndex !== "") {
            ...
            if (data === undefined) {
              qx.data.SingleValueBinding.__resetTargetValue__P_74_10(targetObject, targetProperty);
          ...
          // convert the data
          data = qx.data.SingleValueBinding.__convertValue__P_74_11(data, targetObject, targetProperty, options, sourceObject); // debug message
          ...
          try {
            if (data !== undefined) {
              result = qx.data.SingleValueBinding.__setTargetValue__P_74_9(targetObject, targetProperty, data);
            } else {
              result = qx.data.SingleValueBinding.__resetTargetValue__P_74_10(targetObject, targetProperty);
       ...
       *   object.
       */
      __storeBinding__P_74_8(id, sourceObject, sourceEvent, targetObject, targetProperty) {
        var hash; // add the listener id to the internal registry

        hash = sourceObject.toHashCode();

        if (this.__bindings__P_74_0[hash] === undefined) {
          this.__bindings__P_74_0[hash] = [];
        }

        var binding = [id, sourceObject, sourceEvent, targetObject, targetProperty];

        this.__bindings__P_74_0[hash].push(binding); // add same binding data indexed by target object


        hash = targetObject.toHashCode();

        if (this.__bindingsByTarget__P_74_1[hash] === undefined) {
          this.__bindingsByTarget__P_74_1[hash] = [];
        }

        this.__bindingsByTarget__P_74_1[hash].push(binding);
      },
       ...
       */
      __convertValue__P_74_11(value, targetObject, targetPropertyChain, options, sourceObject) {
        ...
        if (options && options.converter) {
          ...
          return this.__defaultConversion__P_74_16(value, check);
        }
      },
       ...
       */
      __getEventForProperty__P_74_14(sourceObject, sourceProperty) {
        // get the event name
       ...
       */
      __defaultConversion__P_74_16(data, targetCheck) {
        ...
        if (bindings != undefined) {
          for (var i = 0; i < bindings.length; i++) {
            if (bindings[i][0] == id) {
              ...
              if (this.__bindingsByTarget__P_74_1[target.toHashCode()]) {
                qx.lang.Array.remove(this.__bindingsByTarget__P_74_1[target.toHashCode()], bindings[i]);
              } // remove binding data from internal reference indexed by source object


              var source = bindings[i][1];

              if (this.__bindings__P_74_0[source.toHashCode()]) {
                qx.lang.Array.remove(this.__bindings__P_74_0[source.toHashCode()], bindings[i]);
              }
      ...
      removeAllBindingsForObject(object) {
        ...
        delete this.__bindings__P_74_0[hash];
        delete this.__bindingsByTarget__P_74_1[hash];
      },
      ...
      getAllBindingsForObject(object) {
        ...
        var sourceBindings = this.__bindings__P_74_0[hash]; // get all bindings of object as target

        var targetBindings = this.__bindingsByTarget__P_74_1[hash];
      ...
      removeAllBindings() {
        ...
        for (var hash in this.__bindings__P_74_0) {
       ...
       */
      getAllBindings() {
        return this.__bindings__P_74_0;
      },
      ...
      showBindingInLog(object, id) {
        ...
        for (var i = 0; i < this.__bindings__P_74_0[object.toHashCode()].length; i++) {
          // the first array item is the id
          if (this.__bindings__P_74_0[object.toHashCode()][i][0] == id) {
            binding = this.__bindings__P_74_0[object.toHashCode()][i];
            break;
          }
        }
      ...
      showAllBindingsInLog() {
        ...
        for (var hash in this.__bindings__P_74_0) {
          ...
          if (object) {
            for (var i = 0; i < this.__bindings__P_74_0[hash].length; i++) {
              this.showBindingInLog(object, this.__bindings__P_74_0[hash][i][0]);
            }
          }
        }
      }
...
//# sourceMappingURL=SingleValueBinding.js.map