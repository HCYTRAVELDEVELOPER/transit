  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.Part", {
    ...
    construct(loader) {
      ...
      this.__loader__P_163_0 = loader; // initialize the pseudo event listener maps

      this.__partListners__P_163_1 = {};
      this.__packageListeners__P_163_2 = {};
      this.__packageClosureListeners__P_163_3 = {}; // create the packages

      this.__packages__P_163_4 = {};

      for (var key in loader.packages) {
        var pkg = new qx.io.part.Package(this.__decodeUris__P_163_5(loader.packages[key].uris), key, key == bootPackageKey);
        this.__packages__P_163_4[key] = pkg;
      } // create the parts


      this.__parts__P_163_6 = {};
      ...
      for (var name in parts) {
        ...
        for (var i = 0; i < pkgKeys.length; i++) {
          packages.push(this.__packages__P_163_4[pkgKeys[i]]);
        ...
        this.__parts__P_163_6[name] = part;
      }
    },
    ...
    members: {
      __loader__P_163_0: null,
      __packages__P_163_4: null,
      __parts__P_163_6: null,
      __packageClosureListeners__P_163_3: null,
       ...
       */
      addToPackage(pkg) {
        this.__packages__P_163_4[pkg.getId()] = pkg;
      },
      ...
      saveClosure(id, closure) {
        ...
        var pkg = this.__packages__P_163_4[id]; // error if no package could be found
        ...
        var listeners = this.__packageClosureListeners__P_163_3[id];
        ...
        this.__packageClosureListeners__P_163_3[id] = [];
      },
      ...
      require(partNames, callback, self) {
        ...
        for (var i = 0; i < partNames.length; i++) {
          var part = this.__parts__P_163_6[partNames[i]];
      ...
      preload(partNames, callback, self) {
        ...
        for (var i = 0; i < partNames.length; i++) {
          this.__parts__P_163_6[partNames[i]].preload(function () {
            partsPreloaded++;
            ...
            if (partsPreloaded >= partNames.length) {
              ...
              for (var i = 0; i < partNames.length; i++) {
                states.push(this.__parts__P_163_6[partNames[i]].getReadyState());
              }
       ...
       */
      __getUris__P_163_7() {
        var packages = this.__loader__P_163_0.packages;
        var uris = [];

        for (var key in packages) {
          uris.push(this.__decodeUris__P_163_5(packages[key].uris));
        }
       ...
       */
      __decodeUris__P_163_5: qx.$$loader.decodeUris,
      ...
      */
      ...
      addPartListener(part, callback) {
        ...
        if (!this.__partListners__P_163_1[key]) {
          this.__partListners__P_163_1[key] = [];
        }

        this.__partListners__P_163_1[key].push(callback);
      },
      ...
      notifyPartResult(part) {
        var key = part.getName();
        var listeners = this.__partListners__P_163_1[key];
      ...
      ---------------------------------------------------------------------------
      */
      __packageListeners__P_163_2: null,
      ...
      addPackageListener(pkg, callback) {
        ...
        if (!this.__packageListeners__P_163_2[key]) {
          this.__packageListeners__P_163_2[key] = [];
        }

        this.__packageListeners__P_163_2[key].push(callback);
      },
      ...
      notifyPackageResult(pkg) {
        var key = pkg.getId();
        var listeners = this.__packageListeners__P_163_2[key];
