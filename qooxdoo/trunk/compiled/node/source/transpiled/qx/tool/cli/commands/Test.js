  ...
  qx.Class.define("qx.tool.cli.commands.Test", {
    ...
    members: {
      ...
      addTest(test) {
        ...
        this.__tests__P_15_0.push(test);
      ...
      async process() {
        ...
        this.addListener("making", () => {
          if (!this.hasListener("runTests") && this.__tests__P_15_0.length === 0 && (!this.getCompilerApi() || typeof this.getCompilerApi().beforeTests != "function")) {
        ...
        this.addListener("afterStart", async () => {
          ...
          for (let test of this.__tests__P_15_0) {
      ...
      __needsServer__P_15_1() {
        return !this.argv.disableWebserver && (this.getNeedsServer() || this.__tests__P_15_0.some(test => test.getNeedsServer()));
      }
