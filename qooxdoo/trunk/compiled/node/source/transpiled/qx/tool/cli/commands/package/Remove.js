  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.tool.cli.commands.package.Remove", {
    ...
    members: {
      ...
      async process() {
        ...
        for (const elem of data.libraries) {
          if (elem[tag] === this.argv.uri) {
            await this.__removeApplication__P_19_0(elem.uri);
            await this.__deleteRequiredFromManifest__P_19_1(elem.uri);
      ...
      async __deleteRequiredFromManifest__P_19_1(uri) {
       ...
       * @private
       */
      async __removeApplication__P_19_0(uri) {
