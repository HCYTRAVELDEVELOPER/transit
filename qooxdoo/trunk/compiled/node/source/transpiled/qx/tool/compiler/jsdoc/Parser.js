    ...
    statics: {
      ...
      parseComment(comment) {
        ...
        */
        ...
        comment = comment.replace(/`([^`]*)`/gm, "<code>$1</code>"); // Strip optional leading *

        comment = comment.replace(/^[ \t]*\*/gm, ""); // special handling for as markdown lists - * in qooxdoo
      ...
      parseJsDoc(jsdoc, classname, analyser) {
        for (var key in jsdoc) {
          var parser = this.__PARSERS__P_30_0[key];
