(function () {
  ...
  qx.Class.define("qx.tool.compiler.ClassFile", {
    ...
    construct(analyser, className, library) {
      ...
      this.__analyser__P_22_0 = analyser;
      this.__className__P_22_1 = className;
      this.__metaStack__P_22_2 = [];
      this.__metaDefinitions__P_22_3 = {};
      this.__library__P_22_4 = library;
      this.__sourceFilename__P_22_5 = qx.tool.compiler.ClassFile.getSourcePath(library, className);
      this.__requiredClasses__P_22_6 = {};
      this.__environmentChecks__P_22_7 = {
        provided: {},
        required: {}
      };
      this.__requiredAssets__P_22_8 = [];
      this.__translations__P_22_9 = [];
      this.__markers__P_22_10 = [];
      this.__haveMarkersFor__P_22_11 = {};
      this.__scope__P_22_12 = {
        parent: null,
        vars: {},
        unresolved: {}
      };
      this.__externals__P_22_13 = [];
      this.__commonjsModules__P_22_14 = {};
      this.__taskQueueDrains__P_22_15 = [];
      this.__taskQueue__P_22_16 = async.queue(function (task, cb) {
        task(cb);
      });
      this.__taskQueue__P_22_16.drain = this._onTaskQueueDrain;

      this.__taskQueue__P_22_16.error = err => {
        qx.tool.compiler.Console.error(err.stack || err);
      };

      analyser.getIgnores().forEach(s => this.addIgnore(s));
      this.__globalSymbols__P_22_17 = {};
      this.__privates__P_22_18 = {};
      this.__blockedPrivates__P_22_19 = {};
      this.__privateMangling__P_22_20 = analyser.getManglePrivates();
      const CF = qx.tool.compiler.ClassFile;

      const addSymbols = arr => arr.forEach(s => this.__globalSymbols__P_22_17[s] = true);
    ...
    members: {
      __analyser__P_22_0: null,
      __className__P_22_1: null,
      __numClassesDefined__P_22_21: 0,
      __library__P_22_4: null,
      __requiredClasses__P_22_6: null,
      __environmentChecks__P_22_7: null,
      __requiredAssets__P_22_8: null,
      __translateMessageIds__P_22_22: null,
      __scope__P_22_12: null,
      __inDefer__P_22_23: false,
      __inConstruct__P_22_24: false,
      __taskQueue__P_22_16: null,
      __taskQueueDrains__P_22_15: null,
      __markers__P_22_10: null,
      __haveMarkersFor__P_22_11: null,
      __classMeta__P_22_25: null,
      __metaStack__P_22_2: null,
      __metaDefinitions__P_22_3: null,
      __fatalCompileError__P_22_26: false,
      __translations__P_22_9: null,
      __dbClassInfo__P_22_27: null,
      __hasDefer__P_22_28: null,
      __definingType__P_22_29: null,
      __sourceFilename__P_22_5: null,
      __taskQueueDrain__P_22_30: null,
      __globalSymbols__P_22_17: null,
      __privates__P_22_18: null,
      __blockedPrivates__P_22_19: null,
      __externals__P_22_13: null,
      __commonjsModules__P_22_14: null,

      _onTaskQueueDrain() {
        var cbs = this.__taskQueueDrain__P_22_30;
        this.__taskQueueDrain__P_22_30 = [];
      ...
      _waitForTaskQueueDrain(cb) {
        if (this.__taskQueue__P_22_16.length() == 0) {
          cb();
        } else {
          this.__taskQueueDrains__P_22_15.push(cb);
        }
      },

      _queueTask(cb) {
        this.__taskQueue__P_22_16.push(cb);
      },
       ...
       */
      getSourcePath() {
        return this.__sourceFilename__P_22_5;
      },
       ...
       */
      getOutputPath() {
        return qx.tool.compiler.ClassFile.getOutputPath(this.__analyser__P_22_0, this.__className__P_22_1);
      },
      ...
      load(callback) {
        var t = this;
        var className = this.__className__P_22_1;
        t.__fatalCompileError__P_22_26 = false;
        t.__numClassesDefined__P_22_21 = 0;
        fs.readFile(this.getSourcePath(), {
          ...
          try {
            let babelConfig = t.__analyser__P_22_0.getBabelConfig() || {};
            ...
            if (this.__privateMangling__P_22_20 == "unreadable") {
            ...
            t.__fatalCompileError__P_22_26 = true;
          ...
          if (!t.__numClassesDefined__P_22_21) {
          ...
          if (!t.__metaDefinitions__P_22_3[className]) {
            t.addMarker("compiler.wrongClassName", null, className, Object.keys(t.__metaDefinitions__P_22_3).join(", "));
          ...
          qx.tool.utils.Utils.mkParentPath(outputPath, function (err) {
            ...
            if (qx.lang.Array.contains(t.__analyser__P_22_0.getApplicationTypes(), "browser")) {
      ...
      writeDbInfo(dbClassInfo) {
        ...
        for (var key in this.__dbClassInfo__P_22_27) {
          dbClassInfo[key] = this.__dbClassInfo__P_22_27[key];
        }
      },
      ...
      _compileDbClassInfo() {
        var t = this;
        var dbClassInfo = this.__dbClassInfo__P_22_27 = {}; // Collect the dependencies on other classes

        var deps = this.getRequiredClasses();

        if (t.__usesJsx__P_22_31) {
        ...
        if (Object.keys(this.__environmentChecks__P_22_7.provided).length || Object.keys(this.__environmentChecks__P_22_7.required).length) {
          dbClassInfo.environment = {
            provided: [],
            required: {}
          };

          for (let key in this.__environmentChecks__P_22_7.provided) {
            dbClassInfo.environment.provided.push(key);
          }

          for (let key in this.__environmentChecks__P_22_7.required) {
            dbClassInfo.environment.required[key] = this.__environmentChecks__P_22_7.required[key];
          }
        ...
        for (let name in this.__scope__P_22_12.unresolved) {
          let item = this.__scope__P_22_12.unresolved[name]; // item is undefined if it has already been removed from the list
          ...
          if (this.__metaDefinitions__P_22_3[name]) {
            continue;
          }

          var info = t.__analyser__P_22_0.getSymbolType(name);
        ...
        if (this.__externals__P_22_13.length) {
          dbClassInfo.externals = this.__externals__P_22_13;
        } // Translation


        if (this.__translations__P_22_9.length) {
          dbClassInfo.translations = this.__translations__P_22_9.slice(0);
        } // Markers


        if (this.__markers__P_22_10.length) {
          dbClassInfo.markers = qx.lang.Array.clone(this.__markers__P_22_10);
        } // Errors


        if (this.__fatalCompileError__P_22_26) {
          dbClassInfo.fatalCompileError = true;
        } // CommonJS modules


        if (Object.keys(this.__commonjsModules__P_22_14).length > 0) {
          dbClassInfo.commonjsModules = {};

          for (let moduleName in this.__commonjsModules__P_22_14) {
            dbClassInfo.commonjsModules[moduleName] = [...this.__commonjsModules__P_22_14[moduleName]];
          }
        }
       ...
       */
      getOuterClassMeta() {
        let src = this.__metaDefinitions__P_22_3[this.__className__P_22_1] || null;
      ...
      _babelClassPlugins() {
        ...
        function enterFunction(path, node, idNode) {
          ...
          let isClassMember = t.__classMeta__P_22_25 && t.__classMeta__P_22_25._topLevel && t.__classMeta__P_22_25._topLevel.keyName == "members" && path.parentPath.parentPath.parentPath == t.__classMeta__P_22_25._topLevel.path;
        ...
        function makeMeta(sectionName, functionName, node) {
          ...
          if (functionName) {
            var section = t.__classMeta__P_22_25[sectionName];

            if (section === undefined) {
              section = t.__classMeta__P_22_25[sectionName] = {};
            }
            ...
            meta = t.__classMeta__P_22_25[sectionName];
        ...
        var COLLECT_CLASS_NAMES_VISITOR = {
          MemberExpression(path) {
            ...
            var info = t.__analyser__P_22_0.getSymbolType(str);
        ...
        const CODE_ELIMINATION_VISITOR = {
          ...
          CallExpression(path) {
            ...
            if ((name === "qx.core.Environment.select" || name === "qx.core.Environment.get") && types.isLiteral(path.node.arguments[0])) {
              ...
              const env = t.__analyser__P_22_0.getEnvironment();
        ...
        function collectJson(node, isProperties, jsonPath) {
          ...
          if (node.type == "ObjectExpression") {
            ...
            t.warn("Cannot interpret AST " + node.type + " at " + t.__className__P_22_1 + (node.loc ? " [" + node.loc.start.line + "," + node.loc.start.column + "]" : ""));
            result = null;
          }
        ...
        function isValidExtendClause(prop) {
          ...
          if (t.__classMeta__P_22_25.type === "class") {
            return false;
          }
        ...
        function checkValidTopLevel(path) {
          ...
          let allowedKeys = ALLOWED_KEYS[t.__classMeta__P_22_25.type];

          if (t.__classMeta__P_22_25.type === "class") {
            allowedKeys = allowedKeys[t.__classMeta__P_22_25.isStatic ? "static" : "normal"];
          }

          if (allowedKeys[keyName] === undefined) {
            t.addMarker("compiler.invalidClassDefinitionEntry", prop.loc, t.__classMeta__P_22_25.type, keyName);
          }
        }

        function handleTopLevelMethods(path, keyName, functionNode) {
          if (keyName == "defer") {
            t.__hasDefer__P_22_28 = true;
            t.__inDefer__P_22_23 = true;
          }

          t.__classMeta__P_22_25.functionName = FUNCTION_NAMES[keyName] || keyName;
          ...
          path.skip();
          t.__classMeta__P_22_25.functionName = null;
        }
          ...
          ObjectProperty(path) {
            ...
            if (keyName == "extend") {
              if (!isValidExtendClause(prop)) {
                ...
                t.__classMeta__P_22_25.superClass = collapseMemberExpression(prop.value);

                t._requireClass(t.__classMeta__P_22_25.superClass, {
                  location: path.node.loc
                });
              }
            } else if (keyName == "type") {
              var type = prop.value.value;
              t.__classMeta__P_22_25.isAbstract = type === "abstract";
              t.__classMeta__P_22_25.isStatic = type === "static";
              t.__classMeta__P_22_25.isSingleton = type === "singleton";
            } else if (keyName == "implement") {
              path.skip();
              path.traverse(COLLECT_CLASS_NAMES_VISITOR, {
                collectedClasses: t.__classMeta__P_22_25.interfaces
              });
            } else if (keyName == "include") {
              path.skip();
              path.traverse(COLLECT_CLASS_NAMES_VISITOR, {
                collectedClasses: t.__classMeta__P_22_25.mixins
              });
            } else if (keyName == "members" || keyName == "statics" || keyName == "@") {
              t.__classMeta__P_22_25._topLevel = {
                path,
                keyName
              };
              path.skip();
              path.traverse(VISITOR);
              t.__classMeta__P_22_25._topLevel = null;
        ...
        var VISITOR = {
          NewExpression: {
            ...
            exit(path) {
              if (t.__analyser__P_22_0.isAddCreatedAt()) {
                var fn = types.memberExpression(types.identifier("qx"), types.identifier("$$createdAt"));
                var tmp = types.callExpression(fn, [path.node, types.stringLiteral(t.__className__P_22_1.replace(/\./g, "/") + ".js"), types.numericLiteral(path.node.loc ? path.node.loc.start.line : 0), types.numericLiteral(path.node.loc ? path.node.loc.start.column : 0)]);
          ...
          Program: {
            exit(path) {
              ...
              tmp = babylon.parse(t.__className__P_22_1 + ".$$dbClassInfo = $$dbClassInfo;").program.body;
              inject.push(tmp[0]);
          ...
          CallExpression: {
            enter(path) {
              var _path$node, _path$node$callee, _path$node$arguments, _path$node$callee$obj;
              ...
              function addTranslation(entry) {
                ...
                let cur = t.__translations__P_22_9[entry.msgid];
                ...
                if (cur) {
                  ...
                  t.__translations__P_22_9.push(entry);
                }
              ...
              let applicationTypes = t.__analyser__P_22_0.getApplicationTypes();

              if (path.node.callee.type == "Identifier" && ((_path$node = path.node) === null || _path$node === void 0 ? void 0 : (_path$node$callee = _path$node.callee) === null || _path$node$callee === void 0 ? void 0 : _path$node$callee.name) == "require" && ((_path$node$arguments = path.node.arguments) === null || _path$node$arguments === void 0 ? void 0 : _path$node$arguments.length) == 1 && applicationTypes.includes("browser")) {
                // See if this is a reference to global `require` or
                // something in the scope chain
                for (scope = t.__scope__P_22_12; scope; scope = scope.parent) {
                ...
                if (!scope) {
                  ...
                  if (types.isLiteral(arg)) {
                    if (typeof arg.value != "string") {
                      log.error(`${t.__className__P_22_1}: ` + "Only literal string arguments to require() are supported: " + arg.value);
                    } else {
                      qx.tool.compiler.Console.log(`${t.__className__P_22_1}:${path.node.loc.start.line}:` + ` automatically detected \'require(${arg.value})\``);
                      t.addCommonjsModule(arg.value, t.__className__P_22_1, path.node.loc.start.line); // Don't show "unresolved" error for `require` since the
              ...
              if (types.isMemberExpression(path.node.callee) || es6ClassDeclarations == 0 && (((_path$node$callee$obj = path.node.callee.object) === null || _path$node$callee$obj === void 0 ? void 0 : _path$node$callee$obj.type) == "Super" || path.node.callee.type == "Super")) {
                ...
                if (((_path$node$callee$obj2 = path.node.callee.object) === null || _path$node$callee$obj2 === void 0 ? void 0 : _path$node$callee$obj2.type) == "Identifier") {
                  ...
                  for (let scope = t.__scope__P_22_12; scope; scope = scope.parent) {
                    while (!aliasIsThis) {
                ...
                if (TYPE[name]) {
                  t.__definingType__P_22_29 = name.match(/\.([a-zA-Z]+)\./)[1];
                  let node = path.node;
                  ...
                  t.__pushMeta__P_22_32(className);
                  ...
                  t.__classMeta__P_22_25.type = TYPE[name];

                  if (t.__definingType__P_22_29 == "Class" || t.__definingType__P_22_29 == "Bootstrap") {
                    let typeProp = classDef.properties.find(prop => prop.key.type == "Identifier" && prop.key.value == "type");

                    if (typeProp) {
                      t.__classMeta__P_22_25.isStatic == typeProp.value.type == "Literal" && typeProp.value.value === "static";
                    }
                  }
                  ...
                  t.__popMeta__P_22_33(className);
                  ...
                  if (types.isLiteral(arg)) {
                    if (typeof arg.value != "string") {
                      ...
                      t.__environmentChecks__P_22_7.provided[arg.value] = true;

                      if (!arg.value.startsWith(t.__className__P_22_1) && !Object.prototype.hasOwnProperty.call(qx.tool.compiler.ClassFile.ENVIRONMENT_CONSTANTS, arg.value)) {
                        let symbol = t.__library__P_22_4.getSymbolType(arg.value);
                  ...
                  if (t.__definingType__P_22_29 == "Mixin") {
                    expr = types.callExpression(expandMemberExpression("qx.Mixin.baseClassMethod"), [expandMemberExpression("this.constructor"), types.identifier(t.__classMeta__P_22_25.className), types.stringLiteral(t.__classMeta__P_22_25.functionName)]);
                    expr = types.memberExpression(expr, types.identifier("call"));
                  } else if (t.__classMeta__P_22_25.functionName == "$$constructor") {
                    expr = expandMemberExpression(t.__classMeta__P_22_25.superClass + ".constructor.call");
                  } else if (t.__classMeta__P_22_25.className) {
                    expr = expandMemberExpression(t.__classMeta__P_22_25.className + ".superclass" + ".prototype." + t.__classMeta__P_22_25.functionName + ".call");
                  } else {
                    expr = expandMemberExpression(t.__classMeta__P_22_25.superClass + ".prototype." + t.__classMeta__P_22_25.functionName + ".call");
                  }
                  ...
                  if (t.__definingType__P_22_29 == "Mixin") {
                    expr = expandMemberExpression("this.constructor.superclass.prototype." + t.__classMeta__P_22_25.functionName + ".call");
                  } else if (t.__classMeta__P_22_25.functionName == "$$constructor") {
                    expr = expandMemberExpression(t.__classMeta__P_22_25.superClass + ".constructor." + methodName);
                  } else {
                    expr = expandMemberExpression(t.__className__P_22_1 + ".prototype." + t.__classMeta__P_22_25.functionName + ".base." + methodName);
                  ...
                  let expr = expandMemberExpression(t.__classMeta__P_22_25.className);
          ...
          MemberExpression: {
            exit(path) {
              ...
              if (t.__globalSymbols__P_22_17[members[0]] || t.hasDeclaration(members[0])) {
                return;
              }
          ...
          ObjectProperty: {
            exit(path) {
              if (this.__privateMangling__P_22_20 == "readable") {
          ...
          Property(path) {
            if (t.__classMeta__P_22_25 && t.__classMeta__P_22_25._topLevel && t.__classMeta__P_22_25._topLevel.path == path.parentPath.parentPath) {
              t.__classMeta__P_22_25.functionName = getKeyName(path.node.key);
              makeMeta(t.__classMeta__P_22_25._topLevel.keyName, t.__classMeta__P_22_25.functionName, path.node);
              path.skip();
              let functionId = null;
          ...
          ObjectMethod(path) {
            ...
            if (t.__classMeta__P_22_25 && t.__classMeta__P_22_25._topLevel && t.__classMeta__P_22_25._topLevel.path == path.parentPath.parentPath) {
              ...
              path.traverse(VISITOR);
              exitFunction(path);
              t.__classMeta__P_22_25.functionName = null; // Otherwise traverse method as normal
            } else {
              path.skip();
              enterFunction(path);
              path.traverse(VISITOR);
      ...
      __pushMeta__P_22_32(className) {
        ...
        this.__metaStack__P_22_2.push(meta);

        this.__classMeta__P_22_25 = meta;
        this.__metaDefinitions__P_22_3[className] = meta;
        this.__numClassesDefined__P_22_21++;
      },

      /**
       * Pops the current meta off the stack, optionally checking that the classname is correct
       */
      __popMeta__P_22_33(className) {
        if (!this.__metaStack__P_22_2.length) {
          throw new Error("No __metaStack entries to pop");
        }

        let meta = this.__metaStack__P_22_2[this.__metaStack__P_22_2.length - 1];
        ...
        this.__metaStack__P_22_2.pop();

        meta = this.__metaStack__P_22_2[this.__metaStack__P_22_2.length - 1] || null;
        this.__classMeta__P_22_25 = meta;
      },
       ...
       */
      popScope(node) {
        var old = this.__scope__P_22_12;
        var scope = this.__scope__P_22_12 = this.__scope__P_22_12.parent;
       ...
       */
      isLoadScope() {
        return !this.__scope__P_22_12.parent;
      },
       ...
       */
      hasDefer() {
        return this.__hasDefer__P_22_28;
      },
      ...
      addDeclaration(name, valueName) {
        if (this.__scope__P_22_12.vars[name] === undefined) {
          this.__scope__P_22_12.vars[name] = valueName || true;
          var unresolved = this.__scope__P_22_12.unresolved;
      ...
      hasDeclaration(name) {
        ...
        for (var tmp = this.__scope__P_22_12; tmp; tmp = tmp.parent) {
      ...
      addReference(name, loc) {
        ...
        var scope = this.__scope__P_22_12;
        ...
        if (name[0] === "this" || name[0] === "[]" || this.__globalSymbols__P_22_17[name[0]] || this.hasDeclaration(name[0])) {
          return;
        }
        ...
        for (var i = 0; i < name.length; i++) {
          ...
          if (this.__globalSymbols__P_22_17[str] || this.isIgnored(str)) {
            return;
          }
        }
        ...
        if (name == this.__className__P_22_1 || name.startsWith(this.__className__P_22_1 + ".") || name.startsWith("(")) {
          return;
        }
      ...
      encodePrivate(name, isIdentifier, location) {
        ...
        if (DO_NOT_ENCODE[name] || this.__privateMangling__P_22_20 == "off" || !name.startsWith("__") || !name.match(/^[0-9a-z_$]+$/i)) {
          return name;
        }
        ...
        let coded = this.__privates__P_22_18[name];
        ...
        if (!coded) {
          ...
          if (!isIdentifier) {
            this.__blockedPrivates__P_22_19[name] = true;
            return name;
          }

          if (this.__blockedPrivates__P_22_19[name]) {
            this.addMarker("class.blockedMangle", location, name);
            return name;
          }

          let db = this.__analyser__P_22_0.getDatabase();
          ...
          let prefix = prefixes.classPrefixes[this.__className__P_22_1];

          if (!prefix) {
            prefix = "__P_" + ++prefixes.nextPrefix + "_";
            prefixes.classPrefixes[this.__className__P_22_1] = prefix;
          }

          if (this.__privateMangling__P_22_20 == "readable") {
            coded = this.__privates__P_22_18[name] = name + prefix + Object.keys(this.__privates__P_22_18).length;
          } else {
            coded = this.__privates__P_22_18[name] = prefix + Object.keys(this.__privates__P_22_18).length;
          }
        }
      ...
      deleteReference(name) {
        delete this.__scope__P_22_12.unresolved[name];
        var stub = name + ".";

        for (var id in this.__scope__P_22_12.unresolved) {
          if (id.startsWith(stub)) {
            delete this.__scope__P_22_12.unresolved[id];
          }
        }
      },
       ...
       */
      addExternal(name) {
        if (this.__externals__P_22_13.indexOf(name) < 0) {
          this.__externals__P_22_13.push(name);
        }
      },
      ...
      addCommonjsModule(moduleName, className, linenum) {
        if (!this.__commonjsModules__P_22_14[moduleName]) {
          this.__commonjsModules__P_22_14[moduleName] = new Set();
        }

        this.__commonjsModules__P_22_14[moduleName].add(`${className}:${linenum}`);
      },
      ...
      addEnvCheck(name, location) {
        ...
        var requiredOpts = {
          load: t.isLoadScope(),
          defer: t.__inDefer__P_22_23,
          construct: t.__classMeta__P_22_25 && t.__classMeta__P_22_25.functionName == "$$constructor",
          location: location
        };
        var dest = t.__environmentChecks__P_22_7.required[name];

        if (!dest) {
          dest = t.__environmentChecks__P_22_7.required[name] = {};
        }
        ...
        let info = t.__analyser__P_22_0.getSymbolType(name);
      ...
      addMarker(msgId, pos) {
        ...
        if (this.__haveMarkersFor__P_22_11[key]) {
          return;
        }

        this.__haveMarkersFor__P_22_11[key] = true;
        let marker = {
          msgId: msgId
        }; // Extract position
        ...
        this.__markers__P_22_10.push(marker);
      },
      ...
      _requireClass(name, opts) {
        ...
        if (name == this.__className__P_22_1) {
          return null;
        }
        ...
        if (symbolType != "package" && className && className != t.__className__P_22_1) {
          // Re-check the class name as ignored if this is a member
          if (symbolType == "member" && t.isIgnored(className)) {
            return null;
          }

          let data = t.__requiredClasses__P_22_6[className];

          if (!data) {
            data = t.__requiredClasses__P_22_6[className] = {};
          }
          ...
          if (requireOpts.defer) {
            ...
            if (!name.startsWith(t.__className__P_22_1)) {
      ...
      _requireAsset(path) {
        ...
        if (!qx.lang.Array.contains(this.__requiredAssets__P_22_8, path)) {
          this.__requiredAssets__P_22_8.push(path);
        }
      },
       ...
       */
      getAssets() {
        return this.__requiredAssets__P_22_8;
      },
       ...
       * @returns
       */
      __findProperty__P_22_34(props, name) {
       ...
       */
      getRequiredClasses() {
        return this.__requiredClasses__P_22_6;
      },
      ...
      getUnresolvedSymbols() {
        return this.__scope__P_22_12.unresolved;
      },
       ...
       */
      getClassName() {
        return this.__className__P_22_1;
      }
