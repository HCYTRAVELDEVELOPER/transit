(function () {
  ...
  qx.Class.define("qx.tool.utils.LogManager", {
    ...
    statics: {
       ...
       */
      getInstance() {
        if (!this.__instance__P_53_0) {
          this.__instance__P_53_0 = new qx.tool.utils.LogManager();
        }

        return this.__instance__P_53_0;
      },

      nullSink(logger, level, msg) {// Nothing
      },
