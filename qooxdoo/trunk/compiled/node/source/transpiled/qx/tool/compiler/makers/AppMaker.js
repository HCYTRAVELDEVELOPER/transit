(function () {
  ...
  qx.Class.define("qx.tool.compiler.makers.AppMaker", {
    ...
    members: {
       ...
       */
      addApplication(app) {
        this.__applications__P_32_0.push(app);
      },
       ...
       */
      getApplications() {
        return this.__applications__P_32_0;
      },
      ...
      async make() {
        ...
        }, this.getEnvironment(), target.getDefaultEnvironment(), target.getEnvironment());
        ...
        this.__applications__P_32_0.forEach(app => app.setAnalyser(analyser));
        ...
        this.__applications__P_32_0.forEach(function (app) {
        ...
        var appsThisTime = this.__applications__P_32_0.filter(app => {
...
//# sourceMappingURL=AppMaker.js.map