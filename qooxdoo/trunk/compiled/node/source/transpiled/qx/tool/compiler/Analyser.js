(function () {
  ...
  qx.Class.define("qx.tool.compiler.Analyser", {
    ...
    construct(dbFilename) {
      ...
      this.__dbFilename__P_21_0 = dbFilename || "db.json";
      this.__libraries__P_21_1 = [];
      this.__librariesByNamespace__P_21_2 = {};
      this.__initialClassesToScan__P_21_3 = new qx.tool.utils.IndexedArray();
      this.__cldrs__P_21_4 = {};
      this.__translations__P_21_5 = {};
      this.__classFiles__P_21_6 = {};
      this.__environmentChecks__P_21_7 = {};
    },
    ...
    members: {
      __opened__P_21_8: false,
      __resManager__P_21_9: null,
      __dbFilename__P_21_0: null,
      __db__P_21_10: null,

      /** {Library[]} All libraries */
      __libraries__P_21_1: null,

      /** {Map{String,Library}} Lookup of libraries, indexed by namespace */
      __librariesByNamespace__P_21_2: null,
      __classes__P_21_11: null,
      __initialClassesToScan__P_21_3: null,
      __cldrs__P_21_4: null,
      __translations__P_21_5: null,
      __classFiles__P_21_6: null,
      __environmentChecks__P_21_7: null,
      __inDefer__P_21_12: false,
      __qooxdooVersion__P_21_13: null,
      __environmentHash__P_21_14: null,
      ...
      open() {
        ...
        if (!this.__opened__P_21_8) {
          this.__opened__P_21_8 = true;
          var resManager = null;
          ...
          this.__resManager__P_21_9 = resManager;
      ...
      initialScan(cb) {
        ...
        function (cb) {
          if (!t.__resManager__P_21_9) {
            cb(null);
            return;
          }

          t.__resManager__P_21_9.findAllResources().then(() => cb()).catch(cb);
        }, // Find all classes
        function (cb) {
          async.each(t.__libraries__P_21_1, function (library, cb) {
       ...
       */
      async loadDatabase() {
        this.__db__P_21_10 = (await qx.tool.utils.Json.loadJsonAsync(this.getDbFilename())) || {};
      },
       ...
       */
      resetDatabase() {
        this.__db__P_21_10 = null;

        if (this.__resManager__P_21_9) {
          this.__resManager__P_21_9.dispose();

          this.__resManager__P_21_9 = null;
        }

        this.__opened__P_21_8 = false;
        return this.open();
      },
      ...
      async saveDatabase() {
        ...
        await this.fireDataEventAsync("saveDatabase", this.__db__P_21_10);
        await qx.tool.utils.Json.saveJsonAsync(this.getDbFilename(), this.__db__P_21_10).then(() => this.__resManager__P_21_9 && this.__resManager__P_21_9.saveDatabase());
      },
      ...
      async analyseClasses() {
        ...
        await qx.tool.utils.Promisify.map(this.__libraries__P_21_1, async library => qx.tool.utils.Promisify.call(cb => library.scanForClasses(cb)));

        var classes = t.__classes__P_21_11 = t.__initialClassesToScan__P_21_3.toArray();

        function getConstructDependencies(className) {
          var deps = [];
          var info = t.__db__P_21_10.classInfo[className];
      ...
      _addRequiredClass(className) {
        ...
        if (!t.__classes__P_21_11) {
          t.__classes__P_21_11 = [];
        } // Add it


        if (t.__classes__P_21_11.indexOf(className) == -1) {
          t.__classes__P_21_11.push(className);
        }
      },
       ...
       */
      getDependentClasses() {
        return this.__classes__P_21_11;
      },
      ...
      getCachedClassInfo(className) {
        return this.__db__P_21_10 ? this.__db__P_21_10.classInfo[className] : null;
      },
      ...
      async getCldr(locale) {
        var t = this;
        var cldr = this.__cldrs__P_21_4[locale];

        if (cldr) {
          return cldr;
        }

        return qx.tool.compiler.app.Cldr.loadCLDR(locale).then(cldr => t.__cldrs__P_21_4[locale] = cldr);
      },
      ...
      async getTranslation(library, locale) {
        ...
        var translation = t.__translations__P_21_5[id];

        if (!translation) {
          translation = t.__translations__P_21_5[id] = new qx.tool.compiler.app.Translation(library, locale);
      ...
      async updateTranslations(appLibrary, locales, libraries, copyAllMsgs) {
        ...
        await qx.Promise.all(locales.map(async locale => {
          ...
          await qx.Promise.all(this.__classes__P_21_11.map(async classname => {
       ...
       */
      findLibrary(name) {
        var lib = this.__librariesByNamespace__P_21_2[name];
        return lib;
      },
       ...
       */
      getLibraries() {
        return this.__libraries__P_21_1;
      },
       ...
       */
      addLibrary(library) {
        this.__libraries__P_21_1.push(library);

        this.__librariesByNamespace__P_21_2[library.getNamespace()] = library;
      },
       ...
       */
      addClass(classname) {
        this.__initialClassesToScan__P_21_3.push(classname);
      },
      ...
      removeClass(classname) {
        this.__initialClassesToScan__P_21_3.remove(classname);
      },
      ...
      getSymbolType(name) {
        ...
        for (var j = 0; j < t.__libraries__P_21_1.length; j++) {
          var library = t.__libraries__P_21_1[j];
      ...
      getLibraryFromClassname(className) {
        var t = this;
        var info = this.__classFiles__P_21_6[className];
      ...
      setEnvironmentCheck(key, value) {
        if (typeof key == "object") {
          ...
          for (key in map) {
            this.__environmentChecks__P_21_7[key] = map[key];
          }
        } else if (value === undefined) {
          delete this.__environmentChecks__P_21_7[key];
        } else {
          this.__environmentChecks__P_21_7[key] = value;
        }
      },
      ...
      getEnvironmentCheck(key) {
        return this.__environmentChecks__P_21_7[key];
      },
       ...
       */
      getResourceManager() {
        return this.__resManager__P_21_9;
      },
       ...
       */
      getQooxdooVersion() {
        if (this.__qooxdooVersion__P_21_13) {
          return this.__qooxdooVersion__P_21_13;
        }
        ...
        if (!this.__qooxdooVersion__P_21_13) {
          ...
          if (lib) {
            this.__qooxdooVersion__P_21_13 = lib.getVersion();
          }
        }
       ...
       */
      getDbFilename() {
        return this.__dbFilename__P_21_0;
      },
       ...
       */
      getResDbFilename() {
        var m = this.__dbFilename__P_21_0.match(/(^.*)\/([^/]+)$/);
      ...
      _applyEnvironment(value) {
        ...
        this.__environmentHash__P_21_14 = hash(value);
      },
      ...
      isContextChanged() {
        ...
        if (this.__environmentHash__P_21_14 && this.__environmentHash__P_21_14 !== db.environmentHash) {
          return true;
      ...
      updateEnvironmentData() {
        ...
        db.environmentHash = this.__environmentHash__P_21_14;
