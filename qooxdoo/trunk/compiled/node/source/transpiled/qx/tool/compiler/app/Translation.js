(function () {
  ...
  qx.Class.define("qx.tool.compiler.app.Translation", {
    ...
    construct(library, locale) {
      ...
      this.__translations__P_28_0 = {};
      this.__headers__P_28_1 = {};
    },
    ...
    members: {
      __translations__P_28_0: null,
      __headers__P_28_1: null,
      __mtime__P_28_2: 0,
      __onRead__P_28_3: null,
      ...
      async checkRead() {
        ...
        if (stat && this.__mtime__P_28_2 == stat.mtime) {
          return undefined;
        }
      ...
      read() {
        ...
        if (t.__onRead__P_28_3) {
          return t.__onRead__P_28_3;
        }

        return t.__onRead__P_28_3 = new Promise((resolve, reject) => {
          t.__translations__P_28_0 = {};
          t.__headers__P_28_1 = {};
          var poFile = this.getPoFilename();
            ...
            return readFile(poFile, {
              ...
              function saveEntry() {
                if (entry) {
                  ...
                  t.__translations__P_28_0[key] = entry;
                }
      ...
      writeTo(filename, cb) {
        ...
        for (var msgid in t.__translations__P_28_0) {
          var entry = t.__translations__P_28_0[msgid];
       ...
       */
      getEntry(id) {
        return this.__translations__P_28_0[id] || null;
      },
       ...
       */
      deleteEntry(id) {
        let entry = this.__translations__P_28_0[id] || null;
        delete this.__translations__P_28_0[id];
        return entry;
      },
      ...
      getOrCreateEntry(id) {
        var t = this;
        var entry = t.__translations__P_28_0[id];

        if (!entry) {
          entry = t.__translations__P_28_0[id] = {
            msgid: id
          };
        }
       ...
       */
      getEntries() {
        return this.__translations__P_28_0;
      },
