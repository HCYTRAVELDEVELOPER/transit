(function () {
  ...
  qx.Class.define("qx.tool.compiler.app.Library", {
    ...
    construct() {
      ...
      this.__knownSymbols__P_27_0 = {};
      this.__sourceFileExtensions__P_27_1 = {};
      this.__environmentChecks__P_27_2 = {};
    },
    ...
    members: {
      __knownSymbols__P_27_0: null,
      __sourceFileExtensions__P_27_1: null,
      __promiseLoadManifest__P_27_3: null,
      __environmentChecks__P_27_2: null,
      ...
      loadManifest(loadFromDir) {
        if (this.__promiseLoadManifest__P_27_3) {
          return this.__promiseLoadManifest__P_27_3;
        }

        return this.__promiseLoadManifest__P_27_3 = this.__loadManifestImpl__P_27_4(loadFromDir);
      },

      async __loadManifestImpl__P_27_4(loadFromDir) {
        ...
        if (data.provides.environmentChecks) {
          for (var key in data.provides.environmentChecks) {
            ...
            if (pos > -1) {
              this.__environmentChecks__P_27_2[key] = {
            ...
            async.each(filenames, function (filename, cb) {
              ...
              fs.stat(path.join(folder, filename), function (err, stat) {
                ...
                if (extension == ".js" || extension == ".ts") {
                  t.__knownSymbols__P_27_0[className] = "class";
                  t.__sourceFileExtensions__P_27_1[className] = extension;
                  classes.push(className);
                } else {
                  t.__knownSymbols__P_27_0[filename] = "resource";
                }

                if (Boolean(packageName) && !t.__knownSymbols__P_27_0[packageName]) {
                  t.__knownSymbols__P_27_0[packageName] = "package";
                  var pos;
                  tmp = packageName;

                  while ((pos = tmp.lastIndexOf(".")) > -1) {
                    tmp = tmp.substring(0, pos);
                    t.__knownSymbols__P_27_0[tmp] = "package";
                  }
                }
      ...
      getSymbolType(name) {
        ...
        var t = this;
        var type = this.__knownSymbols__P_27_0[name];

        if (type) {
          return {
            symbolType: t.__knownSymbols__P_27_0[name],
        ...
        let result = testEnvironment(this.__environmentChecks__P_27_2[name]);

        if (result) {
          return result;
        }

        for (let key in this.__environmentChecks__P_27_2) {
          let check = this.__environmentChecks__P_27_2[key];
        ...
        while ((pos = tmp.lastIndexOf(".")) > -1) {
          tmp = tmp.substring(0, pos);
          type = this.__knownSymbols__P_27_0[tmp];
       ...
       */
      isClass(classname) {
        var type = this.__knownSymbols__P_27_0[classname];
        return type === "class";
      },
       ...
       */
      getKnownSymbols() {
        return this.__knownSymbols__P_27_0;
      },
      ...
      getSourceFileExtension(className) {
        return this.__sourceFileExtensions__P_27_1[className];
      },
