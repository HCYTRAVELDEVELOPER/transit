  ...
  qx.Class.define("qx.tool.compiler.targets.meta.PolyfillJs", {
    ...
    members: {
      ...
      async writeSourceCodeToStream(ws) {
        await this.__write__P_48_0(path.join(require.resolve("core-js-bundle"), "../minified.js"), ws);
        await new Promise(resolve => {
          ws.write("\n", resolve);
        });
        await this.__write__P_48_0(path.join(require.resolve("regenerator-runtime"), "../runtime.js"), ws);
      },

      async __write__P_48_0(srcFilename, ws) {
