  ...
  qx.Class.define("qx.tool.compiler.targets.Target", {
    ...
    members: {
      ...
      addPathMapping(fromFile, toUri) {
        ...
        if (this.__pathMappings__P_39_0 === null) {
          this.__pathMappings__P_39_0 = {};
        }

        this.__pathMappings__P_39_0[fromFile] = toUri;
      },
      ...
      getPathMapping(filename) {
        if (this.__pathMappings__P_39_0) {
          var absFilename = path.resolve(filename); // Search

          for (var fromFile in this.__pathMappings__P_39_0) {
            if (absFilename.startsWith(fromFile)) {
              var toUri = this.__pathMappings__P_39_0[fromFile];
      ...
      async generateApplication(application, environment) {
        ...
        let appMeta = this.__appMeta__P_39_1 = new qx.tool.compiler.targets.meta.ApplicationMeta(this, application);
