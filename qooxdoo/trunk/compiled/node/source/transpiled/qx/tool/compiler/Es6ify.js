  ...
  qx.Class.define("qx.tool.compiler.Es6ify", {
    ...
    members: {
      ...
      async transform() {
        ...
        let plugins = [require("@babel/plugin-syntax-jsx"), this.__pluginFunctionExpressions__P_24_0()];

        if (this.getArrowFunctions() != "never") {
          plugins.push(this.__pluginArrowFunctions__P_24_1());
        }

        plugins.push(this.__pluginRemoveUnnecessaryThis__P_24_2());
        plugins.push(this.__pluginSwitchToSuper__P_24_3());
        var config = {
          ast: true,
          babelrc: false,
        ...
        let prettierConfig = (await prettier.resolveConfig(this.__filename, {
          editorConfig: true
        })) || {};
       ...
       * @returns
       */
      __pluginFunctionExpressions__P_24_0() {
        return {
          visitor: {
            ObjectExpression(path) {
              ...
              for (let i = 0; i < path.node.properties.length; i++) {
                ...
                if (propNode.type == "ObjectProperty" && propNode.value.type == "FunctionExpression" && KEY_TYPES[propNode.key.type]) {
                  let replacement = types.objectMethod("method", propNode.key, propNode.value.params, propNode.value.body, propNode.value.computed, propNode.value.generator, propNode.value.async);
      ...
      __toArrowExpression__P_24_4(argNode) {
       ...
       * @returns
       */
      __pluginArrowFunctions__P_24_1() {
        let t = this;
            ...
            CallExpression(path) {
              ...
              for (let i = 0; i < path.node.arguments.length; i++) {
                ...
                if (argNode.type == "FunctionExpression") {
                  path.node.arguments[i] = t.__toArrowExpression__P_24_4(argNode);
                }
              }
            }
       ...
       * @returns
       */
      __pluginRemoveUnnecessaryThis__P_24_2() {
        return {
          visitor: {
            CallExpression(path) {
...
//# sourceMappingURL=Es6ify.js.map