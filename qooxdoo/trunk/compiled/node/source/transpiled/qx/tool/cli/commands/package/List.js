  ...
  qx.Class.define("qx.tool.cli.commands.package.List", {
    ...
    members: {
      ...
      async process() {
        ...
        this.__repositories__P_17_0 = [];
        this.__libraries__P_17_1 = {};
        this.__latestCompatible__P_17_2 = {};
        ...
        let num_compat_repos = await this.__createIndexes__P_17_3(qxVersion);
        ...
        if (repo) {
          ...
          if (this.__libraries__P_17_1[repo] && this.__libraries__P_17_1[repo].length) {
            ...
            if (!this.argv.quiet) {
              let data = this.__libraries__P_17_1[repo] // shallow copy
        ...
        let list = this.argv.all ? this.__repositories__P_17_0 : this.__repositories__P_17_0.filter(item => item.latestCompatible || this.argv.installed && item.name === localPathRepoName); // sort
        ...
        for (let repo of list) {
          ...
          if (!qx.lang.Type.isArray(this.__libraries__P_17_1[repo.name])) {
            continue;
          }

          for (let library of this.__libraries__P_17_1[repo.name]) {
        ...
        this.getCache().compat[qxVersion] = this.__latestCompatible__P_17_2[qxVersion];
       ...
       */
      __repositories__P_17_0: null,
      __libraries__P_17_1: null,
      __latestCompatible__P_17_2: null,
       ...
       */
      async __createIndexes__P_17_3(qooxdoo_version) {
        if (this.argv.installed) {
          // local libraries
          const localPathRepoName = qx.tool.cli.commands.package.List.localPathRepoName;

          this.__repositories__P_17_0.push({
            name: localPathRepoName,
            description: "Libraries on local filesystem"
          });

          this.__libraries__P_17_1[localPathRepoName] = [];
          ...
          for (let lib of libData.libraries) {
            if (!lib.repo_name) {
              ...
              this.__libraries__P_17_1[localPathRepoName].push({
                name: info.name,
        ...
        if (this.__latestCompatible__P_17_2[qooxdoo_version] === undefined) {
          this.__latestCompatible__P_17_2[qooxdoo_version] = {};
        ...
        for (let repo_name of repos_cache.list) {
          ...
          for (let tag_name of tag_names) {
            ...
            for (let manifest of manifests) {
              ...
              if (this.__libraries__P_17_1[repo_name] === undefined) {
                this.__libraries__P_17_1[repo_name] = [];
              ...
              let latestCompatibleRelease = this.__latestCompatible__P_17_2[qooxdoo_version][repo_name];
              ...
              if (compatibility === true && (latestCompatibleRelease === undefined || semver.gt(tag_version, latestCompatibleVersion, false) && (!prerelease || this.argv.prereleases))) {
                this.__latestCompatible__P_17_2[qooxdoo_version][repo_name] = tag_name;
                hasCompatibleRelease = true;
              } // save data


              this.__libraries__P_17_1[repo_name].push({
                name: info.name,
          ...
          this.__repositories__P_17_0.push({
            ...
            latestVersion,
            latestCompatible: hasCompatibleRelease ? this.__latestCompatible__P_17_2[qooxdoo_version][repo_name] : false
          });
        }
