  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.tool.cli.Watch", {
    ...
    construct(maker) {
      ...
      this.__maker__P_5_0 = maker;
      this.__stats__P_5_1 = {
        classesCompiled: 0
      };
      this.__debounceChanges__P_5_2 = {};
      this.__configFilenames__P_5_3 = [];
      this.__runWhenWatching__P_5_4 = {};
    ...
    members: {
      __runningPromise__P_5_5: null,
      __applications__P_5_6: null,
      __watcherReady__P_5_7: false,
      __maker__P_5_0: null,
      __stats__P_5_1: null,
      __making__P_5_8: null,
      __stopping__P_5_9: false,
      __outOfDate__P_5_10: null,
      __makeTimerId__P_5_11: null,
      __debounceChanges__P_5_2: null,
      __configFilenames__P_5_3: null,
      __madeApplications__P_5_12: null,

      /** @type{Map<String,Object>} list of runWhenWatching configurations, indexed by app name */
      __runWhenWatching__P_5_4: null,

      async setConfigFilenames(arr) {
        if (!arr) {
          this.__configFilenames__P_5_3 = [];
        } else {
          this.__configFilenames__P_5_3 = arr.map(filename => path.resolve(filename));
        }
      },

      setRunWhenWatching(appName, config) {
        this.__runWhenWatching__P_5_4[appName] = config;
      ...
      async _onWrittenApplication(evt) {
        ...
        let config = this.__runWhenWatching__P_5_4[name];
      ...
      start() {
        ...
        if (this.__runningPromise__P_5_5) {
          throw new Error("Cannot start watching more than once");
        }

        this.__runningPromise__P_5_5 = qx.tool.utils.Utils.newExternalPromise();
        var dirs = [];

        var analyser = this.__maker__P_5_0.getAnalyser();

        analyser.addListener("compiledClass", function () {
          this.__stats__P_5_1.classesCompiled++;
        }, this);
        ...
        var applications = this.__applications__P_5_6 = [];

        this.__maker__P_5_0.getApplications().forEach(function (application) {
          var data = {
        ...
        Promise.all(dirs.map(dir => new Promise((resolve, reject) => {
          ...
          watcher.on("change", filename => this.__onFileChange__P_5_13("change", filename));
          watcher.on("add", filename => this.__onFileChange__P_5_13("add", filename));
          watcher.on("unlink", filename => this.__onFileChange__P_5_13("unlink", filename));
          watcher.on("ready", () => {
            this.__watcherReady__P_5_7 = true;
      ...
      async stop() {
        this.__stopping__P_5_9 = true;

        this._watcher.close();

        if (this.__making__P_5_8) {
          await this.__making__P_5_8;
        }
      },

      __make__P_5_14() {
        if (this.__making__P_5_8) {
          this.__makeNeedsRestart__P_5_15 = true;
          return this.__making__P_5_8;
        }
        ...
        function make() {
          ...
          t.__madeApplications__P_5_12 = null;
          var startTime = new Date().getTime();
          t.__stats__P_5_1.classesCompiled = 0;
          t.__outOfDate__P_5_10 = false;
          return t.__maker__P_5_0.make().then(() => {
            if (t.__stopping__P_5_9) {
              Console.print("qx.tool.cli.watch.makeStopping");
              return null;
            }

            if (t.__outOfDate__P_5_10) {
            ...
            var analyser = t.__maker__P_5_0.getAnalyser();

            var db = analyser.getDatabase();
            var promises = [];

            t.__applications__P_5_6.forEach(data => {
              data.dependsOn = {};
            ...
            return Promise.all(promises).then(() => {
              ...
              Console.print("qx.tool.cli.watch.compiledClasses", t.__stats__P_5_1.classesCompiled, qx.tool.utils.Utils.formatTime(endTime - startTime));
              t.fireEvent("made");
            });
          }).then(() => {
            t.__making__P_5_8 = null;
          }).catch(err => {
        ...
        const runIt = () => make().then(() => {
          if (this.__makeNeedsRestart__P_5_15) {
            delete this.__makeNeedsRestart__P_5_15;
            return runIt();
          }
        ...
        return this.__making__P_5_8 = runIt();
      },

      __scheduleMake__P_5_16() {
        if (this.__making__P_5_8) {
          this.__makeNeedsRestart__P_5_15 = true;
          return this.__making__P_5_8;
        }

        if (this.__makeTimerId__P_5_11) {
          clearTimeout(this.__makeTimerId__P_5_11);
        }

        this.__makeTimerId__P_5_11 = setTimeout(() => this.__make__P_5_14());
        return null;
      },

      __onFileChange__P_5_13(type, filename) {
        const Console = qx.tool.compiler.Console;

        if (!this.__watcherReady__P_5_7) {
          return null;
        }
        ...
        const handleFileChange = async () => {
          ...
          if (this.__configFilenames__P_5_3.find(str => str == filename)) {
            if (this.isDebug()) {
          ...
          this.__applications__P_5_6.forEach(data => {
          ...
          let analyser = this.__maker__P_5_0.getAnalyser();
          ...
          if (isResource) {
            ...
            let target = this.__maker__P_5_0.getTarget();
          ...
          if (outOfDate) {
            this.__outOfDate__P_5_10 = true;

            this.__scheduleMake__P_5_16();
          }
        };
        ...
        let dbc = this.__debounceChanges__P_5_2[filename];

        if (!dbc) {
          dbc = this.__debounceChanges__P_5_2[filename] = {
            types: {}
          };
        }
        ...
        dbc.timerId = setTimeout(() => {
          dbc.promise = runIt(dbc).then(() => delete this.__debounceChanges__P_5_2[filename]);
        }, 150);
        return null;
      },

      __onStop__P_5_17() {
        this.__runningPromise__P_5_5.resolve();
      }
