    ...
    members: {
      ...
      async load(data = undefined) {
        ...
        if (this.isValidate() && this.getVersion() !== null) {
          ...
          let schemaVersion = semver.major(semver.coerce(this.getVersion())); // use version given in the config file, but warn if we expect a different one
          ...
          if (!this.__schema__P_50_0) {
            ...
            this.__schema__P_50_0 = await qx.tool.utils.Json.loadJsonAsync(s);
          }
        } // validate and save
