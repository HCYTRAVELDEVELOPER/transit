  ...
  qx.Class.define("qx.tool.cli.commands.Package", {
    ...
    members: {
      ...
      getCache(readFromFile = false) {
        if (!readFromFile && this.__cache__P_12_0 && typeof this.__cache__P_12_0 == "object") {
          return this.__cache__P_12_0;
        }

        try {
          this.__cache__P_12_0 = JSON.parse(fs.readFileSync(this.getCachePath(), "UTF-8"));
        } catch (e) {
          this.__cache__P_12_0 = {
            repos: {
              list: [],
              data: {}
            },
      ...
      async saveCache() {
        ...
        await fs.writeFileAsync(this.getCachePath(), JSON.stringify(this.__cache__P_12_0, null, 2), "UTF-8");
      },
      ...
      async exportCache(path) {
        try {
          let cache = this.__cache__P_12_0 || this.getCache(true);
