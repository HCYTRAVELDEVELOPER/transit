(function () {
  ...
  qx.Class.define("qx.tool.utils.json.Tokenizer", {
    ...
    statics: {
      tokenTypes: __tokenTypes__P_57_0,
      punctuatorTokensMap: {
        // Lexeme: Token
        "{": __tokenTypes__P_57_0.LEFT_BRACE,
        "}": __tokenTypes__P_57_0.RIGHT_BRACE,
        "[": __tokenTypes__P_57_0.LEFT_BRACKET,
        "]": __tokenTypes__P_57_0.RIGHT_BRACKET,
        ":": __tokenTypes__P_57_0.COLON,
        ",": __tokenTypes__P_57_0.COMMA
      },
      keywordTokensMap: {
        // Lexeme: Token config
        true: {
          type: __tokenTypes__P_57_0.TRUE,
          value: true
        },
        false: {
          type: __tokenTypes__P_57_0.FALSE,
          value: false
        },
        null: {
          type: __tokenTypes__P_57_0.NULL,
          value: null
        }
      },
      stringStates: {
