(function () {
  ...
  qx.Class.define("qx.tool.compiler.targets.meta.ApplicationMeta", {
    ...
    construct(target, application) {
      ...
      this.__target__P_42_0 = target;
      this.__application__P_42_1 = application;
      this.__libraries__P_42_2 = [];
      this.__preload__P_42_3 = {
        urisBefore: [],
        cssBefore: []
      };
      this.__preBootCode__P_42_4 = [];
      this.__resources__P_42_5 = {};
      this.__packages__P_42_6 = [];
      this.__parts__P_42_7 = [];
      this.__partsLookup__P_42_8 = {};
    },
    ...
    members: {
       ...
       */
      getApplication() {
        return this.__application__P_42_1;
      },
       ...
       */
      getApplicationRoot() {
        return this.__target__P_42_0.getApplicationRoot(this.__application__P_42_1);
      },
       ...
       */
      getAnalyser() {
        return this.__application__P_42_1.getAnalyser();
      },
       ...
       */
      async syncAssets() {
        for (let i = 0; i < this.__packages__P_42_6.length; i++) {
          let pkg = this.__packages__P_42_6[i];
          await qx.tool.utils.Promisify.poolEachOf(pkg.getAssets(), 10, asset => asset.sync(this.__target__P_42_0));
        }
      },
       ...
       */
      addLibrary(library) {
        this.__libraries__P_42_2.push(library);
      },
       ...
       */
      getAppLibrary() {
        let appLibrary = this.__application__P_42_1.getAnalyser().getLibraryFromClassname(this.__application__P_42_1.getClassName());
       ...
       */
      getLibraries() {
        return this.__libraries__P_42_2;
      },
      ...
      addExternal(type, uri) {
        this.__preload__P_42_3[type].push("__external__:" + uri);
      },
       ...
       */
      addPreload(type, uri) {
        this.__preload__P_42_3[type].push(uri);
      },
       ...
       */
      addPreBootCode(code) {
        this.__preBootCode__P_42_4.push(code);
      },
       ...
       */
      getPreBootCode() {
        return this.__preBootCode__P_42_4.join("\n");
      },
       ...
       */
      createPart(name) {
        let part = new qx.tool.compiler.targets.meta.Part(this.getTarget(), name, this.__parts__P_42_7.length);

        this.__parts__P_42_7.push(part);

        this.__partsLookup__P_42_8[name] = part;
        return part;
      },
       ...
       */
      getPart(name) {
        return this.__partsLookup__P_42_8[name] || null;
      },
       ...
       */
      getPackages() {
        return this.__packages__P_42_6;
      },
       ...
       */
      createPackage() {
        let pkg = new qx.tool.compiler.targets.meta.Package(this, this.__packages__P_42_6.length);

        this.__packages__P_42_6.push(pkg);
      ...
      addResource(key, path) {
        this.__resources__P_42_5[key] = path;
      },
       ...
       */
      getResources() {
        return this.__resources__P_42_5;
      }
