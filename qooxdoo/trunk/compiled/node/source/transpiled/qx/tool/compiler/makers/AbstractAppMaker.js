  ...
  qx.Class.define("qx.tool.compiler.makers.AbstractAppMaker", {
    ...
    properties: {
      ...
      writeAllTranslations: {
        ...
        nullable: false,
        check: "Boolean",
        apply: "__applyWriteAllTranslations__P_31_1"
      }
    },
    members: {
      /*
       ...
       * @private
       */
      __applyTarget__P_31_0(value, oldValue) {
        if (this._analyser) {
       ...
       * @private
       */
      __applyWriteAllTranslations__P_31_1(value, oldValue) {
        if (this.getTarget()) {
...
//# sourceMappingURL=AbstractAppMaker.js.map