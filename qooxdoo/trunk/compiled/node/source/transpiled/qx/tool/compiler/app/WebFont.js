(function () {
  ...
  qx.Class.define("qx.tool.compiler.app.WebFont", {
    ...
    construct(library) {
      ...
      this.__library__P_29_0 = library;
    },
    ...
    members: {
      __library__P_29_0: null,
      __fontData__P_29_1: null,
      ...
      _loadLocalFont(filename) {
        return new Promise((resolve, reject) => {
          let fontpath = path.join(this.__library__P_29_0.getRootDir(), path.join(this.__library__P_29_0.getResourcePath(), filename));

          this.__processFontFile__P_29_2(fontpath, resolve, reject);
        });
      },
          ...
          http.get(url, function (res) {
            ...
            tmp.tmpName(function _tempNameGenerated(err, tmpFilename) {
              ...
              outFile.on("close", function () {
                this.__processFontFile__P_29_2(tmpFilename, resolve, reject);
       ...
       */
      __processFontFile__P_29_2(filename, resolve, reject) {
        fontkit.open(filename, null, function (err, font) {
          ...
          let resources = {}; // If we have a mapping file, take qx.tool.compiler.Console.information instead
          // of anaylzing the font.

          if (this.getMapping()) {
            let mapPath = path.join(this.__library__P_29_0.getRootDir(), path.join(this.__library__P_29_0.getResourcePath(), this.getMapping()));
            fs.readFile(mapPath, {
              encoding: "utf-8"
            }, (err, data) => {
              if (err) {
      ...
      generateForTarget(target) {
        if (this.__generateForTargetPromise__P_29_3) {
          return this.__generateForTargetPromise__P_29_3;
        }

        this.__generateForTargetPromise__P_29_3 = new Promise((resolve, reject) => {
      ...
      async generateForApplication(target, application) {
        return this.__fontData__P_29_1 || null;
      },
