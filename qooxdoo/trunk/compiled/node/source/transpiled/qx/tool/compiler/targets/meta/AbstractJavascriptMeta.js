(function () {
  ...
  qx.Class.define("qx.tool.compiler.targets.meta.AbstractJavascriptMeta", {
    ...
    construct(appMeta, filename, originalSourceFile) {
      ...
      this.__originalSourceFile__P_41_0 = originalSourceFile;
    },
    ...
    members: {
      _appMeta: null,
      __filename: null,
      __originalSourceFile__P_41_0: null,
      __wrapper__P_41_1: null,
      ...
      wrap(jsMeta) {
        this.__wrapper__P_41_1 = jsMeta;
      },

      getWrapper() {
        return this.__wrapper__P_41_1;
      },

      unwrap() {
        if (this.__wrapper__P_41_1) {
          return this.__wrapper__P_41_1.unwrap();
        }
...
//# sourceMappingURL=AbstractJavascriptMeta.js.map