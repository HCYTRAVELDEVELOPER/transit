  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.tool.cli.commands.Serve", {
    ...
    members: {
       ...
       */
      showStartpage() {
        return this.__showStartpage__P_14_0;
      },
      ...
      async runWebServer() {
        ...
        this.__showStartpage__P_14_0 = this.argv.showStartpage;

        if (this.__showStartpage__P_14_0 === undefined || this.__showStartpage__P_14_0 === null) {
          this.__showStartpage__P_14_0 = defaultMaker === null;
        }
        ...
        if (!this.__showStartpage__P_14_0) {
