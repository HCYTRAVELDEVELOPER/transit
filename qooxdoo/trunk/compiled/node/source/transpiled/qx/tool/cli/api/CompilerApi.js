(function () {
  ...
  qx.Class.define("qx.tool.cli.api.CompilerApi", {
    ...
    members: {
       ...
       */
      async afterProcessFinished(cmd, res) {// Nothing
      },
      ...
      addLibraryApi(libraryApi) {
        ...
        this.__libraryApis__P_6_0[dir] = libraryApi;
      },
       ...
       */
      getLibraryApis() {
        return Object.values(this.__libraryApis__P_6_0);
      }
