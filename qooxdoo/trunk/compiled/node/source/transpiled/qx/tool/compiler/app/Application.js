(function () {
  ...
  qx.Class.define("qx.tool.compiler.app.Application", {
    ...
    construct(classname) {
      ...
      var t = this;
      this.__classes__P_26_0 = [];
      args.forEach(function (arg) {
        if (qx.lang.Type.isArray(arg)) {
          qx.lang.Array.append(t.__classes__P_26_0, arg);
        } else {
          t.__classes__P_26_0.push(arg);
        }
      });
      this.set({
        include: [],
    ...
    properties: {
      ...
      include: {
        nullable: false,
        check: "Array",
        transform: "__transformArray__P_26_1"
      },
    ...
    members: {
      __loadDeps__P_26_2: null,
      __parts__P_26_3: null,
      __requiredLibs__P_26_4: null,
      __fatalCompileErrors__P_26_5: null,
      __classes__P_26_0: null,
      __partsDeps__P_26_6: null,
      ...
      calcDependencies() {
        ...
        this.__loadDeps__P_26_2 = null;
        var partsByName = {};
        var parts = [];
        var bootPart = null;
        var classDataByClassname = {};

        if (this.__parts__P_26_3 && this.__parts__P_26_3.length) {
          parts = [];

          t.__parts__P_26_3.forEach(part => {
        ...
        t.__expandClassnames__P_26_7(t.getExclude()).forEach(name => exclude[name] = true); // Start the ball rolling
        ...
        */
        ...
        this.__loadDeps__P_26_2 = allDeps.toArray();
        var requiredLibs = {};

        this.__loadDeps__P_26_2.forEach(classname => {
        ...
        this.__requiredLibs__P_26_4 = [];

        for (let ns in requiredLibs) {
          if (analyser.findLibrary(ns)) {
            this.__requiredLibs__P_26_4.push(ns);
          } else {
            Console.print("qx.tool.compiler.application.missingRequiredLibrary", ns);
          }
        }

        this.__partsDeps__P_26_6 = parts;
        this.__fatalCompileErrors__P_26_5 = fatalCompileErrors.length ? fatalCompileErrors : null;
      },
      ...
      getFatalCompileErrors() {
        return this.__fatalCompileErrors__P_26_5;
      },
      ...
      getUris() {
        ...
        this.__loadDeps__P_26_2.forEach(add);
       ...
       */
      getDependencies() {
        return this.__loadDeps__P_26_2;
      },
      ...
      getPartsDependencies() {
        return this.__partsDeps__P_26_6;
      },
      ...
      getRequiredLibraries() {
        return this.__requiredLibs__P_26_4;
      },
      ...
      getAssetUris(target, resManager, environment) {
        ...
        var classNames = this.__loadDeps__P_26_2.slice();
       ...
       */
      getClassName() {
        return this.__classes__P_26_0[0];
      },
      ...
      getRequiredClasses() {
        ...
        this.__classes__P_26_0.forEach(name => result[name] = true);

        this.__expandClassnames__P_26_7(this.getInclude()).forEach(name => result[name] = true);

        this.__expandClassnames__P_26_7(this.getExclude()).forEach(name => delete result[name]); // We sort the result so that we can get a consistent ordering for loading classes, otherwise the order in
       ...
       */
      addPart(part) {
        if (!this.__parts__P_26_3) {
          this.__parts__P_26_3 = [];
        }

        this.__parts__P_26_3.push(part);
      },
       ...
       * @return String[]
       */
      __expandClassnames__P_26_7(names) {
        var t = this;
        var result = {};
       ...
       */
      __transformArray__P_26_1(value) {
        if (!value) {
          return null;
        }
