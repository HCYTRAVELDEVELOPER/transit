  ...
  qx.Class.define("qx.tool.compiler.targets.meta.Uglify", {
    ...
    members: {
      ...
      async writeSourceCodeToStream(ws) {
        ...
        var outJsFilename = this.__jsMeta__P_49_0.getFilename();
        ...
        let inSourceCode = await (async () => {
          ...
          await new Promise(async resolve => {
            ...
            await this.__jsMeta__P_49_0.writeSourceCodeToStream(ws);
            ws.end();
          });
          return ss.toString();
        })();
        let inSourceMap = await this.__jsMeta__P_49_0.getSourceMap();
