(function () {
  ...
  qx.Class.define("qx.tool.utils.json.Writer", {
    ...
    construct() {
      ...
      this.buffer = "";
      this.__indent__P_58_0 = 0;
      this.__indentStr__P_58_1 = "";
      this.__currentLine__P_58_2 = 0;
    },
    ...
    members: {
      ...
      write(str) {
        ...
        while (true) {
          ...
          if (pos > -1) {
            ...
            this.__currentLine__P_58_2 = this.buffer.length;
            this.buffer += this.__indentStr__P_58_1;
            startPos = pos + 1;
          } else {
       ...
       */
      indent(count) {
        if (this.__indent__P_58_0 + count < 0) {
          throw new Error("Unbalanced indent");
        }

        this.__indent__P_58_0 += count;
        var indentStr = this.__indentStr__P_58_1;
        ...
        var line = this.buffer.substring(this.__currentLine__P_58_2);

        if (!line.match(/[^\s]/)) {
          this.buffer = this.buffer.substring(0, this.__currentLine__P_58_2) + indentStr;
        }

        this.__indentStr__P_58_1 = indentStr;
        return this;
      },
      ...
      matchIndent() {
        ...
        var m = line.match(/^([\s]*)/);
        var indent = m[0];
        var oldIndent = this.__indentStr__P_58_1;
        this.__indentStr__P_58_1 = indent;
        return oldIndent;
      },
