  ...
  qx.Class.define("qx.tool.utils.Utils", {
    ...
    defer(statics) {
      ...
      class LineCountingTransform extends Transform {
        ...
        getLineNumber() {
          return this.__lineNumber__P_54_0;
        }
      ...
      class StripSourceMapTransform extends Transform {
        constructor(options) {
          super(options);
          this.__lastLine__P_54_1 = "";
        }

        _transform(chunk, encoding, callback) {
          let str = this.__lastLine__P_54_1 + chunk.toString();
          let pos = str.lastIndexOf("\n");

          if (pos > -1) {
            this.__lastLine__P_54_1 = str.substring(pos);
            str = str.substring(0, pos);
          } else {
            this.__lastLine__P_54_1 = str;
            str = "";
          }
        ...
        _flush(callback) {
          let str = this.__lastLine__P_54_1;
          this.__lastLine__P_54_1 = null;
          str = str.replace(/\n\/\/\#\s*sourceMappingURL=.*$/m, "");
          this.push(str);
          callback();
        }
      ...
      class ToStringWriteStream extends Writable {
        constructor(dest, options) {
          super(options);
          this.__dest__P_54_2 = dest;
          this.__value__P_54_3 = "";
        }

        _write(chunk, encoding, callback) {
          this.__value__P_54_3 += chunk.toString();

          if (this.__dest__P_54_2) {
            this.__dest__P_54_2.write(chunk, encoding, callback);
          } else if (callback) {
            callback();
          }
        }
