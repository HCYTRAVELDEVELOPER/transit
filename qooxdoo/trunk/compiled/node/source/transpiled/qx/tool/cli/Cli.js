  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.tool.cli.Cli", {
    ...
    construct() {
      ...
      if (qx.tool.cli.Cli.__instance__P_3_0) {
        throw new Error("qx.tool.cli.Cli has already been initialized!");
      }

      qx.tool.cli.Cli.__instance__P_3_0 = this; // include & register log appender
...
`;
      ...
      Type qx <command> --help for options and subcommands.`;
        ...
        let yargs = this.__createYargs__P_3_3().usage(title);
       ...
       */
      async __fullArgv__P_3_5() {
        let yargs = this.__createYargs__P_3_3().help(true).option("set", {
        ...
        await this.__notifyLibraries__P_3_6();
      },
       ...
       * by Yargs
       */
      async __notifyLibraries__P_3_6() {
        if (this.__librariesNotified__P_3_2) {
          return;
        }

        this.__librariesNotified__P_3_2 = true;
       ...
       */
      async getParsedArgs() {
        return await this.__promiseParseArgs__P_3_1;
      },
      ...
      async run() {
        ...
        this.__promiseParseArgs__P_3_1 = this.__parseArgsImpl__P_3_8();
        await this.__promiseParseArgs__P_3_1;
      },

      /**
       * Does the work of parsing command line arguments and loading `compile.js[on]`
       */
      async __parseArgsImpl__P_3_8() {
        await this.__bootstrapArgv__P_3_4();
        /*
        ...
        if (await fs.existsAsync(compileJsFilename)) {
          let compileJs = await this.__loadJs__P_3_9(compileJsFilename);
        ...
        if (config.libraries && needLibraries) {
          ...
          for (const aPath of config.libraries) {
            ...
            if (await fs.existsAsync(libCompileJsFilename)) {
              let compileJs = await this.__loadJs__P_3_9(libCompileJsFilename);
        ...
        await this.__fullArgv__P_3_5();

        this.__notifyCommand__P_3_7();
    ...
    statics: {
      ...
      getInstance() {
        ...
        return qx.tool.cli.Cli.__instance__P_3_0;
      },
