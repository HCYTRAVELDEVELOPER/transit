  ...
  qx.Class.define("qx.core.Init", {
    ...
    */
    defer(statics) {
      ...
      qx.event.Registration.addListener(window, "shutdown", statics.__P_65_1, statics);
      qx.event.Registration.addListener(window, "beforeunload", statics.__P_65_0, statics);
    }
