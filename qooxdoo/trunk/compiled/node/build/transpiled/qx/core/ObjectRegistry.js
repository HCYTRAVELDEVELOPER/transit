  ...
  qx.Bootstrap.define("qx.core.ObjectRegistry", {
    ...
    */
    statics: {
       ...
       */
      createHashCode() {
        var hash = String(this.__P_70_1++ + this.__P_70_2);
        return hash;
      },
      ...
      fromHashCode(hash, suppressWarnings) {
        var obj = this.__P_70_0[hash] || null;
