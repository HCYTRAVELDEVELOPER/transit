  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.core.MEvent", {
    members: {
      ...
      __P_66_0: qx.event.Registration,
      ...
      addListener(type, listener, self, capture) {
        if (!this.$$disposed) {
          return this.__P_66_0.addListener(this, type, listener, self, capture);
        }
      ...
      removeListener(type, listener, self, capture) {
        if (!this.$$disposed) {
          ...
          return this.__P_66_0.removeListener(this, type, listener, self, capture);
        }
      ...
      removeListenerById(id) {
        if (!this.$$disposed) {
          return this.__P_66_0.removeListenerById(this, id);
        }
      ...
      hasListener(type, capture) {
        return this.__P_66_0.hasListener(this, type, capture);
      },
      ...
      dispatchEvent(evt) {
        if (!this.$$disposed) {
          return this.__P_66_0.dispatchEvent(this, evt);
        }
