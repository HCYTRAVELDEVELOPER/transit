  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.core.Property", {
    statics: {
       ...
       */
      __P_71_12(instance, members, name, variant, code, args) {
       ...
       * @return {var} Return value of the generated function
       */
      __P_71_13(clazz, name, variant, code, args) {
       ...
       * @param name {String} name of the property
       */
      __P_71_17(code, clazz, config, name) {
        code.push("var equ=");
       ...
       */
      __P_71_18(code, config, name, variant, incomingValue) {
        {
       ...
       * @param name {String} name of the property
       */
      __P_71_20(code, clazz, config, name) {
       ...
       * @param variant {String} Method variant.
       */
      __P_71_21(code, incomingValue, store, variant) {
       ...
       * @param variant {String} Method variant.
       */
      __P_71_27: qx.core.Environment.select("qx.debug", {
        true(code, config, clazz, name, variant) {
          ...
          if (config.check !== undefined) {
            ...
            if (this.__P_71_1[config.check] !== undefined) {
              code.push("!(", this.__P_71_1[config.check], ")");
       ...
       * @param incomingValue {Boolean} Whether the setter has an incoming value
       */
      __P_71_22(code, name, variant, incomingValue) {
       ...
       * @param incomingValue {Boolean} Whether the setter has an incoming value
       */
      __P_71_23(code, config, name, variant, incomingValue) {
       ...
       * @param variant {String} Method variant.
       */
      __P_71_24(code, config, name, variant) {
       ...
       * @param variant {String} Method variant.
       */
      __P_71_25(code, config, name, variant) {
       ...
       */
      __P_71_26(code, config, name, variant, refresh) {
