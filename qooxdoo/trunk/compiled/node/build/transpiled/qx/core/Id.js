  ...
  qx.Class.define("qx.core.Id", {
    ...
    members: {
      ...
      getAbsoluteIdOf(obj, suppressWarnings) {
        if (this.__P_64_1 && this.__P_64_1[obj.toHashCode()]) {
        ...
        while (obj) {
          ...
          if (owner) {
            ...
            if (owner === application) {
              ...
              ownerId = this.__P_64_1 && this.__P_64_1[owner.toHashCode()] || null;
      ...
      register(obj, id) {
        ...
        this.__P_64_0[id] = obj;
        this.__P_64_1[obj.toHashCode()] = id;
      ...
      unregister(data) {
        ...
        if (obj) {
          delete this.__P_64_0[id];
          delete this.__P_64_1[obj.toHashCode()];
