  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.lang.String", {
    statics: {
       ...
       */
      camelCase(str) {
        var result = this.__P_111_2[str];

        if (!result) {
          result = str.replace(/\-([a-z])/g, function (match, chr) {
            return chr.toUpperCase();
          });
          this.__P_111_2[str] = result;
        }
       ...
       */
      hyphenate(str) {
        var result = this.__P_111_3[str];

        if (!result) {
          result = str.replace(/[A-Z]/g, function (match) {
            return "-" + match.charAt(0).toLowerCase();
          });
          this.__P_111_3[str] = result;
        }
       ...
       */
      capitalize(str) {
        if (this.__P_111_1 === null) {
          var unicodeEscapePrefix = "\\u";
          this.__P_111_1 = new RegExp("(^|[^" + this.__P_111_0.replace(/[0-9A-F]{4}/g, function (match) {
            return unicodeEscapePrefix + match;
          }) + "])[" + this.__P_111_0.replace(/[0-9A-F]{4}/g, function (match) {
            return unicodeEscapePrefix + match;
          }) + "]", "g");
        }

        return str.replace(this.__P_111_1, function (match) {
       ...
       */
      isUpperCase(str) {
        return qx.lang.String.__P_111_5.upper.test(str);
      },
       ...
       */
      isLowerCase(str) {
        return qx.lang.String.__P_111_5.lower.test(str);
      },
       ...
       */
      isLetters(str) {
        return qx.lang.String.__P_111_5.letter.test(str);
      },
       ...
       */
      isDigits(str) {
        return qx.lang.String.__P_111_5.digit.test(str);
      },
