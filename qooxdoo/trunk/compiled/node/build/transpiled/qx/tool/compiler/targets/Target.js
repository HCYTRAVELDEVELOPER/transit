  ...
  qx.Class.define("qx.tool.compiler.targets.Target", {
    ...
    members: {
      ...
      addPathMapping(fromFile, toUri) {
        ...
        if (this.__P_39_0 === null) {
          this.__P_39_0 = {};
        }

        this.__P_39_0[fromFile] = toUri;
      },
      ...
      getPathMapping(filename) {
        if (this.__P_39_0) {
          ...
          for (var fromFile in this.__P_39_0) {
            if (absFilename.startsWith(fromFile)) {
              var toUri = this.__P_39_0[fromFile];
      ...
      async generateApplication(application, environment) {
        ...
        let appMeta = this.__P_39_1 = new qx.tool.compiler.targets.meta.ApplicationMeta(this, application);
