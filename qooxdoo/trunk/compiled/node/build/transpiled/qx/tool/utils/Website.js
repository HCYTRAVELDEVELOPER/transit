  ...
  qx.Class.define("qx.tool.utils.Website", {
    ...
    members: {
      ...
      async startWatcher() {
        ...
        this._watcher.on("change", filename => this.__P_55_5("change", filename));

        this._watcher.on("add", filename => this.__P_55_5("add", filename));

        this._watcher.on("unlink", filename => this.__P_55_5("unlink", filename));
      ...
      triggerRebuild(immediate) {
        ...
        if (this.__P_55_2) {
          clearTimeout(this.__P_55_2);
          this.__P_55_2 = null;
        }

        this.__P_55_2 = setTimeout(rebuilder, immediate ? 1 : 250);
      },
