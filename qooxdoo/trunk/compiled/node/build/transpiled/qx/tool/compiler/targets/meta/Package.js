(function () {
  ...
  qx.Class.define("qx.tool.compiler.targets.meta.Package", {
    ...
    construct(appMeta, packageIndex) {
      ...
      this.__P_45_0 = appMeta;
      this.__P_45_1 = packageIndex;
      this.__P_45_2 = [];
      this.__P_45_3 = {};
      this.__P_45_4 = {};
      this.__P_45_5 = [];
      this.__P_45_6 = [];
      this.__P_45_7 = new qx.tool.compiler.targets.meta.PackageJavascript(this.__P_45_0, this);
    },
    ...
    members: {
       ...
       */
      isEmpty() {
        if (this.__P_45_2.length > 0) {
          return false;
        }

        for (let localeId in this.__P_45_3) {
          if (this.__P_45_3[localeId]) {
            return false;
          }
        }

        for (let localeId in this.__P_45_4) {
          if (this.__P_45_4[localeId]) {
            return false;
          }
        }

        if (this.isEmbedAllJavascript()) {
          if (this.__P_45_5.length > 0) {
            return false;
          }
        }
      ...
      addLocale(localeId, localeData) {
        this.__P_45_3[localeId] = localeData;
      },
      ...
      addTranslationEntry(localeId, entry) {
        let translations = this.__P_45_4[localeId];

        if (!translations) {
          this.__P_45_4[localeId] = translations = {};
        }
      ...
      removeJavascriptMeta(jsMeta) {
        qx.lang.Array.remove(this.__P_45_5, jsMeta);
      },
      ...
      serializeInto(packages) {
        let data = packages[String(this.__P_45_1)] = {
          uris: []
        };

        let appRoot = this.__P_45_0.getApplicationRoot();

        const toUri = filename => {
          if (this.__P_45_0.isAddTimestampsToUrls()) {
        ...
        if (!this.isEmbedAllJavascript()) {
          data.uris = this.__P_45_5.map(js => toUri(js.getFilename()));
        }

        if (this.isNeedsWriteToDisk()) {
          data.uris.unshift(toUri(this.__P_45_7.getFilename()));
        }
      },
      ...
      _applyNeedsWriteToDisk(value) {
        this.__P_45_7.setNeedsWriteToDisk(value);
      }
