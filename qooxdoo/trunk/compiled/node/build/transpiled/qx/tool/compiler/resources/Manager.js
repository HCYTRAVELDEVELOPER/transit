(function () {
  ...
  qx.Class.define("qx.tool.compiler.resources.Manager", {
    ...
    construct(analyser) {
      ...
      this.__P_36_0 = analyser;
      this.__P_36_1 = analyser.getResDbFilename() || "resource-db.json";
      this.__P_36_2 = [new qx.tool.compiler.resources.ImageLoader(), new qx.tool.compiler.resources.MetaLoader()];
      this.__P_36_3 = [new qx.tool.compiler.resources.ScssConverter(), new qx.tool.compiler.resources.ScssIncludeConverter()];
    },
    ...
    members: {
       ...
       */
      async loadDatabase() {
        this.__P_36_4 = (await qx.tool.utils.Json.loadJsonAsync(this.__P_36_1)) || {};
      },
      ...
      async saveDatabase() {
        ...
        return qx.tool.utils.Json.saveJsonAsync(this.__P_36_1, this.__P_36_4);
      },
      ...
      findLibrariesForResource(uri) {
        const findLibrariesForResourceImpl = () => {
          ...
          if (path.isAbsolute(uri)) {
            let library = this.__P_36_0.getLibraries().find(lib => uri.startsWith(path.resolve(lib.getRootDir())));
          ...
          if (pos !== -1) {
            ...
            let library = this.__P_36_0.findLibrary(ns);
          ...
          if (pos === -1) {
            let library = this.__P_36_5[uri] || null;
            return library;
          } // Strip wildcard
          ...
          if (!this.__P_36_6) {
            this.__P_36_6 = Object.keys(this.__P_36_5).sort();
          }

          var thisUriPos = qx.tool.utils.Values.binaryStartsWith(this.__P_36_6, uri);

          if (thisUriPos > -1) {
            let libraries = {};

            for (; thisUriPos < this.__P_36_6.length; thisUriPos++) {
              var thisUri = this.__P_36_6[thisUriPos];
              ...
              if (pos !== -1) {
                ...
                if (!libraries[ns]) {
                  libraries[ns] = this.__P_36_0.findLibrary(ns);
                }
              }
            }
      ...
      async findAllResources() {
        ...
        this.__P_36_6 = null;
        this.__P_36_7 = {};
        await qx.Promise.all(t.__P_36_0.getLibraries().map(async library => {
        ...
        await qx.tool.utils.Promisify.poolEachOf(Object.values(this.__P_36_7), 10, async asset => {
          await asset.load();
          ...
          if (fileInfo.meta) {
            for (var altPath in fileInfo.meta) {
              ...
              let otherAsset = this.__P_36_7[lib.getNamespace() + ":" + altPath];
          ...
          if (fileInfo.dependsOn) {
            ...
            fileInfo.dependsOn.forEach(str => {
              let otherAsset = this.__P_36_7[str];
       ...
       */
      __P_36_8(asset) {
        this.__P_36_7[asset.toUri()] = asset;
        ...
        filename.split("/").forEach((seg, index) => {
          ...
          if (current) {
            if (qx.lang.Type.isArray(current)) {
              ...
              current = this.__P_36_5[tmp] = [current, library];
            }
          } else {
            this.__P_36_5[tmp] = library;
          }
        });
        asset.setLoaders(this.__P_36_2.filter(loader => loader.matches(filename, library)));
        asset.setConverters(this.__P_36_3.filter(converter => converter.matches(filename, library)));
      },
      ...
      getAsset(srcPath, create, isThemeFile) {
        ...
        let asset = this.__P_36_7[library.getNamespace() + ":" + srcPath];
      ...
      getAssetsForPaths(srcPaths) {
        var db = this.__P_36_4; // Generate a lookup that maps the resource name to the meta file that
        ...
        srcPaths.forEach(srcPath => {
          ...
          if (pos > -1) {
            ...
            let tmp = this.__P_36_0.findLibrary(ns);
          ...
          libraries.forEach(library => {
            ...
            resourceNames.forEach(resourceName => {
              ...
              let asset = this.__P_36_7[library.getNamespace() + ":" + resourceName];
