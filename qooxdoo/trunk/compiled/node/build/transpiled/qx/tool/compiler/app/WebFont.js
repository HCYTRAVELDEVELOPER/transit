    ...
    members: {
      ...
      _loadLocalFont(filename) {
        return new Promise((resolve, reject) => {
          let fontpath = path.join(this.__P_29_0.getRootDir(), path.join(this.__P_29_0.getResourcePath(), filename));

          this.__P_29_2(fontpath, resolve, reject);
        });
      },
          ...
          http.get(url, function (res) {
            ...
            tmp.tmpName(function _tempNameGenerated(err, tmpFilename) {
              ...
              outFile.on("close", function () {
                this.__P_29_2(tmpFilename, resolve, reject);
       ...
       */
      __P_29_2(filename, resolve, reject) {
        fontkit.open(filename, null, function (err, font) {
          ...
          if (this.getMapping()) {
            let mapPath = path.join(this.__P_29_0.getRootDir(), path.join(this.__P_29_0.getResourcePath(), this.getMapping()));
            fs.readFile(mapPath, {
              encoding: "utf-8"
            }, (err, data) => {
              if (err) {
      ...
      generateForTarget(target) {
        ...
        this.__P_29_3 = new Promise((resolve, reject) => {
