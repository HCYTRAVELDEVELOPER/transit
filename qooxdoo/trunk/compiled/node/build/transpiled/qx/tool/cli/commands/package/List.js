  ...
  qx.Class.define("qx.tool.cli.commands.package.List", {
    ...
    members: {
      ...
      async process() {
        ...
        let num_compat_repos = await this.__P_17_3(qxVersion);
        ...
        if (repo) {
          ...
          if (this.__P_17_1[repo] && this.__P_17_1[repo].length) {
            ...
            if (!this.argv.quiet) {
              let data = this.__P_17_1[repo] // shallow copy
        ...
        let list = this.argv.all ? this.__P_17_0 : this.__P_17_0.filter(item => item.latestCompatible || this.argv.installed && item.name === localPathRepoName); // sort
        ...
        for (let repo of list) {
          ...
          if (!qx.lang.Type.isArray(this.__P_17_1[repo.name])) {
            continue;
          }

          for (let library of this.__P_17_1[repo.name]) {
        ...
        this.getCache().compat[qxVersion] = this.__P_17_2[qxVersion];
       ...
       */
      async __P_17_3(qooxdoo_version) {
        if (this.argv.installed) {
          // local libraries
          const localPathRepoName = qx.tool.cli.commands.package.List.localPathRepoName;
          ...
          this.__P_17_1[localPathRepoName] = [];
          ...
          for (let lib of libData.libraries) {
            if (!lib.repo_name) {
              ...
              this.__P_17_1[localPathRepoName].push({
                name: info.name,
        ...
        if (this.__P_17_2[qooxdoo_version] === undefined) {
          this.__P_17_2[qooxdoo_version] = {};
        ...
        for (let repo_name of repos_cache.list) {
          ...
          for (let tag_name of tag_names) {
            ...
            for (let manifest of manifests) {
              ...
              if (this.__P_17_1[repo_name] === undefined) {
                this.__P_17_1[repo_name] = [];
              ...
              let latestCompatibleRelease = this.__P_17_2[qooxdoo_version][repo_name];
              ...
              if (compatibility === true && (latestCompatibleRelease === undefined || semver.gt(tag_version, latestCompatibleVersion, false) && (!prerelease || this.argv.prereleases))) {
                this.__P_17_2[qooxdoo_version][repo_name] = tag_name;
                hasCompatibleRelease = true;
              } // save data


              this.__P_17_1[repo_name].push({
                name: info.name,
          ...
          this.__P_17_0.push({
            ...
            latestVersion,
            latestCompatible: hasCompatibleRelease ? this.__P_17_2[qooxdoo_version][repo_name] : false
          });
        }
