(function () {
  ...
  qx.Class.define("qx.tool.compiler.ClassFile", {
    ...
    construct(analyser, className, library) {
      ...
      this.__P_22_14 = {};
      this.__P_22_15 = [];
      this.__P_22_16 = async.queue(function (task, cb) {
        task(cb);
      });
      this.__P_22_16.drain = this._onTaskQueueDrain;

      this.__P_22_16.error = err => {
      ...
      this.__P_22_18 = {};
      this.__P_22_19 = {};
      this.__P_22_20 = analyser.getManglePrivates();
      const CF = qx.tool.compiler.ClassFile;

      const addSymbols = arr => arr.forEach(s => this.__P_22_17[s] = true);
    ...
    members: {
      ...
      load(callback) {
        ...
        fs.readFile(this.getSourcePath(), {
          ...
          qx.tool.utils.Utils.mkParentPath(outputPath, function (err) {
            ...
            if (qx.lang.Array.contains(t.__P_22_0.getApplicationTypes(), "browser")) {
      ...
      writeDbInfo(dbClassInfo) {
        ...
        for (var key in this.__P_22_27) {
          dbClassInfo[key] = this.__P_22_27[key];
        }
      },
      ...
      _compileDbClassInfo() {
        var t = this;
        var dbClassInfo = this.__P_22_27 = {}; // Collect the dependencies on other classes
        ...
        if (Object.keys(this.__P_22_14).length > 0) {
          dbClassInfo.commonjsModules = {};

          for (let moduleName in this.__P_22_14) {
            dbClassInfo.commonjsModules[moduleName] = [...this.__P_22_14[moduleName]];
          }
        }
      ...
      _babelClassPlugins() {
        ...
        function enterFunction(path, node, idNode) {
          ...
          let isClassMember = t.__P_22_25 && t.__P_22_25._topLevel && t.__P_22_25._topLevel.keyName == "members" && path.parentPath.parentPath.parentPath == t.__P_22_25._topLevel.path;
        ...
        function makeMeta(sectionName, functionName, node) {
          ...
          if (functionName) {
            var section = t.__P_22_25[sectionName];

            if (section === undefined) {
              section = t.__P_22_25[sectionName] = {};
            }
        ...
        function checkValidTopLevel(path) {
          ...
          let allowedKeys = ALLOWED_KEYS[t.__P_22_25.type];

          if (t.__P_22_25.type === "class") {
            allowedKeys = allowedKeys[t.__P_22_25.isStatic ? "static" : "normal"];
          }

          if (allowedKeys[keyName] === undefined) {
            t.addMarker("compiler.invalidClassDefinitionEntry", prop.loc, t.__P_22_25.type, keyName);
          }
        }
        ...
        function handleTopLevelMethods(path, keyName, functionNode) {
          ...
          t.__P_22_25.functionName = FUNCTION_NAMES[keyName] || keyName;
          ...
          ObjectProperty(path) {
            ...
            if (keyName == "extend") {
              if (!isValidExtendClause(prop)) {
                ...
                t.__P_22_25.superClass = collapseMemberExpression(prop.value);

                t._requireClass(t.__P_22_25.superClass, {
                  location: path.node.loc
                });
              }
            } else if (keyName == "type") {
              var type = prop.value.value;
              t.__P_22_25.isAbstract = type === "abstract";
              t.__P_22_25.isStatic = type === "static";
              t.__P_22_25.isSingleton = type === "singleton";
              ...
              t.__P_22_25._topLevel = {
                path,
                keyName
              };
              path.skip();
              path.traverse(VISITOR);
              t.__P_22_25._topLevel = null;
        ...
        var VISITOR = {
          ...
          CallExpression: {
            enter(path) {
              ...
              let applicationTypes = t.__P_22_0.getApplicationTypes();
              ...
              if (path.node.callee.type == "Identifier" && ((_path$node = path.node) === null || _path$node === void 0 ? void 0 : (_path$node$callee = _path$node.callee) === null || _path$node$callee === void 0 ? void 0 : _path$node$callee.name) == "require" && ((_path$node$arguments = path.node.arguments) === null || _path$node$arguments === void 0 ? void 0 : _path$node$arguments.length) == 1 && applicationTypes.includes("browser")) {
                ...
                for (scope = t.__P_22_12; scope; scope = scope.parent) {
              ...
              if (types.isMemberExpression(path.node.callee) || es6ClassDeclarations == 0 && (((_path$node$callee$obj = path.node.callee.object) === null || _path$node$callee$obj === void 0 ? void 0 : _path$node$callee$obj.type) == "Super" || path.node.callee.type == "Super")) {
                ...
                if (TYPE[name]) {
                  t.__P_22_29 = name.match(/\.([a-zA-Z]+)\./)[1];
                  let node = path.node;
                  ...
                  t.__P_22_25.type = TYPE[name];

                  if (t.__P_22_29 == "Class" || t.__P_22_29 == "Bootstrap") {
                    let typeProp = classDef.properties.find(prop => prop.key.type == "Identifier" && prop.key.value == "type");

                    if (typeProp) {
                      t.__P_22_25.isStatic == typeProp.value.type == "Literal" && typeProp.value.value === "static";
                    }
                  }
                  ...
                  if (types.isLiteral(arg)) {
                    if (typeof arg.value != "string") {
                      ...
                      if (!arg.value.startsWith(t.__P_22_1) && !Object.prototype.hasOwnProperty.call(qx.tool.compiler.ClassFile.ENVIRONMENT_CONSTANTS, arg.value)) {
                  ...
                  if (t.__P_22_29 == "Mixin") {
                    expr = types.callExpression(expandMemberExpression("qx.Mixin.baseClassMethod"), [expandMemberExpression("this.constructor"), types.identifier(t.__P_22_25.className), types.stringLiteral(t.__P_22_25.functionName)]);
                    expr = types.memberExpression(expr, types.identifier("call"));
                  } else if (t.__P_22_25.functionName == "$$constructor") {
                    expr = expandMemberExpression(t.__P_22_25.superClass + ".constructor.call");
                  } else if (t.__P_22_25.className) {
                    expr = expandMemberExpression(t.__P_22_25.className + ".superclass" + ".prototype." + t.__P_22_25.functionName + ".call");
                  } else {
                    expr = expandMemberExpression(t.__P_22_25.superClass + ".prototype." + t.__P_22_25.functionName + ".call");
                  }
                  ...
                  if (t.__P_22_29 == "Mixin") {
                    expr = expandMemberExpression("this.constructor.superclass.prototype." + t.__P_22_25.functionName + ".call");
                  } else if (t.__P_22_25.functionName == "$$constructor") {
                    expr = expandMemberExpression(t.__P_22_25.superClass + ".constructor." + methodName);
                  } else {
                    expr = expandMemberExpression(t.__P_22_1 + ".prototype." + t.__P_22_25.functionName + ".base." + methodName);
                  ...
                  let expr = expandMemberExpression(t.__P_22_25.className);
          ...
          MemberExpression: {
            exit(path) {
              ...
              if (t.__P_22_17[members[0]] || t.hasDeclaration(members[0])) {
                return;
              }
          ...
          Property(path) {
            if (t.__P_22_25 && t.__P_22_25._topLevel && t.__P_22_25._topLevel.path == path.parentPath.parentPath) {
              t.__P_22_25.functionName = getKeyName(path.node.key);
              makeMeta(t.__P_22_25._topLevel.keyName, t.__P_22_25.functionName, path.node);
              path.skip();
              let functionId = null;
          ...
          ObjectMethod(path) {
            ...
            if (t.__P_22_25 && t.__P_22_25._topLevel && t.__P_22_25._topLevel.path == path.parentPath.parentPath) {
              ...
              path.traverse(VISITOR);
              exitFunction(path);
              t.__P_22_25.functionName = null; // Otherwise traverse method as normal
            } else {
              path.skip();
              enterFunction(path);
              path.traverse(VISITOR);
      ...
      addReference(name, loc) {
        ...
        if (name[0] === "this" || name[0] === "[]" || this.__P_22_17[name[0]] || this.hasDeclaration(name[0])) {
          return;
        }
        ...
        for (var i = 0; i < name.length; i++) {
          ...
          if (this.__P_22_17[str] || this.isIgnored(str)) {
            return;
          }
        }
      ...
      encodePrivate(name, isIdentifier, location) {
        ...
        if (DO_NOT_ENCODE[name] || this.__P_22_20 == "off" || !name.startsWith("__") || !name.match(/^[0-9a-z_$]+$/i)) {
          return name;
        }
        ...
        if (!coded) {
          ...
          if (!isIdentifier) {
            this.__P_22_19[name] = true;
            return name;
          }

          if (this.__P_22_19[name]) {
          ...
          if (this.__P_22_20 == "readable") {
            coded = this.__P_22_18[name] = name + prefix + Object.keys(this.__P_22_18).length;
          } else {
            coded = this.__P_22_18[name] = prefix + Object.keys(this.__P_22_18).length;
          }
        }
      ...
      addCommonjsModule(moduleName, className, linenum) {
        if (!this.__P_22_14[moduleName]) {
          this.__P_22_14[moduleName] = new Set();
        }

        this.__P_22_14[moduleName].add(`${className}:${linenum}`);
      },
      ...
      addEnvCheck(name, location) {
        ...
        var requiredOpts = {
          load: t.isLoadScope(),
          defer: t.__P_22_23,
          construct: t.__P_22_25 && t.__P_22_25.functionName == "$$constructor",
          location: location
        };
