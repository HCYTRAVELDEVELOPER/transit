  ...
  qx.Class.define("qx.tool.compiler.app.Translation", {
    ...
    members: {
      ...
      async checkRead() {
        ...
        if (stat && this.__P_28_2 == stat.mtime) {
          return undefined;
        }
      ...
      read() {
        ...
        return t.__P_28_3 = new Promise((resolve, reject) => {
          t.__P_28_0 = {};
          t.__P_28_1 = {};
          var poFile = this.getPoFilename();
      ...
      writeTo(filename, cb) {
        ...
        for (var msgid in t.__P_28_0) {
          var entry = t.__P_28_0[msgid];
       ...
       */
      deleteEntry(id) {
        let entry = this.__P_28_0[id] || null;
        delete this.__P_28_0[id];
        return entry;
      },
