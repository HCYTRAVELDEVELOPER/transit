  ...
  qx.Class.define("qx.tool.compiler.targets.meta.PackageJavascript", {
    ...
    members: {
      ...
      async writeSourceCodeToStream(ws) {
        ...
        if (pkg.isEmbedAllJavascript()) {
          ...
          await new Promise(async resolve => {
            for (let i = 0; i < pkg.getJavascriptMetas().length; i++) {
              ...
              this.__P_46_1.push(ws.getLineNumber());
        ...
        ws.write(`qx.$$packageData['${this.__P_46_0.getPackageIndex()}'] = ${JSON.stringify(data, null, 2)};\n`);
      },
      ...
      async writeToDisk() {
        ...
        if (!this.__P_46_0.isEmbedAllJavascript()) {
          for (let i = 0; i < this.__P_46_0.getJavascriptMetas().length; i++) {
            await this.__P_46_0.getJavascriptMetas()[i].unwrap().writeToDisk();
          }
        }
      },
      ...
      async getSourceMap() {
        ...
        return this._copySourceMap(this.__P_46_0.getJavascriptMetas(), this.__P_46_1);
      }
