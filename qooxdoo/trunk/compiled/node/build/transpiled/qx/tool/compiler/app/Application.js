  ...
  qx.Class.define("qx.tool.compiler.app.Application", {
    ...
    construct(classname) {
      ...
      args.forEach(function (arg) {
        if (qx.lang.Type.isArray(arg)) {
          qx.lang.Array.append(t.__P_26_0, arg);
        } else {
          t.__P_26_0.push(arg);
        }
      });
    ...
    members: {
      ...
      calcDependencies() {
        ...
        if (this.__P_26_3 && this.__P_26_3.length) {
          parts = [];

          t.__P_26_3.forEach(part => {
        ...
        t.__P_26_7(t.getExclude()).forEach(name => exclude[name] = true); // Start the ball rolling
        ...
        */
        ...
        this.__P_26_2 = allDeps.toArray();
        var requiredLibs = {};

        this.__P_26_2.forEach(classname => {
        ...
        this.__P_26_6 = parts;
        this.__P_26_5 = fatalCompileErrors.length ? fatalCompileErrors : null;
      },
      ...
      getAssetUris(target, resManager, environment) {
        ...
        var classNames = this.__P_26_2.slice();
      ...
      getRequiredClasses() {
        ...
        this.__P_26_0.forEach(name => result[name] = true);

        this.__P_26_7(this.getInclude()).forEach(name => result[name] = true);

        this.__P_26_7(this.getExclude()).forEach(name => delete result[name]); // We sort the result so that we can get a consistent ordering for loading classes, otherwise the order in
