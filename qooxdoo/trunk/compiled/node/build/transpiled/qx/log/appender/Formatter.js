  ...
  qx.Class.define("qx.log.appender.Formatter", {
    ...
    members: {
      ...
      formatEntryTime(entry) {
        ...
        if (!qx.log.appender.Formatter.__P_117_0) {
          qx.log.appender.Formatter.__P_117_0 = new qx.util.format.DateFormat("YYYY-MM-dd HH:mm:ss");
        }

        return qx.log.appender.Formatter.__P_117_0.format(entry.time);
      },
    ...
    statics: {
       ...
       */
      getFormatter() {
        if (!qx.log.appender.Formatter.__P_117_1) {
          qx.log.appender.Formatter.__P_117_1 = new qx.log.appender.Formatter();
        }

        return qx.log.appender.Formatter.__P_117_1;
      },
      ...
      setFormatter(instance) {
        qx.log.appender.Formatter.__P_117_1 = instance;
      },
       ...
       */
      escapeHTML(value) {
        return String(value).replace(/[<>&"']/g, qx.log.appender.Formatter.__P_117_2);
      },
