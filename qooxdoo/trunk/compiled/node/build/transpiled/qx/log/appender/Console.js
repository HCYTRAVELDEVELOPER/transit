(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.log.appender.Console", {
    statics: {
      ...
      */
      ...
      init() {
        ...
        this.__P_116_0 = main;
        this.__P_116_1 = main.childNodes[1];
        this.__P_116_2 = main.childNodes[2].firstChild; // Correct height of messages frame

        this.__P_116_4(); // Finally register to log engine
       ...
       */
      dispose() {
        qx.event.Registration.removeListener(document.documentElement, "keypress", this.__P_116_5, this);
      ...
      */
      ...
      process(entry) {
        ...
        this.__P_116_1.appendChild(formatter.toHtml(entry)); // Scroll down
       ...
       */
      __P_116_6() {
        this.__P_116_1.scrollTop = this.__P_116_1.scrollHeight;
      },
      ...
      */
      ...
      toggle() {
        if (!this.__P_116_0) {
          this.init();
        } else if (this.__P_116_0.style.display == "none") {
          this.show();
        } else {
          this.__P_116_0.style.display = "none";
        }
      },
      ...
      show() {
        if (!this.__P_116_0) {
          ...
          this.__P_116_0.style.display = "block";
          this.__P_116_1.scrollTop = this.__P_116_1.scrollHeight;
        }
      },
      ...
      */
       ...
       */
      execute() {
        var value = this.__P_116_2.value;
        ...
        this.__P_116_8.push(value);

        this.__P_116_3 = this.__P_116_8.length;

        this.__P_116_1.appendChild(command);
      ...
      */
       ...
       */
      __P_116_4(e) {
        this.__P_116_1.style.height = this.__P_116_0.clientHeight - this.__P_116_0.firstChild.offsetHeight - this.__P_116_0.lastChild.offsetHeight + "px";
      },
      ...
      __P_116_5(e) {
        ...
        if (!qx.dom.Hierarchy.contains(this.__P_116_0, e.getTarget())) {
          return;
        } // Command execution


        if (iden == "Enter" && this.__P_116_2.value != "") {
          this.execute();
          this.__P_116_2.value = "";
        } // History management


        if (iden == "Up" || iden == "Down") {
          this.__P_116_3 += iden == "Up" ? -1 : 1;
          this.__P_116_3 = Math.min(Math.max(0, this.__P_116_3), this.__P_116_8.length);
          var entry = this.__P_116_8[this.__P_116_3];
          this.__P_116_2.value = entry || "";

          this.__P_116_2.select();
        }
      }
    ...
    */
    defer(statics) {
      qx.event.Registration.addListener(document.documentElement, "keypress", statics.__P_116_5, statics);
      qx.event.Registration.addListener(document.documentElement, "longtap", statics.__P_116_5, statics);
    }
