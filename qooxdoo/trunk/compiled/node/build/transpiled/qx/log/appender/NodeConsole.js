  ...
  qx.Class.define("qx.log.appender.NodeConsole", {
    statics: {
      ...
      log(logMessage, level) {
        if (this.__P_118_2 && this.__P_118_3[level]) {
          logMessage = this.__P_118_3[level] + logMessage + this.__P_118_3.reset;
        }

        if (level === "error") {
          this.__P_118_1.write(logMessage + "\n");
        } else {
          this.__P_118_0.write(logMessage + "\n");
        }
      },
    ...
    defer(statics) {
      if (typeof process !== "undefined") {
        statics.__P_118_0 = process.stdout;
        statics.__P_118_1 = process.stderr;
