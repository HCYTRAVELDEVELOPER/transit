  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.io.jsonrpc.protocol.Request", {
    ...
    statics: {
      ...
      getCurrentId() {
        return qx.io.jsonrpc.protocol.Request.__P_90_0;
      },

      resetId() {
        qx.io.jsonrpc.protocol.Request.__P_90_0 = 0;
      }
    ...
    construct(method, params, id) {
      ...
      if (id === undefined) {
        id = ++qx.io.jsonrpc.protocol.Request.__P_90_0;
      }

      this.set({
        id
      });
      this.__P_90_1 = new qx.Promise();
    },
