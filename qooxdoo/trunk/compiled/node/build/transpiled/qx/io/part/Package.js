  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.io.part.Package", {
    ...
    construct(urls, id, loaded) {
      this.__P_92_0 = loaded ? "complete" : "initialized";
      this.__P_92_1 = urls;
      this.__P_92_2 = id;
    },
    ...
    members: {
       ...
       */
      saveClosure(closure) {
        if (this.__P_92_0 == "error") {
          return;
        }

        this.__P_92_3 = closure;

        if (!this.__P_92_4) {
          this.execute();
        } else {
          clearTimeout(this.__P_92_5);
          this.__P_92_0 = "cached";
      ...
      execute() {
        if (this.__P_92_3) {
          ...
          delete this.__P_92_3;
        }

        if (qx.$$packageData[this.__P_92_2]) {
          this.__P_92_7(qx.$$packageData[this.__P_92_2]);

          delete qx.$$packageData[this.__P_92_2];
        }

        this.__P_92_0 = "complete";
      },
      ...
      loadClosure(notifyPackageResult, self) {
        if (this.__P_92_0 !== "initialized") {
          return;
        }

        this.__P_92_4 = true;
        this.__P_92_0 = "loading";
        this.__P_92_6 = qx.Bootstrap.bind(notifyPackageResult, self);

        this.__P_92_8(this.__P_92_1, function () {}, function () {
          this.__P_92_0 = "error";
          notifyPackageResult.call(self, this);
        }, this);

        var pkg = this;
        this.__P_92_5 = setTimeout(function () {
          pkg.__P_92_0 = "error";
      ...
      load(notifyPackageResult, self) {
        ...
        this.__P_92_8(this.__P_92_1, function () {
          this.__P_92_0 = "complete";
          this.execute();
          notifyPackageResult.call(self, this);
        }, function () {
       ...
       */
      __P_92_8(urlList, callback, errBack, self) {
        if (urlList.length == 0) {
          callback.call(self);
          return;
        }
        ...
        var loadScripts = function (urls) {
          ...
          loader.onerror = function () {
            if (self.__P_92_0 == "loading") {
              clearTimeout(self.__P_92_5);
              loader.dispose();
       ...
       */
      __P_92_7: qx.$$loader.importPackageData
    }
  });
