(function () {
  ...
  qx.Class.define("qx.io.transport.Xhr", {
    ...
    members: {
       ...
       */
      getTransportImpl() {
        this.__P_109_0 = this._createTransportImpl();
      ...
      async send(message) {
        ...
        const req = this.__P_109_0 || this.getTransportImpl();
        req.setRequestData(message);
        this.__P_109_0 = null; // free the internal reference for the next request
