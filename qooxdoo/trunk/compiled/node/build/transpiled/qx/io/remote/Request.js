  ...
  qx.Class.define("qx.io.remote.Request", {
    ...
    */
    ...
    construct(vUrl, vMethod, vResponseType) {
      ...
      this.__P_95_4 = ++qx.io.remote.Request.__P_95_4;
    },
    ...
    */
    members: {
      ...
      */
       ...
       */
      __P_95_5: qx.event.GlobalError.observeMethod(function (e) {
      ...
      _oncompleted(e) {
        ...
        this.__P_95_5(e); // Automatically dispose after event completion
      ...
      */
      ...
      setParameter(vId, vValue, bAsData) {
        if (bAsData) {
          this.__P_95_2[vId] = vValue;
        } else {
          this.__P_95_1[vId] = vValue;
        }
      },
      ...
      removeParameter(vId, bFromData) {
        if (bFromData) {
          delete this.__P_95_2[vId];
        } else {
          delete this.__P_95_1[vId];
        }
      },
      ...
      getParameter(vId, bFromData) {
        if (bFromData) {
          return this.__P_95_2[vId] || null;
        } else {
          return this.__P_95_1[vId] || null;
        }
      },
      ...
      getParameters(bFromData) {
        return bFromData ? this.__P_95_2 : this.__P_95_1;
      },
    ...
    */
    destruct() {
      ...
      this.__P_95_0 = this.__P_95_1 = this.__P_95_2 = this.__P_95_3 = null;
    }
