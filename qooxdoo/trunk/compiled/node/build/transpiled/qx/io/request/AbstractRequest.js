  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.io.request.AbstractRequest", {
    ...
    construct(url) {
      ...
      this.__P_102_1 = qx.lang.Function.bind(this._onReadyStateChange, this);
      this.__P_102_2 = qx.lang.Function.bind(this._onLoad, this);
      this.__P_102_3 = qx.lang.Function.bind(this._onLoadEnd, this);
      this.__P_102_4 = qx.lang.Function.bind(this._onAbort, this);
      this.__P_102_5 = qx.lang.Function.bind(this._onTimeout, this);
      this.__P_102_6 = qx.lang.Function.bind(this._onError, this);
      transport.onreadystatechange = this.__P_102_1;
      transport.onload = this.__P_102_2;
      transport.onloadend = this.__P_102_3;
      transport.onabort = this.__P_102_4;
      transport.ontimeout = this.__P_102_5;
      transport.onerror = this.__P_102_6;
    },
    ...
    members: {
      ...
      */
      ...
      abort() {
        ...
        this.__P_102_8 = true; // Update phase to "abort" before user handler are invoked [BUG #5485]

        this.__P_102_9 = "abort";
      ...
      */
      ...
      _getAllRequestHeaders() {
        ...
        qx.lang.Object.mergeWith(requestHeaders, this.__P_102_11()); // User-defined, requestHeaders property (deprecated)

        qx.lang.Object.mergeWith(requestHeaders, this.__P_102_10); // User-defined

        qx.lang.Object.mergeWith(requestHeaders, this.__P_102_0);
      ...
      removeRequestHeader(key) {
        if (this.__P_102_0[key]) {
          delete this.__P_102_0[key];
        }
      },
      ...
      */
      ...
      _setResponse(response) {
        ...
        if (this.__P_102_7 !== response) {
          this.__P_102_7 = response;
          this.fireEvent("changeResponse", qx.event.type.Data, [this.__P_102_7, oldResponse]);
        }
      },
      ...
      */
       ...
       */
      _setPhase(phase) {
        var previousPhase = this.__P_102_9;
        this.__P_102_9 = phase;
