  ...
  qx.Class.define("qx.io.remote.Rpc", {
    ...
    */
    ...
    construct(url, serviceName) {
      ...
      if (qx.core.ServerSettings) {
        this.__P_98_0 = qx.core.ServerSettings.serverPathSuffix;
      }
    },
    ...
    */
    members: {
        ...
        req.addListener("completed", function (evt) {
          ...
          if (exTest != null) {
            ...
            if (refreshSession) {
              ...
              if (self.__P_98_0 != newSuffix) {
                self.__P_98_1 = self.__P_98_0;
                self.__P_98_0 = newSuffix;
              }
       ...
       */
      fixUrl(url) {
        if (this.__P_98_1 == null || this.__P_98_0 == null || this.__P_98_1 == "" || this.__P_98_1 == this.__P_98_0) {
          return url;
        }

        var index = url.indexOf(this.__P_98_1);

        if (index == -1) {
          return url;
        }

        return url.substring(0, index) + this.__P_98_0 + url.substring(index + this.__P_98_1.length);
      },
