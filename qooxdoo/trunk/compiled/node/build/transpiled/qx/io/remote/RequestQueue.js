  ...
  qx.Class.define("qx.io.remote.RequestQueue", {
    ...
    */
    construct() {
      ...
      this.__P_96_0 = [];
      this.__P_96_1 = [];
      this.__P_96_2 = 0; // timeout handling

      this.__P_96_3 = new qx.event.Timer(500);

      this.__P_96_3.addListener("interval", this._oninterval, this);
    },
    ...
    members: {
      ...
      */
      ...
      _check() {
        ...
        if (this.__P_96_1.length == 0 && this.__P_96_0.length == 0) {
          this.__P_96_3.stop();
        } // Checking if enabled
        ...
        if (this.__P_96_0.length == 0 || this.__P_96_0[0].isAsynchronous() && this.__P_96_1.length >= this.getMaxConcurrentRequests()) {
          return;
        } // Checking number of total requests


        if (this.getMaxTotalRequests() != null && this.__P_96_2 >= this.getMaxTotalRequests()) {
          return;
        }

        var vRequest = this.__P_96_0.shift();

        var vTransport = new qx.io.remote.Exchange(vRequest); // Increment counter

        this.__P_96_2++; // Add to active queue

        this.__P_96_1.push(vTransport); // Debug output
      ...
      _remove(vTransport) {
        ...
        qx.lang.Array.remove(this.__P_96_1, vTransport); // Dispose transport object
      ...
      */
      ...
      _applyEnabled(value, old) {
        ...
        this.__P_96_3.setEnabled(value);
      },
      ...
      */
      ...
      add(vRequest) {
        ...
        if (vRequest.isAsynchronous()) {
          this.__P_96_0.push(vRequest);
        } else {
          this.__P_96_0.unshift(vRequest);
        }
      ...
      abort(vRequest) {
        ...
        if (vTransport) {
          vTransport.abort();
        } else if (this.__P_96_0.includes(vRequest)) {
          qx.lang.Array.remove(this.__P_96_0, vRequest);
        }
      }
    ...
    */
    destruct() {
      this._disposeArray("__P_96_1");

      this._disposeObjects("__P_96_3");
