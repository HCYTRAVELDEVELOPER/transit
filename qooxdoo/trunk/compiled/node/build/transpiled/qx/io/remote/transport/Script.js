  ...
  qx.Class.define("qx.io.remote.transport.Script", {
    ...
    */
    construct() {
      ...
      var vUniqueId = ++qx.io.remote.transport.Script.__P_100_0;

      if (vUniqueId >= 2000000000) {
        qx.io.remote.transport.Script.__P_100_0 = vUniqueId = 1;
      }

      this.__P_100_1 = null;
      this.__P_100_0 = vUniqueId;
    },
    ...
    members: {
      ...
      */
      ...
      send() {
        ...
        vUrl += (vUrl.indexOf("?") >= 0 ? "&" : "?") + qx.io.remote.transport.Script.ScriptTransport_ID_PARAM + "=" + this.__P_100_0;
        ...
        qx.io.remote.transport.Script._instanceRegistry[this.__P_100_0] = this;
        this.__P_100_1 = document.createElement("script"); // IE needs this (it ignores the
        // encoding from the header sent by the
        // server for dynamic script tags)

        this.__P_100_1.charset = "utf-8";
        this.__P_100_1.src = vUrl;
        document.body.appendChild(this.__P_100_1);
      },
      ...
      _switchReadyState(vReadyState) {
        ...
        while (this.__P_100_2 < vReadyState) {
          this.setState(qx.io.remote.Exchange._nativeMap[++this.__P_100_2]);
        }
      },
    ...
    */
    destruct() {
      if (this.__P_100_1) {
        delete qx.io.remote.transport.Script._instanceRegistry[this.__P_100_0];
        document.body.removeChild(this.__P_100_1);
      }

      this.__P_100_1 = this._responseContent = null;
    }
