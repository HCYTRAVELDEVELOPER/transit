    ...
    */
    members: {
      ...
      */
       ...
       */
      getRequest() {
        if (this.__P_101_3 === null) {
          this.__P_101_3 = qx.io.remote.transport.XmlHttp.createRequestObject();
          this.__P_101_3.onreadystatechange = qx.lang.Function.bind(this._onreadystatechange, this);
        }

        return this.__P_101_3;
      },
      ...
      */
      ...
      _onreadystatechange: qx.event.GlobalError.observeMethod(function (e) {
        ...
        if (vReadyState == 4) {
          ...
          if (!qx.io.remote.Exchange.wasSuccessful(this.getStatusCode(), vReadyState, this.__P_101_1)) {
            // Fix for bug #2272
        ...
        if (vReadyState == 3 && this.__P_101_2 == 1) {
          this.setState(qx.io.remote.Exchange._nativeMap[++this.__P_101_2]);
        } // Updating internal state


        while (this.__P_101_2 < vReadyState) {
          this.setState(qx.io.remote.Exchange._nativeMap[++this.__P_101_2]);
        }
      }),
      ...
      */
      ...
      getResponseXml() {
        ...
        if (qx.io.remote.Exchange.wasSuccessful(vStatus, vReadyState, this.__P_101_1)) {
          try {
