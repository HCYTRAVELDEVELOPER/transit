    ...
    members: {
      _applyTheme(value) {
        ...
        if (value) {
          ...
          for (var name in colors) {
            if (!dest[name]) {
              dest[name] = this.__P_232_0(colors, name);
            }
          }
        }
      },
        ...
        if (typeof color === "string") {
          if (!qx.util.ColorUtil.isCssString(color)) {
            ...
            if (colors[color] != undefined) {
              return this.__P_232_0(colors, color);
            }
          ...
          return this.__P_232_0(colors, color(name));
      ...
      resolve(value) {
        ...
        if (theme !== null && theme.colors[value]) {
          return cache[value] = this.__P_232_0(theme.colors, value);
        }
      ...
      isDynamic(value) {
        ...
        if (theme !== null && value && theme.colors[value] !== undefined) {
          cache[value] = this.__P_232_0(theme.colors, value);
          return true;
        }
