    ...
    members: {
      ...
      resolve(value) {
        ...
        if (theme !== null && theme.fonts[value]) {
          var font = this.__P_236_0(theme.fonts[value]);
        ...
        if (value) {
          ...
          for (var key in source) {
            if (source[key].include && source[source[key].include]) {
              this.__P_236_1(source, key);
            }

            var font = this.__P_236_0(source[key]);
