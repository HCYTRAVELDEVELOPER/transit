  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.theme.manager.Decoration", {
    ...
    construct() {
      ...
      this.__P_230_0 = [];
      this.__P_230_1 = qx.core.Environment.get("engine.name") == "mshtml" && qx.core.Environment.get("browser.documentmode") < 9;
    },
    ...
    */
    members: {
      ...
      addCssClass(value) {
        ...
        Object.keys(styles).sort().forEach(function (key) {
          ...
          if (qx.Bootstrap.isObject(styles[key])) {
            ...
            var innerSelector = this.__P_230_1 ? selector : selector + (inner ? ":" : "");

            this.__P_230_0.push(innerSelector + key);
      ...
      removeAllCssClasses() {
        // remove old rules
        for (var i = 0; i < this.__P_230_0.length; i++) {
          var selector = this.__P_230_0[i];
      ...
      resolve(value) {
        ...
        var cache = this.__P_230_2;

        if (!cache) {
          cache = this.__P_230_2 = {};
        }
       ...
       */
      isCached(decorator) {
        return !this.__P_230_2 ? false : qx.lang.Object.contains(this.__P_230_2, decorator);
      },
