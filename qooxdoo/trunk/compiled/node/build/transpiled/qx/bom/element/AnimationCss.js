  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.element.AnimationCss", {
    statics: {
      ...
      __P_261_5: qx.core.Environment.get("css.animation"),
      ...
      _animate(el, desc, duration, reverse) {
        this.__P_261_6(desc); // debug validation
        ...
        if (!this.__P_261_0) {
          this.__P_261_0 = qx.bom.Stylesheet.createElement();
        }
        ...
        if (this.__P_261_5 != null) {
          var name = this.__P_261_7(keyFrames, reverse);

          var style = name + " " + duration + "ms " + desc.timing + " " + (desc.delay ? desc.delay + "ms " : "") + desc.repeat + " " + (desc.alternate ? "alternate" : "");
          qx.bom.Event.addNativeListener(el, this.__P_261_5["start-event"], this.__P_261_8);
          qx.bom.Event.addNativeListener(el, this.__P_261_5["iteration-event"], this.__P_261_9);
          qx.bom.Event.addNativeListener(el, this.__P_261_5["end-event"], this.__P_261_10);
          el.style[qx.lang.String.camelCase(this.__P_261_5["name"])] = style; // use the fill mode property if available and suitable

          if (keep && keep == 100 && this.__P_261_5["fill-mode"]) {
            el.style[this.__P_261_5["fill-mode"]] = "forwards";
          }
        }
        ...
        if (this.__P_261_5 == null) {
          window.setTimeout(function () {
            qx.bom.element.AnimationCss.__P_261_10({
              target: el
            });
          }, 0);
        }
      ...
      __P_261_10(e) {
        ...
        if (qx.bom.element.AnimationCss.__P_261_5 != null) {
          // reset the styling
          var key = qx.lang.String.camelCase(qx.bom.element.AnimationCss.__P_261_5["name"]);
          el.style[key] = "";
          qx.bom.Event.removeNativeListener(el, qx.bom.element.AnimationCss.__P_261_5["name"], qx.bom.element.AnimationCss.__P_261_10);
        }
        ...
        qx.bom.element.AnimationCss.__P_261_11(el, desc.keyFrames[animation.keep]);
       ...
       */
      __P_261_11(el, endFrame) {
        // keep the element at this animation step
        var transforms;

        for (var style in endFrame) {
          if (style in qx.bom.element.AnimationCss.__P_261_4) {
            if (!transforms) {
              transforms = {};
            }
       ...
       * @param desc {Map} The description of the animation.
       */
      __P_261_12: qx.core.Environment.select("qx.debug", {
        true(desc) {
      ...
      __P_261_7(frames, reverse) {
        ...
        if (this.__P_261_3[rule]) {
          return this.__P_261_3[rule];
        }

        var name = this.__P_261_1 + this.__P_261_2++;
        var selector = this.__P_261_5["keyframes"] + " " + name;
        qx.bom.Stylesheet.addRule(this.__P_261_0, selector, rule);
        this.__P_261_3[rule] = name;
        return name;
      },
      ...
      __P_261_13() {
        ...
        if (this.__P_261_0) {
          this.__P_261_0.ownerNode.remove();
