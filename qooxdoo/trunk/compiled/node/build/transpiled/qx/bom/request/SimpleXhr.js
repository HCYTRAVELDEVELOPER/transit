  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.request.SimpleXhr", {
    ...
    construct(url, method) {
      ...
      this.__P_194_0 = {};
      this.__P_194_1 = this._createResponseParser();
    },
    ...
    members: {
      ...
      */
       ...
       */
      setParser(parser) {
        return this.__P_194_1.setParser(parser);
      },
      ...
      send() {
        var curTimeout = this.getTimeout(),
            ...
            hasCacheControlHeader = this.__P_194_0.hasOwnProperty("Cache-Control"),
        ...
        for (var key in this.__P_194_0) {
          this._transport.setRequestHeader(key, this.__P_194_0[key]);
        } // send
      ...
      */
      ...
      __P_194_9() {
        ...
        if (qx.util.Request.isSuccessful(this._transport.status)) {
          ...
          this._setResponse(this.__P_194_1.parse(response, contentType));
