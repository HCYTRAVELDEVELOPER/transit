  ...
  qx.Class.define("qx.bom.webfonts.Manager", {
    ...
    */
    construct() {
      ...
      this.__P_257_1 = {};
      this.__P_257_2 = [];
      this.__P_257_3 = this.getPreferredFormats();
    },
    ...
    */
    members: {
      ...
      */
      ...
      require(familyName, sourcesList, callback, context) {
        ...
        if (qx.core.Environment.get("engine.name") == "mshtml" && (parseInt(qx.core.Environment.get("engine.version")) < 9 || qx.core.Environment.get("browser.documentmode") < 9)) {
          if (!this.__P_257_5) {
            this.__P_257_5 = new qx.event.Timer(100);

            this.__P_257_5.addListener("interval", this.__P_257_6, this);
          }

          if (!this.__P_257_5.isEnabled()) {
            this.__P_257_5.start();
          }

          this.__P_257_2.push([familyName, sources, fontWeight, fontStyle, comparisonString, version, callback, context]);
        } else {
          this.__P_257_7(familyName, sources, fontWeight, fontStyle, comparisonString, version, callback, context);
        }
      },
      ...
      remove(familyName, fontWeight, fontStyle) {
        var fontLookupKey = this.__P_257_8(familyName, fontWeight, fontStyle);

        var index = null;

        for (var i = 0, l = this.__P_257_0.length; i < l; i++) {
          if (this.__P_257_0[i] == fontLookupKey) {
            index = i;

            this.__P_257_9(familyName, fontWeight, fontStyle);
        ...
        if (index !== null) {
          qx.lang.Array.removeAt(this.__P_257_0, index);
        }

        if (fontLookupKey in this.__P_257_1) {
          this.__P_257_1[fontLookupKey].dispose();

          delete this.__P_257_1[fontLookupKey];
        }
      },
      ...
      removeStyleSheet() {
        ...
        if (this.__P_257_4) {
          qx.bom.Stylesheet.removeSheet(this.__P_257_4);
        }
      ...
      */
       ...
       */
      __P_257_8(familyName, fontWeight, fontStyle) {
       ...
       * @param context {Object?} Optional context for the callback function
       */
      __P_257_7(familyName, sources, fontWeight, fontStyle, comparisonString, version, callback, context) {
        var fontLookupKey = this.__P_257_8(familyName, fontWeight, fontStyle);

        if (!this.__P_257_0.includes(fontLookupKey)) {
          var sourcesMap = this.__P_257_10(sources);

          var rule = this.__P_257_11(familyName, fontWeight, fontStyle, sourcesMap, version);
          ...
          if (!this.__P_257_4) {
            this.__P_257_4 = qx.bom.Stylesheet.createElement();
          }

          try {
            this.__P_257_12(rule);
          } catch (ex) {}

          this.__P_257_0.push(fontLookupKey);
        }

        if (!this.__P_257_1[fontLookupKey]) {
          this.__P_257_1[fontLookupKey] = new qx.bom.webfonts.Validator(familyName, comparisonString, fontWeight, fontStyle);

          this.__P_257_1[fontLookupKey].setTimeout(qx.bom.webfonts.Manager.VALIDATION_TIMEOUT);

          this.__P_257_1[fontLookupKey].addListenerOnce("changeStatus", this.__P_257_13, this);
        }

        if (callback) {
          var cbContext = context || window;

          this.__P_257_1[fontLookupKey].addListenerOnce("changeStatus", callback, cbContext);
        }

        this.__P_257_1[fontLookupKey].validate();
      },
       ...
       */
      __P_257_6() {
        if (this.__P_257_2.length == 0) {
          this.__P_257_5.stop();

          return;
        }

        var next = this.__P_257_2.shift();

        this.__P_257_7.apply(this, next);
      },
       ...
       */
      __P_257_11(familyName, fontWeight, fontStyle, sourcesMap, version) {
        var rules = [];
        var formatList = this.__P_257_3.length > 0 ? this.__P_257_3 : qx.bom.webfonts.Manager.FONT_FORMATS;

        for (var i = 0, l = formatList.length; i < l; i++) {
          var format = formatList[i];

          if (sourcesMap[format]) {
            rules.push(this.__P_257_14(format, sourcesMap[format], version));
          }
        }
      ...
      __P_257_12(rule) {
        ...
        if (qx.core.Environment.get("browser.name") == "ie" && qx.core.Environment.get("browser.documentmode") < 9) {
          var cssText = this.__P_257_15(this.__P_257_4.cssText);

          cssText += completeRule;
          this.__P_257_4.cssText = cssText;
        } else {
          this.__P_257_4.insertRule(completeRule, this.__P_257_4.cssRules.length);
        }
      },
       ...
       */
      __P_257_9(familyName, fontWeight, fontStyle) {
        ...
        for (var i = 0, l = document.styleSheets.length; i < l; i++) {
          ...
          if (sheet.cssText) {
            ...
            cssText = this.__P_257_15(cssText);
    ...
    */
    destruct() {
      if (this.__P_257_5) {
        ...
        this.__P_257_5.dispose();
      }

      delete this.__P_257_0;
      this.removeStyleSheet();

      for (var prop in this.__P_257_1) {
        this.__P_257_1[prop].dispose();
      }
