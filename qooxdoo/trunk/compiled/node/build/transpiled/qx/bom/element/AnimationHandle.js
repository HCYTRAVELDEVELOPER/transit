  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.element.AnimationHandle", {
    ...
    construct() {
      ...
      this.__P_270_0 = css && css["play-state"];
      this.__P_270_1 = true;
      this.addListenerOnce("end", this.__P_270_2, this);
    },
    ...
    members: {
       ...
       */
      isPaused() {
        return this.el.style[this.__P_270_0] == "paused";
      },
      ...
      pause() {
        if (this.el) {
          this.el.style[this.__P_270_0] = "paused";
          this.el.$$animation.__P_270_1 = false; // in case the animation is based on JS
      ...
      play() {
        if (this.el) {
          this.el.style[this.__P_270_0] = "running";
          this.el.$$animation.__P_270_1 = true; // in case the animation is based on JS
      ...
      stop() {
        if (this.el && qx.core.Environment.get("css.animation") && !this.jsAnimation) {
          this.el.style[this.__P_270_0] = "";
          this.el.style[qx.core.Environment.get("css.animation").name] = "";
          this.el.$$animation.__P_270_1 = false;
          this.el.$$animation.__P_270_3 = true;
