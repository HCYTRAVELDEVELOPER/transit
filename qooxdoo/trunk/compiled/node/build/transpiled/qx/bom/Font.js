    ...
    */
    members: {
      ...
      _applySize(value, old) {
        this.__P_238_0.fontSize = value === null ? null : value + "px";
      },

      _applyLineHeight(value, old) {
        this.__P_238_0.lineHeight = value === null ? null : value;
      },
      ...
      _applyFamily(value, old) {
        ...
        this.__P_238_0.fontFamily = family;
      },

      // property apply
      _applyBold(value, old) {
        this.__P_238_0.fontWeight = value == null ? null : value ? "bold" : "normal";
      },

      // property apply
      _applyItalic(value, old) {
        this.__P_238_0.fontStyle = value == null ? null : value ? "italic" : "normal";
      },

      // property apply
      _applyDecoration(value, old) {
        this.__P_238_0.textDecoration = value == null ? null : value;
      },

      // property apply
      _applyColor(value, old) {
        this.__P_238_0.color = null;

        if (value) {
          this.__P_238_0.color = qx.theme.manager.Color.getInstance().resolve(value);
        }
      },

      // property apply
      _applyWeight(value, old) {
        this.__P_238_0.fontWeight = value;
      },

      // property apply
      _applyTextShadow(value, old) {
        this.__P_238_0.textShadow = value == null ? null : value;
      },

      // property apply
      _applyLetterSpacing(value, old) {
        this.__P_238_0.letterSpacing = value === null ? null : value + "px";
      },
