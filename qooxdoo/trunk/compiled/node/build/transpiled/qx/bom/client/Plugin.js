  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.client.Plugin", {
    statics: {
       ...
       */
      getQuicktimeVersion() {
        var entry = qx.bom.client.Plugin.__P_193_0["quicktime"];
        return qx.bom.client.Plugin.__P_193_1(entry.control, entry.plugin);
      },
      ...
      getWindowsMediaVersion() {
        var entry = qx.bom.client.Plugin.__P_193_0["wmv"];
        return qx.bom.client.Plugin.__P_193_1(entry.control, entry.plugin, true);
      },
       ...
       */
      getDivXVersion() {
        var entry = qx.bom.client.Plugin.__P_193_0["divx"];
        return qx.bom.client.Plugin.__P_193_1(entry.control, entry.plugin);
      },
      ...
      getSilverlightVersion() {
        var entry = qx.bom.client.Plugin.__P_193_0["silverlight"];
        return qx.bom.client.Plugin.__P_193_1(entry.control, entry.plugin);
      },
       ...
       */
      getPdfVersion() {
        var entry = qx.bom.client.Plugin.__P_193_0["pdf"];
        return qx.bom.client.Plugin.__P_193_1(entry.control, entry.plugin);
      },
      ...
      getQuicktime() {
        var entry = qx.bom.client.Plugin.__P_193_0["quicktime"];
        return qx.bom.client.Plugin.__P_193_2(entry.control, entry.plugin);
      },
      ...
      getWindowsMedia() {
        var entry = qx.bom.client.Plugin.__P_193_0["wmv"];
        return qx.bom.client.Plugin.__P_193_2(entry.control, entry.plugin, true);
      },
       ...
       */
      __P_193_1(activeXName, pluginNames, forceActiveX) {
        var available = qx.bom.client.Plugin.__P_193_2(activeXName, pluginNames, forceActiveX); // don't check if the plugin is not available
       ...
       */
      __P_193_2(activeXName, pluginNames, forceActiveX) {
        // IE checks
        if (qx.bom.client.Engine.getName() == "mshtml" && (qx.bom.client.Browser.getDocumentMode() < 11 || forceActiveX)) {
          if (!this.getActiveX()) {
            return false;
