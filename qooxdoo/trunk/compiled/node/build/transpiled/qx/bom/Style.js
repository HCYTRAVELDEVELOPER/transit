  ...
  qx.Bootstrap.define("qx.bom.Style", {
    statics: {
      ...
      getCssName(propertyName) {
        var cssName = this.__P_190_0[propertyName];
        ...
        if (!cssName) {
          ...
          this.__P_190_0[propertyName] = cssName;
        }
      ...
      getAppliedStyle(element, propertyName, value, prefixed) {
        ...
        for (var i = 0, l = vendorPrefixes.length; i < l; i++) {
          ...
          if (qx.bom.Style.__P_190_1) {
            supported = qx.bom.Style.__P_190_1.call(win, cssProperty, prefixedVal);
          } else {
    ...
    defer(statics) {
      if (window.CSS && window.CSS.supports) {
        qx.bom.Style.__P_190_1 = window.CSS.supports.bind(window.CSS);
      } else if (window.supportsCSS) {
        qx.bom.Style.__P_190_1 = window.supportsCSS.bind(window);
      }
    }
