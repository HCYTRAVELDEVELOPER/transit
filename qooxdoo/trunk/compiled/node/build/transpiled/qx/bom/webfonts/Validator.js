  ...
  qx.Class.define("qx.bom.webfonts.Validator", {
    ...
    */
    ...
    construct(fontFamily, comparisonString, fontWeight, fontStyle) {
      ...
      if (fontFamily) {
        ...
        this.__P_269_0 = this._getRequestedHelpers();
      }
    },
    ...
    */
    statics: {
      ...
      removeDefaultHelperElements() {
        var defaultHelpers = qx.bom.webfonts.Validator.__P_269_2;
        ...
        delete qx.bom.webfonts.Validator.__P_269_2;
      }
    ...
    */
    members: {
      ...
      */
       ...
       */
      validate() {
        this.__P_269_4 = new Date().getTime();

        if (this.__P_269_3) {
          this.__P_269_3.restart();
        } else {
          this.__P_269_3 = new qx.event.Timer(100);

          this.__P_269_3.addListener("interval", this.__P_269_5, this); // Give the browser a chance to render the new elements


          qx.event.Timer.once(function () {
            this.__P_269_3.start();
          }, this, 0);
        }
      },
      ...
      */
      ...
      _reset() {
        if (this.__P_269_0) {
          for (var prop in this.__P_269_0) {
            var elem = this.__P_269_0[prop];
       ...
       */
      _isFontValid() {
        if (!qx.bom.webfonts.Validator.__P_269_1) {
          this.__P_269_6();
        }
        ...
        this.__P_269_0.sans.style.visibility = "visible";
        this.__P_269_0.sans.style.visibility = "hidden";
        this.__P_269_0.serif.style.visibility = "visible";
        this.__P_269_0.serif.style.visibility = "hidden";
        var requestedSans = qx.bom.element.Dimension.getWidth(this.__P_269_0.sans);
        var requestedSerif = qx.bom.element.Dimension.getWidth(this.__P_269_0.serif);
        var cls = qx.bom.webfonts.Validator;

        if (requestedSans !== cls.__P_269_1.sans || requestedSerif !== cls.__P_269_1.serif) {
          return true;
        }
      ...
      */
      ...
      __P_269_6() {
        ...
        cls.__P_269_1 = {
          sans: qx.bom.element.Dimension.getWidth(cls.__P_269_2.sans),
          serif: qx.bom.element.Dimension.getWidth(cls.__P_269_2.serif)
        };
      },
      ...
      __P_269_5() {
        if (this._isFontValid()) {
          ...
          if (now - this.__P_269_4 >= this.getTimeout()) {
            this.__P_269_3.stop();
    ...
    */
    destruct() {
      ...
      this.__P_269_3.removeListener("interval", this.__P_269_5, this);

      this._disposeObjects("__P_269_3");
    }
