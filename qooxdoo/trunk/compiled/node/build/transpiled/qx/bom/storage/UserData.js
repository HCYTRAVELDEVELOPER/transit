  ...
  qx.Bootstrap.define("qx.bom.storage.UserData", {
    statics: {
      ...
      getLocal() {
        ...
        return this.__P_185_0 = new qx.bom.storage.UserData("local");
      },
      ...
      getSession() {
        if (this.__P_185_1) {
          return this.__P_185_1;
        }

        return this.__P_185_1 = new qx.bom.storage.UserData("session");
      }
    ...
    construct(storeName) {
      ...
      this.__P_185_3 = document.createElement("div");
      this.__P_185_3.style["display"] = "none";
      document.getElementsByTagName("head")[0].appendChild(this.__P_185_3);

      this.__P_185_3.addBehavior("#default#userdata");

      this.__P_185_4 = storeName; // load the inital data which might be stored

      this.__P_185_3.load(this.__P_185_4); // set up the internal reference maps


      this.__P_185_5 = {};
      this.__P_185_6 = {}; // initialize

      var value = this.__P_185_3.getAttribute("qx" + qx.bom.storage.UserData.__P_185_2);

      while (value != undefined) {
        value = qx.lang.Json.parse(value); // save the data in the internal storage

        this.__P_185_5[value.key] = value.value; // save the reference

        this.__P_185_6[value.key] = "qx" + qx.bom.storage.UserData.__P_185_2;
        qx.bom.storage.UserData.__P_185_2++;
        value = this.__P_185_3.getAttribute("qx" + qx.bom.storage.UserData.__P_185_2);
      }
    },
    ...
    members: {
       ...
       */
      getLength() {
        return Object.keys(this.__P_185_5).length;
      },
      ...
      setItem(key, value) {
        // override case
        if (this.__P_185_6[key]) {
          var storageKey = this.__P_185_6[key]; // new case
        } else {
          var storageKey = "qx" + qx.bom.storage.UserData.__P_185_2;
          qx.bom.storage.UserData.__P_185_2++;
        ...
        this.__P_185_3.setAttribute(storageKey, storageValue);

        this.__P_185_3.save(this.__P_185_4); // also update the internal mappings


        this.__P_185_5[key] = value;
        this.__P_185_6[key] = storageKey;
      },
       ...
       */
      getItem(key) {
        return this.__P_185_5[key] || null;
      },
      ...
      removeItem(key) {
        ...
        var storageName = this.__P_185_6[key];
        ...
        this.__P_185_3.removeAttribute(storageName); // decrease the id because we removed one item


        qx.bom.storage.UserData.__P_185_2--; // update the internal maps

        delete this.__P_185_5[key];
        delete this.__P_185_6[key]; // check if we have deleted the last item

        var lastStoreName = "qx" + qx.bom.storage.UserData.__P_185_2;

        if (this.__P_185_3.getAttribute(lastStoreName)) {
          // if not, move the last item to the deleted spot
          var lastItem = this.__P_185_3.getAttribute("qx" + qx.bom.storage.UserData.__P_185_2);

          this.__P_185_3.removeAttribute(lastStoreName);

          this.__P_185_3.setAttribute(storageName, lastItem); // update the reference map


          var lastKey = qx.lang.Json.parse(lastItem).key;
          this.__P_185_6[lastKey] = storageName;
        }

        this.__P_185_3.save(this.__P_185_4);
      },
      ...
      clear() {
        ...
        for (var key in this.__P_185_6) {
          this.__P_185_3.removeAttribute(this.__P_185_6[key]);
        }

        this.__P_185_3.save(this.__P_185_4); // reset the internal maps
       ...
       */
      getKey(index) {
        return Object.keys(this.__P_185_5)[index];
      },
