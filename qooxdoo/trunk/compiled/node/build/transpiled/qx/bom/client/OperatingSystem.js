  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.client.OperatingSystem", {
    statics: {
       ...
       */
      getVersion() {
        var version = qx.bom.client.OperatingSystem.__P_148_1(navigator.userAgent);

        if (version == null) {
          version = qx.bom.client.OperatingSystem.__P_148_2(navigator.userAgent);
        }
      ...
      __P_148_1(userAgent) {
        ...
        for (var key in qx.bom.client.OperatingSystem.__P_148_0) {
          str.push(key);
        }
        ...
        if (match && match[1]) {
          return qx.bom.client.OperatingSystem.__P_148_0[match[1]];
        }
