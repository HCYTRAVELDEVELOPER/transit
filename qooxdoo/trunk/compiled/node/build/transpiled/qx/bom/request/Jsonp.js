  ...
  qx.Bootstrap.define("qx.bom.request.Jsonp", {
    ...
    members: {
      ...
      open(method, url) {
        ...
        this.__P_169_4 = false;
        callbackParam = this.__P_169_2 || "callback";
        callbackName = this.__P_169_3 || this.__P_169_8 + "qx.bom.request.Jsonp." + this.__P_169_1 + ".callback"; // Default callback

        if (!this.__P_169_3) {
          // Store globally available reference to this object
          this.constructor[this.__P_169_1] = this; // Custom callback
        } else {
          // Dynamically create globally available callback (if it does not
          // exist yet) with user defined name. Delegate to this object’s
          // callback method.
          if (!window[this.__P_169_3]) {
            this.__P_169_5 = true;

            window[this.__P_169_3] = function (data) {
              that.callback(data);
            };
          } else {
            if (qx.core.Environment.get("qx.debug.io")) {
              qx.Bootstrap.debug(qx.bom.request.Jsonp, "Callback " + this.__P_169_3 + " already exists");
            }
          }
        }
        ...
        this.__P_169_6 = url = qx.util.Uri.appendParamsToUrl(url, query);

        this.__P_169_9("open", [method, url]);
      },
      ...
      callback(data) {
        ...
        this.__P_169_4 = true; // Sanitize and parse

        // Set response
        this.responseJson = data; // Delete global reference to this

        this.constructor[this.__P_169_1] = undefined;
      ...
      _onNativeLoad() {
        ...
        this.status = this.__P_169_4 ? 200 : 500;

        this.__P_169_9("_onNativeLoad");
      },
       ...
       */
      __P_169_10() {
        if (this.__P_169_5 && window[this.__P_169_3]) {
          window[this.__P_169_3] = undefined;
          this.__P_169_5 = false;
        }
      },
      ...
      __P_169_0() {
        ...
        this.__P_169_1 = "qx" + new Date().valueOf() + ("" + Math.random()).substring(2, 5);
      }
