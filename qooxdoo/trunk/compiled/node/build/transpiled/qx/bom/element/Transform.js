  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.element.Transform", {
    statics: {
      ...
      __P_271_0: qx.core.Environment.get("css.transform"),
      ...
      transform(el, transforms) {
        ...
        if (this.__P_271_0 != null) {
          var style = this.__P_271_0["name"];
      ...
      setOrigin(el, value) {
        if (this.__P_271_0 != null) {
          el.style[this.__P_271_0["origin"]] = value;
        }
      },
      ...
      getOrigin(el) {
        if (this.__P_271_0 != null) {
          return el.style[this.__P_271_0["origin"]];
        }
      ...
      setStyle(el, value) {
        if (this.__P_271_0 != null) {
          el.style[this.__P_271_0["style"]] = value;
        }
      },
      ...
      getStyle(el) {
        if (this.__P_271_0 != null) {
          return el.style[this.__P_271_0["style"]];
        }
      ...
      setPerspective(el, value) {
        if (this.__P_271_0 != null) {
          el.style[this.__P_271_0["perspective"]] = value + "px";
        }
      },
      ...
      getPerspective(el) {
        if (this.__P_271_0 != null) {
          return el.style[this.__P_271_0["perspective"]];
        }
      ...
      setPerspectiveOrigin(el, value) {
        if (this.__P_271_0 != null) {
          el.style[this.__P_271_0["perspective-origin"]] = value;
        }
      },
      ...
      getPerspectiveOrigin(el) {
        if (this.__P_271_0 != null) {
          var value = el.style[this.__P_271_0["perspective-origin"]];

          if (value != "") {
            return value;
          } else {
            var valueX = el.style[this.__P_271_0["perspective-origin"] + "X"];
            var valueY = el.style[this.__P_271_0["perspective-origin"] + "Y"];
      ...
      setBackfaceVisibility(el, value) {
        if (this.__P_271_0 != null) {
          el.style[this.__P_271_0["backface-visibility"]] = value ? "visible" : "hidden";
        }
      },
      ...
      getBackfaceVisibility(el) {
        if (this.__P_271_0 != null) {
          return el.style[this.__P_271_0["backface-visibility"]] == "visible";
        }
