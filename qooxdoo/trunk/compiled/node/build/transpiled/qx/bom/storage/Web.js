  ...
  qx.Bootstrap.define("qx.bom.storage.Web", {
    statics: {
      ...
      getLocal() {
        ...
        return this.__P_184_0 = new qx.bom.storage.Web("local");
      },
      ...
      getSession() {
        ...
        return this.__P_184_1 = new qx.bom.storage.Web("session");
      }
    ...
    members: {
       ...
       */
      getStorage() {
        return window[this.__P_184_2 + "Storage"];
      },
       ...
       */
      getLength() {
        return this.getStorage(this.__P_184_2).length;
      },
      ...
      setItem(key, value) {
        ...
        try {
          this.getStorage(this.__P_184_2).setItem(key, value);
        } catch (e) {
       ...
       */
      getItem(key) {
        var item = this.getStorage(this.__P_184_2).getItem(key);
       ...
       */
      removeItem(key) {
        this.getStorage(this.__P_184_2).removeItem(key);
      },
       ...
       */
      clear() {
        var storage = this.getStorage(this.__P_184_2);
       ...
       */
      getKey(index) {
        return this.getStorage(this.__P_184_2).key(index);
      },
