    ...
    statics: {
      ...
      create(content, html, win) {
        ...
        if (!qx.core.Environment.get("css.textoverflow") && qx.core.Environment.get("html.xul")) {
          ...
          qx.bom.element.Style.setStyles(el, this.__P_239_4(html));
        }
      ...
      setValue(element, value) {
        ...
        if (element.useHtml) {
          if (qx.bom.Label.__P_239_5 && typeof qx.bom.Label.__P_239_5 === "function") {
            value = qx.bom.Label.__P_239_5(value);
          }
      ...
      getHtmlSize(content, styles, width) {
        var element = this._htmlElement || this.__P_239_3(); // apply width


        element.style.width = width != undefined ? width + "px" : "auto"; // insert content

        element.innerHTML = content;
        return this.__P_239_6(element, styles);
      },
      ...
      getTextSize(text, styles) {
        var element = this._textElement || this.__P_239_1();
       ...
       * @return {Map} A map with preferred <code>width</code> and <code>height</code>.
       */
      __P_239_6(element, styles) {
        // sync styles
        var keys = this.__P_239_0;
