  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.request.Script", {
    ...
    construct() {
      ...
      this.__P_164_1 = qx.Bootstrap.bind(this._onNativeLoad, this);
      this.__P_164_2 = qx.Bootstrap.bind(this._onNativeError, this);
      this.__P_164_3 = qx.Bootstrap.bind(this._onTimeout, this);
      this.__P_164_4 = document.head || document.getElementsByTagName("head")[0] || document.documentElement;
      ...
      this.timeout = this.__P_164_5() ? 0 : 15000;
    },
    ...
    members: {
      ...
      open(method, url) {
        ...
        if (this.__P_164_10("qx.debug.io")) {
      ...
      setRequestHeader(key, value) {
        ...
        param[key] = value;
        this.__P_164_9 = qx.util.Uri.appendParamsToUrl(this.__P_164_9, param);
        return this;
      },
      ...
      send() {
        ...
        var script = this.__P_164_11(),
            head = this.__P_164_4,
            that = this;

        if (this.timeout > 0) {
          this.__P_164_12 = window.setTimeout(this.__P_164_3, this.timeout);
        }
      ...
      dispose() {
        ...
        if (!this.__P_164_7) {
          ...
          if (this.__P_164_12) {
            window.clearTimeout(this.__P_164_12);
          }
      ...
      */
      ...
      _onNativeLoad() {
        var script = this.__P_164_14,
            determineSuccess = this.__P_164_6,
        ...
        if (this.__P_164_10("engine.name") === "mshtml" && this.__P_164_10("browser.documentmode") < 9) {
      ...
      */
       ...
       */
      __P_164_5() {
        var isLegacyIe = this.__P_164_10("engine.name") === "mshtml" && this.__P_164_10("browser.documentmode") < 9;
        var isOpera = this.__P_164_10("engine.name") === "opera";
       ...
       */
      __P_164_11() {
        var script = this.__P_164_14 = document.createElement("script");
        script.src = this.__P_164_9;
        script.onerror = this.__P_164_2;
        script.onload = this.__P_164_1; // BUGFIX: IE < 9
        // Legacy IEs do not fire the "load" event for script elements.
        // Instead, they support the "readystatechange" event

        if (this.__P_164_10("engine.name") === "mshtml" && this.__P_164_10("browser.documentmode") < 9) {
          script.onreadystatechange = this.__P_164_1;
        }
      ...
      __P_164_13() {
        ...
        if (script && script.parentNode) {
          this.__P_164_4.removeChild(script);
        }
      },
