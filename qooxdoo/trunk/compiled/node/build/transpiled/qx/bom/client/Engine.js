  ...
  qx.Bootstrap.define("qx.bom.client.Engine", {
    ...
    statics: {
      ...
      getVersion() {
        ...
        if (qx.bom.client.Engine.__P_147_0()) {
        ...
        } else if (qx.bom.client.Engine.__P_147_1()) {
        ...
        } else if (qx.bom.client.Engine.__P_147_2()) {
        ...
        } else if (qx.bom.client.Engine.__P_147_3()) {
      ...
      __P_147_0() {
        ...
        if (qx.bom.client.Engine.__P_147_4()) {
          return true;
        }
