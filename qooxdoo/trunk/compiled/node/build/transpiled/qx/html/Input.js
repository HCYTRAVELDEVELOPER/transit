    ...
    */
    members: {
      ...
      */
      ...
      //overridden
      _createDomElement() {
        return qx.bom.Input.create(this.__P_264_0);
      },
      ...
      setEnabled(value) {
        ...
        if (qx.core.Environment.get("engine.name") == "webkit") {
          if (!value) {
            ...
            this.setStyles({
              userModify: null,
              userSelect: this.__P_264_1 ? null : "none"
            });
          }
        }
      },
      ...
      setSelectable: qx.core.Environment.select("engine.name", {
        webkit(value) {
          this.__P_264_1 = value; // Only apply the value when it is enabled

          qx.html.Input.superclass.prototype.setSelectable.call(this, this.__P_264_2 && value);
        },
