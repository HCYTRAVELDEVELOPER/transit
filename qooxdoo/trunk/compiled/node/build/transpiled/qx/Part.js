  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.Part", {
    ...
    construct(loader) {
      ...
      this.__P_163_0 = loader; // initialize the pseudo event listener maps

      this.__P_163_1 = {};
      this.__P_163_2 = {};
      this.__P_163_3 = {}; // create the packages

      this.__P_163_4 = {};

      for (var key in loader.packages) {
        var pkg = new qx.io.part.Package(this.__P_163_5(loader.packages[key].uris), key, key == bootPackageKey);
        this.__P_163_4[key] = pkg;
      } // create the parts
      ...
      for (var name in parts) {
        ...
        for (var i = 0; i < pkgKeys.length; i++) {
          packages.push(this.__P_163_4[pkgKeys[i]]);
    ...
    members: {
      ...
      saveClosure(id, closure) {
        ...
        var pkg = this.__P_163_4[id]; // error if no package could be found
        ...
        var listeners = this.__P_163_3[id];
      ...
      require(partNames, callback, self) {
        ...
        for (var i = 0; i < partNames.length; i++) {
          var part = this.__P_163_6[partNames[i]];
      ...
      preload(partNames, callback, self) {
        ...
        for (var i = 0; i < partNames.length; i++) {
          this.__P_163_6[partNames[i]].preload(function () {
            partsPreloaded++;
            ...
            if (partsPreloaded >= partNames.length) {
              ...
              for (var i = 0; i < partNames.length; i++) {
                states.push(this.__P_163_6[partNames[i]].getReadyState());
              }
       ...
       */
      __P_163_7() {
        var packages = this.__P_163_0.packages;
        var uris = [];

        for (var key in packages) {
          uris.push(this.__P_163_5(packages[key].uris));
        }
       ...
       */
      __P_163_5: qx.$$loader.decodeUris,
      ...
      */
      ...
      addPartListener(part, callback) {
        ...
        if (!this.__P_163_1[key]) {
          this.__P_163_1[key] = [];
        }

        this.__P_163_1[key].push(callback);
      },
      ...
      notifyPartResult(part) {
        var key = part.getName();
        var listeners = this.__P_163_1[key];
      ...
      */
      ...
      addPackageListener(pkg, callback) {
        ...
        if (!this.__P_163_2[key]) {
          this.__P_163_2[key] = [];
        }

        this.__P_163_2[key].push(callback);
      },
      ...
      notifyPackageResult(pkg) {
        var key = pkg.getId();
        var listeners = this.__P_163_2[key];
