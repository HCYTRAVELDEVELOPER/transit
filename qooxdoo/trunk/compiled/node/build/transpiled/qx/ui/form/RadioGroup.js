  ...
  qx.Class.define("qx.ui.form.RadioGroup", {
    ...
    */
    ...
    construct(varargs) {
      ...
      this.__P_220_0 = []; // add listener before call add!!!

      this.addListener("changeSelection", this.__P_220_1, this);
    ...
    members: {
      ...
      */
      ...
      _applyGroupedProperty(value, old) {
        ...
        for (var i = 0; i < this.__P_220_0.length; i++) {
          item = this.__P_220_0[i]; // remove the listener for the old change event
      ...
      _applyInvalidMessage(value, old) {
        for (var i = 0; i < this.__P_220_0.length; i++) {
          this.__P_220_0[i].setInvalidMessage(value);
        }
      },
      ...
      _applyValid(value, old) {
        for (var i = 0; i < this.__P_220_0.length; i++) {
          this.__P_220_0[i].setValid(value);
        }
      },
      ...
      */
      ...
      _isItemSelectable(item) {
        return this.__P_220_0.indexOf(item) != -1;
      },
      ...
      __P_220_1(e) {
        ...
        if (value) {
          ...
          if (this.__P_220_2() && value.isFocusable()) {
            value.focus();
          }
        }
      },
