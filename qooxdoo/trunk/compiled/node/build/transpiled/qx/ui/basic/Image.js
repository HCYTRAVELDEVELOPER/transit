(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.basic.Image", {
    ...
    */
    members: {
      ...
      */
      ...
      _getContentHint() {
        return {
          width: this.__P_210_1 || 0,
          height: this.__P_210_2 || 0
        };
      },
      ...
      _applyDecorator(value, old) {
        ...
        this.__P_210_8(el, source);
      },

      // overridden
      _applyTextColor(value) {
        if (this.__P_210_9() === "font") {
          var el = this.getContentElement();
      ...
      */
      ...
      __P_210_9() {
        if (this.__P_210_3 == null) {
          ...
          if (this.getScale() && isPng && qx.core.Environment.get("css.alphaimageloaderneeded")) {
            this.__P_210_3 = "alphaScaled";
          } else if (this.getScale()) {
            this.__P_210_3 = "scaled";
          } else {
            this.__P_210_3 = "nonScaled";
          }
        }
      ...
      __P_210_11(mode) {
        ...
        if (mode == "font") {
          ...
          if (qx.core.Environment.get("css.alphaimageloaderneeded")) {
            var wrapper = this.__P_210_5 = new qx.html.Element("div");
            element.connectObject(this);
      ...
      __P_210_7() {
        ...
        var mode = this.__P_210_9();

        if (this.__P_210_0[mode] == null) {
          this.__P_210_0[mode] = this.__P_210_11(mode);
        }

        var element = this.__P_210_0[mode];

        if (!this.__P_210_4) {
          this.__P_210_4 = element;
        }
      ...
      _styleSource() {
        ...
        if (!source) {
          this.__P_210_12(element);

          return;
        }

        this.__P_210_13(source);
        ...
        var contentEl = this.__P_210_14(); // Detect if the image registry knows this image


        if (ResourceManager.isFontUri(source)) {
          this.__P_210_15(contentEl, source);
          ...
          if (highResolutionSource) {
            ...
            this.__P_210_4.setStyle("background-size", backgroundSize);
          ...
          this.__P_210_17(contentEl, source);

          this.__P_210_16();
        } else {
          this.__P_210_18(contentEl, source);
        }
      },
      ...
      __P_210_16() {
        ...
        qx.bom.AnimationFrame.request(function (rId) {
          ...
          if (rId === this.__P_210_6) {
            this.fireEvent("loaded");
          } else {
            this.fireEvent("aborted");
          }
        }.bind(this, this.__P_210_6));
      },
       ...
       */
      __P_210_13: qx.core.Environment.select("engine.name", {
        mshtml(source) {
          ...
          if (isFont) {
            this.__P_210_10("font");
          } else if (alphaImageLoader && isPng) {
            if (this.getScale() && this.__P_210_9() != "alphaScaled") {
              this.__P_210_10("alphaScaled");
            } else if (!this.getScale() && this.__P_210_9() != "nonScaled") {
              this.__P_210_10("nonScaled");
            }
          } else {
            if (this.getScale() && this.__P_210_9() != "scaled") {
              this.__P_210_10("scaled");
            } else if (!this.getScale() && this.__P_210_9() != "nonScaled") {
              this.__P_210_10("nonScaled");
            }
          }

          this.__P_210_19(this.__P_210_7());
        },
        ...
        default(source) {
          ...
          if (isFont) {
            this.__P_210_10("font");
          } else if (this.getScale() && this.__P_210_9() != "scaled") {
            this.__P_210_10("scaled");
          } else if (!this.getScale() && this.__P_210_9() != "nonScaled") {
            this.__P_210_10("nonScaled");
          }
       ...
       */
      __P_210_19(elementToAdd) {
        var currentContentElement = this.__P_210_4;
        ...
        if (currentContentElement != elementToAdd) {
          if (currentContentElement != null) {
            ...
            styles.zIndex = 10;
            var newEl = this.__P_210_5 ? elementToAdd.getChild(0) : elementToAdd;
      ...
      __P_210_15(el, source) {
        ...
        if (isFont) {
          ...
          if (this.getScale()) {
            ...
            var font = this.__P_210_20(source);
          ...
          this.__P_210_21(width, height);

          this.__P_210_8(el, source); // Apply source

        } else {
          // Apply source
          this.__P_210_8(el, source); // Compare with old sizes and relayout if necessary


          this.__P_210_21(ResourceManager.getImageWidth(source), ResourceManager.getImageHeight(source));
        }
      },

      __P_210_22(el, width, height) {
        if (this.getScale()) {
      ...
      _applyDimension() {
        ...
        if (isFont) {
          ...
          if (el) {
            ...
            this.__P_210_22(el, width, height);
          }
        } else {
          this.__P_210_21();
        }
      ...
      __P_210_8(el, source) {
        ...
        if (isFont) {
          ...
          this.__P_210_22(el, this.__P_210_1, this.__P_210_2);
      ...
      __P_210_23(source, imageInfo) {
        ...
        this.__P_210_17(this.__P_210_14(), source);
      },
       ...
       */
      __P_210_21(width, height) {
        if (width === undefined) {
          width = this.__P_210_1;
        }

        if (height === undefined) {
          height = this.__P_210_2;
        }
      ...
      _recalc(originalWidth, originalHeight) {
        ...
        if (width != this.__P_210_1 || height != this.__P_210_2) {
          this.__P_210_1 = width;
          this.__P_210_2 = height;
          return true;
        }
    ...
    */
    destruct() {
      for (var mode in this.__P_210_0) {
        if (this.__P_210_0.hasOwnProperty(mode)) {
          this.__P_210_0[mode].disconnectObject(this);
        }
      }

      delete this.__P_210_4;

      if (this.__P_210_5) {
        delete this.__P_210_5;
      }

      this._disposeMap("__P_210_0");
    }
