  ...
  qx.Class.define("qx.ui.core.EventHandler", {
    ...
    */
    construct() {
      ...
      this.__P_227_0 = qx.event.Registration.getManager(window);
    },
    ...
    */
    ...
    members: {
      ...
      _dispatchEvent(domEvent) {
        ...
        if (this.__P_227_1[domEvent.getType()]) {
        ...
        if (!currentWidget || !(currentWidget.isEnabled() || this.__P_227_2[type])) {
          return;
        } // PROCESS LISTENERS
        // Load listeners
        ...
        var listeners = this.__P_227_0.getListeners(currentWidget, type, capture);
        ...
        if (domEvent.getEventPhase() == qx.event.type.Event.AT_TARGET) {
          ...
          var otherListeners = this.__P_227_0.getListeners(currentWidget, type, !capture);
