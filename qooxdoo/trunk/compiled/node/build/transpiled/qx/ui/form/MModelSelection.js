  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.ui.form.MModelSelection", {
    construct() {
      ...
      this.__P_246_0 = new qx.data.Array(); // listen to the changes

      this.__P_246_0.addListener("change", this.__P_246_1, this);

      this.addListener("changeSelection", this.__P_246_2, this);
    },
    ...
    members: {
      ...
      __P_246_1() {
        ...
        var modelSelection = this.__P_246_0.toArray();
        ...
        this.__P_246_3 = false; // check if the setting has worked
      ...
      setModelSelection(modelSelection) {
        ...
        if (!modelSelection) {
          this.__P_246_0.removeAll();

          return;
        }

        // add the first two parameter
        modelSelection.unshift(this.__P_246_0.getLength()); // remove index

        modelSelection.unshift(0); // start index

        var returnArray = this.__P_246_0.splice.apply(this.__P_246_0, modelSelection);
    ...
    destruct() {
      this._disposeObjects("__P_246_0");
    }
...
//# sourceMappingURL=MModelSelection.js.map