  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.core.queue.Layout", {
    statics: {
       ...
       */
      remove(widget) {
        delete this.__P_205_0[widget.toHashCode()];
      },
       ...
       */
      add(widget) {
        this.__P_205_0[widget.toHashCode()] = widget;
       ...
       */
      isScheduled(widget) {
        return !!this.__P_205_0[widget.toHashCode()];
      },
      ...
      flush() {
        ...
        var queue = this.__P_205_2(); // iterate in reversed order to process widgets with the smallest nesting
      ...
      __P_205_3() {
        ...
        this.__P_205_1 = {}; // sparse level array

        var levels = [];
        var queue = this.__P_205_0;
        var widget, level;
