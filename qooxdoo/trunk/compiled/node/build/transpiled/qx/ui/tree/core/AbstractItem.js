  ...
  qx.Class.define("qx.ui.tree.core.AbstractItem", {
    ...
    members: {
      ...
      */
      ...
      addSpacer() {
        if (!this.__P_211_2) {
          this.__P_211_2 = new qx.ui.core.Spacer();
        } else {
          this._remove(this.__P_211_2);
        }

        this._add(this.__P_211_2);
      },
      ...
      */
      ...
      _applyIconOpened(value, old) {
        if (this.isOpen()) {
          ...
          if (this.__P_211_5() && this.__P_211_3()) {
            this.__P_211_4(value);
          } // .. only "opened" icon was user-defined
          else if (!this.__P_211_5() && this.__P_211_3()) {
            this.__P_211_4(value);
          }
        }
      },
      ...
      _applyOpen(value, old) {
        ...
        if (value) {
          ...
          source = this.__P_211_3() ? this.getIconOpened() : null;
        } // Closed
        else {
          source = this.getIcon();
        }
      ...
      */
      ...
      _updateIndent() {
        ...
        if (this.__P_211_2) {
          this.__P_211_2.setWidth((this.getLevel() + 1) * this.getIndent() - openWidth);
        }
      },
...
//# sourceMappingURL=AbstractItem.js.map