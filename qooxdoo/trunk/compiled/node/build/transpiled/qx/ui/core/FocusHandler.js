(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.core.FocusHandler", {
    ...
    */
    members: {
      ...
      connectTo(root) {
        ...
        root.addListener("keypress", this.__P_247_4, this);
      ...
      addRoot(widget) {
        ...
        this.__P_247_0[widget.toHashCode()] = widget;
      },
      ...
      removeRoot(widget) {
        ...
        delete this.__P_247_0[widget.toHashCode()];
      },
       ...
       */
      isFocusRoot(widget) {
        return !!this.__P_247_0[widget.toHashCode()];
      },
      ...
      */
      ...
      _onActivate(e) {
        ...
        this.__P_247_1 = target; //this.debug("active: " + target);

        var root = this.__P_247_5(target);

        if (root != this.__P_247_3) {
          this.__P_247_3 = root;
        }
      },
      ...
      _onFocusIn(e) {
        ...
        if (target != this.__P_247_2) {
          this.__P_247_2 = target;
      ...
      __P_247_4(e) {
        ...
        var current = this.__P_247_2;

        if (!e.isShiftPressed()) {
          var next = current ? this.__P_247_6(current) : this.__P_247_7();
        } else {
          var next = current ? this.__P_247_8(current) : this.__P_247_9();
      ...
      */
       ...
       */
      __P_247_7() {
        return this.__P_247_11(this.__P_247_3, null);
      },
       ...
       */
      __P_247_9() {
        return this.__P_247_12(this.__P_247_3, null);
      },
       ...
       */
      __P_247_6(widget) {
        var root = this.__P_247_3;

        if (root == widget) {
          return this.__P_247_7();
        }
        ...
        this.__P_247_13(root, widget, result);

        result.sort(this.__P_247_10);
        var len = result.length;
        return len > 0 ? result[0] : this.__P_247_7();
      },
      ...
      __P_247_8(widget) {
        ...
        this.__P_247_14(root, widget, result);

        result.sort(this.__P_247_10);
        var len = result.length;
        return len > 0 ? result[len - 1] : this.__P_247_9();
      },
      ...
      */
       ...
       */
      __P_247_13(parent, widget, result) {
        ...
        for (var i = 0, l = children.length; i < l; i++) {
          ...
          if (!this.isFocusRoot(child) && child.isEnabled() && child.isVisible()) {
            if (child.isTabable() && this.__P_247_10(widget, child) < 0) {
              result.push(child);
            }

            this.__P_247_13(child, widget, result);
          }
        }
      },
       ...
       * @param result {Array} Result list
       */
      __P_247_14(parent, widget, result) {
        var children = parent.getLayoutChildren();
        var child;
        ...
        for (var i = 0, l = children.length; i < l; i++) {
          ...
          if (!this.isFocusRoot(child) && child.isEnabled() && child.isVisible()) {
            ...
            this.__P_247_14(child, widget, result);
          }
        }
      },
      ...
      __P_247_11(parent, firstWidget) {
        ...
        for (var i = 0, l = children.length; i < l; i++) {
          ...
          if (!this.isFocusRoot(child) && child.isEnabled() && child.isVisible()) {
            if (child.isTabable()) {
              if (firstWidget == null || this.__P_247_10(child, firstWidget) < 0) {
                firstWidget = child;
              }
            } // Deep iteration into children hierarchy


            firstWidget = this.__P_247_11(child, firstWidget);
          }
        }
      ...
      __P_247_12(parent, lastWidget) {
        ...
        for (var i = 0, l = children.length; i < l; i++) {
          ...
          if (!this.isFocusRoot(child) && child.isEnabled() && child.isVisible()) {
            if (child.isTabable()) {
              if (lastWidget == null || this.__P_247_10(child, lastWidget) > 0) {
                lastWidget = child;
              }
            } // Deep iteration into children hierarchy


            lastWidget = this.__P_247_12(child, lastWidget);
          }
        }
    ...
    */
    destruct() {
      this._disposeMap("__P_247_0");

      this.__P_247_2 = this.__P_247_1 = this.__P_247_3 = null;
    }
