  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.ui.decoration.MLinearBackgroundGradient", {
    ...
    members: {
      ...
      _styleLinearBackgroundGradient(styles) {
        ...
        (function (startColors, endColors, units, orientations, startColorPositions, endColorPositions) {
          for (var i = 0; i < startColors.length; i++) {
            var startColor = this.__P_267_4(startColors[i]);

            var endColor = this.__P_267_4(endColors[i]);
       ...
       */
      __P_267_1(startColor, endColor, unit, orientation, startColorPosition, endColorPosition, styles, backgroundStyle) {
       ...
       * @return {Boolean} Whether this implementation supports multiple gradients atop each other (true).
       */
      __P_267_2(startColor, endColor, unit, orientation, startColorPosition, endColorPosition, styles, backgroundStyle) {
        const me = qx.ui.decoration.MLinearBackgroundGradient.__P_267_2;

        if (!me.__P_267_5) {
          me.__P_267_5 = document.createElement("canvas");
        }
        ...
        me.__P_267_5.width = width;
        me.__P_267_5.height = height;

        var ctx = me.__P_267_5.getContext("2d");
        ...
        backgroundStyle.push("url(" + me.__P_267_5.toDataURL() + ") " + size);
        return true;
      },
       ...
       */
      __P_267_3(startColor, endColor, unit, orientation, startColorPosition, endColorPosition, styles, backgroundStyle) {
       ...
       * @return {Boolean} Whether this implementation supports multiple gradients atop each other (true).
       */
      __P_267_0(startColor, endColor, unit, orientation, startColorPosition, endColorPosition, styles, backgroundStyle) {
...
//# sourceMappingURL=MLinearBackgroundGradient.js.map