  ...
  qx.Class.define("qx.ui.basic.Label", {
    ...
    */
    ...
    members: {
      ...
      */
      ...
      _getContentHint() {
        if (this.__P_209_1) {
          this.__P_209_4 = this.__P_209_5();
          delete this.__P_209_1;
        }

        return {
          width: this.__P_209_4.width,
          height: this.__P_209_4.height
        };
      },
      ...
      _getContentHeightForWidth(width) {
        ...
        return this.__P_209_5(width).height;
      },
      ...
      */
      ...
      _applyFont(value, old) {
        if (old && this.__P_209_0 && this.__P_209_3) {
          this.__P_209_0.removeListenerById(this.__P_209_3);
        ...
        if (value) {
          this.__P_209_0 = qx.theme.manager.Font.getInstance().resolve(value);

          if (this.__P_209_0 instanceof qx.bom.webfonts.WebFont) {
            if (!this.__P_209_0.isValid()) {
              this.__P_209_3 = this.__P_209_0.addListener("changeStatus", this._onWebFontStatusChange, this);
            }
          }

          styles = this.__P_209_0.getStyles();
        } else {
          this.__P_209_0 = null;
        ...
        this.__P_209_1 = true; // Update layout
      ...
      __P_209_5(width) {
        ...
        var styles = font ? this.__P_209_0.getStyles() : qx.bom.Font.getDefaultStyles();
      ...
      */
      ...
      _applyBuddy(value, old) {
        if (old != null) {
          ...
          this.removeListenerById(this.__P_209_2);
          this.__P_209_2 = null;
        }

        if (value != null) {
          value.bind("enabled", this, "enabled");
          this.__P_209_2 = this.addListener("tap", function () {
    ...
    */
    destruct() {
      ...
      if (this.__P_209_0 && this.__P_209_3) {
        this.__P_209_0.removeListenerById(this.__P_209_3);
      }
