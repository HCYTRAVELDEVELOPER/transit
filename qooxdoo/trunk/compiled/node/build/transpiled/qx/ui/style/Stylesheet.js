  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.style.Stylesheet", {
    ...
    construct() {
      ...
      this.__P_254_0 = qx.bom.Stylesheet.createElement();
      this.__P_254_1 = [];
    },
    ...
    members: {
      ...
      addRule(selector, css) {
        ...
        qx.bom.Stylesheet.addRule(this.__P_254_0, selector, css);

        this.__P_254_1.push(selector);
      },
       ...
       */
      hasRule(selector) {
        return this.__P_254_1.indexOf(selector) != -1;
      },
       ...
       */
      removeRule(selector) {
        delete this.__P_254_1[this.__P_254_1.indexOf(selector)];
        qx.bom.Stylesheet.removeRule(this.__P_254_0, selector);
      }
