    ...
    */
    members: {
      ...
      _applyCommand(value, old) {
        // execute forwarding
        if (old != null) {
          old.removeListenerById(this.__P_201_2);
        }

        if (value != null) {
          this.__P_201_2 = value.addListener("execute", this.__P_201_3, this);
        } // binding stuff


        var ids = this.__P_201_0;
...
//# sourceMappingURL=MExecutable.js.map