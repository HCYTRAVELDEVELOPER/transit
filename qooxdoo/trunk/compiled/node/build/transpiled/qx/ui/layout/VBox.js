(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.layout.VBox", {
    ...
    members: {
      ...
      */
      ...
      __P_213_4() {
        ...
        var reuse = this.__P_213_0 && this.__P_213_0.length != length && this.__P_213_1 && this.__P_213_0;
        var props; // Sparse array (keep old one if lengths has not been modified)

        var heights = reuse ? this.__P_213_0 : new Array(length);
        var flexs = reuse ? this.__P_213_1 : new Array(length); // Reverse support
        ...
        if (!reuse) {
          this.__P_213_0 = heights;
          this.__P_213_1 = flexs;
        }

        this.__P_213_2 = enableFlex;
        this.__P_213_3 = children; // Clear invalidation marker
      ...
      */
      ...
      renderLayout(availWidth, availHeight, padding) {
        ...
        if (this.__P_213_2 && allocatedHeight != availHeight) {
          var flexibles = {};
          var flex, offset;
          var notEnoughSpace = allocatedHeight > availHeight;

          for (i = 0; i < length; i += 1) {
            flex = this.__P_213_1[i];
      ...
      _computeSizeHint() {
        ...
        var children = this.__P_213_3; // Initialize
        ...
        for (var i = 0, l = children.length; i < l; i += 1) {
          ...
          var flex = this.__P_213_1[i];
          var percent = this.__P_213_0[i];
    ...
    */
    destruct() {
      this.__P_213_0 = this.__P_213_1 = this.__P_213_3 = null;
    }
