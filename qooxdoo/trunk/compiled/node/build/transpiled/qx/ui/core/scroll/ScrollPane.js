      ...
      */
      ...
      scrollToX(value, duration) {
        ...
        if (duration) {
          ...
          this.__P_212_0 = new qx.bom.AnimationFrame();

          this.__P_212_0.on("end", function () {
            this.setScrollX(value);
            this.__P_212_0 = null;
            this.fireEvent("scrollAnimationEnd");
          }, this);

          this.__P_212_0.on("frame", function (timePassed) {
            var newX = parseInt(timePassed / duration * (value - from) + from);
            this.setScrollX(newX);
          }, this);

          this.__P_212_0.startSequence(duration);
        } else {
          this.setScrollX(value);
        }
      },
