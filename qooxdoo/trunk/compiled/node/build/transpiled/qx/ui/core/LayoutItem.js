  ...
  qx.Class.define("qx.ui.core.LayoutItem", {
    ...
    */
    ...
    members: {
      ...
      */
       ...
       */
      getBounds() {
        return this.__P_229_5 || this.__P_229_1 || null;
      },

      /**
       * Reconfigure number of separators
       */
      clearSeparators() {// empty template
      },
       ...
       */
      renderSeparator(separator, bounds) {// empty template
      },
      ...
      renderLayout(left, top, width, height) {
        ...
        var computed = this.__P_229_1;

        if (!computed) {
          computed = this.__P_229_1 = {};
        } // Detect changes
        ...
        if (this.__P_229_2) {
          changes.local = true;
          delete this.__P_229_2;
        }

        if (this.__P_229_4) {
          changes.margin = true;
          delete this.__P_229_4;
        }
        /*
        ...
        if (this.getHeight() == null && this._hasHeightForWidth()) {
          ...
          if (flowHeight != null && flowHeight !== this.__P_229_0) {
            // This variable is used in the next computation of the size hint
            this.__P_229_0 = flowHeight; // Re-add to layout queue
      ...
      getSizeHint(compute) {
        ...
        hint = this.__P_229_3 = this._computeSizeHint(); // Respect height for width

        if (this._hasHeightForWidth() && this.__P_229_0 && this.getHeight() == null) {
          hint.height = this.__P_229_0;
        } // normalize width
      ...
      */
      ...
      setLayoutProperties(props) {
        ...
        var storage = this.__P_229_6;

        if (!storage) {
          storage = this.__P_229_6 = {};
       ...
       */
      getLayoutProperties() {
        return this.__P_229_6 || this.__P_229_7;
      },
      ...
      */
      ...
      clone() {
        ...
        var props = this.__P_229_6;

        if (props) {
          clone.__P_229_6 = qx.lang.Object.clone(props);
        }
    ...
    */
    destruct() {
      ...
      this.$$parent = this.$$subparent = this.__P_229_6 = this.__P_229_1 = this.__P_229_5 = this.__P_229_3 = null;
    }
