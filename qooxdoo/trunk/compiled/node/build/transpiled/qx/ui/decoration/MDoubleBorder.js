  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.ui.decoration.MDoubleBorder", {
    ...
    construct() {
      ...
      this._getDefaultInsetsForBorder = this.__P_266_0;
      this._styleBorder = this.__P_266_1;
    },
    ...
    */
    ...
    members: {
      ...
      __P_266_1(styles) {
        ...
        if (innerOpacity < 1) {
          this.__P_266_2(innerColor, innerOpacity);
        } // inner border
       ...
       */
      __P_266_2(innerColor, innerOpacity) {
...
//# sourceMappingURL=MDoubleBorder.js.map