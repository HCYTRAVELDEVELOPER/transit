  ...
  qx.Mixin.define("qx.ui.core.MPlacement", {
    ...
    members: {
      ...
      placeToWidget(target, liveupdate) {
        ...
        if (liveupdate) {
          this.__P_256_5(); // Bind target and livupdate to placeToWidget


          this.__P_256_2 = qx.lang.Function.bind(this.placeToWidget, this, target, false);
          qx.event.Idle.getInstance().addListener("interval", this.__P_256_2); // Remove the listener when the element disappears.

          this.__P_256_4 = function () {
            this.__P_256_5();
          };

          this.addListener("disappear", this.__P_256_4, this);
        }
      ...
      __P_256_5() {
        if (this.__P_256_2) {
          qx.event.Idle.getInstance().removeListener("interval", this.__P_256_2);
          this.__P_256_2 = null;
        }

        if (this.__P_256_4) {
          this.removeListener("disappear", this.__P_256_4, this);
          this.__P_256_4 = null;
        }
      },
      ...
      placeToElement(elem, liveupdate) {
        ...
        if (liveupdate) {
          ...
          this.__P_256_2 = qx.lang.Function.bind(this.placeToElement, this, elem, false);
          qx.event.Idle.getInstance().addListener("interval", this.__P_256_2); // Remove the listener when the element disappears.
...
//# sourceMappingURL=MPlacement.js.map