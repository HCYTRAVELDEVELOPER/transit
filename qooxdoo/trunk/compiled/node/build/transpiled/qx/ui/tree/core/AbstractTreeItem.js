(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.tree.core.AbstractTreeItem", {
    ...
    members: {
      ...
      */
      ...
      getChildrenContainer() {
        if (!this.__P_182_1) {
          this.__P_182_1 = new qx.ui.container.Composite(new qx.ui.layout.VBox()).set({
      ...
      */
      ...
      // overridden
      hasChildren() {
        return this.__P_182_0 ? this.__P_182_0.length > 0 : false;
      },
      ...
      addAt(treeItem, index) {
        if (index == this.__P_182_0.length) {
          this.add(treeItem);
          return;
        }
        ...
        treeItem.setParent(this);
        var hasChildren = this.hasChildren();
        var nextItem = this.__P_182_0[index];
        ...
        qx.lang.Array.insertAt(this.__P_182_0, treeItem, index);
      ...
      addBefore(treeItem, before) {
        ...
        this.addAt(treeItem, this.__P_182_0.indexOf(before));
      },
      ...
      addAfter(treeItem, after) {
        ...
        this.addAt(treeItem, this.__P_182_0.indexOf(after) + 1);
      },
      ...
      remove(varargs) {
        for (var i = 0, l = arguments.length; i < l; i++) {
          ...
          if (this.__P_182_0.indexOf(treeItem) == -1) {
          ...
          qx.lang.Array.remove(this.__P_182_0, treeItem);
      ...
      removeAll() {
        ...
        var children = this.__P_182_0.concat();

        for (var i = this.__P_182_0.length - 1; i >= 0; i--) {
          this.remove(this.__P_182_0[i]);
        }
    ...
    destruct() {
      this._disposeArray("__P_182_0");

      this._disposeObjects("__P_182_1");
    }
...
//# sourceMappingURL=AbstractTreeItem.js.map