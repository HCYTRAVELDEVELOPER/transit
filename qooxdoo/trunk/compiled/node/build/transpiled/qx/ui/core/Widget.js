  ...
  qx.Class.define("qx.ui.core.Widget", {
    ...
    */
    construct() {
      ...
      this.__P_208_0 = this.__P_208_1(); // Initialize properties
    ...
    */
    statics: {
      ...
      __P_208_2: new qx.util.ObjectPool()
    },
    ...
    */
    members: {
      ...
      */
      ...
      _setLayout(layout) {
        if (this.__P_208_5) {
          this.__P_208_5.connectToWidget(null);
        }
      ...
      renderLayout(left, top, width, height) {
        ...
        if (inner || changes.local || changes.margin) {
          if (this.__P_208_5 && this.hasLayoutChildren()) {
            ...
            this.__P_208_5.renderLayout(innerWidth, innerHeight, padding);
      ...
      */
      ...
      // overridden
      clearSeparators() {
        var reg = this.__P_208_6;

        if (!reg) {
          return;
        }

        var pool = qx.ui.core.Widget.__P_208_2;
        var content = this.getContentElement();
        var widget;
      ...
      renderSeparator(separator, bounds) {
        // Insert
        var widget = qx.ui.core.Widget.__P_208_2.getObject(qx.ui.core.Widget);
      ...
      */
      ...
      invalidateLayoutCache() {
        ...
        if (this.__P_208_5) {
          this.__P_208_5.invalidateLayoutCache();
        }
      },
      ...
      */
       ...
       */
      getLayoutChildren() {
        var children = this.__P_208_7;

        if (!children) {
          return this.__P_208_8;
        }
       ...
       */
      _getChildren() {
        return this.__P_208_7 || this.__P_208_8;
      },
      ...
      _add(child, options) {
        ...
        if (child.getLayoutParent() == this) {
          qx.lang.Array.remove(this.__P_208_7, child);
        }

        if (this.__P_208_7) {
          this.__P_208_7.push(child);
        } else {
          this.__P_208_7 = [child];
        }

        this.__P_208_9(child, options);
      },
      ...
      _addAt(child, index, options) {
        ...
        if (ref) {
          qx.lang.Array.insertBefore(this.__P_208_7, child, ref);
        } else {
          this.__P_208_7.push(child);
        }
      ...
      _addBefore(child, before, options) {
        ...
        qx.lang.Array.insertBefore(this.__P_208_7, child, before);
      ...
      _addAfter(child, after, options) {
        ...
        qx.lang.Array.insertAfter(this.__P_208_7, child, after);
      ...
      _removeAt(index) {
        ...
        var child = this.__P_208_7[index];
        qx.lang.Array.removeAt(this.__P_208_7, index);
      ...
      _removeAll() {
        ...
        var children = this.__P_208_7.concat();

        this.__P_208_7.length = 0;

        for (var i = children.length - 1; i >= 0; i--) {
          this.__P_208_10(children[i]);
        }
      ...
      */
      ...
      __P_208_10(child) {
        ...
        if (this.__P_208_5) {
          this.__P_208_5.invalidateChildrenCache();
        } // Add to layout queue
      ...
      */
      ...
      _applyToolTipText(value, old) {
        {
          ...
          this.__P_208_4 = manager.addListener("changeLocale", function () {
      ...
      // property apply
      _applyTextColor(value, old) {// empty template
      },
      ...
      // property apply
      _applyFont(value, old) {// empty template
      },
      ...
      */
      ...
      addState(state) {
        ...
        this.__P_208_12[state] = true; // Fast path for hovered state
      ...
      removeState(state) {
        ...
        delete this.__P_208_12[state]; // Fast path for hovered state
      ...
      */
      ...
      syncAppearance() {
        ...
        if (this.__P_208_15) {
          // Clear flag
          delete this.__P_208_15; // Check if the selector was created previously
        ...
        this.fireDataEvent("syncAppearance", this.__P_208_12);
      },
      ...
      updateAppearance() {
        // Clear selector
        this.__P_208_15 = true; // Add to appearance queue
      ...
      */
       ...
       */
      syncWidget(jobs) {// empty implementation
      },
      ...
      */
      // property apply
      _applyNativeContextMenu(value, old, name) {// empty body to allow overriding
      },
      ...
      */
      ...
      getChildControl(id, notcreate) {
        ...
        var control = this.__P_208_13[id];
      ...
      _createChildControl(id) {
        ...
        return this.__P_208_13[id] = control;
      },
      ...
      */
      ...
      addAriaLabelledBy(...labelWidgets) {
        this.__P_208_16(labelWidgets, "aria-labelledby");
      },
      ...
      addAriaDescribedBy(...describingWidgets) {
        this.__P_208_16(describingWidgets, "aria-describedby");
      },
    ...
    */
    destruct() {
      ...
      if (!qx.core.ObjectRegistry.inShutDown) {
        {
          if (this.__P_208_4) {
            qx.locale.Manager.getInstance().removeListenerById(this.__P_208_4);
          }
      ...
      if (!qx.core.ObjectRegistry.inShutDown) {
        ...
        this._disposeArray("__P_208_6");
      } // Clear children array


      this._disposeArray("__P_208_7"); // Cleanup map of appearance states


      this.__P_208_12 = this.__P_208_13 = null; // Dispose layout manager and HTML elements

      this._disposeObjects("__P_208_5", "__P_208_0");
    }
