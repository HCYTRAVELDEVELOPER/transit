  ...
  qx.Class.define("qx.ui.core.SingleSelectionManager", {
    ...
    */
    ...
    construct(selectionProvider) {
      ...
      this.__P_259_0 = selectionProvider;
    },
    ...
    */
    members: {
      ...
      */
       ...
       */
      getSelectables(all) {
        var items = this.__P_259_0.getItems();

        var result = [];

        for (var i = 0; i < items.length; i++) {
          if (this.__P_259_0.isItemSelectable(items[i])) {
            result.push(items[i]);
          }
      ...
      */
       ...
       */
      __P_259_4(item) {
        var oldSelected = this.__P_259_2;
     ...
     */
    destruct() {
      if (this.__P_259_0.toHashCode) {
        this._disposeObjects("__P_259_0");
      } else {
        this.__P_259_0 = null;
      }

      this._disposeObjects("__P_259_2");
    }
...
//# sourceMappingURL=SingleSelectionManager.js.map