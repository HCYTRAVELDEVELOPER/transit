    ...
    statics: {
      ...
      remove(widget, job) {
        ...
        if (job == null) {
          ...
          delete this.__P_159_1[hash];
          return;
        }

        if (this.__P_159_1[hash]) {
          delete this.__P_159_1[hash][job];

          if (qx.lang.Object.getLength(this.__P_159_1[hash]) == 0) {
            qx.lang.Array.remove(queue, widget);
          }
        }
      },
       ...
       */
      add(widget, job) {
        var queue = this.__P_159_0; //add widget if not containing
      ...
      flush() {
        ...
        for (var i = queue.length - 1; i >= 0; i--) {
          ...
          obj = queue[i];
          jobs = this.__P_159_1[obj.toHashCode()];
          queue.splice(i, 1);
          obj.syncWidget(jobs);
        } // Empty check
