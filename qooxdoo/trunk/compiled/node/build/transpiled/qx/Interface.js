  ...
  qx.Bootstrap.define("qx.Interface", {
    statics: {
      ...
      */
       ...
       */
      __P_154_0(object, clazz, iface, wrap, shouldThrow) {
        // Validate members
        ...
        if (members) {
          for (var key in members) {
            if (qx.Bootstrap.isFunction(members[key])) {
              var isPropertyMethod = this.__P_154_1(clazz, key);
              ...
              if (shouldWrapFunction) {
                object[key] = this.__P_154_2(iface, object[key], key, members[key]);
              }
            } else {
       ...
       */
      __P_154_3(clazz, iface, shouldThrow) {
        if (iface.$$properties) {
       ...
       */
      __P_154_4(clazz, iface, shouldThrow) {
        if (iface.$$events) {
      ...
      assertObject(object, iface) {
        ...
        this.__P_154_0(object, clazz, iface, false, true);

        this.__P_154_3(clazz, iface, true);

        this.__P_154_4(clazz, iface, true); // Validate extends, recursive
      ...
      assert(clazz, iface, wrap) {
        this.__P_154_0(clazz.prototype, clazz, iface, wrap, true);
      ...
      objectImplements(object, iface) {
        ...
        if (!this.__P_154_0(object, clazz, iface) || !this.__P_154_3(clazz, iface) || !this.__P_154_4(clazz, iface)) {
          return false;
      ...
      classImplements(clazz, iface) {
        if (!this.__P_154_0(clazz.prototype, clazz, iface) || !this.__P_154_3(clazz, iface) || !this.__P_154_4(clazz, iface)) {
          return false;
        } // Validate extends, recursive
      ...
      */
       ...
       */
      __P_154_2: qx.core.Environment.select("qx.debug", {
      ...
      __P_154_5: qx.core.Environment.select("qx.debug", {
        true: {
          extend: "object",
          // Interface | Interface[]
          statics: "object",
       ...
       */
      __P_154_6: qx.core.Environment.select("qx.debug", {
        true(name, config) {},
