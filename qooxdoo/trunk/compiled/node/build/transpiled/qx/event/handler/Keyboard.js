  ...
  qx.Class.define("qx.event.handler.Keyboard", {
    ...
    */
    ...
    construct(manager) {
      ...
      this.__P_173_0 = manager;
      this.__P_173_1 = manager.getWindow(); // Gecko ignores key events when not explicitly clicked in the document.

      if (qx.core.Environment.get("engine.name") == "gecko") {
        this.__P_173_2 = this.__P_173_1;
      } else {
        this.__P_173_2 = this.__P_173_1.document.documentElement;
      } // Internal sequence cache


      this.__P_173_3 = {}; // Initialize observer
    ...
    members: {
      ...
      */
      ...
      _fireInputEvent(domEvent, charCode) {
        ...
        if (target && target.offsetWidth != 0) {
          ...
          qx.event.Utils.then(tracker, function () {
            self.__P_173_0.dispatchEvent(target, event);
          });
        ...
        if (this.__P_173_1) {
          var self = this;
          qx.event.Utils.then(tracker, function () {
            return qx.event.Registration.fireEvent(self.__P_173_1, "useraction", qx.event.type.Data, ["keyinput"]);
          });
        }
      ...
      _fireSequenceEvent(domEvent, type, keyIdentifier) {
        ...
        qx.event.Utils.then(tracker, function () {
          return self.__P_173_0.dispatchEvent(target, event);
        ...
        if (this.__P_173_1) {
          qx.event.Utils.then(tracker, function () {
            return qx.event.Registration.fireEvent(self.__P_173_1, "useraction", qx.event.type.Data, [type]);
          });
        }
       ...
       */
      __P_173_8() {
        var focusHandler = this.__P_173_0.getHandler(qx.event.handler.Focus);
        ...
        if (!target || target.offsetWidth == 0) {
          target = this.__P_173_0.getWindow().document.body;
        }
      ...
      */
       ...
       */
      _initKeyObserver() {
        this.__P_173_4 = qx.lang.Function.listener(this.__P_173_9, this);
        this.__P_173_7 = qx.lang.Function.listener(this.__P_173_10, this);
        var Event = qx.bom.Event;
        Event.addNativeListener(this.__P_173_2, "keyup", this.__P_173_4);
        Event.addNativeListener(this.__P_173_2, "keydown", this.__P_173_4);
        Event.addNativeListener(this.__P_173_2, "keypress", this.__P_173_7);
      },
      ...
      _stopKeyObserver() {
        var Event = qx.bom.Event;
        Event.removeNativeListener(this.__P_173_2, "keyup", this.__P_173_4);
        Event.removeNativeListener(this.__P_173_2, "keydown", this.__P_173_4);
        Event.removeNativeListener(this.__P_173_2, "keypress", this.__P_173_7);

        for (var key in this.__P_173_6 || {}) {
          var listener = this.__P_173_6[key];
          Event.removeNativeListener(listener.target, "keypress", listener.callback);
        }

        delete this.__P_173_6;
      },
      ...
      */
       ...
       */
      __P_173_9: qx.event.GlobalError.observeMethod(qx.core.Environment.select("engine.name", {
        "gecko|webkit|mshtml"(domEvent) {
          ...
          this.__P_173_3[keyCode] = type;
          return tracker.promise;
        },

        opera(domEvent) {
          this.__P_173_5 = domEvent.keyCode;
       ...
       */
      __P_173_11: qx.core.Environment.select("engine.name", {
          ...
          if (type === "keydown" && (keyCode == 33 || keyCode == 34 || keyCode == 38 || keyCode == 40) && target.type == "text" && target.tagName.toLowerCase() === "input" && target.getAttribute("autoComplete") !== "off") {
            ...
            this.__P_173_6[hash] = {
              ...
              callback(domEvent) {
                ...
                self.__P_173_10(domEvent);
              }

            };
            var listener = qx.event.GlobalError.observeMethod(this.__P_173_6[hash].callback);
       ...
       * @param domEvent {Event} DOM event object
       */
      __P_173_10: qx.event.GlobalError.observeMethod(qx.core.Environment.select("engine.name", {
        mshtml(domEvent) {
        ...
        opera(domEvent) {
          ...
          if (keyCode != this.__P_173_5) {
            return this._idealKeyHandler(0, this.__P_173_5, type, domEvent);
          } else {
    ...
    */
    destruct() {
      ...
      this.__P_173_5 = this.__P_173_0 = this.__P_173_1 = this.__P_173_2 = this.__P_173_3 = null;
    },
