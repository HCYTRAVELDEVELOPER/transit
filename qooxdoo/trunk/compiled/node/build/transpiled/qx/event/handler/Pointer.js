(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.event.handler.Pointer", {
    ...
    construct(manager) {
      // Define shorthands
      this.__P_197_0 = manager;
      this.__P_197_1 = manager.getWindow();
      this.__P_197_2 = this.__P_197_1.document;
      qx.event.handler.PointerCore.apply(this, [this.__P_197_2]);
    },
    ...
    members: {
        ...
        if (target && target.nodeType) {
          ...
          qx.event.Utils.then(tracker, function () {
            if ((domEvent.getPointerType() !== "mouse" || domEvent.button <= qx.event.handler.PointerCore.LEFT_BUTTON) && (type == "pointerdown" || type == "pointerup" || type == "pointermove" || type == "pointercancel")) {
              return qx.event.Registration.fireEvent(self.__P_197_2, qx.event.handler.PointerCore.POINTER_TO_GESTURE_MAPPING[type], qx.event.type.Pointer, [domEvent, target, null, false, false]);
            }
          });
          qx.event.Utils.then(tracker, function () {
            // Fire user action event
            return qx.event.Registration.fireEvent(self.__P_197_1, "useraction", qx.event.type.Data, [type]);
          });
       ...
       */
      dispose() {
        this.__P_197_3("dispose");

        this.__P_197_0 = this.__P_197_1 = this.__P_197_2 = null;
      },
