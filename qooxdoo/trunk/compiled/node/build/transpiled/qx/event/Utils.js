        ...
        true(tracker, fn) {
          ...
          if (tracker.promise) {
            if (qx.lang.Type.isPromise(fn)) {
              this.__P_178_0(tracker, tracker.promise.then(fn));
            } else {
              var self = this;

              this.__P_178_0(tracker, tracker.promise.then(function (result) {
                if (tracker.rejected) {
                  return null;
                }
            ...
            this.__P_178_1(tracker);

            return tracker.promise;
          }

          if (qx.lang.Type.isPromise(fn)) {
            return this.__P_178_2(tracker, fn);
          }

          var result = fn(tracker.result);

          if (qx.lang.Type.isPromise(result)) {
            return this.__P_178_2(tracker, result);
          }
