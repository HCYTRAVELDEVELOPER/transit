  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.event.handler.Gesture", {
    ...
    construct(manager) {
      ...
      this.__P_174_1 = manager.getWindow();
      this.__P_174_2 = this.__P_174_1.document;
      qx.event.handler.GestureCore.apply(this, [this.__P_174_2]);
    },
    ...
    members: {
      ...
      // overridden
      _initObserver() {
        this.__P_174_3 = qx.lang.Function.listener(this.checkAndFireGesture, this);
        qx.event.handler.Gesture.GESTURE_EVENTS.forEach(function (type) {
          qx.event.Registration.addListener(this.__P_174_2, type, this.__P_174_3, this);
        }.bind(this));

        if (qx.core.Environment.get("engine.name") == "mshtml" && qx.core.Environment.get("browser.documentmode") < 9) {
          this.__P_174_4 = qx.lang.Function.listener(this._onDblClick, this);
          qx.bom.Event.addNativeListener(this.__P_174_2, "dblclick", this.__P_174_4);
        } // list to wheel events


        var data = qx.bom.client.Event.getMouseWheel(this.__P_174_1);
        this.__P_174_5 = qx.lang.Function.listener(this._fireRoll, this); // replaced the useCapture (4th parameter) from this to true
        // see https://github.com/qooxdoo/qooxdoo/pull/9292

        qx.bom.Event.addNativeListener(data.target, data.type, this.__P_174_5, true, false);
      },
      ...
      checkAndFireGesture(pointerEvent, type, target) {
        this.__P_174_6("checkAndFireGesture", [pointerEvent.getNativeEvent(), pointerEvent.getType(), pointerEvent.getTarget()]);
      },

      // overridden
      _stopObserver() {
        qx.event.handler.Gesture.GESTURE_EVENTS.forEach(function (type) {
          qx.event.Registration.removeListener(this.__P_174_2, type, this.__P_174_3);
        }.bind(this));

        if (qx.core.Environment.get("engine.name") == "mshtml" && qx.core.Environment.get("browser.documentmode") < 9) {
          qx.bom.Event.removeNativeListener(this.__P_174_2, "dblclick", this.__P_174_4);
        }

        var data = qx.bom.client.Event.getMouseWheel(this.__P_174_1);
        qx.bom.Event.removeNativeListener(data.target, data.type, this.__P_174_5);
      },
      ...
      _fireEvent(domEvent, type, target) {
        ...
        qx.event.Registration.fireEvent(this.__P_174_1, "useraction", qx.event.type.Data, [type]);
      },
      ...
      dispose() {
        ...
        this.__P_174_6("dispose");

        this.__P_174_0 = this.__P_174_1 = this.__P_174_2 = this.__P_174_4 = null;
      },
