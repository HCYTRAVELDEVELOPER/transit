  ...
  qx.Class.define("qx.event.Timer", {
    ...
    */
    statics: {
      ...
      once(func, obj, timeout) {
        ...
        timer.__P_165_1 = func; // Add event listener to interval

        timer.addListener("interval", function (e) {
          timer.stop();
          func.call(obj, e);
          delete timer.__P_165_1;
          timer.dispose();
          obj = null;
    ...
    members: {
      ...
      */
      ...
      _applyEnabled(value, old) {
        if (old) {
          window.clearInterval(this.__P_165_2);
          this.__P_165_2 = null;
        } else if (value) {
          this.__P_165_2 = window.setInterval(this.__P_165_0, this.getInterval());
        }
      },
    ...
    */
    destruct() {
      ...
      this.__P_165_2 = this.__P_165_0 = null;
    }
