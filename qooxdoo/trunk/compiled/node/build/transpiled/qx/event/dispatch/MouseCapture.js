  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.event.dispatch.MouseCapture", {
    ...
    construct(manager, registration) {
      ...
      this.__P_231_0 = manager.getWindow();
      this.__P_231_1 = registration;
      manager.addListener(this.__P_231_0, "blur", this.releaseCapture, this);
      manager.addListener(this.__P_231_0, "focus", this.releaseCapture, this);
      manager.addListener(this.__P_231_0, "scroll", this.releaseCapture, this);
    },
    ...
    members: {
      ...
      */
      ...
      canDispatchEvent(target, event, type) {
        return !!(this.__P_231_2 && this.__P_231_4[type]);
      },
      ...
      dispatchEvent(target, event, type) {
        ...
        if (this.__P_231_3 || !qx.dom.Hierarchy.contains(this.__P_231_2, target)) {
          target = this.__P_231_2;
        }
      ...
      */
      ...
      activateCapture(element, containerCapture) {
        ...
        if (this.__P_231_2 === element && this.__P_231_3 == containerCapture) {
          return;
        }
        ...
        this.__P_231_3 = containerCapture;
        this.__P_231_2 = element;

        this.__P_231_1.fireEvent(element, "capture", qx.event.type.Event, [true, false]);
      },
      ...
      releaseCapture() {
        ...
        this.__P_231_1.fireEvent(element, "losecapture", qx.event.type.Event, [true, false]); // turn off native mouse capturing if the browser supports it
...
//# sourceMappingURL=MouseCapture.js.map