    ...
    */
    statics: {
      ...
      getManager(target) {
        ...
        var manager = this.__P_156_0[hash];

        if (!manager) {
          manager = new qx.event.Manager(target, this);
          this.__P_156_0[hash] = manager;
        }
       ...
       * @see #createEvent
       */
      __P_156_1(target, type, clazz, args) {
       ...
       * @see #createEvent
       */
      __P_156_2(target, type, clazz, args) {
      ...
      fireNonBubblingEvent(target, type, clazz, args) {
        var evt = this.__P_156_2.apply(this, arguments);
      ...
      */
      ...
      addHandler(handler) {
        // Append to list
        this.__P_156_3.push(handler); // Re-sort list


        this.__P_156_3.sort(function (a, b) {
      ...
      */
      ...
      addDispatcher(dispatcher, priority) {
        // Append to list
        this.__P_156_4.push(dispatcher); // Re-sort list


        this.__P_156_4.sort(function (a, b) {
          return a.PRIORITY - b.PRIORITY;
        });
      },
