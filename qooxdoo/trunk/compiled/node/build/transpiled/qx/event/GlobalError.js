  ...
  qx.Bootstrap.define("qx.event.GlobalError", {
    statics: {
      ...
      setErrorHandler(callback, context) {
        this.__P_162_0 = callback || null;
        this.__P_162_2 = context || window;

        if (this.__P_162_3()) {
          // wrap the original onerror
          if (callback && window.onerror) {
            var wrappedHandler = qx.Bootstrap.bind(this.__P_162_4, this);

            if (this.__P_162_1 == null) {
              this.__P_162_1 = window.onerror;
            }

            var self = this;

            window.onerror = function (msg, uri, lineNumber) {
              self.__P_162_1(msg, uri, lineNumber);
          ...
          if (callback && !window.onerror) {
            window.onerror = qx.Bootstrap.bind(this.__P_162_4, this);
          } // reset


          if (this.__P_162_0 == null) {
            if (this.__P_162_1 != null) {
              window.onerror = this.__P_162_1;
              this.__P_162_1 = null;
            } else {
              window.onerror = null;
            }
       ...
       */
      __P_162_4(msg, uri, lineNumber, columnNumber, exception) {
        if (this.__P_162_0) {
      ...
      handleError(ex) {
        if (this.__P_162_0) {
          this.__P_162_0.call(this.__P_162_2, ex);
        }
      }
