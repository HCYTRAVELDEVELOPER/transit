  ...
  qx.Class.define("qx.event.handler.DragDrop", {
    ...
    */
    ...
    construct(manager) {
      ...
      this.__P_228_1 = manager.getWindow().document.documentElement; // Initialize listener

      this.__P_228_0.addListener(this.__P_228_1, "longtap", this._onLongtap, this);

      this.__P_228_0.addListener(this.__P_228_1, "pointerdown", this._onPointerdown, this, true);
    ...
    */
    members: {
      ...
      */
       ...
       */
      getData(type) {
        if (!this.__P_228_12 || !this.__P_228_3) {
          throw new Error("This method must not be used outside the drop event listener!");
        }

        if (!this.__P_228_5[type]) {
          throw new Error("Unsupported data type: " + type + "!");
        }

        if (!this.__P_228_8[type]) {
          this.__P_228_9 = type;

          this.__P_228_17("droprequest", this.__P_228_4, this.__P_228_3, false, false);
        }
        ...
        return this.__P_228_8[type] || null;
      },
      ...
      getDataAsync(type) {
        ...
        if (!this.__P_228_8[type]) {
          qx.event.Utils.then(tracker, function () {
            self.__P_228_9 = type;
            return self.__P_228_17("droprequest", self.__P_228_4, self.__P_228_3, false);
          });
        }
      ...
      getCurrentActionAsync: qx.core.Environment.select("qx.promise", {
        true() {
          var self = this;
          return qx.Promise.resolve(self.__P_228_16()).then(function () {
            return self.__P_228_10;
          });
        },
      ...
      */
       ...
       */
      __P_228_16() {
        if (this.__P_228_4 == null) {
          {
            return qx.Promise.reject();
          }
        }

        var actions = this.__P_228_6;
        var keys = this.__P_228_7;
        var current = null;
        ...
        var self = this;
        var tracker = {};
        var old = this.__P_228_10;

        if (current != old) {
          if (this.__P_228_3) {
            qx.event.Utils.catch(function () {
              self.__P_228_13 = false;
              current = null;
            });
            qx.event.Utils.then(tracker, function () {
              self.__P_228_10 = current;
              return self.__P_228_17("dragchange", self.__P_228_3, self.__P_228_4, true);
            });
            qx.event.Utils.then(tracker, function (validAction) {
              self.__P_228_13 = validAction;
        ...
        return qx.event.Utils.then(tracker, function () {
          if (current != old) {
            self.__P_228_10 = current;
            return self.__P_228_17("dragchange", self.__P_228_4, self.__P_228_3, false);
          }
        });
      },
       ...
       * not prevented
       */
      __P_228_17(type, target, relatedTarget, cancelable, original, async) {
      ...
      clearSession() {
        ...
        this.__P_228_0.removeListener(this.__P_228_1, "pointermove", this._onPointermove, this);

        this.__P_228_0.removeListener(this.__P_228_1, "pointerup", this._onPointerup, this, true);

        this.__P_228_0.removeListener(this.__P_228_1, "keydown", this._onKeyDown, this, true);

        this.__P_228_0.removeListener(this.__P_228_1, "keyup", this._onKeyUp, this, true);

        this.__P_228_0.removeListener(this.__P_228_1, "keypress", this._onKeyPress, this, true);

        this.__P_228_0.removeListener(this.__P_228_1, "roll", this._onRoll, this, true);
        ...
        if (this.__P_228_4) {
          qx.event.Utils.then(tracker, function () {
            return self.__P_228_17("dragend", self.__P_228_4, self.__P_228_3, false);
          });
        }

        return qx.event.Utils.then(tracker, function () {
          // Cleanup
          self.__P_228_12 = false;
          self.__P_228_3 = null;

          if (self.__P_228_14) {
            self.__P_228_14.removeState("drag");

            self.__P_228_14 = null;
          } // Clear init
          //self.debug("Clearing drag target");


          self.__P_228_4 = null;
          self.__P_228_11 = false;
          self.__P_228_15 = null;
      ...
      */
      ...
      _onLongtap(e) {
        ...
        this.__P_228_0.addListener(this.__P_228_1, "roll", this._onRoll, this, true);
      ...
      _start(e) {
        ...
        var target = this.__P_228_15 ? this.__P_228_15.target : e.getTarget();

        var draggable = this.__P_228_18(target);

        if (draggable) {
          // This is the source target
          //this.debug("Setting dragtarget = " + draggable);
          this.__P_228_4 = draggable;
          var widgetOriginalTarget = qx.ui.core.Widget.getWidgetByElement(this.__P_228_15.original);
          ...
          if (widgetOriginalTarget) {
            this.__P_228_14 = widgetOriginalTarget;
          ...
          qx.event.Utils.then(tracker, function () {
            return self.__P_228_17("dragstart", self.__P_228_4, self.__P_228_3, true, e);
          });
          return qx.event.Utils.then(tracker, function (validAction) {
            ...
            self.__P_228_0.addListener(self.__P_228_1, "keydown", self._onKeyDown, self, true);

            self.__P_228_0.addListener(self.__P_228_1, "keyup", self._onKeyUp, self, true);

            self.__P_228_0.addListener(self.__P_228_1, "keypress", self._onKeyPress, self, true);

            self.__P_228_11 = true;
          });
        }
      },
      ...
      _onPointerdown(e) {
        if (e.isPrimary()) {
          ...
          this.__P_228_0.addListener(this.__P_228_1, "pointermove", this._onPointermove, this);

          this.__P_228_0.addListener(this.__P_228_1, "pointerup", this._onPointerup, this, true);
        }
      },
      ...
      _onPointermove(e) {
        ...
        if (!self.__P_228_11 && e.getPointerType() == "mouse") {
        ...
        return qx.event.Utils.then(tracker, function () {
          ...
          qx.event.Utils.then(tracker, function () {
            ...
            return self.__P_228_17("drag", self.__P_228_4, self.__P_228_3, true, e);
          });
          qx.event.Utils.then(tracker, function (validAction) {
            if (!validAction) {
              this.clearSession();
            ...
            if (el !== cursorEl) {
              var droppable = self.__P_228_19(el); // new drop target detected


              if (droppable && droppable != self.__P_228_3) {
                var dropLeaveTarget = self.__P_228_3;
                self.__P_228_12 = true; // initial value should be true

                self.__P_228_3 = droppable;
                var innerTracker = {};
                ...
                if (dropLeaveTarget) {
                  qx.event.Utils.then(innerTracker, function () {
                    return self.__P_228_17("dragleave", dropLeaveTarget, self.__P_228_4, false, e);
                  });
                }

                qx.event.Utils.then(innerTracker, function () {
                  return self.__P_228_17("dragover", droppable, self.__P_228_4, true, e);
                });
                return qx.event.Utils.then(innerTracker, function (validDrop) {
                  self.__P_228_12 = validDrop;
                });
              } // only previous drop target
              else if (!droppable && self.__P_228_3) {
                var innerTracker = {};
                qx.event.Utils.then(innerTracker, function () {
                  return self.__P_228_17("dragleave", self.__P_228_3, self.__P_228_4, false, e);
                });
                return qx.event.Utils.then(innerTracker, function () {
                  self.__P_228_3 = null;
                  self.__P_228_12 = false;
                  return self.__P_228_16();
                });
              }
            }
          });
      ...
      _getDelta(e) {
        ...
        var deltaX = e.getDocumentLeft() - this.__P_228_15.left;

        var deltaY = e.getDocumentTop() - this.__P_228_15.top;
      ...
      _onPointerup(e) {
        ...
        if (this.__P_228_12 && this.__P_228_13) {
          qx.event.Utils.then(tracker, function () {
            return self.__P_228_17("drop", self.__P_228_3, self.__P_228_4, false, e);
          });
        }

        return qx.event.Utils.then(tracker, function () {
          // Stop event
          if (e.getTarget() == self.__P_228_4) {
            e.stopPropagation();
          } // Clean up
      ...
      _onKeyDown(e) {
        ...
        switch (iden) {
          ...
          case "Control":
          case "Shift":
            if (!this.__P_228_7[iden]) {
              this.__P_228_7[iden] = true;
              return this.__P_228_16();
            }
    ...
    */
    destruct() {
      ...
      this.__P_228_4 = this.__P_228_3 = this.__P_228_0 = this.__P_228_1 = this.__P_228_5 = this.__P_228_6 = this.__P_228_7 = this.__P_228_8 = null;
    },
