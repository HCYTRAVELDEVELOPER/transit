  ...
  qx.Class.define("qx.event.handler.Appear", {
    ...
    */
    ...
    construct(manager) {
      ...
      this.__P_222_1 = {}; // Register

      qx.event.handler.Appear.__P_222_2[this.toHashCode()] = this;
    },
        ...
        Object.keys(targets).forEach(function (hash) {
          ...
          qx.event.Utils.then(tracker, function () {
            ...
            if (!!elem.$$displayed !== displayed) {
              ...
              return self.__P_222_0.dispatchEvent(elem, evt);
            }
          });
        });
    ...
    */
    destruct() {
      this.__P_222_0 = this.__P_222_1 = null; // Deregister

      delete qx.event.handler.Appear.__P_222_2[this.toHashCode()];
    },
