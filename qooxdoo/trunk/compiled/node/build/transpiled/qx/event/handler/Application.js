  ...
  qx.Class.define("qx.event.handler.Application", {
    ...
    */
    ...
    construct(manager) {
      ...
      this.__P_150_0 = false;
      this.__P_150_1 = false;
      this.__P_150_2 = false;
      this.__P_150_3 = false;
      this.__P_150_4 = false; // Initialize observers
    ...
    members: {
      ...
      */
      ...
      __P_150_5() {
        ...
        if (!this.__P_150_2 && this.__P_150_0 && qx.$$loader.scriptLoaded) {
          ...
          if (qx.core.Environment.get("engine.name") == "mshtml") {
            if (qx.event.Registration.hasListener(this._window, "ready")) {
              this.__P_150_2 = true; // Fire user event
       ...
       */
      __P_150_6() {
        this.__P_150_3 = true; // Fire user event
      ...
      */
      ...
      _onNativeLoad() {
        var callback = qx.core.Environment.select("qx.globalErrorHandling", {
          true: qx.event.GlobalError.observeMethod(this.__P_150_7),
          false: this.__P_150_7
        });
      ...
      _onNativeUnload() {
        var callback = qx.core.Environment.select("qx.globalErrorHandling", {
          true: qx.event.GlobalError.observeMethod(this.__P_150_8),
          false: this.__P_150_8
        });
        callback.apply(this, arguments);
      },
