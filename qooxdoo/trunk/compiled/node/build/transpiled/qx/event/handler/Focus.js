  ...
  qx.Class.define("qx.event.handler.Focus", {
    ...
    */
    members: {
      ...
      */
       ...
       */
      tryActivate(element) {
        var active = this.__P_196_14(element);
      ...
      */
       ...
       */
      __P_196_15(target, related, type, bubbles) {
      ...
      */
      ...
      __P_196_16() {
        ...
        if (this._windowFocused) {
          ...
          this.__P_196_15(this._window, null, "blur", false);
        }
      },
      ...
      __P_196_17() {
        ...
        if (!this._windowFocused) {
          ...
          this.__P_196_15(this._window, null, "focus", false);
        }
      },
      ...
      */
      ...
      _initObserver: qx.core.Environment.select("engine.name", {
        gecko() {
          // Bind methods
          this.__P_196_1 = qx.lang.Function.listener(this.__P_196_18, this);
          this.__P_196_2 = qx.lang.Function.listener(this.__P_196_19, this);
          this.__P_196_3 = qx.lang.Function.listener(this.__P_196_20, this);
          this.__P_196_4 = qx.lang.Function.listener(this.__P_196_21, this);
          this.__P_196_5 = qx.lang.Function.listener(this.__P_196_22, this); // Register events

          qx.bom.Event.addNativeListener(this._document, "mousedown", this.__P_196_1, true);
          qx.bom.Event.addNativeListener(this._document, "mouseup", this.__P_196_2, true); // Capturing is needed for gecko to correctly
          // handle focus of input and textarea fields

          qx.bom.Event.addNativeListener(this._window, "focus", this.__P_196_3, true);
          qx.bom.Event.addNativeListener(this._window, "blur", this.__P_196_4, true); // Capture drag events

          qx.bom.Event.addNativeListener(this._window, "draggesture", this.__P_196_5, true);
        },
        ...
        mshtml() {
          ...
          this.__P_196_1 = qx.lang.Function.listener(this.__P_196_18, this);
          this.__P_196_2 = qx.lang.Function.listener(this.__P_196_19, this);
          this.__P_196_7 = qx.lang.Function.listener(this.__P_196_23, this);
          this.__P_196_8 = qx.lang.Function.listener(this.__P_196_24, this);
          this.__P_196_6 = qx.lang.Function.listener(this.__P_196_25, this); // Register events

          qx.bom.Event.addNativeListener(this._document, "mousedown", this.__P_196_1);
          qx.bom.Event.addNativeListener(this._document, "mouseup", this.__P_196_2); // MSHTML supports their own focusin and focusout events
          ...
          qx.bom.Event.addNativeListener(this._document, "focusin", this.__P_196_7);
          qx.bom.Event.addNativeListener(this._document, "focusout", this.__P_196_8); // Add selectstart to prevent selection

          qx.bom.Event.addNativeListener(this._document, "selectstart", this.__P_196_6);
        },
        ...
        webkit: qx.core.Environment.select("browser.name", {
          ...
          edge(domEvent) {
            ...
            qx.bom.Event.addNativeListener(this._document, "mousedown", this.__P_196_1, true);
            qx.bom.Event.addNativeListener(this._document, "mouseup", this.__P_196_2, true);
            qx.bom.Event.addNativeListener(this._document, "selectstart", this.__P_196_6, false);
            qx.bom.Event.addNativeListener(this._document, "focusin", this.__P_196_7);
            qx.bom.Event.addNativeListener(this._document, "focusout", this.__P_196_8);
          },
          ...
          default(domEvent) {
            ...
            qx.bom.Event.addNativeListener(this._document, "mouseup", this.__P_196_2, true);
            qx.bom.Event.addNativeListener(this._document, "selectstart", this.__P_196_6, false);
            qx.bom.Event.addNativeListener(this._window, "DOMFocusOut", this.__P_196_8, true);
            qx.bom.Event.addNativeListener(this._window, "focus", this.__P_196_3, true);
            qx.bom.Event.addNativeListener(this._window, "blur", this.__P_196_4, true);
          }
        ...
        opera() {
          ...
          this.__P_196_2 = qx.lang.Function.listener(this.__P_196_19, this);
          this.__P_196_7 = qx.lang.Function.listener(this.__P_196_23, this);
          this.__P_196_8 = qx.lang.Function.listener(this.__P_196_24, this); // Register events

          qx.bom.Event.addNativeListener(this._document, "mousedown", this.__P_196_1, true);
          qx.bom.Event.addNativeListener(this._document, "mouseup", this.__P_196_2, true);
          qx.bom.Event.addNativeListener(this._window, "DOMFocusIn", this.__P_196_7, true);
          qx.bom.Event.addNativeListener(this._window, "DOMFocusOut", this.__P_196_8, true);
        }
      ...
      _stopObserver: qx.core.Environment.select("engine.name", {
        gecko() {
          qx.bom.Event.removeNativeListener(this._document, "mousedown", this.__P_196_1, true);
          qx.bom.Event.removeNativeListener(this._document, "mouseup", this.__P_196_2, true);
          qx.bom.Event.removeNativeListener(this._window, "focus", this.__P_196_3, true);
          qx.bom.Event.removeNativeListener(this._window, "blur", this.__P_196_4, true);
          qx.bom.Event.removeNativeListener(this._window, "draggesture", this.__P_196_5, true);
        },

        mshtml() {
          qx.bom.Event.removeNativeListener(this._document, "mousedown", this.__P_196_1);
          qx.bom.Event.removeNativeListener(this._document, "mouseup", this.__P_196_2);
          qx.bom.Event.removeNativeListener(this._document, "focusin", this.__P_196_7);
          qx.bom.Event.removeNativeListener(this._document, "focusout", this.__P_196_8);
          qx.bom.Event.removeNativeListener(this._document, "selectstart", this.__P_196_6);
        },
        ...
        webkit: qx.core.Environment.select("browser.name", {
          ...
          default() {
            qx.bom.Event.removeNativeListener(this._document, "mousedown", this.__P_196_1, true);
            qx.bom.Event.removeNativeListener(this._document, "mouseup", this.__P_196_2, true);
            qx.bom.Event.removeNativeListener(this._document, "selectstart", this.__P_196_6, false);
            qx.bom.Event.removeNativeListener(this._window, "DOMFocusOut", this.__P_196_8, true);
            qx.bom.Event.removeNativeListener(this._window, "focus", this.__P_196_3, true);
            qx.bom.Event.removeNativeListener(this._window, "blur", this.__P_196_4, true);
          }
        ...
        opera() {
          qx.bom.Event.removeNativeListener(this._document, "mousedown", this.__P_196_1, true);
          qx.bom.Event.removeNativeListener(this._document, "mouseup", this.__P_196_2, true);
          qx.bom.Event.removeNativeListener(this._window, "DOMFocusIn", this.__P_196_7, true);
          qx.bom.Event.removeNativeListener(this._window, "DOMFocusOut", this.__P_196_8, true);
        }
      ...
      */
       ...
       */
      __P_196_22: qx.event.GlobalError.observeMethod(qx.core.Environment.select("engine.name", {
        gecko(domEvent) {
          var target = qx.bom.Event.getTarget(domEvent);

          if (!this.__P_196_26(target)) {
       ...
       * @param domEvent {Event} Native event
       */
      __P_196_23: qx.event.GlobalError.observeMethod(qx.core.Environment.select("engine.name", {
        mshtml(domEvent) {
          // Force window focus to be the first
          this.__P_196_17(); // Update internal data
          ...
          var focusTarget = this.__P_196_27(target);
        ...
        opera(domEvent) {
          ...
          if (target == this._document || target == this._window) {
            ...
            if (this.__P_196_9) {
              this.setFocus(this.__P_196_9);
              delete this.__P_196_9;
            }

            if (this.__P_196_10) {
              this.setActive(this.__P_196_10);
              delete this.__P_196_10;
            }
          } else {
       ...
       * @param domEvent {Event} Native event
       */
      __P_196_24: qx.event.GlobalError.observeMethod(qx.core.Environment.select("engine.name", {
        mshtml(domEvent) {
          var relatedTarget = qx.bom.Event.getRelatedTarget(domEvent); // If the focus goes to nowhere (the document is blurred)

          if (relatedTarget == null) {
            // Update internal representation
            this.__P_196_16(); // Reset active and focus
        ...
        opera(domEvent) {
          ...
          if (target == this._document) {
            this.__P_196_16(); // Store old focus/active elements
            // Opera do not fire focus events for them
            // when refocussing the window (in my opinion an error)


            this.__P_196_9 = this.getFocus();
            this.__P_196_10 = this.getActive();
            this.resetFocus();
            this.resetActive();
          } else {
            if (target === this.getFocus()) {
       ...
       * @param domEvent {Event} Native event
       */
      __P_196_21: qx.event.GlobalError.observeMethod(qx.core.Environment.select("engine.name", {
        gecko(domEvent) {
          var target = qx.bom.Event.getTarget(domEvent);
       ...
       * @param domEvent {Event} Native event
       */
      __P_196_20: qx.event.GlobalError.observeMethod(qx.core.Environment.select("engine.name", {
        gecko(domEvent) {
          var target = qx.bom.Event.getTarget(domEvent);

          if (target === this._window || target === this._document) {
            this.__P_196_17(); // Always speak of the body, not the window or document
        ...
        webkit(domEvent) {
          ...
          if (target === this._window || target === this._document) {
            ...
            this.__P_196_13 = domEvent.relatedTarget;
            this.setFocus(target);
            this.__P_196_13 = null;
            this.tryActivate(target);
          }
        },
       ...
       * @param domEvent {Event} Native event
       */
      __P_196_18: qx.event.GlobalError.observeMethod(qx.core.Environment.select("engine.name", {
        mshtml(domEvent) {
       ...
       * @param domEvent {Event} Native event
       */
      __P_196_19: qx.event.GlobalError.observeMethod(qx.core.Environment.select("engine.name", {
        mshtml(domEvent) {
          var target = qx.bom.Event.getTarget(domEvent);
          ...
          this.tryActivate(this.__P_196_28(target));
        },
       ...
       */
      __P_196_28: qx.event.GlobalError.observeMethod(qx.core.Environment.select("engine.name", {
        mshtml(target) {
          return this.__P_196_29(target);
        },
       ...
       * @param domEvent {Event} Native event
       */
      __P_196_25: qx.event.GlobalError.observeMethod(qx.core.Environment.select("engine.name", {
        mshtml(domEvent) {
          var target = qx.bom.Event.getTarget(domEvent);
      ...
      */
      ...
      _applyActive(value, old) {
        // Fire events
        if (old) {
          this.__P_196_15(old, value, "deactivate", true);
        }

        if (value) {
          this.__P_196_15(value, old, "activate", true);
      ...
      _applyFocus(value, old) {
        ...
        if (old) {
          this.__P_196_15(old, value, "focusout", true);
        }

        if (value) {
          this.__P_196_15(value, old, "focusin", true);
        } // Fire after events


        if (old) {
          this.__P_196_15(old, value, "blur", false);
        }

        if (value) {
          this.__P_196_15(value, old || this.__P_196_13, "focus", false);
        }
      }
    ...
    */
    destruct() {
      ...
      this._manager = this._window = this._document = this._root = this._body = this.__P_196_31 = this.__P_196_13 = null;
    },
