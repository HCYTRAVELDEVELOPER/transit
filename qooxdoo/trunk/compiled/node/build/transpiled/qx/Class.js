  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.Class", {
    statics: {
       ...
       * should be included.
       */
      __P_146_0: true ? qx.core.Property : null,
      ...
      */
      ...
      define(name, config) {
        try {
          return this.__P_146_1(name, config);
        } catch (ex) {
      ...
      __P_146_1(name, config) {
        ...
        // Create the class
        var clazz = this.__P_146_2(name, config.type, config.extend, config.statics, config.construct, config.destruct, config.include); // Initialise class and constructor/destructor annotations


        ["@", "@construct", "@destruct"].forEach(function (id) {
          this.__P_146_3(clazz, id, null, config[id]);
        }, this); // Members, properties, events and mixins are only allowed for non-static classes

        if (config.extend) {
          // Attach properties
          if (config.properties) {
            this.__P_146_4(clazz, config.properties, true);
          } // Attach members


          if (config.members) {
            this.__P_146_5(clazz, config.members, true, true, false);
          } // Process events


          if (config.events) {
            this.__P_146_6(clazz, config.events, true);
          } // Include mixins
          ...
          if (config.include) {
            for (var i = 0, l = config.include.length; i < l; i++) {
              this.__P_146_7(clazz, config.include[i], false);
            }
          }
        ...
        if (config.implement) {
          for (var i = 0, l = config.implement.length; i < l; i++) {
            this.__P_146_8(clazz, config.implement[i]);
          }
        }
          ...
          qx.Bootstrap.addPendingDefer(clazz, function () {
            ...
            config.defer(clazz, clazz.prototype, {
              add(name, config) {
                ...
                qx.Class.__P_146_4(clazz, properties, true);
              }
       ...
       */
      include(clazz, mixin) {
        qx.Class.__P_146_7(clazz, mixin, false);
      },
       ...
       */
      patch(clazz, mixin) {
        qx.Class.__P_146_7(clazz, mixin, true);
      ...
      */
      ...
      __P_146_9: qx.core.Environment.select("qx.debug", {
        true: {
          "@": "object",
          "@construct": "object",
          "@destruct": "object",
      ...
      __P_146_10: qx.core.Environment.select("qx.debug", {
        true: {
          "@": "object",
          type: "string",
          // String
       ...
       */
      __P_146_11: qx.core.Environment.select("qx.debug", {
        true(name, config) {
          // Validate type
          ...
          var allowed = config.type === "static" ? this.__P_146_10 : this.__P_146_9;
       ...
       */
      __P_146_12: qx.core.Environment.select("qx.debug", {
        true(clazz) {
       ...
       */
      __P_146_3(clazz, group, key, anno) {
        if (anno !== undefined) {
       ...
       */
      __P_146_2(name, type, extend, statics, construct, destruct, mixins) {
        ...
        if (!extend && true) {
          ...
          if (extend) {
            ...
            if (!construct) {
              construct = this.__P_146_13();
            }

            clazz = this.__P_146_14(construct, name, type); // Add singleton getInstance()
          ...
          if (statics) {
            ...
            for (var i = 0, a = Object.keys(statics), l = a.length; i < l; i++) {
              ...
              this.__P_146_3(clazz, "statics", key, statics["@" + key]);
            }
          }
        } // Create namespace
      ...
      */
       ...
       */
      __P_146_4(clazz, properties, patch) {
        ...
        for (var name in properties) {
          ...
          if (config.event !== undefined) {
            ...
            this.__P_146_6(clazz, event, patch);
          } // Remember inheritable properties


          if (config.inheritable) {
            this.__P_146_0.$$inheritable[name] = true;

            if (!proto.$$refreshInheritables) {
              this.__P_146_0.attachRefreshInheritables(clazz);
            }
          }

          if (!config.refine) {
            this.__P_146_0.attachMethods(clazz, name, config);
          } // Add annotations


          this.__P_146_3(clazz, "properties", name, config["@"]);
        }
      },
       ...
       */
      __P_146_15: qx.core.Environment.select("qx.debug", {
        true(clazz, name, config, patch) {
          ...
          var allowed = config.group ? this.__P_146_0.$$allowedGroupKeys : this.__P_146_0.$$allowedKeys;
       ...
       */
      __P_146_5(clazz, members, patch, base, wrap) {
        var proto = clazz.prototype;
        var key, member;
        ...
        for (var i = 0, a = Object.keys(members), l = a.length; i < l; i++) {
          ...
          if (key.charAt(0) === "@") {
            ...
            if (members[annoKey] === undefined) {
              this.__P_146_3(clazz, "members", annoKey, members[key]);
            }
          ...
          this.__P_146_3(clazz, "members", key, members["@" + key]);
        }
      },
      ...
      */
       ...
       */
      __P_146_14(construct, name, type) {
