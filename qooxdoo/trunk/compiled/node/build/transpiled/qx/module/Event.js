    ...
    statics: {
      ...
      ready(callback) {
        ...
        var onWindowLoad = function () {
          qx.module.Event.__P_249_2 = true;
          callback();
        };
      ...
      $registerEventNormalization(types, normalizer) {
        ...
        var registry = qx.module.Event.__P_249_0;
      ...
      $getEventNormalizationRegistry() {
        return qx.module.Event.__P_249_0;
      },
      ...
      $registerEventHook(types, registerHook, unregisterHook) {
        ...
        var onHooks = qx.module.Event.__P_249_1.on;
        ...
        var offHooks = qx.module.Event.__P_249_1.off;
      ...
      $getEventHookRegistry() {
        return qx.module.Event.__P_249_1;
      }
    ...
    members: {
      ...
      on(type, listener, context, useCapture) {
        for (var i = 0; i < this.length; i++) {
          ...
          var hooks = qx.module.Event.__P_249_1.on; // generic
          ...
          var bound = function (el, event) {
            ...
            var registry = qx.module.Event.__P_249_0; // generic
          ...
          if (!el.__P_249_3[type]) {
            el.__P_249_3[type] = {};
          }

          el.__P_249_3[type][el.$$lastlistenerId] = bound;
          ...
          if (!context) {
            ...
            el.__P_249_4[el.$$lastlistenerId] = ctx;
          }
        }
      ...
      off(type, listener, context, useCapture) {
        ...
        for (var j = 0; j < this.length; j++) {
          ...
          if (type !== null) {
            ...
            for (var listenerType in el.__P_249_3) {
              types.push(listenerType);
            }
          }

          for (var i = 0, l = types.length; i < l; i++) {
            for (var id in el.__P_249_3[types[i]]) {
              var storedListener = el.__P_249_3[types[i]][id];

              if (removeAll || storedListener == listener || storedListener.original == listener) {
                // get the stored context
                var hasStoredContext = typeof el.__P_249_4 !== "undefined" && el.__P_249_4[id];
                var storedContext;

                if (!context && hasStoredContext) {
                  storedContext = el.__P_249_4[id];
                ...
                if (result !== null) {
                  delete el.__P_249_3[types[i]][id];
                }

                if (hasStoredContext) {
                  delete el.__P_249_4[id];
                }
              }
            } // call hooks


            var hooks = qx.module.Event.__P_249_1.off; // generic
