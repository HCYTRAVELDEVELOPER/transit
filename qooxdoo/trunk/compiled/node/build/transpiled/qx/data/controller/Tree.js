  ...
  qx.Class.define("qx.data.controller.Tree", {
    ...
    */
    ...
    construct(model, target, childPath, labelPath) {
      ...
      this.__P_80_0 = {};
      this.__P_80_1 = []; // reference to the child
    ...
    */
    members: {
      ...
      */
      ...
      _applyChildPath(value, old) {
        ...
        this.__P_80_6(); // reset the old name
      ...
      */
      ...
      __P_80_7(ev) {
        ...
        var treeNode = this.__P_80_2[children.toHashCode()].treeNode;

        var modelNode = this.__P_80_2[children.toHashCode()].modelNode; // update the subtree


        this.__P_80_8(treeNode, modelNode); // update the selection in case a selected element has been removed
      ...
      __P_80_9(e) {
        ...
        var oldRef = this.__P_80_2[oldChildren.toHashCode()];
        ...
        delete this.__P_80_2[oldChildren.toHashCode()]; // remove the old change listener for the children
        ...
        var changeChildernListenerId = modelNode.addListener(eventName, this.__P_80_9, this); // add the new ref

        var treeNode = oldRef.treeNode;
        this.debug("1: adding children=" + children.toHashCode() + " to this=" + this.toHashCode());
        this.__P_80_2[children.toHashCode()] = {
          modelNode: modelNode,
          treeNode: treeNode,
      ...
      */
      ...
      __P_80_6() {
        ...
        this.__P_80_5(); // only build up a new tree if a model is given
        ...
        if (this.getModel() != null) {
          ...
          this.__P_80_10(this.getModel(), rootNode);

          this.__P_80_8(rootNode, this.getModel()); // assign the new root once the tree has been built
      ...
      __P_80_8(rootNode, modelNode) {
        ...
        if (this.__P_80_2[children.toHashCode()] == undefined) {
          // add the listener for the change
          var changeListenerId = children.addListener("change", this.__P_80_7, this); // add a listener for the change of the children array itself

          var property = qx.Class.getPropertyDefinition(modelNode.constructor, this.getChildPath());
          var eventName = property.event;
          var changeChildernListenerId = modelNode.addListener(eventName, this.__P_80_9, this);
        ...
        for (var i = 0; i < children.length; i++) {
          ...
          if (rootNode.getChildren()[i] == null || children.getItem(i) != rootNode.getChildren()[i].getModel()) {
            ...
            if (oldIndex != undefined) {
              ...
              this.__P_80_10(children.getItem(i), treeNode); // add all children recursive


              this.__P_80_8(treeNode, children.getItem(i));
            }
          }
        ...
        for (var i = rootNode.getChildren().length - 1; i >= children.length; i--) {
          ...
          this.__P_80_11(treeFolder, rootNode);
        }
      },
      ...
      __P_80_12(node) {
        ...
        for (var i = children.length - 1; i >= 0; i--) {
          if (children[i].getChildren().length > 0) {
            this.__P_80_12(children[i]);
          }

          this.__P_80_11(children[i], node);
        }
      },
       ...
       *   treeFolder.
       */
      __P_80_11(treeFolder, rootNode) {
        // get the model
        var model = treeFolder.getModel();
        var childPath = this.__P_80_3 || this.getChildPath();
        ...
        if (model[childrenGetterName] != undefined) {
          ...
          var oldRef = this.__P_80_2[children.toHashCode()];
          ...
          this.__P_80_12(treeFolder); // delete the model reference


          delete this.__P_80_2[children.toHashCode()];
        } // get the binding and remove it


        this.__P_80_13(model); // remove the folder from the tree
      ...
      */
      ...
      bindProperty(sourcePath, targetPath, options, targetWidget, modelNode) {
        ...
        if (this.__P_80_0[targetPath] == null) {
          this.__P_80_0[targetPath] = {};
        } // store the binding reference


        var storage = this.__P_80_0[targetPath];
        ...
        if (!this.__P_80_1.includes(targetPath)) {
          this.__P_80_1.push(targetPath);
        }
      },
      ...
      bindPropertyReverse(targetPath, sourcePath, options, sourceWidget, modelNode) {
        ...
        if (this.__P_80_0[sourcePath] == null) {
          this.__P_80_0[sourcePath] = {};
        } // check if there is already a stored item


        var storage = this.__P_80_0[sourcePath];
        qx.core.ObjectRegistry.register(modelNode);
        ...
        if (!this.__P_80_1.includes(sourcePath)) {
          this.__P_80_1.push(sourcePath);
        }
      },
      ...
      __P_80_4() {
        ...
        for (var hash in this.__P_80_0[firstProp]) {
          // get the data
          var treeNode = this.__P_80_0[firstProp][hash].treeNode;
          var modelNode = qx.core.ObjectRegistry.fromHashCode(hash); // remove the old bindings

          this.__P_80_13(modelNode); // add the new bindings


          this.__P_80_10(modelNode, treeNode);
        }
      },
       ...
       */
      __P_80_13(modelNode) {
        for (var i = 0; i < this.__P_80_1.length; i++) {
          var property = this.__P_80_1[i];

          var bindingsMap = this.__P_80_0[property][modelNode.toHashCode()];
          ...
          if (bindingsMap != null) {
            ...
            delete this.__P_80_0[property][modelNode.toHashCode()];
          }
        }
      },
    ...
    destruct() {
      ...
      this.__P_80_0 = this.__P_80_2 = this.__P_80_1 = null;
    }
