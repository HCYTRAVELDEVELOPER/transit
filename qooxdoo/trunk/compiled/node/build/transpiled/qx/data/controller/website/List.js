  ...
  qx.Class.define("qx.data.controller.website.List", {
    ...
    members: {
      ...
      _applyModel(value, old) {
        ...
        if (old != undefined) {
          if (this.__P_81_0 != undefined) {
            old.removeListenerById(this.__P_81_0);
          }

          if (this.__P_81_1 != undefined) {
            old.removeListenerById(this.__P_81_1);
          }
        } // if a model is set
        ...
        if (value != null) {
          ...
          if (value instanceof qx.core.Object) {
            // add new listeners
            this.__P_81_0 = value.addListener("change", this.update, this);
            this.__P_81_1 = value.addListener("changeBubble", this.update, this);
          }
        } else {
      ...
      update() {
        ...
        this.__P_81_2(); // delegate methods
