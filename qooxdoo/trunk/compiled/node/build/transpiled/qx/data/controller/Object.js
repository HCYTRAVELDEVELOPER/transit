  ...
  qx.Class.define("qx.data.controller.Object", {
    ...
    */
    ...
    construct(model) {
      ...
      this.__P_79_0 = {}; // create an array to store all current targets
    ...
    */
    members: {
      ...
      _applyModel(value, old) {
        // for every target
        for (var i = 0; i < this.__P_79_1.length; i++) {
          // get the properties
          var targetObject = this.__P_79_1[i][0];
          var targetProperty = this.__P_79_1[i][1];
          var sourceProperty = this.__P_79_1[i][2];
          var bidirectional = this.__P_79_1[i][3];
          var options = this.__P_79_1[i][4];
          var reverseOptions = this.__P_79_1[i][5]; // remove it from the old if possible

          if (old != undefined && !old.isDisposed()) {
            this.__P_79_2(targetObject, targetProperty, sourceProperty, old);
          } // add it to the new if available


          if (value != undefined) {
            this.__P_79_3(targetObject, targetProperty, sourceProperty, bidirectional, options, reverseOptions);
          } else {
      ...
      addTarget(targetObject, targetProperty, sourceProperty, bidirectional, options, reverseOptions) {
        ...
        this.__P_79_1.push([targetObject, targetProperty, sourceProperty, bidirectional, options, reverseOptions]); // delegate the adding
       ...
       *   {@link qx.data.SingleValueBinding} class.
       */
      __P_79_3(targetObject, targetProperty, sourceProperty, bidirectional, options, reverseOptions) {
        ...
        if (this.__P_79_0[targetHash] == undefined) {
          this.__P_79_0[targetHash] = [];
        }

        this.__P_79_0[targetHash].push([id, idReverse, targetProperty, sourceProperty, options, reverseOptions]);
      },
      ...
      removeTarget(targetObject, targetProperty, sourceProperty) {
        this.__P_79_2(targetObject, targetProperty, sourceProperty, this.getModel()); // delete the target in the targets reference


        for (var i = 0; i < this.__P_79_1.length; i++) {
          if (this.__P_79_1[i][0] == targetObject && this.__P_79_1[i][1] == targetProperty && this.__P_79_1[i][2] == sourceProperty) {
            this.__P_79_1.splice(i, 1);
          }
        }
      },
       ...
       *   comes.
       */
      __P_79_2(targetObject, targetProperty, sourceProperty, sourceObject) {
        ...
        var currentListing = this.__P_79_0[targetObject.toHashCode()]; // if no binding is stored
