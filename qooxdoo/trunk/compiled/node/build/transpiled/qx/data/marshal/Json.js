  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.data.marshal.Json", {
    ...
    members: {
       ...
       */
      __P_82_1(data, includeBubbleEvents) {
        if (this.__P_82_0 && this.__P_82_0.getJsonHash) {
          return this.__P_82_0.getJsonHash(data, includeBubbleEvents);
        }
       ...
       * @return {String} The hash representation of the given JavaScript object.
       */
      __P_82_2(data, includeBubbleEvents) {
        // forced mode?
        //
        if (includeBubbleEvents === true) {
          return this.__P_82_1(data, true);
        }

        if (includeBubbleEvents === false) {
          return this.__P_82_1(data, false);
        } // automatic mode!
        //


        var hash = this.__P_82_1(data); // without bubble event feature
      ...
      toClass(data, includeBubbleEvents) {
        this.__P_82_3(data, includeBubbleEvents, null, 0);
      },
       ...
       */
      __P_82_3(data, includeBubbleEvents, parentProperty, depth) {
        ...
        data instanceof qx.core.Object) {
          ...
          if (data instanceof Array || qx.Bootstrap.getClass(data) == "Array") {
            for (var i = 0; i < data.length; i++) {
              this.__P_82_3(data[i], includeBubbleEvents, parentProperty + "[" + i + "]", depth + 1);
            }
        ...
        var hash = this.__P_82_1(data, includeBubbleEvents); // ignore rules


        if (this.__P_82_4(hash, parentProperty, depth)) {
          return;
        } // check for the possible child classes


        for (var key in data) {
          this.__P_82_3(data[key], includeBubbleEvents, key, depth + 1);
        ...
        if (this.__P_82_0 && this.__P_82_0.getModelClass && this.__P_82_0.getModelClass(hash, data, parentProperty, depth) != null) {
          return;
        ...
        var members = {
          __P_82_5: this.__P_82_5
        };

        for (var key in data) {
          // apply the property names mapping
          if (this.__P_82_0 && this.__P_82_0.getPropertyMapping) {
            key = this.__P_82_0.getPropertyMapping(key, hash);
          ...
          if (this.__P_82_0 && this.__P_82_0.getValidationRule) {
            var rule = this.__P_82_0.getValidationRule(hash, key);
        ...
        if (this.__P_82_0 && this.__P_82_0.getModelSuperClass) {
          var superClass = this.__P_82_0.getModelSuperClass(hash, parentProperty, depth) || qx.core.Object;
        } else {
        ...
        if (this.__P_82_0 && this.__P_82_0.getModelMixins) {
          var delegateMixins = this.__P_82_0.getModelMixins(hash, parentProperty, depth); // check if its an array
       ...
       * @return {qx.core.Object} An instance of the corresponding class.
       */
      __P_82_6(hash, data, parentProperty, depth) {
        var delegateClass; // get the class from the delegate

        if (this.__P_82_0 && this.__P_82_0.getModelClass) {
          delegateClass = this.__P_82_0.getModelClass(hash, data, parentProperty, depth);
        }
       ...
       */
      __P_82_4(hash, parentProperty, depth) {
        var del = this.__P_82_0;
      ...
      toModel(data, includeBubbleEvents) {
        return this.__P_82_7(data, includeBubbleEvents, null, 0);
      },
       ...
       * @return {qx.core.Object} The created model object.
       */
      __P_82_7(data, includeBubbleEvents, parentProperty, depth) {
        ...
        data instanceof qx.core.Object) {
        ...
        } else if (this.__P_82_4(this.__P_82_2(data, includeBubbleEvents), parentProperty, depth)) {
          return data;
        } else if (isArray) {
          var arrayClass = qx.data.Array;

          if (this.__P_82_0 && this.__P_82_0.getArrayClass) {
            var customArrayClass = this.__P_82_0.getArrayClass(parentProperty, depth);
          ...
          for (var i = 0; i < data.length; i++) {
            array.push(this.__P_82_7(data[i], includeBubbleEvents, parentProperty + "[" + i + "]", depth + 1));
          }

          return array;
        } else if (isObject) {
          // create an instance for the object
          var hash = this.__P_82_2(data, includeBubbleEvents);

          var model = this.__P_82_6(hash, data, parentProperty, depth); // go threw all element in the data
          ...
          for (var key in data) {
            ...
            if (this.__P_82_0 && this.__P_82_0.getPropertyMapping) {
              propertyName = this.__P_82_0.getPropertyMapping(key, hash);
            }
            ...
            if (model[setterName]) {
              model[setterName](this.__P_82_7(data[key], includeBubbleEvents, key, depth + 1));
            }
          }
