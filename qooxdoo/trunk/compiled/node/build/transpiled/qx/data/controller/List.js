  ...
  qx.Class.define("qx.data.controller.List", {
    ...
    */
    ...
    construct(model, target, labelPath) {
      ...
      this.__P_77_0 = []; // register for bound target properties and onUpdate methods
    ...
    */
    members: {
      ...
      */
      ...
      _applyModel(value, old) {
        ...
        if (old != undefined) {
          if (this.__P_77_4 != undefined) {
            old.removeListenerById(this.__P_77_4);
          }
        ...
        if (value != null) {
          // add a new listener
          this.__P_77_4 = value.addListener("change", this.__P_77_10, this); // renew the index lookup table

          this.__P_77_11(); // check for the new length


          this.__P_77_7(); // as we only change the labels of the items, the selection change event
      ...
      _applyTarget(value, old) {
        ...
        if (value != null) {
          if (this.getModel() != null) {
            ...
            for (var i = 0; i < this.__P_77_0.length; i++) {
              this.__P_77_13(this.__P_77_14(i));
            }
          }
        }
      },
      ...
      */
      ...
      __P_77_10() {
        ...
        this.__P_77_15 = true; // need an asynchronous selection update because the bindings have to be
      ...
      syncWidget() {
        ...
        this.__P_77_6 = this.__P_77_5 = null;
      },
      ...
      __P_77_7() {
        ...
        this.__P_77_11(); // sync the target selection in case someone deleted a item in
      ...
      __P_77_16() {
        ...
        if (model != null) {
          model.removeListenerById(this.__P_77_4);
          this.__P_77_4 = model.addListener("change", this.__P_77_10, this);
        }
      },
      ...
      */
      ...
      bindProperty(sourcePath, targetProperty, options, targetWidget, index) {
        ...
        if (options != null) {
          ...
          this.__P_77_3[targetProperty] = options.onUpdate;
          delete options.onUpdate;
        } else {
          options = {};
          this.__P_77_3[targetProperty] = null;
        }
        ...
        if (!this.__P_77_1.includes(targetProperty)) {
          this.__P_77_1.push(targetProperty);
        }
      },
      ...
      bindPropertyReverse(targetPath, sourcePath, options, sourceWidget, index) {
        ...
        if (!this.__P_77_2.includes(targetPath)) {
          this.__P_77_2.push(targetPath);
        }
      },
      ...
      _onBindingSet(index, sourceObject, targetObject) {
        ...
        for (var i = 0; i < this.__P_77_1.length; i++) {
          // if there is an onUpdate for one of it, invoke it
          if (this.__P_77_3[this.__P_77_1[i]] != null) {
            this.__P_77_3[this.__P_77_1[i]]();
          }
        }
      },
      ...
      _removeBindingsFrom(item) {
        ...
        for (var i = 0; i < this.__P_77_1.length; i++) {
          ...
          var id = item.getUserData(this.__P_77_1[i] + "BindingId");

          if (id != null) {
            this.removeBinding(id);
            item.setUserData(this.__P_77_1[i] + "BindingId", null);
          }
        } // go through all reverse bound properties


        for (var i = 0; i < this.__P_77_2.length; i++) {
          // get the binding id and remove it, if possible
          var id = item.getUserData(this.__P_77_2[i] + "ReverseBindingId");

          if (id != null) {
            item.removeBinding(id);
            item.getUserData(this.__P_77_2[i] + "ReverseBindingId", null);
          }
        }
      },
      ...
      __P_77_8() {
        ...
        for (var i = 0; i < items.length; i++) {
          ...
          this._bindListItem(items[i], this.__P_77_14(i));
      ...
      */
      ...
      _setFilter(value, old) {
        ...
        var oldTable = this.__P_77_0; // generate a new lookup table

        this.__P_77_11(); // if there are lesser items


        if (oldTable.length > this.__P_77_0.length) {
          // remove the unnecessary items
          for (var j = oldTable.length; j > this.__P_77_0.length; j--) {
            this.getTarget().removeAt(j - 1).destroy();
          } // if there are more items

        } else if (oldTable.length < this.__P_77_0.length) {
          // add the new elements
          for (var j = oldTable.length; j < this.__P_77_0.length; j++) {
        ...
        for (var i = 0; i < listItems.length; i++) {
          this._bindListItem(listItems[i], this.__P_77_14(i));
        } // move the controllers change handler for the model to the end of the
        // listeners queue
      ...
      __P_77_17() {
        ...
        this.__P_77_7(); // renew the bindings


        this.__P_77_8(); // need an asynchronous selection update because the bindings have to be
        // executed to update the selection probably (using the widget queue)
      ...
      */
      ...
      __P_77_11() {
        ...
        this.__P_77_0 = []; // -1 is a special lookup value, to represent the "null" option

        if (this.isAllowNull()) {
          this.__P_77_0.push(-1);
        }

        for (var i = 0; i < model.getLength(); i++) {
          if (filter == null || filter(model.getItem(i))) {
            this.__P_77_0.push(i);
          }
        }
      },
     ...
     */
    destruct() {
      this.__P_77_0 = this.__P_77_3 = this.__P_77_1 = null;
      this.__P_77_2 = null; // remove yourself from the widget queue
