    ...
    */
    construct() {
      ...
      if (this.getSelection() == null) {
        ...
        this.setSelection(this.__P_78_0);
      }
    },
    ...
    members: {
      ...
      */
      ...
      _applySelection(value, old) {
        ...
        if (this.__P_78_2 != undefined && old != undefined) {
          old.removeListenerById(this.__P_78_2);
          this.__P_78_2 = null;
        } // add a new change listener to the changeArray


        if (value) {
          this.__P_78_2 = value.addListener("change", this.__P_78_3, this);
      ...
      */
      ...
      _changeTargetSelection() {
        ...
        if (!this.__P_78_4() && !this.__P_78_5()) {
          return;
      ...
      */
      ...
      _addChangeTargetListener(value, old) {
        ...
        if (this.__P_78_1 != undefined && old != undefined) {
          old.removeListenerById(this.__P_78_1);
        }
        ...
        if (value != null) {
          ...
          if (this.__P_78_4() || this.__P_78_5()) {
            ...
            this.__P_78_1 = value.addListener("changeSelection", this._changeTargetSelection, this);
          }
        }
      },
      ...
      _updateSelection() {
        ...
        if (this.__P_78_4()) {
          ...
          for (var i = 0; i < this.getSelection().length; i++) {
            ...
            var selectable = this.__P_78_6(model);
          ...
          if (item !== undefined) {
            ...
            this.__P_78_7(item); // remove the other items from the selection data array and get
       ...
       */
      __P_78_7(item) {
        var selectable = this.__P_78_6(item); // if no selectable could be found, just return
