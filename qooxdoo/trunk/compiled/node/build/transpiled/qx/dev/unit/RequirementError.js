  ...
  qx.Class.define("qx.dev.unit.RequirementError", {
    ...
    */
    ...
    construct(requirement, message) {
      this.__P_243_0 = message || "Requirement not met";
      this.__P_243_1 = requirement;
      var inst = Error.call(this, this.__P_243_0); // map stack trace properties since they're not added by Error's constructor
