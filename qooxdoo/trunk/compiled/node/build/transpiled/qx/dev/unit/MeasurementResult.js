  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.dev.unit.MeasurementResult", {
    ...
    construct(message, iterations, ownTime, renderTime) {
      this.__P_215_0 = message;
      this.__P_215_1 = iterations;
      this.__P_215_2 = ownTime;
      this.__P_215_3 = renderTime;
    },
    ...
    members: {
      ...
      getData() {
        return {
          message: this.__P_215_0,
          iterations: this.__P_215_1,
          ownTime: this.__P_215_2,
          renderTime: this.__P_215_3
        };
      },
       ...
       */
      toString() {
        return ["Measured: " + this.__P_215_0, "Iterations: " + this.__P_215_1, "Time: " + this.__P_215_2 + "ms", "Render time: " + this.__P_215_3 + "ms"].join("\n");
      }
