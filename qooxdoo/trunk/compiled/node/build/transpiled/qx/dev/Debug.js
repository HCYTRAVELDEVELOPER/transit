    ...
    statics: {
      ...
      startDisposeProfiling: qx.core.Environment.select("qx.debug.dispose", {
        true() {
          ...
          this.__P_216_0 = qx.core.ObjectRegistry.getNextHash();
      ...
      stopDisposeProfiling: qx.core.Environment.select("qx.debug.dispose", {
        true(checkFunction, startHandle) {
          ...
          var undisposedObjects = this.showDisposeProfiling(checkFunction, startHandle || this.__P_216_0);
          delete this.__P_216_0;
      ...
      showDisposeProfiling: qx.core.Environment.select("qx.debug.dispose", {
        true(checkFunction) {
          ...
          for (var hash = this.__P_216_0; hash < nextHashLast; hash++) {
