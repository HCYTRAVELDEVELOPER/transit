    ...
    statics: {
      ...
      hexStringToRgb(value) {
        if (this.ishexShortString(value)) {
          return this.__P_126_2(value);
        }

        if (this.ishexLongString(value)) {
          return this.__P_126_3(value);
        }
       ...
       */
      __P_126_6(color, tuneMap, tuner, hue_tuner) {
      ...
      scale(color, scaleMap) {
        return this.__P_126_6(color, scaleMap, function (value, scale, max) {
          if (value > max) {
            value = max;
          }
      ...
      adjust(color, adjustMap) {
        return this.__P_126_6(color, adjustMap, function (value, offset, max) {
          value += offset;
