  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.util.DynamicScriptLoader", {
    ...
    construct(scriptArr) {
      ...
      this.__P_130_0 = false;
      this.__P_130_1 = qx.lang.Type.isString(scriptArr) ? [scriptArr] : qx.lang.Array.clone(scriptArr);
    },
    ...
    */
    members: {
      ...
      __P_130_4() {
        ...
        if (DynamicScriptLoader.__P_130_3[script]) {
        ...
        dynLoader = DynamicScriptLoader.__P_130_2[script];
        ...
        loader.on("load", function (request) {
          ...
          DynamicScriptLoader.__P_130_3[script] = true;
          delete DynamicScriptLoader.__P_130_2[script];
          this.fireDataEvent("loaded", {
            script: script,
        ...
        loader.open("GET", uri);
        DynamicScriptLoader.__P_130_2[script] = this;
        loader.send();
      }
    ...
    destruct() {
      ...
      for (var key in DynamicScriptLoader.__P_130_2) {
        if (DynamicScriptLoader.__P_130_2[key] === this) {
          delete DynamicScriptLoader.__P_130_2[key];
        }
      }

      this.__P_130_1 = undefined;
    }
