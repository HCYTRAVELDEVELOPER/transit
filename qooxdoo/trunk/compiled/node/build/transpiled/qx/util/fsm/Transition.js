  ...
  qx.Class.define("qx.util.fsm.Transition", {
    ...
    construct(transitionName, transitionInfo) {
      ...
      for (var field in transitionInfo) {
        ...
        switch (field) {
          case "predicate":
            this.setPredicate(this.__P_144_0(transitionInfo[field], context));
            break;
          ...
          case "autoActionsBeforeOntransition":
            this.setAutoActionsBeforeOntransition(this.__P_144_0(transitionInfo[field], context));
            break;

          case "autoActionsAfterOntransition":
            this.setAutoActionsAfterOntransition(this.__P_144_0(transitionInfo[field], context));
            break;

          case "ontransition":
            this.setOntransition(this.__P_144_0(transitionInfo[field], context));
            break;
