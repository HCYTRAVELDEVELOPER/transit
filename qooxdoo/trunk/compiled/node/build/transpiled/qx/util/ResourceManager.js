  ...
  qx.Class.define("qx.util.ResourceManager", {
    ...
    */
    members: {
       ...
       */
      getIds(pathfragment) {
        var registry = qx.util.ResourceManager.__P_134_0;
       ...
       */
      has(id) {
        return !!qx.util.ResourceManager.__P_134_0[id];
      },
       ...
       */
      getData(id) {
        return qx.util.ResourceManager.__P_134_0[id] || null;
      },
      ...
      getImageWidth(id) {
        ...
        var entry = qx.util.ResourceManager.__P_134_0[id]; // [ width, height, codepoint ]
      ...
      getImageHeight(id) {
        ...
        var entry = qx.util.ResourceManager.__P_134_0[id];
      ...
      getCombinedFormat(id) {
        var clippedtype = "";
        var entry = qx.util.ResourceManager.__P_134_0[id];
        var isclipped = entry && entry.length > 4 && typeof entry[4] == "string" && this.constructor.__P_134_0[entry[4]];

        if (isclipped) {
          var combId = entry[4];
          var combImg = this.constructor.__P_134_0[combId];
      ...
      toUri(id) {
        ...
        if (qx.core.Environment.get("engine.name") == "mshtml" && qx.core.Environment.get("io.ssl")) {
          urlPrefix = qx.util.ResourceManager.__P_134_1[lib];
        }
       ...
       */
      toDataUri(resid) {
        var resentry = this.constructor.__P_134_0[resid];
        var combined = resentry ? this.constructor.__P_134_0[resentry[4]] : null;
        var uri;
        ...
        if (qx.core.Environment.get("io.ssl")) {
          for (var lib in qx.$$libraries) {
            ...
            if (resourceUri.match(/^\/\//) != null) {
              statics.__P_134_1[lib] = window.location.protocol;
            } // If the resourceUri begins with a single slash, include the current
            // hostname
            else if (resourceUri.match(/^\//) != null) {
              if (href) {
                statics.__P_134_1[lib] = href;
              } else {
                statics.__P_134_1[lib] = window.location.protocol + "//" + window.location.host;
              }
            ...
            // IMPORTANT: this is only applicable for the source version
              ...
              statics.__P_134_1[lib] = url.substring(0, url.lastIndexOf("/") + 1);
              ...
              statics.__P_134_1[lib] = href.substring(0, href.lastIndexOf("/") + 1);
            }
          }
        }
      }
