  ...
  qx.Class.define("qx.util.TimerManager", {
    ...
    members: {
      ...
      start(callback, recurTime, context, userData, initialTime) {
        ...
        qx.util.TimerManager.__P_138_1[++qx.util.TimerManager.__P_138_2] = {
          callback: callback,
        ...
        this.__P_138_4(expireAt, qx.util.TimerManager.__P_138_2); // Give 'em the timer id


        return qx.util.TimerManager.__P_138_2;
      },
      ...
      stop(timerId) {
        ...
        var timerQueue = qx.util.TimerManager.__P_138_0;
        ...
        delete qx.util.TimerManager.__P_138_1[timerId]; // If there are no more timers pending...

        if (timerQueue.length == 0 && this.__P_138_3) {
          // ... then stop listening for the periodic timer
          qx.event.Idle.getInstance().removeListener("interval", this.__P_138_5, this);
          this.__P_138_3 = false;
        }
      },
      ...
      __P_138_4(expireAt, timerId) {
        ...
        var timerQueue = qx.util.TimerManager.__P_138_0;
        var timerData = qx.util.TimerManager.__P_138_1;
        var length = timerQueue.length;
        ...
        if (!this.__P_138_3) {
          ...
          qx.event.Idle.getInstance().addListener("interval", this.__P_138_5, this);
          this.__P_138_3 = true;
        }
      },
      ...
      __P_138_5() {
        ...
        var timerQueue = qx.util.TimerManager.__P_138_0;
        var timerData = qx.util.TimerManager.__P_138_1; // Is it time to process the first timer element yet?
        ...
        while (timerQueue.length > 0 && timerData[timerQueue[0]].expireAt <= timeNow) {
          ...
          if (expiredTimerData.recurTime && timerData[expiredTimerId]) {
            ...
            this.__P_138_4(expiredTimerData.expireAt, expiredTimerId);
          } else {
