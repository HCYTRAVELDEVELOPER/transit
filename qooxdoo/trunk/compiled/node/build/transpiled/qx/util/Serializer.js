  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.util.Serializer", {
    statics: {
        ...
        for (var name in properties) {
          ...
          if (qx.lang.Type.isArray(value)) {
            ...
            for (var i = 0; i < value.length; i++) {
              ...
              result += this.__P_137_0(name, valueAtI, qxSerializer);
            }
          } else if (qx.lang.Type.isDate(value) && dateFormat != null) {
            result += this.__P_137_0(name, dateFormat.format(value), qxSerializer);
          } else {
            result += this.__P_137_0(name, value, qxSerializer);
          }
        }
       ...
       */
      __P_137_0(name, value, qxSerializer) {
