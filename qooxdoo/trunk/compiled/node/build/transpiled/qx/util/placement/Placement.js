  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.util.placement.Placement", {
    ...
    construct() {
      ...
      this.__P_145_0 = qx.util.placement.DirectAxis;
    },
    ...
    statics: {
      ...
      compute(size, area, target, offsets, position, modeX, modeY) {
        this.__P_145_1 = this.__P_145_1 || new qx.util.placement.Placement();
        var splitted = position.split("-");
        var edge = splitted[0];
        var align = splitted[1];

        this.__P_145_1.set({
          axisX: this.__P_145_2(modeX),
          axisY: this.__P_145_2(modeY),
          edge: edge,
          align: align
        });

        return this.__P_145_1.compute(size, area, target, offsets);
      },
      ...
      __P_145_2(mode) {
        switch (mode) {
          case "direct":
            this.__P_145_3 = this.__P_145_3 || qx.util.placement.DirectAxis;
            return this.__P_145_3;

          case "keep-align":
            this.__P_145_4 = this.__P_145_4 || qx.util.placement.KeepAlignAxis;
            return this.__P_145_4;

          case "best-fit":
            this.__P_145_5 = this.__P_145_5 || qx.util.placement.BestFitAxis;
    ...
    members: {
      ...
      compute(size, area, target, offsets) {
        var axisX = this.getAxisX() || this.__P_145_0;
        ...
        }, area.width, this.__P_145_6());

        var axisY = this.getAxisY() || this.__P_145_0;
