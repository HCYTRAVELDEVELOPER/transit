  ...
  qx.Class.define("qx.util.AliasManager", {
    ...
    */
    construct() {
      ...
      this.__P_124_0 = {}; // Define static alias from setting
    ...
    members: {
      ...
      _preprocess(value) {
        ...
        if (dynamics[value] === false) {
          ...
          if (this.__P_124_0[value]) {
            return this.__P_124_0[value];
          }

          var alias = value.substring(0, value.indexOf("/"));
          var resolved = this.__P_124_0[alias];
      ...
      add(alias, base) {
        ...
        this.__P_124_0[alias] = base; // Localify stores
       ...
       */
      remove(alias) {
        delete this.__P_124_0[alias]; // No signal for depending objects here. These
