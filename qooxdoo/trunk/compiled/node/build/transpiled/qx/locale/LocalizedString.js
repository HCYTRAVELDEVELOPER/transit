  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.locale.LocalizedString", {
    ...
    construct(translation, messageId, args, localized) {
      ...
      this.__P_113_0 = messageId;
      this.__P_113_1 = !!localized;
      this.__P_113_2 = args;
    },
    ...
    members: {
      ...
      translate() {
        if (this.__P_113_1) {
          return qx.locale.Manager.getInstance().localize(this.__P_113_0, this.__P_113_2);
        }

        return qx.locale.Manager.getInstance().translate(this.__P_113_0, this.__P_113_2);
      },
