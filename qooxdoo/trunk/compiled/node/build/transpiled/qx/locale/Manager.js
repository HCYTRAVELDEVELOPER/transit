  ...
  qx.Class.define("qx.locale.Manager", {
    ...
    */
    construct() {
      ...
      this.__P_114_0 = qx.$$translations || {};
      this.__P_114_1 = qx.$$locales || {};
      this.initLocale();
      this.__P_114_2 = this.getLocale();
    },
    ...
    */
    members: {
      __P_114_3: qx.core.Environment.get("locale.default"),
      __P_114_4: null,
      __P_114_5: null,
      __P_114_0: null,
      __P_114_1: null,
      ...
      getAvailableLocales(includeNonloaded) {
        ...
        for (var locale in this.__P_114_1) {
          if (locale != this.__P_114_3) {
            if (this.__P_114_1[locale] === null && !includeNonloaded) {
      ...
      _applyLocale(value, old) {
        this.__P_114_4 = value;
        this.__P_114_5 = this.__P_114_6(value);
      },
      ...
      translate(messageId, args, locale) {
        var catalog = this.__P_114_0;
        return this.__P_114_7(catalog, messageId, args, locale);
      },
       ...
       * @return {String | LocalizedString} translated message or localized string
       */
      __P_114_7(catalog, messageId, args, locale) {
        var txt;
        ...
        if (locale) {
          var language = this.__P_114_6(locale);
        } else {
          locale = this.__P_114_4;
          language = this.__P_114_5;
        } // e.g. DE_at
        ...
        if (!txt && catalog[this.__P_114_3]) {
          txt = catalog[this.__P_114_3][messageId];
        }
        ...
        {
          txt = new qx.locale.LocalizedString(txt, messageId, args, catalog === this.__P_114_1);
        }
        return txt;
      }
