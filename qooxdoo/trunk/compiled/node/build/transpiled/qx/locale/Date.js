  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.locale.Date", {
    statics: {
       ...
       * @internal
       */
      __P_112_0: qx.locale.Manager.getInstance(),
       ...
       */
      getAmMarker(locale) {
        return this.__P_112_0.localize("cldr_am", [], locale);
      },
       ...
       */
      getPmMarker(locale) {
        return this.__P_112_0.localize("cldr_pm", [], locale);
      },
      ...
      getDayNames(length, locale, context, withFallback) {
        ...
        for (var i = 0; i < days.length; i++) {
          ...
          names.push(withFallback ? this.__P_112_1(context, context === "format" ? "stand-alone" : "format", key, locale) : this.__P_112_0.localize(key, [], locale));
        }
      ...
      getDayName(length, day, locale, context, withFallback) {
        ...
        return withFallback ? this.__P_112_1(context, context === "format" ? "stand-alone" : "format", key, locale) : this.__P_112_0.localize(key, [], locale);
      },
      ...
      getDateFormat(size, locale) {
        ...
        return this.__P_112_0.localize(key, [], locale);
      },
      ...
      getDateTimeFormat(canonical, fallback, locale) {
        ...
        var localizedFormat = this.__P_112_0.localize(key, [], locale);
      ...
      _getTerritory(locale) {
        if (locale) {
          ...
          territory = this.__P_112_0.getTerritory() || this.__P_112_0.getLanguage();
        }
       ...
       *
       */
      __P_112_1(context, fallbackContext, key, locale) {
        var localizedString = this.__P_112_0.localize(key, [], locale);

        if (localizedString == key) {
          var newKey = key.replace("_" + context + "_", "_" + fallbackContext + "_");
          return this.__P_112_0.localize(newKey, [], locale);
        } else {
