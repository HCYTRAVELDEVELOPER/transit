  ...
  qx.Bootstrap.define("qx.bom.client.Engine", {
    ...
    statics: {
      ...
      getVersion() {
        ...
        if (qx.bom.client.Engine.__P_61_0()) {
        ...
        } else if (qx.bom.client.Engine.__P_61_1()) {
        ...
        } else if (qx.bom.client.Engine.__P_61_2()) {
        ...
        } else if (qx.bom.client.Engine.__P_61_3()) {
      ...
      __P_61_0() {
        ...
        if (qx.bom.client.Engine.__P_61_4()) {
          return true;
        }
