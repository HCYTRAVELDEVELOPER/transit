  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.data.SingleValueBinding", {
    statics: {
       ...
       */
      __P_98_2(sourceObject, sourcePropertyChain, targetObject, targetPropertyChain, options) {
       ...
       */
      __P_98_10(targetObject, targetPropertyChain) {
       ...
       */
      __P_98_9(targetObject, targetPropertyChain, value) {
        // get the last target object of the chain
        var properties = this.__P_98_12(targetPropertyChain);
       ...
       *   should be set.
       */
      __P_98_13(targetObject, targetProperties, index) {
       ...
       */
      __P_98_5(value, targetObject, targetPropertyChain, options, sourceObject) {
       ...
       *   property.
       */
      __P_98_6(sourceObject, sourceEvent, targetObject, targetProperty, options, arrayIndex) {
        // checks
       ...
       *   object.
       */
      __P_98_8(id, sourceObject, sourceEvent, targetObject, targetProperty) {
       ...
       */
      __P_98_11(value, targetObject, targetPropertyChain, options, sourceObject) {
       ...
       */
      __P_98_14(sourceObject, sourceProperty) {
        // get the event name
