(function () {
  ...
  qx.Class.define("qx.tool.compiler.targets.SourceCodeCopier", {
    ...
    construct(outputFilename) {
      ...
      this.__P_38_0 = basename + "-tmp.js";
      this.__P_38_1 = basename + ".js";
      this.__P_38_2 = basename + ".js.map";
      this.__P_38_3 = fs.createWriteStream(this.__P_38_0);
      this.__P_38_4 = crypto.createHash("sha256");

      this.__P_38_4.setEncoding("hex");

      this.__P_38_5 = new sourceMap.SourceMapGenerator({
        file: this.__P_38_2
      });
      this.__P_38_6 = 0;
    },
    ...
    members: {
       ...
       */
      async open() {
        let stat = await qx.tool.utils.files.Utils.safeStat(this.__P_38_1);

        if (stat) {
          let hash = crypto.createHash("sha256");
          hash.setEncoding("hex");
          let data = await fs.readFileAsync(this.__P_38_1, "utf8");
          hash.write(data);
          this.__P_38_7 = this.__P_38_4.read();
        }
      },
       ...
       */
      __P_38_8(str) {
        this.__P_38_4.write(str);

        this.__P_38_3.write(str);
      },
      ...
      async addSourceFile(jsFilename, jsUri) {
        ...
        if (stat) {
          ...
          map.eachMapping(mapping => {
            mapping = {
              generated: {
                line: mapping.generatedLine + this.__P_38_6,
            ...
            this.__P_38_5.addMapping(mapping);
          });
          map.sources.forEach(origSource => this.__P_38_5.setSourceContent(source, map.sourceContentFor(origSource)));
        }

        this.__P_38_6 += numLines;
      },
       ...
       */
      async close() {
        this.__P_38_8("\n//# sourceMappingURL=" + path.basename(this.__P_38_2) + "\n");

        this.__P_38_3.end();

        this.__P_38_4.end();

        var hashValue = this.__P_38_4.read();

        if (!this.__P_38_7 || hashValue !== this.__P_38_7) {
          await fs.renameAsync(this.__P_38_0, this.__P_38_1);
          await fs.writeFileAsync(this.__P_38_2, JSON.stringify(JSON.parse(this.__P_38_5.toString()), null, 2), "utf8");
          return true;
        }

        await fs.unlinkAsync(this.__P_38_0);
        return false;
      }
