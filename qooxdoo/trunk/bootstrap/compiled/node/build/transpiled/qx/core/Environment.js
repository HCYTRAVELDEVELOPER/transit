  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.core.Environment", {
    statics: {
      ...
      get(key) {
        // check the cache
        if (this.__P_59_0[key] != undefined) {
          return this.__P_59_0[key];
      ...
      getAsync(key, callback, self) {
        ...
        if (this.__P_59_0[key] != undefined) {
          ...
          window.setTimeout(function () {
            callback.call(self, env.__P_59_0[key]);
          }, 0);
          return;
        }
       ...
       */
      select(key, values) {
        return this.__P_59_1(this.get(key), values);
      },
      ...
      selectAsync(key, values, self) {
        this.getAsync(key, function (result) {
          var value = this.__P_59_1(key, values);
      ...
      add(key, check) {
        ...
        if (this._checks[key] == undefined) {
          ...
          if (check instanceof Function) {
            ...
            this._checks[key] = this.__P_59_2(check);
          }
        }
      },
      ...
      __P_59_3() {
        ...
        if (qx && qx.$$environment) {
          for (var key in qx.$$environment) {
            ...
            this._checks[key] = this.__P_59_2(value);
          }
        }
      },
    ...
    defer(statics) {
      ...
      statics.__P_59_3(); // load the checks from the url
