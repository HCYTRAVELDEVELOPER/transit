  ...
  qx.Class.define("qx.util.DeferredCall", {
    ...
    */
    ...
    construct(callback, context) {
      ...
      this.__P_101_0 = callback;
      this.__P_101_1 = context || null;
      this.__P_101_2 = qx.util.DeferredCallManager.getInstance();
    },
    ...
    */
    members: {
       ...
       */
      call() {
        this.__P_101_1 ? this.__P_101_0.apply(this.__P_101_1) : this.__P_101_0();
      }
    ...
    */
    destruct() {
      this.cancel();
      this.__P_101_1 = this.__P_101_0 = this.__P_101_2 = null;
    }
