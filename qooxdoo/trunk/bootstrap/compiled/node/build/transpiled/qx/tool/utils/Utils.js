    ...
    defer(statics) {
      ...
      class StripSourceMapTransform extends Transform {
        ...
        _transform(chunk, encoding, callback) {
          let str = this.__P_54_1 + chunk.toString();
          let pos = str.lastIndexOf("\n");

          if (pos > -1) {
            this.__P_54_1 = str.substring(pos);
      ...
      class ToStringWriteStream extends Writable {
        ...
        _write(chunk, encoding, callback) {
          this.__P_54_3 += chunk.toString();

          if (this.__P_54_2) {
            this.__P_54_2.write(chunk, encoding, callback);
          } else if (callback) {
            callback();
          }
        }
