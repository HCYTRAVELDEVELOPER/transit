  ...
  qx.Class.define("qx.event.handler.Application", {
    ...
    */
    ...
    construct(manager) {
      ...
      this.__P_65_2 = false;
      this.__P_65_3 = false;
      this.__P_65_4 = false; // Initialize observers
    ...
    members: {
      ...
      */
      ...
      __P_65_5() {
        ...
        if (!this.__P_65_2 && this.__P_65_0 && qx.$$loader.scriptLoaded) {
          ...
          if (qx.core.Environment.get("engine.name") == "mshtml") {
            if (qx.event.Registration.hasListener(this._window, "ready")) {
              this.__P_65_2 = true; // Fire user event
       ...
       */
      __P_65_6() {
        this.__P_65_3 = true; // Fire user event
      ...
      */
      ...
      _onNativeLoad() {
        var callback = qx.core.Environment.select("qx.globalErrorHandling", {
          true: qx.event.GlobalError.observeMethod(this.__P_65_7),
          false: this.__P_65_7
        });
      ...
      _onNativeUnload() {
        var callback = qx.core.Environment.select("qx.globalErrorHandling", {
          true: qx.event.GlobalError.observeMethod(this.__P_65_8),
          false: this.__P_65_8
        });
        callback.apply(this, arguments);
      },
