  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.core.Property", {
    statics: {
       ...
       */
      __P_76_3(clazz) {
        var inheritables = this.__P_76_4(clazz);

        if (!inheritables.length) {
          var refresher = function () {};
        } else {
          refresher = this.__P_76_5(inheritables);
        }
      ...
      attachRefreshInheritables(clazz) {
        clazz.prototype.$$refreshInheritables = function () {
          qx.core.Property.__P_76_3(clazz);
      ...
      attachMethods(clazz, name, config) {
        ...
        config.group ? this.__P_76_6(clazz, config, name) : this.__P_76_7(clazz, config, name);
      },
       ...
       * @param name {String} Name of the property
       */
      __P_76_7(clazz, config, name) {
        var upname = qx.Bootstrap.firstUp(name);
        var members = clazz.prototype;

        // Fill dispose value
        if (config.dereference === undefined && typeof config.check === "string") {
          config.dereference = this.__P_76_8(config.check);
        }
        ...
        members[method.get[name]].$$install = function () {
          qx.core.Property.__P_76_9(clazz, name, "get", arguments);

          if (config.async) {
            qx.core.Property.__P_76_9(clazz, name, "getAsync", arguments);
          }
        };
        ...
        members[setName].$$install = function () {
          qx.core.Property.__P_76_10(clazz, name, "set");

          qx.core.Property.__P_76_10(clazz, name, "setImpl");

          if (config.async) {
            qx.core.Property.__P_76_10(clazz, name, "setAsync");
          }
        };
        ...
        members[method.reset[name]].$$install = function () {
          qx.core.Property.__P_76_10(clazz, name, "reset");
        };
      ...
      error(obj, id, property, variant, value) {
        ...
        throw new Error(msg + (this.__P_76_11[id] || "Unknown reason: " + id));
      },
       ...
       */
      __P_76_12(instance, members, name, variant, code, args) {
        var fn = this.__P_76_13(instance.constructor, name, variant, code, args); // Executing new function
       ...
       * @return {var} Return value of the generated function
       */
      __P_76_13(clazz, name, variant, code, args) {
      ...
      executeOptimizedGetter(instance, clazz, name, variant) {
        var code = this.__P_76_14(clazz, name, variant);

        var members = clazz.prototype;
        return this.__P_76_12(instance, members, name, variant, code);
      },
       ...
       * @param variant {String} Method variant.
       */
      __P_76_9(clazz, name, variant) {
        var code = this.__P_76_14(clazz, name, variant);

        this.__P_76_13(clazz, name, variant, code);
      },
      ...
      executeOptimizedSetter(instance, clazz, name, variant, args) {
        var code = this.__P_76_15(clazz, name, variant);

        var members = clazz.prototype;
        return this.__P_76_12(instance, members, name, variant, code, args);
      },
       ...
       * @return {var} Return value of the generated function
       */
      __P_76_10(clazz, name, variant) {
        var code = this.__P_76_15(clazz, name, variant);

        return this.__P_76_13(clazz, name, variant, code);
      },
      ...
      __P_76_15(clazz, name, variant) {
        ...
        var store = this.__P_76_16(variant, name);

        this.__P_76_17(code, clazz, config, name);

        this.__P_76_18(code, config, name, variant, incomingValue);

        if (incomingValue || hasCallback) {
          this.__P_76_19(code, config, name);
        }

        if (incomingValue) {
          this.__P_76_20(code, clazz, config, name);
        }

        if (hasCallback) {
          this.__P_76_21(code, incomingValue, store, variant);
        }
        ...
        if (!hasCallback) {
          this.__P_76_22(code, name, variant, incomingValue);
        } else {
          this.__P_76_23(code, config, name, variant, incomingValue);
        }

        if (config.inheritable) {
          this.__P_76_24(code, config, name, variant);
        } else if (hasCallback) {
          this.__P_76_25(code, config, name, variant);
        }

        if (hasCallback) {
          // Emit callback and event firing; Refreshing children (5th parameter) requires the parent/children interface
          this.__P_76_26(code, config, name, variant, !!(config.inheritable && members._getChildren));
        } // Return value
       ...
       * @param name {String} name of the property
       */
      __P_76_17(code, clazz, config, name) {
        code.push("var equ=");
       ...
       */
      __P_76_18(code, config, name, variant, incomingValue) {
        {
       ...
       * @param name {String} name of the property
       */
      __P_76_20(code, clazz, config, name) {
       ...
       * @param variant {String} Method variant.
       */
      __P_76_21(code, incomingValue, store, variant) {
       ...
       * @param variant {String} Method variant.
       */
      __P_76_27: qx.core.Environment.select("qx.debug", {
        true(code, config, clazz, name, variant) {
          ...
          if (config.check !== undefined) {
            ...
            if (this.__P_76_1[config.check] !== undefined) {
              code.push("!(", this.__P_76_1[config.check], ")");
       ...
       * @param incomingValue {Boolean} Whether the setter has an incoming value
       */
      __P_76_22(code, name, variant, incomingValue) {
       ...
       * @param incomingValue {Boolean} Whether the setter has an incoming value
       */
      __P_76_23(code, config, name, variant, incomingValue) {
       ...
       * @param variant {String} Method variant.
       */
      __P_76_24(code, config, name, variant) {
       ...
       * @param variant {String} Method variant.
       */
      __P_76_25(code, config, name, variant) {
       ...
       */
      __P_76_26(code, config, name, variant, refresh) {
