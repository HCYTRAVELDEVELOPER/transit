  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.core.GlobalError", {
    ...
    construct(exc, args) {
      ...
      this.__P_97_0 = "GlobalError: " + (exc && exc.message ? exc.message : exc);
      var inst = Error.call(this, this.__P_97_0); // map stack trace properties since they're not added by Error's constructor
