  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.client.OperatingSystem", {
    statics: {
       ...
       */
      getVersion() {
        var version = qx.bom.client.OperatingSystem.__P_63_1(navigator.userAgent);

        if (version == null) {
          version = qx.bom.client.OperatingSystem.__P_63_2(navigator.userAgent);
        }
      ...
      __P_63_1(userAgent) {
        ...
        for (var key in qx.bom.client.OperatingSystem.__P_63_0) {
          str.push(key);
        }
        ...
        if (match && match[1]) {
          return qx.bom.client.OperatingSystem.__P_63_0[match[1]];
        }
