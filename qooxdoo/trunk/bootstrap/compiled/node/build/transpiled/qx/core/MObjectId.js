    ...
    members: {
      ...
      _applyQxObjectId(value, oldValue) {
        if (!this.__P_84_1) {
          ...
          if (owner) {
            owner.__P_84_2(this, value, oldValue);
          }
       ...
       */
      __P_84_2(obj, newId, oldId) {
        delete this.__P_84_0[oldId];
        this.__P_84_0[newId] = obj;
      },
      ...
      _cascadeQxObjectIdChanges() {
        ...
        if (this.__P_84_0) {
          for (var name in this.__P_84_0) {
            var obj = this.__P_84_0[name];
       ...
       */
      getOwnedQxObjects() {
        return this.__P_84_0 ? Object.values(this.__P_84_0) : [];
      }
