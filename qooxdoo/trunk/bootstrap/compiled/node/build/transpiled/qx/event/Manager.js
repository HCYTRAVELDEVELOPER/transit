  ...
  qx.Class.define("qx.event.Manager", {
    ...
    */
    ...
    construct(win, registration) {
      ...
      this.__P_93_0 = win;
      this.__P_93_1 = qx.core.ObjectRegistry.toHashCode(win);
      this.__P_93_2 = registration; // Register to the page unload event.
      ...
      this.__P_93_3 = {}; // The handler and dispatcher instances

      this.__P_93_4 = {};
      this.__P_93_5 = {};
      this.__P_93_6 = {};
      this.__P_93_7 = new qx.util.DeferredCall(function () {
        this.__P_93_8 = null;
      }, this);
      this.__P_93_7.$$blackListCleaner = true;
    },
    ...
    */
    statics: {
      ...
      removeGlobalEventMonitor(fn) {
        qx.core.Assert.assertFunction(fn);
        qx.lang.Array.remove(this.__P_93_10, fn);
      },
    ...
    */
    members: {
      ...
      */
       ...
       */
      getHandler(clazz) {
        var handler = this.__P_93_4[clazz.classname];

        if (handler) {
          return handler;
        }

        return this.__P_93_4[clazz.classname] = new clazz(this);
      },
       ...
       */
      getDispatcher(clazz) {
        var dispatcher = this.__P_93_5[clazz.classname];

        if (dispatcher) {
          return dispatcher;
        }

        return this.__P_93_5[clazz.classname] = new clazz(this, this.__P_93_2);
      },
      ...
      */
      ...
      getListeners(target, type, capture) {
        ...
        var targetMap = this.__P_93_3[targetKey];
      ...
      toggleAttachedEvents(target, enable) {
        ...
        if (targetMap) {
          ...
          for (var entryKey in targetMap) {
            ...
            if (enable) {
              this.__P_93_12(target, type, capture);
            } else {
              this.__P_93_13(target, type, capture);
            }
          }
        }
      },
      ...
      importListeners(target, list) {
        ...
        for (var listKey in list) {
          ...
          if (!entryList) {
            ...
            this.__P_93_12(target, item.type, item.capture);
          ...
          entryList.push({
            ...
            context: item.self,
            unique: item.unique || clazz.__P_93_9++ + ""
          });
        }
      },
      ...
      addListener(target, type, listener, self, capture) {
        ...
        if (!targetMap) {
          targetMap = this.__P_93_3[targetKey] = {};
        }
        ...
        var unique = qx.event.Manager.__P_93_9++ + "";
        var entry = {
          handler: listener,
          context: self,
          unique: unique
      ...
      findHandler(target, type) {
        ...
        var cache = this.__P_93_6;

        if (cache[key]) {
          return cache[key];
        }

        var classes = this.__P_93_2.getHandlers();
      ...
      removeAllListeners(target) {
        ...
        delete this.__P_93_3[targetKey];
        return true;
      },
      ...
      */
      ...
      dispatchEvent(target, event) {
        ...
        var monitors = qx.event.Manager.__P_93_10;
        ...
        var classes = this.__P_93_2.getDispatchers();
      ...
      dispose() {
        ...
        this.__P_93_2.removeManager(this);

        qx.util.DisposeUtil.disposeMap(this, "__P_93_4");
        qx.util.DisposeUtil.disposeMap(this, "__P_93_5"); // Dispose data fields

        this.__P_93_3 = this.__P_93_0 = this.__P_93_11 = null;
        this.__P_93_2 = this.__P_93_6 = null;
      },
       ...
       */
      __P_93_14(uid) {
        if (this.__P_93_8 === null) {
          this.__P_93_8 = {};

          this.__P_93_7.schedule();
        }

        this.__P_93_8[uid] = true;
      },
       ...
       */
      isBlacklisted(uid) {
        return this.__P_93_8 !== null && this.__P_93_8[uid] === true;
      }
