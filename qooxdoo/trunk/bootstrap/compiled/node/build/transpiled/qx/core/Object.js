  ...
  qx.Class.define("qx.core.Object", {
    ...
    members: {
      ...
      */
      ...
      clone() {
        ...
        var user = this.__P_66_0.$$store.user;
        var setter = this.__P_66_0.$$method.set;
    ...
    */
    destruct() {
      ...
      this.__P_66_1 = null; // only of properties are available

      {
        // Cleanup properties
        var clazz = this.constructor;
        var properties;
        var store = this.__P_66_0.$$store;
