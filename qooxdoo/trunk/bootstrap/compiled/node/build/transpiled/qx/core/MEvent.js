  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.core.MEvent", {
    members: {
      ...
      __P_83_0: qx.event.Registration,
      ...
      addListener(type, listener, self, capture) {
        if (!this.$$disposed) {
          return this.__P_83_0.addListener(this, type, listener, self, capture);
        }
      ...
      removeListener(type, listener, self, capture) {
        if (!this.$$disposed) {
          ...
          return this.__P_83_0.removeListener(this, type, listener, self, capture);
        }
      ...
      removeListenerById(id) {
        if (!this.$$disposed) {
          return this.__P_83_0.removeListenerById(this, id);
        }
      ...
      hasListener(type, capture) {
        return this.__P_83_0.hasListener(this, type, capture);
      },
      ...
      dispatchEvent(evt) {
        if (!this.$$disposed) {
          return this.__P_83_0.dispatchEvent(this, evt);
        }
      ...
      fireEvent(type, clazz, args) {
        if (!this.$$disposed) {
          return this.__P_83_0.fireEvent(this, type, clazz, args);
        }
      ...
      fireEventAsync(type, clazz, args) {
        if (!this.$$disposed) {
          return this.__P_83_0.fireEventAsync(this, type, clazz, args);
        }
      ...
      fireNonBubblingEvent(type, clazz, args) {
        if (!this.$$disposed) {
          return this.__P_83_0.fireNonBubblingEvent(this, type, clazz, args);
        }
      ...
      fireNonBubblingEventAsync(type, clazz, args) {
        if (!this.$$disposed) {
          return this.__P_83_0.fireNonBubblingEventAsync(this, type, clazz, args);
        }
      ...
      fireDataEvent(type, data, oldData, cancelable) {
        if (!this.$$disposed) {
          ...
          return this.__P_83_0.fireEvent(this, type, qx.event.type.Data, [data, oldData, !!cancelable]);
        }
      ...
      fireDataEventAsync(type, data, oldData, cancelable) {
        if (!this.$$disposed) {
          ...
          return this.__P_83_0.fireEventAsync(this, type, qx.event.type.Data, [data, oldData, !!cancelable]);
        }
