  ...
  qx.Bootstrap.define("qx.core.ObjectRegistry", {
    ...
    */
    statics: {
       ...
       */
      createHashCode() {
        var hash = String(this.__P_81_1++ + this.__P_81_2);
        return hash;
      },
      ...
      fromHashCode(hash, suppressWarnings) {
        var obj = this.__P_81_0[hash] || null;
