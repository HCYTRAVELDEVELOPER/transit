  ...
  qx.Class.define("qx.util.DeferredCallManager", {
    ...
    */
    members: {
      ...
      schedule(deferredCall) {
        if (this.__P_103_4 == null) {
          this.__P_103_4 = window.setTimeout(this.__P_103_1, 0);
        }

        var callKey = deferredCall.toHashCode(); // the flush is currently running and the call is already
        // scheduled

        if (this.__P_103_5 && this.__P_103_5[callKey]) {
          return;
        }

        this.__P_103_0[callKey] = deferredCall;
        this.__P_103_3 = true;
      },
      ...
      cancel(deferredCall) {
        ...
        if (this.__P_103_5 && this.__P_103_5[callKey]) {
          this.__P_103_5[callKey] = null;
          return;
        }

        delete this.__P_103_0[callKey]; // stop timer if no other calls are waiting

        if (qx.lang.Object.isEmpty(this.__P_103_0) && this.__P_103_4 != null) {
          window.clearTimeout(this.__P_103_4);
          this.__P_103_4 = null;
        }
      },
       ...
       * @signature function()
       */
      __P_103_2: qx.event.GlobalError.observeMethod(function () {
        this.__P_103_4 = null; // the queue may change while doing the flush so we work on a copy of
        // the queue and loop while the queue has any entries.

        while (this.__P_103_3) {
          this.__P_103_5 = qx.lang.Object.clone(this.__P_103_0);
          this.__P_103_0 = {};
          this.__P_103_3 = false;

          for (var key in this.__P_103_5) {
            var call = this.__P_103_5[key];

            if (call) {
              this.__P_103_5[key] = null;
              call.call();
            }
          }
        }
    ...
    */
    destruct() {
      ...
      this.__P_103_1 = this.__P_103_0 = null;
    }
