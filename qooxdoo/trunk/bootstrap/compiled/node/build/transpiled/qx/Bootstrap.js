  ...
  qx.Bootstrap.define("qx.Bootstrap", {
    statics: {
      ...
      executePendingDefers(dbClassInfo) {
        ...
        if (!dbClassInfo) {
          var pendingDefers = this.__P_64_0;
          this.__P_64_0 = [];
      ...
      */
       ...
       * @type {String[]}
       */
      __P_64_1: ["isPrototypeOf", "hasOwnProperty", "toLocaleString", "toString", "valueOf", "propertyIsEnumerable", "constructor"],
      ...
      keys: {
        ...
        BROKEN_IE(map) {
          ...
          var shadowedKeys = qx.Bootstrap.__P_64_1;
      ...
      */
      ...
      getClass(value) {
        ...
        return qx.Bootstrap.__P_64_2[classString] || classString.slice(8, -1);
      },
