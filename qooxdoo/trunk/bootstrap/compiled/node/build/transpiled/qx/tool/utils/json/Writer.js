(function () {
  ...
  qx.Class.define("qx.tool.utils.json.Writer", {
    ...
    members: {
      ...
      write(str) {
        ...
        while (true) {
          ...
          if (pos > -1) {
            ...
            this.__P_58_2 = this.buffer.length;
            this.buffer += this.__P_58_1;
            startPos = pos + 1;
          } else {
       ...
       */
      indent(count) {
        if (this.__P_58_0 + count < 0) {
          throw new Error("Unbalanced indent");
        }

        this.__P_58_0 += count;
        var indentStr = this.__P_58_1;
        ...
        var line = this.buffer.substring(this.__P_58_2);

        if (!line.match(/[^\s]/)) {
          this.buffer = this.buffer.substring(0, this.__P_58_2) + indentStr;
        }

        this.__P_58_1 = indentStr;
        return this;
      },
      ...
      matchIndent() {
        ...
        var m = line.match(/^([\s]*)/);
        var indent = m[0];
        var oldIndent = this.__P_58_1;
        this.__P_58_1 = indent;
        return oldIndent;
      },
