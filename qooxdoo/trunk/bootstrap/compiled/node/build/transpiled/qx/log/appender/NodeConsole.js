  ...
  qx.Class.define("qx.log.appender.NodeConsole", {
    statics: {
      ...
      log(logMessage, level) {
        if (this.__P_67_2 && this.__P_67_3[level]) {
          logMessage = this.__P_67_3[level] + logMessage + this.__P_67_3.reset;
        }

        if (level === "error") {
          this.__P_67_1.write(logMessage + "\n");
        } else {
          this.__P_67_0.write(logMessage + "\n");
        }
      },
    ...
    defer(statics) {
      if (typeof process !== "undefined") {
        statics.__P_67_0 = process.stdout;
        statics.__P_67_1 = process.stderr;
