  ...
  qx.Class.define("qx.tool.cli.commands.Package", {
    ...
    members: {
      ...
      getCache(readFromFile = false) {
        if (!readFromFile && this.__P_12_0 && typeof this.__P_12_0 == "object") {
          return this.__P_12_0;
        }

        try {
          this.__P_12_0 = JSON.parse(fs.readFileSync(this.getCachePath(), "UTF-8"));
        } catch (e) {
          this.__P_12_0 = {
            repos: {
              list: [],
      ...
      async saveCache() {
        ...
        await fs.writeFileAsync(this.getCachePath(), JSON.stringify(this.__P_12_0, null, 2), "UTF-8");
      },
      ...
      async exportCache(path) {
        try {
          let cache = this.__P_12_0 || this.getCache(true);
