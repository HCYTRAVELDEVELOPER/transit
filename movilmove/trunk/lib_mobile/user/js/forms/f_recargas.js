        ...
        self.consultaPlanes(function (planes) {
            self.consultaSaldo(function (p) {
                ...
                var fields = [
                    ...
                    {
                        name: "my_link_img",
                        label: "<span class='imgRecargas' style='background-image: url(" + config.domain_rpc + "/lib_mobile/driver/img/recargas.png);'></span>",
                        type: "html"
                    },
                    {
                        name: "my_link_description",
                        label: "<span class='titleRecargas'>" + nw.tr("Recarga saldo") + "</span><span class='descpRecargas'>" + nw.tr("Te quedaste sin saldo recarga y sigue disfrutando de nuestros servicios") + ".</span>",
                        type: "html"
                    },
                    {
                        label: "",
                    ...
                    },
                    {
                        ...
                        label: "<div class='titleSaldo'>" + nw.tr("Tu saldo es") + " <strong class='saldo_tit_tot'> $" + nw.addNumber(saldo) + aplydec + "</strong></div>",
                        type: "html"
                    },
                    {
                        name: "my_link_saldo",
                        label: "<span class='iconRecargas'><i class='material-icons'>attach_money</i></span><span class='contSaldo'>" + nw.tr("Recargar Saldo") + "</span>",
                        type: "html"
                    },
                    {
                        label: "",
...
//                visible: false
                    },
                    {
                        name: "valor_recarga",
                        label: "",
                        placeholder: nw.tr("Ingresa el valor"),
                        type: "integer",
//                        required: true,
                        visible: true
                    },
...
//                            });
                    ...
                    setTimeout(function () {
                        ...
                        d.callBackEnd = function (e) {
                            ...
                            rpc.exec("updatecheckout", data, func);
                        }
                        ...
                        if (main.debugConstruct) {
                            console.log("SAVE::f_recargas:::d", d);
                        }
