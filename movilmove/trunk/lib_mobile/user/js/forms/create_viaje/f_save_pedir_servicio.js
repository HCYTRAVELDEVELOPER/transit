...
//        }
        console.log("self.servicioAllData", self.servicioAllData);
        data.valorDescuentoCupon = 0;
        if (nw.utils.evalueData(self.servicioAllData.valorDescuentoCupon)) {
            data.valorDescuentoCupon = self.servicioAllData.valorDescuentoCupon;
        }
