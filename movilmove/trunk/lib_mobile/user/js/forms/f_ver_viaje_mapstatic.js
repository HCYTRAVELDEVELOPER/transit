...
//                direccion_destino: d.direccion_destino
            ...
            if (nw.utils.evalueData(d.direccion_origen)) {
                data.direccion_origen = d.direccion_origen;
            }
            if (nw.utils.evalueData(d.direccion_destino)) {
                data.direccion_destino = d.direccion_destino;
            }
