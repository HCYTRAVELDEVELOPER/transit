...
//        self.idiomaPorDefecto = "EN";
        self.name = "WorldExpress";
        self.description = "WorldExpress";
        ...
        self.emailSupport = "info@WorldExpress.com";
...
//        self.paymentStorePruebas = false;
        ...
        self.testing = false;
        self.url_play_store = "https://play.google.com/store/apps/details?id=com.movilmove.worldexpress";
        self.url_app_store = "";
        self.nameApplication = "com.movilmove.worldexpress";
...
//        self.iconDriverPuntoDriver = self.domain_rpc + self.carpet_files_extern + '/img/pindriver_1_35.png';
        self.iconDriverPuntoDriver = self.domain_rpc + self.carpet_files_extern + '/img/icon_moto_arriba_36.png';
        self.iconCarsMap = self.domain_rpc + self.carpet_files_extern + '/img/icon_moto_arriba_36.png';
...
//        self.iconDriverMap = self.domain_rpc + self.carpet_files_extern + '/img/pindriver_1_35.png';
        self.iconDriverMap = self.domain_rpc + self.carpet_files_extern + '/img/moto_marker_driver.png';
...
//        self.login_background_image = self.domain_rpc + self.carpet_files_extern + "img/home-img1.jpg";
        ...
        self.config_crear_cuenta = {
            ...
            pedir_politicas_text: "<span class='textpoliticsspan'>Al ingresar acepto las políticas de uso <a target='_BLANK' href='https://app.movilmove.com/app/policies.php?empresa=44&perfil=1'>Ver las políticas aquí­</a></span>",
            pedir_politicas_link: "https://app.movilmove.com/app/policies.php?empresa=44&perfil=1",
        ...
        if (nw.evalueData(up.usuario)) {
            self.logotipoHeader = "<img src='" + self.domain_rpc + self.carpet_files_extern + "img/worlexpress_288.png' />";
...
//            }
        ...
        self.contentCenter = "";
        self.contentFooter = "<br /><br /><br /><p class='footCredits'>WorldExpress 2023. Todos los derechos reservados. <br />Powered by Grupo <span style='color:firebrick;'>N</span><span style='color:#000;'>w</span> V " + self.version + "</p>";
    },
    destruct: function () {
    },
    members: {
