...
//        self.paymentStorePruebas = false;
        ...
        self.testing = false;
        self.url_play_store = "https://play.google.com/store/apps/details?id=com.movilmove.ultravans";
        self.url_app_store = "";
...
//        self.iconUserMap = self.domain_rpc + self.carpet_files_extern + '/img/me_pin.png';
        ...
        self.config_crear_cuenta = {
            ...
            pedir_politicas_text: "<span class='textpoliticsspan'>Al ingresar acepto las políticas de uso <a target='_BLANK' href='https://uvans.com.co/privacidad-para-pasajeros/'>Ver las políticas aquí­</a></span>",
            pedir_politicas_link: "https://uvans.com.co/privacidad-para-pasajeros/",
