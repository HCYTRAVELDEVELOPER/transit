...
//        nw.utils.validateElementIfExist(".aceptar", function () {
//            nw.addClass(".aceptar", "aceptar_mireeeeeeeeeeeee");
//        });
...
//        self.idiomaPorDefecto = "EN";
        self.name = "Newtt";
        self.description = "Newtt Pasajero";
        ...
        self.emailSupport = "info@Newtt.cl";
...
//        self.paymentStorePruebas = false;
        ...
        self.testing = false;
        self.url_play_store = "https://play.google.com/store/apps/details?id=movilmove.newtt";
        self.url_app_store = "";
        self.nameApplication = "movilmove.newtt";
...
//            }
        ...
        self.contentCenter = "";
        self.contentFooter = "<br /><br /><br /><p class='footCredits'>Newtt 2023. Todos los derechos reservados. <br />Powered by Grupo <span style='color:firebrick;'>N</span><span style='color:#000;'>w</span> V " + self.version + "</p>";
    },
    destruct: function () {
    },
    members: {
