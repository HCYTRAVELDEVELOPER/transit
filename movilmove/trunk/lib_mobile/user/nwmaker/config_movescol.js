...
//        self.idiomaPorDefecto = "EN";
        self.name = "Movescol";
        self.description = "Movescol Pasajero";
        ...
        self.emailSupport = "info@movescol.com.co";
...
//        self.paymentStorePruebas = false;
        ...
        self.testing = false;
        self.url_play_store = "https://play.google.com/store/apps/details?id=movilmove.movescol";
        self.url_app_store = "";
        self.nameApplication = "movilmove.movescol";
...
//        self.searchUpdatesAppInBack = true;
...
//        self.iconUserMap = self.domain_rpc + self.carpet_files_extern + '/img/me_pin.png';
        ...
        self.login_background_image = self.domain_rpc + self.carpet_files_extern + "img/fondo_movescol_login_pasajero.png";
        ...
        self.config_crear_cuenta = {
            ...
            pedir_politicas_text: "<span class='textpoliticsspan'>Al ingresar acepto las políticas de uso <a target='_BLANK' href='https://movescol.com.co/aviso-de-privacidad-para-pasajeros/'>Ver las políticas aquí­</a></span>",
            pedir_politicas_link: "https://movescol.com.co/aviso-de-privacidad-para-pasajeros/",
...
//            }
        ...
        self.contentCenter = "";
        self.contentFooter = "<p class='footCreditsInt'>Movescol 2023. Todos los derechos reservados. <br />Powered by Grupo <span style='color:firebrick;'>N</span><span style='color:#000;'>w</span> V " + self.version + "</p>";
