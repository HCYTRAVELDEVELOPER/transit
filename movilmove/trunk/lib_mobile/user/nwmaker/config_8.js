nw.Class.define("config", {
    ...
    construct: function () {
        ...
        self.name = "Netcar Cliente";
        self.description = "Netcar Cliente";
        ...
        self.testing = false;
        self.url_play_store = "https://play.google.com/store/apps/details?id=com.movilmove.movilmove_netcar";
        self.url_app_store = "";
        self.nameApplication = "com.movilmove.movilmove_netcar";
