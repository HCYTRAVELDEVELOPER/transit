...
//        self.idiomaPorDefecto = "EN";
        self.name = "Rmovil Cliente";
        self.description = "Rmovil Cliente";
        ...
        self.testing = false;
        self.url_play_store = "https://play.google.com/store/apps/details?id=com.movilmove.movilmove_rmovil";
        self.url_app_store = "";
        self.nameApplication = "com.movilmove.movilmove_rmovil";
...
//        self.iconUserMap = self.domain_rpc + self.carpet_files_extern + '/img/pinpasajero.png';
...
//            },
//            {
//                name: "adjunto_opcional",
//                label: "Documento FM3",
//                required: false
//            }
//        ];
//        self.labelsAccountTypeDocs = {};
//        self.labelsAccountTypeDocs[""] = "Seleccione";
//        self.labelsAccountTypeDocs["INE"] = nw.str("INE");
//        self.labelsAccountTypeDocs["LICENCIA DE CONDUCIR"] = nw.str("LICENCIA DE CONDUCIR");
//        self.labelsAccountTypeDocs["CEDULA PROFESIONAL"] = nw.str("CÉDULA PROFESIONAL");
//        self.labelsAccountTypeDocs["PASAPORTE"] = nw.str("PASAPORTE");
        ...
        self.config_crear_cuenta = {
            ...
            pedir_politicas_text: "<span class='textpoliticsspan'>Al ingresar acepto las políticas de uso <a target='_BLANK' href='https://app.movilmove.com/app/policies.php?empresa=40&perfil=1'>Ver las políticas aquí­</a></span>",
            pedir_politicas_link: "https://app.movilmove.com/app/policies.php?empresa=40&perfil=1",
