...
//        if (os === "ANDROID" && typeof versionInAppLibDevice !== "undefined") {
        ...
        self.emailSupport = "soporte@aglvans.com";
...
//        self.paymentStorePruebas = false;
        ...
        self.testing = false;
        self.url_play_store = "https://play.google.com/store/apps/details?id=movilmove.agl";
        self.url_app_store = "";
        self.nameApplication = "movilmove.agl";
...
//        self.iconUserMap = self.domain_rpc + self.carpet_files_extern + '/img/me_pin.png';
        ...
        self.config_crear_cuenta = {
            ...
            pedir_politicas_text: "<span class='textpoliticsspan'>Al ingresar acepto las políticas de uso <a target='_BLANK' href='https://app.movilmove.com/app/policies.php?empresa=49&perfil=1'>Ver las políticas aquí­</a></span>",
            pedir_politicas_link: "https://app.movilmove.com/app/policies.php?empresa=49&perfil=1",
        ...
        if (nw.evalueData(up.usuario)) {
            self.logotipoHeader = "<img src='" + self.domain_rpc + self.carpet_files_extern + "img/agl_logotipo_57.png' />";
            $(".logotipoHeader").addClass("logotipoHeader_home");
        } else {
//            self.logotipoHeader = "<img src='" + self.domain_rpc + self.carpet_files_extern + "img/agl_logotipo.png' />";
            self.logotipoHeader = "<img src='" + self.domain_rpc + self.carpet_files_extern + "img/agl_288.png' />";
...
//            }
        ...
        self.contentCenter = "";
        self.contentFooter = "<br /><br /><br /><p class='footCredits'>AGL 2023. Todos los derechos reservados. <br />Powered by Grupo <span style='color:firebrick;'>N</span><span style='color:#000;'>w</span> V " + self.version + "</p>";
    },
    destruct: function () {
    },
    members: {
