...
//        self.version = "0.1.2.4";
        self.name = "Limocars Cliente";
        self.description = "Limocars Cliente";
        ...
        self.testing = false;
        self.url_play_store = "https://play.google.com/store/apps/details?id=com.movilmove.limocars";
        self.url_app_store = "";
        self.nameApplication = "com.movilmove.movilmove_limocars";
...
//        self.domain_rpc = "http://movilmove.loc";
//        self.domain_rpc = "https://192.168.1.45";
//        self.domain_files = "http://movilmove.loc";
        ...
        //login facebook
//        cordova plugin add cordova-plugin-facebook4 --save --variable APP_ID="2651602848434556" --variable APP_NAME="Netcar"
...
//        self.fb_hashes_activacion = "S1/NXdloaM+gxiTGRf+x94s7C/w="; //keytool -exportcert -alias YOUR_RELEASE_KEY_ALIAS -keystore YOUR_RELEASE_KEY_PATH | openssl sha1 -binary | openssl base64
        ...
        self.config_crear_cuenta = {
            ...
            pedir_empresa: self.empresa_id, //limocars antes 22 ahora 35 prod
//            pedir_empresa: 24, // transdal
            terminal: 5415,
            perfil: 1,
            pedir_genero: false,
            pedir_pais: true,
            ...
            pedir_politicas_text: "Al ingresar acepto las políticas de uso <a target='_BLANK' href='https://app.movilmove.com/app/policies.php?empresa=22&perfil=1'>Ver las políticas aquí</a>",
            pedir_politicas_link: "https://app.movilmove.com/app/policies.php?empresa=22&perfil=1",
...
//            self.logotipoHeader = "<img src='img/MAIN-LOGO2.png' />";
            self.logotipoHeader = "<img src='" + self.domain_rpc + self.carpet_files_extern + "img/LOGO_ENERGY_LIMOCARS.svg' />";
//            self.logotipoHeader = "<img src='" + self.domain_rpc + "/app/img/limocars_icon.png' />";
...
//        nw.require("https://test.movilmove.com/lib_mobile/user/nwmaker/nwmaker-2.min.js", function () {
//            alert("TEST");
//        });
