nw.Class.define("config", {
    ...
    construct: function () {
        ...
        self.name = "MovilMove Driver";
        self.description = "MovilMove Driver";
        self.co_creator = "Movilmove";
        self.moneda = "COP";
        //developers
        self.showConsoleDeveloper = false;
        self.showConsoleEvents = false;
        self.url_play_store = "https://play.google.com/store/apps/details?id=com.movilmove.driver";
        self.url_app_store = "";
        self.nameApplication = "com.movilmove.driver";
...
//        self.domain_rpc = "https://www.app.movilmove.com";
//        self.domain_rpc = "https://test.movilmove.com";
        self.domain_rpc = "http://localhost/";
//        self.domain_rpc = "https://192.168.1.50/";
