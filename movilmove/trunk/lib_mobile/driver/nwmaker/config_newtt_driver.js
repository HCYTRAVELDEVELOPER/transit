...
//        if (os === "ANDROID" && typeof versionInAppLibDevice !== "undefined") {
        ...
        self.name = "Newtt Conductor";
        self.description = "Newtt Conductor";
...
//        self.decimalesFixed = 2;
        ...
        self.emailSupport = "soporte@newtt.cl";
        ...
        self.testing = false;
        self.url_play_store = "https://play.google.com/store/apps/details?id=movilmove.newtt.driver";
        self.url_app_store = "";
        self.nameApplication = "movilmove.newtt.driver";
...
//        self.home_background_color = "#f1f1f1";
        ...
        if (nw.evalueData(up.usuario)) {
            self.logotipoHeader = "<img src='" + self.domain_rpc + self.carpet_files_extern + "img/newtt_288.png' />";
