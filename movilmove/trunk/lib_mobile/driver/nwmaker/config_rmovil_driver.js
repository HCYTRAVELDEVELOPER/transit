...
//        self.idiomaPorDefecto = "EN";
        self.name = "Rmovil Driver";
        self.description = "Rmovil Driver";
        ...
        self.emailSupport = "movil@grupo-roble.com.mx";
        self.usaFechaVencimientoSaldo = true;
        ...
        self.testing = false;
        self.url_play_store = "https://play.google.com/store/apps/details?id=com.movilmove.movilmove_rmovil_driver";
        self.url_app_store = "";
        self.nameApplication = "com.movilmove.movilmove_rmovil_driver";
        ...
        self.configureBackgroundMode = {
            title: "Rmóvil Drivers",
            text: "Trabajando en segundo plano..."
        };
//        self.labels = [
//            {
//                name: "antecedentes_judiciales",
//                label: nw.str("Antecedentes no penales")
//            },
//            {
//                name: "tarjeta_propiedad",
//                label: nw.str("Tarjeta de circulación"),
//                required: true
//            },
//            {
//                name: "nit",
//                label: nw.str("C.U.R.P"),
//                car_min: "18",
//                car_max: "18",
//                required: true
//            },
//            {
//                name: "foto_soat",
//                label: nw.str("Foto de póliza de seguro")
//            },
//            {
//                name: "fecha_vencimiento_soat",
//                label: nw.str("Fecha vencimiento póliza de seguro")
//            },
//            {
//                name: "codigo_rut",
//                placeholder: nw.str("RFC"),
//                required: true
//            },
//            {
//                name: "adjunto_rut",
//                label: nw.str("Imagen RFC"),
//                required: true
//            },
//            {
//                name: "hoja_vida",
...
//        ];
//        self.tipo_doc = {};
//        self.tipo_doc[""] = "Seleccione";
//        self.tipo_doc["INE"] = nw.str("INE");
////        self.tipo_doc["LICENCIA DE CONDUCIR"] = nw.str("LICENCIA DE CONDUCIR");
//        self.tipo_doc["CEDULA PROFESIONAL"] = nw.str("CÉDULA PROFESIONAL");
//        self.tipo_doc["PASAPORTE"] = nw.str("PASAPORTE");
...
//        self.fechaLanzamiento = '09/20/2021 8:00 AM';
        ...
        self.bodyReferidoUser = "¡Gana más con " + self.name + "! " + up.nombre + " te refirió para que te unas como usuario a " + self.name + ", la línea de transporte única en México, enlace: {link}";
        self.titleReferidoDriver = "¡Gana más con " + self.name + "!";
        self.bodyReferidoDriver = "¡Gana más con " + self.name + "! " + up.nombre + " te refirió para que te unas como conductor a " + self.name + ", la línea de transporte única en México, enlace: {link}";
...
//        self.domain_files = "http://movilmove.loc";
        ...
        self.login_background_image = self.domain_rpc + self.carpet_files_extern + "img/Login-Conductor-Fondo-rmovil.jpg";
        ...
        self.config_crear_cuenta = {
            ...
            pedir_politicas_text: "<span class='textpoliticsspan'>Al ingresar acepto las políticas de uso <a target='_BLANK' href='https://app.movilmove.com/app/policies.php?empresa=40&perfil=2'>Ver las políticas aquí­</a></span>",
            pedir_politicas_link: "https://app.movilmove.com/app/policies.php?empresa=40&perfil=2",
...
//        self.home_background_color = "#f1f1f1";
        ...
        if (nw.evalueData(up.usuario)) {
            self.logotipoHeader = "<img src='" + self.domain_rpc + self.carpet_files_extern + "img/LOGO_RMOVIL.svg' />";
...
//                }, 2000);
        ...
        self.contentCenter = "";
        self.contentFooter = "<br /><br /><br /><p class='footCredits'>rmovil 2021. Todos los derechos reservados. <br />Powered by Grupo <span style='color:firebrick;'>N</span><span style='color:#000;'>w</span> V " + self.version + "</p>";
    },
    destruct: function () {
    },
    members: {
