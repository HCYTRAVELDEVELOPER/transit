...
//        if (os === "ANDROID" && typeof versionInAppLibDevice !== "undefined") {
        ...
        self.name = "AGL Driver";
        self.description = "AGL Driver";
...
//        self.decimalesFixed = 2;
        ...
        self.testing = false;
        self.url_play_store = "https://play.google.com/store/apps/details?id=movilmove.agl.driver";
        self.url_app_store = "";
        self.nameApplication = "movilmove.agl.driver";
...
//        self.login_background_image = "";
        ...
        self.config_crear_cuenta = {
            ...
            pedir_politicas_text: "<span class='textpoliticsspan'>Al ingresar acepto las políticas de uso <a target='_BLANK' href='https://app.movilmove.com/app/policies.php?empresa=49&perfil=2'>Ver las políticas aquí­</a></span>",
            pedir_politicas_link: "https://app.movilmove.com/app/policies.php?empresa=49&perfil=2",
...
//                }, 2000);
        ...
        self.contentCenter = "";
        self.contentFooter = "<br /><br /><br /><p class='footCredits'>AGL Driver 2023. Todos los derechos reservados. <br />Powered by Grupo <span style='color:firebrick;'>N</span><span style='color:#000;'>w</span> V " + self.version + "</p>";
    },
    destruct: function () {
    },
    members: {
