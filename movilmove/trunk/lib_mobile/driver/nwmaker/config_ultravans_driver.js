...
//        self.idiomaPorDefecto = "EN";
        self.name = "Ultravans Driver";
        self.description = "Ultravans Driver";
...
//        self.decimalesFixed = 2;
        ...
        self.emailSupport = "soporte@ultravans.com";
        ...
        self.testing = false;
        self.url_play_store = "https://play.google.com/store/apps/details?id=com.movilmove.ultravans.driver";
        self.url_app_store = "";
        self.nameApplication = "com.movilmove.movilmove.ultravans.driver";
...
//        self.domain_files = "http://movilmove.loc";
        ...
        self.config_crear_cuenta = {
            ...
            pedir_politicas_text: "<span class='textpoliticsspan'>Al ingresar acepto las políticas de uso <a target='_BLANK' href='https://uvans.com.co/privacidad-para-conductores/'>Ver las políticas aquí­</a></span>",
            pedir_politicas_link: "https://uvans.com.co/privacidad-para-conductores/",
...
//        self.home_background_color = "#f1f1f1";
        ...
        if (nw.evalueData(up.usuario)) {
            self.logotipoHeader = "<img src='" + self.domain_rpc + self.carpet_files_extern + "img/ultravans_logo_alta.jpeg' />";
...
//                }, 2000);
        ...
        self.contentCenter = "";
        self.contentFooter = "<br /><br /><br /><p class='footCredits'>Ultravan 2022. Todos los derechos reservados. <br />Powered by Grupo <span style='color:firebrick;'>N</span><span style='color:#000;'>w</span> V " + self.version + "</p>";
    },
    destruct: function () {
    },
    members: {
