...
//        self.idiomaPorDefecto = "EN";
        self.name = "Sonder Driver";
        self.description = "Sonder Driver";
...
//        self.decimalesFixed = 2;
        ...
        self.emailSupport = "soporte@sondercolombia.com";
        ...
        self.testing = false;
        self.url_play_store = "https://play.google.com/store/apps/details?id=movilmove.sonder.driver";
        self.url_app_store = "";
        self.nameApplication = "movilmove.sonder.driver";
...
//        self.fechaLanzamiento = '09/20/2021 8:00 AM';
        ...
        self.initSessionWithEmail = false;
        self.ringowID = "2";
...
//        self.login_background_image = "";
        self.login_background_image = self.domain_rpc + self.carpet_files_extern + "img/logo_fondo_sonder.png";
...
//            terminal: 1,
            ...
            pedir_politicas_text: "<span class='textpoliticsspan'>Al ingresar acepto las políticas de uso <a target='_BLANK' href='https://app.movilmove.com/app/policies.php?empresa=26&perfil=2'>Ver las políticas aquí­</a></span>",
            pedir_politicas_link: "https://app.movilmove.com/app/policies.php?empresa=26&perfil=2",
...
//        self.home_background_color = "#f1f1f1";
        ...
        if (nw.evalueData(up.usuario)) {
            self.logotipoHeader = "<img src='" + self.domain_rpc + self.carpet_files_extern + "img/logo_sonder_150.png' />";
            $(".logotipoHeader").addClass("logotipoHeader_home");
        } else {
//            self.logotipoHeader = "<img src='" + self.domain_rpc + self.carpet_files_extern + "img/logo_sonder.png' />";
            self.logotipoHeader = "";
...
//                }, 2000);
        ...
        self.contentCenter = "";
        self.contentFooter = "<br /><br /><br /><p class='footCredits'>Sonder Driver 2022. Todos los derechos reservados. <br />Powered by Grupo <span style='color:firebrick;'>N</span><span style='color:#000;'>w</span> V " + self.version + "</p>";
    },
    destruct: function () {
    },
    members: {
