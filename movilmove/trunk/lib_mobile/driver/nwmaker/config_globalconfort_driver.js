...
//        self.idiomaPorDefecto = "EN";
        self.name = "GlobalConfort Conductor";
        self.description = "GlobalConfort Conductor";
...
//        self.decimalesFixed = 2;
        ...
        self.emailSupport = "GlobalConfort@gmail.com";
        ...
        self.testing = false;
        self.url_play_store = "https://play.google.com/store/apps/details?id=movilmove.globalconfort.driver";
        self.url_app_store = "";
        self.nameApplication = "movilmove.globalconfort.driver";
...
//        self.login_background_image = self.domain_rpc + self.carpet_files_extern + "img/Login-Conductor-Fondo.jpg";
        ...
        self.config_crear_cuenta = {
            ...
            pedir_politicas_text: "<span class='textpoliticsspan'>Al ingresar acepto las políticas de uso <a target='_BLANK' href='https://app.movilmove.com/app/policies.php?empresa=42&perfil=2'>Ver las políticas aquí­</a></span>",
            pedir_politicas_link: "https://app.movilmove.com/app/policies.php?empresa=42&perfil=2",
...
//        self.home_background_color = "#f1f1f1";
        ...
        if (nw.evalueData(up.usuario)) {
            self.logotipoHeader = "<img src='" + self.domain_rpc + self.carpet_files_extern + "img/globalconfort_user_57.png' />";
