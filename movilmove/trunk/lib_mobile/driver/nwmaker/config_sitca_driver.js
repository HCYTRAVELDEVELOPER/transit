...
//        if (os === "ANDROID" && typeof versionInAppLibDevice !== "undefined") {
        ...
        self.idiomaPorDefecto = "ES";
        self.name = "Sitca Última Milla Driver";
        self.description = "Sitca Última Milla Driver";
...
//        self.decimalesFixed = 2;
        ...
        self.testing = false;
        self.url_play_store = "https://play.google.com/store/apps/details?id=movilmove.deanzone.driver";
        self.url_app_store = "";
        self.nameApplication = "movilmove.deanzone.driver";
...
//             nw.menuProfile();
        ...
        if (cordova.platformId !== "browser" && os === "ANDROID" || os === "IOS") {
            self.empresa_id = 32;
            self.domain_rpc = "https://ultimamilla.sitca.co";
        }
        var get = nw.getGET();
        ...
        self.login_background_image = self.domain_rpc + self.carpet_files_extern + "img/fondo_login_ultimamilla.jpg";
        ...
        self.config_crear_cuenta = {
            ...
            pedir_politicas: false,
            pedir_politicas_text: "<span class='textpoliticsspan'>Al ingresar acepto las políticas de uso <a target='_BLANK' href='https://www.sitca.co/politicas'>Ver las políticas aquí­</a></span>",
            pedir_politicas_link: "https://www.sitca.co/politicas",
...
//        self.home_background_color = "#f1f1f1";
        ...
        if (nw.evalueData(up.usuario)) {
            self.logotipoHeader = "<img src='" + self.domain_rpc + self.carpet_files_extern + "img/logo_ultimamilla_150.png' />";
            $(".logotipoHeader").addClass("logotipoHeader_home");
        } else {
            self.logotipoHeader = "<img src='" + self.domain_rpc + self.carpet_files_extern + "img/logo_ultimamilla.png' />";
...
//                }, 2000);
        ...
        self.contentCenter = "";
        self.contentFooter = "<br /><br /><br /><p class='footCredits'>Sitca Última Milla 2022. Todos los derechos reservados. <br />Powered by Grupo <span style='color:firebrick;'>N</span><span style='color:#000;'>w</span> V " + self.version + "</p>";
    },
    destruct: function () {
    },
    members: {
