...
//        if (os === "ANDROID" && typeof versionInAppLibDevice !== "undefined") {
        ...
        self.name = "DyJ Conductor";
        self.description = "DyJ Conductor";
...
//        self.decimalesFixed = 2;
        ...
        self.emailSupport = "soporte@dyj.com";
        ...
        self.testing = false;
        self.url_play_store = "https://play.google.com/store/apps/details?id=movilmove.dyj.driver";
        self.url_app_store = "";
        self.nameApplication = "movilmove.dyj.driver";
...
//        self.domain_rpc = "http://movilmove.loc";
        ...
        //config login
        self.contentCenterInLogin = "<p style='text-align: center; font-weight: bold; margin: auto; margin-top: 14px; padding: 0;'>Inicia sesión conductor</p>";
...
//        self.home_background_color = "#f1f1f1";
        ...
        if (nw.evalueData(up.usuario)) {
            self.logotipoHeader = "<img src='" + self.domain_rpc + self.carpet_files_extern + "img/dyj_288.png' />";
...
//                }, 2000);
        ...
        self.contentCenter = "";
        self.contentFooter = "<br /><br /><br /><p class='footCredits'>" + self.name + " Driver 2023. Todos los derechos reservados. <br />Powered by Grupo <span style='color:firebrick;'>N</span><span style='color:#000;'>w</span> V " + self.version + "</p>";
    },
    destruct: function () {
    },
    members: {
