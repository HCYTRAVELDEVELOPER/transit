nw.Class.define("config", {
    ...
    construct: function () {
        ...
        var pedir_pais_required = false;
        var pedir_ciudad_required = false;
        var pedir_documento_required = false;
        if (os == "ANDROID") {
            pedir_pais_required = true;
            pedir_ciudad_required = true;
            pedir_documento_required = true;
        }
...
//        self.idiomaPorDefecto = "EN";
        self.name = "Zero Conductor";
        self.description = "Zero Conductor";
...
//        self.decimalesFixed = 2;
        ...
        self.emailSupport = "thezerocolombia@gmail.com";
        ...
        self.testing = false;
        self.url_play_store = "https://play.google.com/store/apps/details?id=movilmove.zero.driver";
        self.url_app_store = "";
        self.nameApplication = "movilmove.zero.driver";
...
//        self.login_background_image = self.domain_rpc + self.carpet_files_extern + "img/Login-Conductor-Fondo.jpg";
        ...
        self.config_crear_cuenta = {
            ...
            pedir_documento_required: pedir_documento_required,
            pedir_celular: true,
            pedir_direccion: false,
            pedir_pais: true,
            pedir_pais_required: pedir_pais_required,
            pedir_empresa: self.empresa_id,
            terminal: 5691,
            perfil: 2,
            pedir_departamento_geo: false,
            pedir_ciudad: true,
            pedir_ciudad_required: pedir_ciudad_required,
            pedir_fecha_nacimiento: false,
            pedir_politicas: true,
            pedir_politicas_text: "<span class='textpoliticsspan'>Al ingresar acepto las políticas de uso <a target='_BLANK' href='https://app.movilmove.com/app/policies.php?empresa=36&perfil=2'>Ver las políticas aquí­</a></span>",
            pedir_politicas_link: "https://app.movilmove.com/app/policies.php?empresa=36&perfil=2",
...
//        self.home_background_color = "#f1f1f1";
        ...
        if (nw.evalueData(up.usuario)) {
            self.logotipoHeader = "<img src='" + self.domain_rpc + self.carpet_files_extern + "img/zero_driver_100x100.png' />";
...
//                }, 2000);
        ...
        self.contentCenter = "";
        self.contentFooter = "<br /><br /><br /><p class='footCredits'>Zero 2023. Todos los derechos reservados. <br />Powered by Grupo <span style='color:firebrick;'>N</span><span style='color:#000;'>w</span> V " + self.version + "</p>";
    },
    destruct: function () {
    },
    members: {
