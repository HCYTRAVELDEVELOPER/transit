...
<div id="nwfuec">
    ...
    <table border="1" style="width: 100%;  border-spacing: 0; border: #9f9f9f;">
        <tbody>
            ...
            <tr>
                <td style="border-bottom: 0px;border-right: 0px;"><b>RAZON SOCIAL:</b> <?php echo $si["nom_empresa"] ?></td>
                <td style="border-bottom: 0px;border-left: 0px; text-align: right;"><b>NIT:</b><?php echo $si["documento"] ?></td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="width: 50%;">
                    <p style="text-align: center;">Para efectos de control y seguridad, Contáctenos:<br>
                        DESTINOS EXPRESS S.A.S<br>
                        Dirección: Carrera 71 N° 48A - 55  BOGOTÁ D.C.<br>
                        Dirección: Carrera 43A N° 19 - 17 Medellín<br>
                        Teléfono: 4954180<br>
                        comercial@destinosexpress.com<br>
                        operaciones@destinosexpress.com
                    </p>
                </td>
