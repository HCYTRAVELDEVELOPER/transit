qx.Class.define("transmovapp.forms.f_confirma_cotizacion_cliente", {
    extend: qxnw.forms,
    properties: {
        position: {
            init: null,
    ...
    construct: function (r, e) {
        ...
        this.base(arguments);
        this.createBase();
        self.setGroupHeader("Mapa confimar cotización servicio");
        self.setTitle("Mapa confimar cotización servicio");
        self.marker = false;
        self.markerc = false;
        ...
        var fields = [
            ...
            {
                name: "valor_final",
                label: self.tr("<strong>Valor a enviar cotización</strong>"),
                caption: "valor_final",
                type: "textField",
                mode: "money",
                required: true
            ...
            {
                name: "tiempo",
                label: self.tr("<strong>Duración promedio del viaje (mins)</strong>"),
                caption: "tiempo",
                type: "textField",
                required: false
            },
            {
                ...
                label: self.tr("<strong>Trayecto promedio final (km)</strong>"),
            ...
            },
            {
                ...
                label: self.tr("<strong>Numero expediente</strong>"),
                caption: "total_metros_final",
                type: "textField",
                required: false
            },
...
//            self.slotSave();
        ...
        console.log("f_confirma_cotizacion_servicio:::r:::", r);
...
//                callback(result.routes);
        ...
        slotSave: function slotSave() {
            ...
            rpc.exec("aprobarCotizacion", data, func);
        },
...
//                self.parent[e.id] = self.tree.addTreeFolder(e.nombre + " - " + e.nit + "</b><br>", icon, e, true);
        ...
        slotCond: function slotCond(si) {
            ...
            var data = this.getRecord();
            var ms = "<h1>¿Continuar con la confirmación de la cotización del servicio?</h1>";
            qxnw.utils.question(ms, function (e) {
                if (e) {
                    ...
                    var func = function (r) {
                        ...
                        qxnw.utils.information("¡Servicio confirmado exitosamente!");
                        self.reject();
                        self.accept();
                    };
                    rpc.exec("aprobarCotizacion", data, func);
