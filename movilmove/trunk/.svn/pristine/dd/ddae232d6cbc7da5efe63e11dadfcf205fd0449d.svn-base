...
//        self.idiomaPorDefecto = "EN";
        self.name = "Ultravans Cliente";
        self.description = "Ultravans Cliente";
        ...
        self.emailSupport = "info@Ultravans.com";
...
//        self.paymentStorePruebas = false;
        ...
        self.testing = false;
        self.url_play_store = "https://play.google.com/store/apps/details?id=com.movilmove.movilmove.ultravans";
        self.url_app_store = "";
        self.nameApplication = "com.movilmove.movilmove.ultravans";
...
//        self.iconUserMap = self.domain_rpc + self.carpet_files_extern + '/img/me_pin.png';
        ...
        self.config_crear_cuenta = {
            ...
            pedir_politicas_text: "<span class='textpoliticsspan'>Al ingresar acepto las políticas de uso <a target='_BLANK' href='https://ultravans.com.co/politica-pasajeros/'>Ver las políticas aquí­</a></span>",
            pedir_politicas_link: "https://ultravans.com.co/politica-pasajeros/",
...
//            }
        ...
        self.contentCenter = "";
        self.contentFooter = "<br /><br /><br /><p class='footCredits'>Ultravans 2022. Todos los derechos reservados. <br />Powered by Grupo <span style='color:firebrick;'>N</span><span style='color:#000;'>w</span> V " + self.version + "</p>";
    },
    destruct: function () {
    },
    members: {
