...
//        if (os === "ANDROID" && typeof versionInAppLibDevice !== "undefined") {
        ...
        self.useTranslateStr = false;
//        self.idiomaPorDefecto = "EN";
        self.name = "Movescol Driver";
        self.description = "Movescol Driver";
...
//        self.decimalesFixed = 2;
        ...
        self.preoperacional_obligatorio = false;
        self.emailSupport = "soporte@movescol.com";
        ...
        self.testing = false;
        self.url_play_store = "https://play.google.com/store/apps/details?id=movilmove.movescol.driver";
        self.url_app_store = "";
        self.nameApplication = "movilmove.movescol.driver";
...
//        console.log("self.empresa_id", self.empresa_id);
//        console.log("self.domain_rpc", self.domain_rpc);
        ...
        self.pedirDatosContactoEmergencia = false;
        self.vehiculo_publico_particular = false;
        self.vehiculo_poliza_contractual = false;
        self.vehiculo_poliza_todoriesgo = false;
        ...
        self.login_crear_cuenta = false;
        self.login_background_color = "transparent";
//        self.login_background_image = "";
        self.login_background_image = self.domain_rpc + self.carpet_files_extern + "img/fondo_movescol_login.png";
        ...
        self.config_crear_cuenta = {
            ...
            pedir_politicas_text: "<span class='textpoliticsspan'>Al ingresar acepto las políticas de uso <a target='_BLANK' href='https://movescol.com.co/aviso-de-privacidad-para-conductores/'>Ver las políticas aquí­</a></span>",
            pedir_politicas_link: "https://movescol.com.co/aviso-de-privacidad-para-conductores/",
...
//        self.home_background_color = "#f1f1f1";
        ...
        if (nw.evalueData(up.usuario)) {
            self.logotipoHeader = "<img src='" + self.domain_rpc + self.carpet_files_extern + "img/logo_horizontal_movescol.png' />";
            $(".logotipoHeader").addClass("logotipoHeader_home");
        } else {
//            self.logotipoHeader = "<img src='" + self.domain_rpc + self.carpet_files_extern + "img/logo_movescol.png' />";
            self.logotipoHeader = "";
...
//                }, 2000);
        ...
        self.contentCenter = "";
        self.contentFooter = "<p class='footCreditsInt'>Movescol Driver 2023. Todos los derechos reservados. <br />Powered by Grupo <span style='color:firebrick;'>N</span><span style='color:#000;'>w</span> V " + self.version + "</p>";
