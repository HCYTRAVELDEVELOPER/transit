nw.Class.define("config", {
    ...
    construct: function () {
        ...
        self.name = "Interceptos Driver";
        self.description = "Interceptos Driver";
        ...
        self.url_play_store = "https://play.google.com/store/apps/details?id=com.movilmove.movilmove_interceptos_driver";
        self.url_app_store = "";
        self.nameApplication = "com.movilmove.movilmove_interceptos_driver";
        self.testing = false;
