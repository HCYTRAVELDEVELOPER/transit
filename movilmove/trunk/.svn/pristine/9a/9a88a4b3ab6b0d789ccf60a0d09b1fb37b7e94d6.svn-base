...
//        self.idiomaPorDefecto = "EN";
        self.name = "G&N Driver";
        self.description = "G&N Driver";
...
//        self.decimalesFixed = 2;
        ...
        self.testing = false;
        self.url_play_store = "https://play.google.com/store/apps/details?id=movilmove.gyn.driver";
        self.url_app_store = "";
        self.nameApplication = "movilmove.gyn.driver";
        ...
        console.log("window.location.host 22", window.location.host);
...
//             nw.menuProfile();
        ...
        self.login_background_image = self.domain_rpc + self.carpet_files_extern + "img/gyn_bg_home.png";
        console.log(self.login_background_image);
        ...
        self.config_crear_cuenta = {
            ...
            pedir_politicas_text: "<span class='textpoliticsspan'>Al ingresar acepto las políticas de uso <a target='_BLANK' href='https://app.movilmove.com/app/policies.php?empresa=51&perfil=2'>Ver las políticas aquí­</a></span>",
            pedir_politicas_link: "https://app.movilmove.com/app/policies.php?empresa=51&perfil=2",
...
//        self.home_background_color = "#f1f1f1";
        ...
        if (nw.evalueData(up.usuario)) {
            self.logotipoHeader = "<img src='" + self.domain_rpc + self.carpet_files_extern + "img/gyn_200.png' />";
...
//                }, 2000);
        ...
        console.log("self.logotipoHeader", self.logotipoHeader)
        self.contentCenter = "";
        self.contentFooter = "<br /><br /><br /><p class='footCredits'>G&N Driver 2023. Todos los derechos reservados. <br />Powered by Grupo <span style='color:firebrick;'>N</span><span style='color:#000;'>w</span> V " + self.version + "</p>";
