...
//        self.idiomaPorDefecto = "EN";
        ...
        self.emailSupport = "info@dyj.com";
...
//        self.paymentStorePruebas = false;
        ...
        self.testing = false;
        self.url_play_store = "https://play.google.com/store/apps/details?id=movilmove.dyj";
        self.url_app_store = "";
        self.nameApplication = "movilmove.dyj";
...
//        if (nw.utils.evalueData(up.usuario) && nw.evalueData(up.acepto_terminos_condiciones)) {
//            nw.loading({text: "", title: self.logotipoHeader, addClass: "loading_home_localiz"});
//        }
