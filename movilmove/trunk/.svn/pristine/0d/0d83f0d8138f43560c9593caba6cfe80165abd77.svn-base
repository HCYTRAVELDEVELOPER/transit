...
//        self.idiomaPorDefecto = "EN";
        self.name = "Mi Sol";
        self.description = "Mi Sol Pasajero";
...
//        self.paymentStorePruebas = false;
        ...
        self.testing = false;
        self.url_play_store = "https://play.google.com/store/apps/details?id=movilmove.solvariante";
        self.url_app_store = "";
        self.nameApplication = "movilmove.solvariante";
...
//        self.iconUserMap = self.domain_rpc + self.carpet_files_extern + '/img/me_pin.png';
        ...
        self.config_crear_cuenta = {
            ...
            pedir_politicas_text: "<span class='textpoliticsspan'>Al ingresar acepto las políticas de uso <a target='_BLANK' href='https://app.movilmove.com/app/policies.php?empresa=50&perfil=1'>Ver las políticas aquí­</a></span>",
            pedir_politicas_link: "https://app.movilmove.com/app/policies.php?empresa=50&perfil=1",
        ...
        if (nw.evalueData(up.usuario)) {
            self.logotipoHeader = "<img src='" + self.domain_rpc + self.carpet_files_extern + "img/solvariante_login_pasajero.png' />";
