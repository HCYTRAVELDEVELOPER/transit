...
//        self.idiomaPorDefecto = "EN";
        self.name = "Zima Conductor";
        self.description = "Zima Conductor";
...
//        self.decimalesFixed = 2;
        ...
        self.emailSupport = "zima@gmail.com";
        ...
        self.testing = false;
        self.url_play_store = "https://play.google.com/store/apps/details?id=movilmove.zima.driver";
        self.url_app_store = "";
        self.nameApplication = "com.movilmove.movilmove.zero.driver";
...
//        self.fechaLanzamiento = '09/20/2021 8:00 AM';
        ...
        self.bodyReferidoUser = "¡Gana más con " + self.name + "! " + up.nombre + " te refirió para que te unas como usuario a " + self.name + ", la línea de transporte única en Ecuador, enlace: {link}";
        self.titleReferidoDriver = "¡Gana más con " + self.name + "!";
        self.bodyReferidoDriver = "¡Gana más con " + self.name + "! " + up.nombre + " te refirió para que te unas como conductor a " + self.name + ", la línea de transporte única en Ecuador, enlace: {link}";
...
//        self.domain_files = "http://movilmove.loc";
        ...
        //config login
        self.contentCenterInLogin = "<div class='titleEncContain'>Conductor, inicia sesión</div>";
...
//        self.login_background_image = self.domain_rpc + self.carpet_files_extern + "img/Login-Conductor-Fondo.jpg";
        ...
        self.config_crear_cuenta = {
            ...
            pedir_politicas_text: "<span class='textpoliticsspan'>Al ingresar acepto las políticas de uso <a target='_BLANK' href='https://app.movilmove.com/app/policies.php?empresa=39&perfil=2'>Ver las políticas aquí­</a></span>",
            pedir_politicas_link: "https://app.movilmove.com/app/policies.php?empresa=39&perfil=2",
...
//            self.logotipoHeader = "<img src='" + self.domain_rpc + self.carpet_files_extern + "img/Logo-Zima-Usuarios-200x200.png' />";
            self.logotipoHeader = "<img src='" + self.domain_rpc + self.carpet_files_extern + "img/Logo-Zima-blanco-sin-fondo-100X100.png' />";
...
//                }, 2000);
        ...
        self.contentCenter = "";
        self.contentFooter = "<br /><br /><br /><p class='footCredits'>Zima 2023. Todos los derechos reservados. <br />Powered by Grupo <span style='color:firebrick;'>N</span><span style='color:#000;'>w</span> V " + self.version + "</p>";
    },
    destruct: function () {
    },
    members: {
