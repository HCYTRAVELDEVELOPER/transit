qx.Class.define("booking.lists.l_booking_searchjourneys", {
    extend: qxnw.lists,
    construct: function () {
//        if (document.querySelector(".container_form_bookingoaccepted")) {
//            return false;
//        }
        var self = this;
        this.base(arguments);
        ...
        this.createBase();
        self.setTitle("Booking trae servicios aceptados");
...
//        self.table.getTableColumnModel().setColumnWidth(10, 200);
        ...
        self.addListener("appear", function () {
            if (!self.creadoOnAppear) {
                qx.bom.element.Class.add(self.getContentElement().getDomElement(), "container_form_bookingoaccepted");
...
//                    document.querySelector(".container_form_bookingoaccepted").appendChild(self.nosize);
//                }, 500);
            }
...
//            });
        ...
        applyFilters: function applyFilters() {
            ...
            if (!self.creado) {
                qxnw.utils.loadingnw("Conectándose a Booking (getJourneysAccepted)... Por favor espere...", "cargando_axtest_dos");
            }
...
//                    self.idsShow[res[i].id] = res[i].id;
            ...
            rpc.exec("actualizacionesoffers", ds, func);
        }
    }
});