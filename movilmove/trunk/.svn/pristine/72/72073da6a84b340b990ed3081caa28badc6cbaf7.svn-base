qx.Class.define("transmovapp.lists.l_clientes", {
    extend: qxnw.lists,
...
//        self.hideColumn("id");
    ...
    members: {
        contextMenu: function contextMenu(veteapp) {
            ...
            m.addAction("Adjuntar contrato", "icon/16/actions/document-properties.png", function (e) {
                self.slotAdjuntar();
            });
        ...
        applyFilters: function applyFilters() {
            ...
            var r = rpc.exec("traeClientes", data);
            if (rpc.isError()) {
        ...
        slotNuevo: function slotNuevo() {
            var self = this;
            var d = new transmovapp.forms.f_clientes(self.portal);
...
//            d.set({showClose: false, showMinimize: false, showMaximize: false});
        ...
        slotAdjuntar: function slotAdjuntar() {
            ...
            f.ui.contrato_adjunto.setValue(r.contrato_adjunto);
            f.setModal(true);
            f.show();
