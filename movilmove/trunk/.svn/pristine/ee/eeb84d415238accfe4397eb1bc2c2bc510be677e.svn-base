...
//        self.idiomaPorDefecto = "EN";
        self.name = "Transdal";
        self.description = "Transdal";
        self.co_creator = "GrupoNw";
        self.credits_creator = "Grupo Nw<br /><a href='https://www.gruponw.com' target='_BLANK'>gruponw.com</a>";
        self.moneda = "CLP";
        self.country = "CHL";
        self.country_text = "Chile";
        self.decimales = ".00";
        self.indicativo = "56";
        self.accountAdminBancos = false;
        self.emailSupport = "info@transdal.com";
        self.usaRecargas = false;
        self.usaReferidos = false;
        self.usaMetodosDePago = false;
        self.usaCupones = false;
        self.muestraValorPasajero = false;
        self.editarDireccionServiciosReservados = false;
        self.reagendarServiciosReservados = false;
...
//        self.paymentStorePruebas = false;
        ...
        self.testing = false;
        self.url_play_store = "https://play.google.com/store/apps/details?id=com.movilmove.transdal";
        self.url_app_store = "";
        self.nameApplication = "com.movilmove.transdal";
...
//           self.domain_files = "http://movilmove.loc";
        self.domain_rpc = "https://transdal.movilmove.com";
...
//        self.iconUserMap = self.domain_rpc + self.carpet_files_extern + '/img/me_pin.png';
        ...
        self.config_crear_cuenta = {
            ...
            pedir_politicas_text: "<span class='textpoliticsspan'>Al ingresar acepto las políticas de uso <a target='_BLANK' href='https://transdal.cl/politica_de_privacidad/politica.html'>Ver las políticas aquí­</a></span>",
            pedir_politicas_link: "https://transdal.cl/politica_de_privacidad/politica.html",
        ...
        if (nw.evalueData(up.usuario)) {
            self.logotipoHeader = "<img src='" + self.domain_rpc + self.carpet_files_extern + "img/transdal_logo.svg' />";
            $(".logotipoHeader").addClass("logotipoHeader_home");
        } else {
            self.logotipoHeader = "<img src='" + self.domain_rpc + self.carpet_files_extern + "img/transdal_logo.svg' />";
            $(".logotipoHeader").addClass("logotipoHeader_login");
...
//            }
        ...
        self.contentCenter = "";
        self.contentFooter = "<br /><br /><br /><p class='footCredits'>Transdal 2022. Todos los derechos reservados. <br />Powered by Grupo <span style='color:firebrick;'>N</span><span style='color:#000;'>w</span> V " + self.version + "</p>";
    },
    destruct: function () {
    },
    members: {
