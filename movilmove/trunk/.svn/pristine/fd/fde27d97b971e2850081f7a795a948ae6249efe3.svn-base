...
//        self.idiomaPorDefecto = "EN";
        self.name = "TPT pasajero";
        self.description = "TPT pasajero";
        ...
        self.emailSupport = "info@transprotours.com";
...
//        self.paymentStorePruebas = false;
        ...
        self.testing = false;
        self.url_play_store = "https://play.google.com/store/apps/details?id=com.movilmove.transprotours";
        self.url_app_store = "";
        self.nameApplication = "com.movilmove.transprotours";
...
//        self.domain_rpc = "https://transprotours.gruponw.com/";
...
//        self.iconUserMap = self.domain_rpc + self.carpet_files_extern + '/img/me_pin.png';
        ...
        self.config_crear_cuenta = {
            ...
            pedir_politicas_text: "<span class='textpoliticsspan'>Al ingresar acepto las políticas de uso <a target='_BLANK' href='https://app.movilmove.com/app/policies.php?empresa=" + self.empresa_id + "&perfil=1'>Ver las políticas aquí­</a></span>",
            pedir_politicas_link: "https://app.movilmove.com/app/policies.php?empresa=" + self.empresa_id + "&perfil=1",
