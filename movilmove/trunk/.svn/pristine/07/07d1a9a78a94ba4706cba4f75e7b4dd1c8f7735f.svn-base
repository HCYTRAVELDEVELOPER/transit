...
//        self.idiomaPorDefecto = "EN";
        self.name = "WorldExpress Conductor";
        self.description = "WorldExpress Conductor";
...
//        self.decimalesFixed = 2;
        ...
        self.testing = false;
        self.url_play_store = "https://play.google.com/store/apps/details?id=com.movilmove.worldexpress.driver";
        self.url_app_store = "";
        self.nameApplication = "com.movilmove.worldexpress.driver";
...
//        self.iconDriverMap = self.domain_rpc + self.carpet_files_extern + '/img/pindriver_1_35.png';
        ...
        self.iconCarOffline = self.domain_rpc + '/lib_mobile/driver/img/moto_off.png';
...
//        self.login_background_image = self.domain_rpc + self.carpet_files_extern + "img/Login-Conductor-Fondo.jpg";
        ...
        self.config_crear_cuenta = {
            ...
            pedir_politicas_text: "<span class='textpoliticsspan'>Al ingresar acepto las políticas de uso <a target='_BLANK' href='https://app.movilmove.com/app/policies.php?empresa=44&perfil=2'>Ver las políticas aquí­</a></span>",
            pedir_politicas_link: "https://app.movilmove.com/app/policies.php?empresa=44&perfil=2",
