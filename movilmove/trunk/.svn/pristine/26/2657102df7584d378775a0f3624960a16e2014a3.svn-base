...
//        self.idiomaPorDefecto = "EN";
        self.name = "HCYTravel Cliente";
        self.description = "HCYTravel Cliente";
        ...
        self.emailSupport = "info@hcytravel.com";
...
//        self.paymentStorePruebas = false;
        ...
        self.testing = false;
        self.url_play_store = "https://play.google.com/store/apps/details?id=movilmove.hcytravel";
        self.url_app_store = "";
        self.nameApplication = "com.movilmove.movilmove.hcytravel";
...
//        self.login_background_image = self.domain_rpc + self.carpet_files_extern + "img/home-img1.jpg";
        ...
        self.config_crear_cuenta = {
            ...
            pedir_politicas_text: "<span class='textpoliticsspan'>Al ingresar acepto las políticas de uso <a target='_BLANK' href='https://app.movilmove.com/app/policies.php?empresa=37&perfil=1'>Ver las políticas aquí­</a></span>",
            pedir_politicas_link: "https://app.movilmove.com/app/policies.php?empresa=37&perfil=1",
