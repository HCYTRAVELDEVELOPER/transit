...
//        self.idiomaPorDefecto = "EN";
        self.name = "TPT Driver";
        self.description = "Transprotours Driver";
...
//        self.decimalesFixed = 2;
        ...
        self.emailSupport = "soporte@Transprotours.com";
        ...
        self.testing = false;
        self.url_play_store = "https://play.google.com/store/apps/details?id=com.movilmove.transprotours.driver";
        self.url_app_store = "";
        self.nameApplication = "com.movilmove.transprotours.driver";
...
//        self.domain_rpc = "https://test.movilmove.com";
//        self.domain_files = "http://movilmove.loc";
//        self.domain_files = "http://192.168.10.24";
        ...
        self.vehiculo_publico_particular = true;
        ...
        self.login_background_image = self.domain_rpc + self.carpet_files_extern + "img/screen_transprotours.png";
        ...
        self.config_crear_cuenta = {
            ...
            pedir_politicas_text: "<span class='textpoliticsspan'>Al ingresar acepto las políticas de uso <a target='_BLANK' href='https://app.movilmove.com/app/policies.php?empresa=" + self.empresa_id + "&perfil=2'>Ver las políticas aquí­</a></span>",
            pedir_politicas_link: "https://app.movilmove.com/app/policies.php?empresa=" + self.empresa_id + "&perfil=2",
...
//        self.home_background_color = "#f1f1f1";
        ...
        if (nw.evalueData(up.usuario)) {
            self.logotipoHeader = "<img src='" + self.domain_rpc + self.carpet_files_extern + "img/logo_transprotours_100.png' />";
