    ...
    <div id="contenedor2">
        <div class="bloques_text_center">
            ...
            <div class="bloques_textos bloque_img_left">
                ...
                <p>
                    Sistema de notas buscando que el usuario tenga las herramientas de trabajo en el mismo entorno. 
                    Posee un chat corporativo con posibilidad de salas interactivas por grupos de empleados. 
                    Además un sistema de alarmas que alertan según se configuren por el usuario.
                </p> 
            </div>
            <div class="bloques_textos bloque_img_right">
    ...
    <div id="contenedor2">
        <div class="bloques_text_center">
            ...
            <p>
                ...
                Asistentes: 7 integrantes por sesión máximo.<br />
                Duración: 40 horas distribuidas en máximo 7 sesiones.
            </p>
            <h1 class="title1">
                GARANTÍAS
            </h1>
