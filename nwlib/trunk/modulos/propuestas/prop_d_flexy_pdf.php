<div id="contenedor1">
    ...
    <div id="contenedor2">
        ...
        <div class="img1">
            <img src="http://www.netwoods.net/imagenes/propuestas/img_inicial_pla_flexy.jpg" />
        </div>
    </div>
</div>
<div id="contenedor1">
    ...
    <div id="contenedor2">
        ...
        <div class="bloques_text_center">
            ...
            <ul>
                <li>Diseñar una página Web administrable a partir de la cual El  administrador de la misma podrá cambiar cualquier contenido que incluya el plan  Flexy, sin necesidad de recurrir a terceros. </li>
                <li>Integrar el diseño a la medida requerido, teniendo en cuenta sus  lineamientos e imagen corporativa, con una plataforma de administración de  contenido con navegación y 
                    funcionalidades &ldquo;User Friendly&rdquo;. </li>
...
<div id="contenedor1">
    ...
    <div id="contenedor2">
        ...
        <div class="bloques_text_center">
            <img src="http://www.netwoods.net/imagenes/propuestas/img_plan_flexy.jpg" style="float: left;" />
            <p><strong>Ficha Técnica</strong></p>
            <ul>
                <li>Número  de  páginas: 4</li>
                <li>1 Inicio  - 1 Quienes Somos  - 1 productos y/o servicios - 1 Contáctenos</li>
                <li>Hosting  con dominio a un año: <strong>500 Mb disco, 1 GB  de transferencia mensual </strong></li>
                <li><strong>cuentas de correo: </strong>3<strong>.</strong> <strong></strong></li>
            </ul>
            <p style="font-size: 20px;"><strong>Este plan Incluye:</strong>                    </p>
            <h1>Diseño Sobre Plantilla</h1>
            <ul>
                <li>Para este plan podrá seleccionar una plantilla y sobre esa se harán los ajustes de logotipo, colores a su gusto.  </li>
                <li>Nuestro  administrador de contenidos <strong>N</strong><strong>w</strong> <strong>Project</strong> es propio, creado por nosotros para brindar una administración más amigable  para los usuarios que no tengan conocimientos de programación ni diseño, <strong>no usamos </strong>cms como joomla, wordpress,  drupal<strong> </strong>entre otros<strong>.</strong></li>
            ...
            <ul>
                <li><strong>Tendrán administrador de  contenidos Nw Project</strong>, tendrá acceso mínimo, podrá modificar los párrafos de las diferentes hojas e imágenes.</li>
            </ul>
            <p>&nbsp;</p>
            <h1>Posicionamiento.</h1>
            <ul>
                <li>El posicionamiento lo va dando  automáticamente el administrador de contenidos, posicionamiento gradual  automático orgánico. </li>
            </ul>
            <p>&nbsp;</p>
            <p>&nbsp;</p>
        </div>
        ...
        <div class="bloques_text_center">
            ...
            <table border="1" align="left" cellpadding="0" cellspacing="0" style="margin: 20px;">
                <tr>
                    ...
                    <td width="180" valign="top"><p>500 MB</p></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td width="180" valign="top"><p>3</p></td>
                </tr>
                <tr>
    ...
    <div id="contenedor2">
        <div class="bloques_text_center">
            ...
            <p>Capacitación  sobre administración del sistema.  <br />
                Vía  ONLINE, se envía por correo tutorial del Administrador de contenidos.<br />
