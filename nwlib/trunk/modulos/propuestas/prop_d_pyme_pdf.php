...
<div id="contenedor1">
    ...
    <div id="contenedor2">
        ...
        <br />
        <div class="img1">
            <img src="/<?php echo "nwlib{$cfg["nwlibVersion"]}"; ?>/modulos/propuestas/imagenes/banner_diseno_web_2013_propuestas.png" />
        </div>
    </div>
</div>
<div id="contenedor1">
    ...
    <div id="contenedor2">
        ...
        <div class="bloques_text_center">
            ...
            <ul>
                <li>Diseñar una página Web administrable a partir de la cual El  administrador de la misma podrá cambiar cualquier contenido a través de  perfiles de usuario, sin necesidad de recurrir a terceros.                  </li>
            </ul>
            <ul>
                <li>Integrar el diseño a la medida requerido, teniendo en  cuenta sus lineamientos e imagen corporativa, con una plataforma de  administración de contenido con navegación y funcionalidades &ldquo;User Friendly&rdquo;.                  </li>
            </ul>
            <ul>
                <li>Permitir una fácil actualización de información (textos,  fotografías, videos, formularios, noticias, encuestas, módulos), en cualquier  sección, hoja o zona en el diseño Web a la medida concebido por Netwoods.net.                  </li>
            </ul>
            <ul>
                <li>Cumplir con los lineamientos y los estándares de W3C.                  </li>
            </ul>
            <ul>
                <li>Permitir que los visitantes de la pagina web siempre estén  a la expectativa de observan un contenido nuevo.                  </li>
            </ul>
            <ul>
                <li>Poner  en las manos de nuestro cliente, las herramientas necesarias para mantener  actualizada la información y contenido de su sitio web, según el plan  seleccionado (pyme).                  </li>
            </ul>
            <ul>
                <li>Crear  e integrar módulos para este plan.</li>
            </ul>
        </div>
    </div>
</div>
...
<div id="contenedor1">
    ...
    <div id="contenedor2">
        ...
        <div class="bloques_text_center">
            <img src="http://www.netwoods.net/imagenes/img_plan_pyme.jpg" style="float: left;" />
            <p>&nbsp;</p>
            <p><strong>Ficha Técnica</strong></p>
            <ul>
                <li><strong>Fotografías  suministradas por cliente para agregar:</strong> Las que el cliente desee  subir (ilimitadas). 10 editadas y subidas por Netwoods.</li>
                <li><strong>Número de hojas:</strong> 9.</li>
                <li><strong>Diseño</strong>: Único. Será en HTML con  PHP, tendrá animación en html, html5, Css y Css3 con javascript, jquery y otras  librerías.</li>
                <li><strong>Todas las secciones son  administrables</strong>.                    </li>
            </ul>
            <p style="font-size: 20px;"><strong>Este plan Incluye:</strong>                    </p>
            <h1>Diseño único</h1>
            <ul>
                <li>No manejamos plantillas, su página será un diseño exclusivo y ajustado a  sus necesidades, se enviará 1 bosquejo hasta llegar a lo deseado.           </li>
                <li>Nuestro administrador de contenidos es propio, creado por nosotros para  brindar una administración más amigable para los usuarios que no tengan  conocimientos de programación ni diseño, <strong>no  usamos</strong> cms como joomla, wordpress, drupal entre otros.</li>
            ...
            <ul>
                <li>Transición entre imágenes (máximo 1),  animaciones en banners en html5, CSS3, javascript, no usamos flash ya que no es  compatible con celulares. Las animaciones no son videos y no pueden tener línea de tiempo ni durar más de 7 segundos.
                    Se entiendo como animación un banner animado en 2D.
                </li>
            </ul>
            <p>&nbsp;</p>
            <h1>Administrador de  contenidos NW Project</h1>
            <ul>
                <li><strong>Tendrán administrador de  contenidos Nw Project</strong>, no tendrá acceso total, este permitirá cambiar los párrafos de todas las  páginas, imágenes, fuentes, imágenes de fondo, mover objetos y módulos o  aplicaciones web, podrá seleccionar 3 módulos (aplicaciones web) para su  página. En este plan no podrá agregar nuevas hojas adicionales, secciones,  marcos u objetos flotantes en la página web. Podrá realizar cambios y  actualizaciones a su página web en cualquier momento y lugar, no dependerá de  nosotros.</li>
...
<div id="contenedor1">
    ...
    <div id="contenedor2">
        <div class="bloques_text_center">
            ...
            <ul>
                <li>
                    <strong>Galería de imágenes:</strong> Se organizarán  alfabéticamente 5 álbumes por página, cada uno con una pequeña foto y nombre,  si se supera este número se organizarán automáticamente en páginas siguientes.</li>
                <li>Si el visitante hace clic la  foto se desplegará una nueva página con las fotos contenidas en cada álbum,  organizadas, 5 por página, si se supera este número se organizarán  automáticamente en páginas siguientes.</li>
                <li>Netwoods ingresará las fotos  suministradas por el cliente, el administrador podrá ingresar nuevas, uno a  uno, usando el administrador de contenidos.</li>
                <li>
                    <strong>Módulo Blog, Noticias:</strong> En una hoja especial podrá  agregar, modificar o borrar publicaciones de interés para los usuarios, puede  crear categorías para cada tipo de publicación, haciéndola más llamativa y un  sitio de interés, cada publicación tiene un espacio para que los usuarios  puedan comentar y tener interacción con el administrador, tanto en la página  como en <strong>facebook</strong>, el comentario se  publicará automáticamente en el muro de <strong>facebook </strong>del usuario.</li>
                <li>
                    <strong>Galería de Videos: </strong> Los videos deben estar en FLV o colgados  previamente el youtube.com
                    <ul>
                        <li>Netwoods ingresará 5 videos,  el administrador podrá ingresar nuevos, uno a uno, usando el administrador de  contenidos.</li>
                        <li>Se podrán ingresar videos  limitándose en el Hosting.</li>
                        <li>Si el visitante hace clic en  reproducir vera el video en la misma página.</li>
                        <li>Se organizarán alfabéticamente  5 videos por página, cada uno con su nombre.</li>
                    </ul>
                </li>
                <li>
                    <strong>Calendario de Eventos:  </strong>Podrá publicar sus eventos en la fecha seleccionada,  dejando solo texto informativo o un enlace para ver más información del evento.<strong></strong></li>
                <li>
                    <strong>Suscripción a noticias, newsletter: </strong>Los  usuarios podrán ingresar su correo y nombre para quedar suscritos al  newsletter. Esto se guardar en una base de datos interna donde podrán descargar  y posteriormente usar su proveedor de correo para enviar la información que  deseen.<strong></strong></li>
                <li>
                    <strong>Chat Soporte:</strong> Incorporar un sistema de chat, mediante el cual los usuarios podrán comunicarse  con un asesor de la página para resolver dudas, hacer algún pedido, cotización  o cualquier otra cosa que deseen.  Otorga  un buen servicio en línea en tiempo real, también podrá saber el administrador  del chat que procedencia tiene el usuario, el idioma, tiempo en la página, qué páginas ha visto, de qué página llegó, por qué palabras clave encontró el sitio, país, podrá invitarlo al chat, entre otras, y todo en tiempo real.
                </li>
                <li><strong>Módulo Slider:</strong>  Es un pasador de imágenes con una descripción  y enlace, muy útil para generar noticias instantáneas y directas en el home.</li>
                <li><strong>Formulario contacto:</strong> En este el usuario se podrá  poner en contacto con la empresa seleccionando el departamento al que se quiere  dirigir.</li>
                <li><strong>Versión para móviles:</strong> Su página será totalmente  compatible con celulares, sin embargo no tendrá una versión especial para  dispositivos móviles. La creación de la página especial para móviles tendrá un  valor adicional.</li>
                <li><strong>Herramienta para crear  encuestas:</strong> Con  una herramienta creada especialmente para nuestro cliente, podrá crear  encuestas y ver en tiempo real estadísticas y exportar en Excel.</li>
                <li><strong>Motor de Búsqueda:</strong> El sitio contará con un  buscador con filtros, este buscará en todo el portal lo relacionado con las palabras  clave digitadas.</li>
                <li><strong>Módulos sociales:</strong> Cada hoja o publicación  quedará integrada con los plugins de facebook y twitter, comentarios, me gusta  y twittear.</li>
                <li><strong>Google Maps:</strong> Tendrá el mapa de su  empresa en Google Maps, esta estará integrada en una hoja especial en la página  web.</li>
                <li><strong>Opinometro:</strong>  Buzón de quejas que los usuarios pueden hacer,  solo deben ingresar el correo, nombre, otros campos solicitados y el comentario  o queja, este llegará a los correos que nos indiquen.</li>
                <li></li>
            </ul>
        </div>
    </div>
...
<div id="contenedor1">
    ...
    <div id="contenedor2">
        <div class="bloques_text_center">
            <h1>Posicionamiento y seguridad web.</h1>
            <ul>
                <li>El posicionamiento lo va dando  automáticamente el administrador de contenidos, posicionamiento gradual  automático y técnicas especiales de posicionamiento web SEO. Su página  aparecerá en los motores de búsqueda en la primera semana de abrirse y se  posicionará de 2 a 3 meses, quedando en los primeros lugares de acuerdo a las  palabras clave que seleccione.</li>
            </ul>
            <p>&nbsp;</p>
            <h1>Interacción con redes sociales y otras aplicaciones  Google.                  </h1>
            <ul>
                <li>Interacción de todas las redes sociales,  como facebook, twitter, etc.</li>
                <li>Integración con google maps.</li>
                <li>Integración con webservice que sea  solicitado.</li>
            </ul>
            <p>&nbsp;</p>
            <h1>Publicidad</h1>
            <ul>
                <li>Podrá publicar cualquier texto, imagen o flash publicitario en cualquier  hoja.</li>
                <li>También crearemos una hoja especial para ver todas las publicaciones que  podrá modificar, agregar o eliminar a su gusto.</li>
                <li>Todas las pautas publicitarias deben ser subidas por el administrador.</li>
            </ul>
            <p>&nbsp;</p>
...
<div id="contenedor1">
    ...
    <div id="contenedor2">
        <div class="bloques_text_center">
            ...
            <table border="1" align="left" cellpadding="0" cellspacing="0" style="margin: 20px;">
                <tr>
                    <td width="158" valign="top"><p>Espacio </p></td>
                    <td width="180" valign="top"><p>1 GB</p></td>
                </tr>
                <tr>
                    <td width="158" valign="top"><p>Transferencia mensual</p></td>
                    <td width="180" valign="top"><p>10 GB</p></td>
                </tr>
                <tr>
                    <td width="158" valign="top"><p>Cuentas Email</p></td>
            ...
            <p>&nbsp;</p>
            <p>&nbsp;</p>
            <p>Hosting y Dominio : 1 año. Luego de cumplir el año es responsabilidad      del cliente renovarlo. </p>
            <p><strong>Si cuenta con Hosting y dominio no      afecta el valor y consideración de la propuesta</strong></p>
            <p>&nbsp;</p>
            <p>&nbsp;</p>
        </div>
    </div>
...
<div id="contenedor1">
    ...
    <div id="contenedor2">
        <div class="bloques_text_center">
            ...
            <p>Puede diseñar su página con objetos que usted  mismo arrastra y suelta en el lugar que desee. Así, puede mostrar su página y  su contenido en la posición que desee, exacta, en tiempo real. 
                Además podrá  definir si quiere que esté por encima de los elementos, o que esté estática en  el navegador.&nbsp;</p>
...
<div id="contenedor1">
    ...
    <div id="contenedor2">
        <div class="bloques_text_center">
            <h1 class="title3"><strong>Información de Contacto y asesoría</strong></h1>
            ...
            <p>
                Esperamos que todo lo contemplado en esta propuesta comercial sea lo que usted está buscando.
            </p>
