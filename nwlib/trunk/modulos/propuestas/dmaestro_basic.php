    ...
    <div id="contenedor2">
        <div class="bloq">
            ...
            <div class="how">
                ...
                <p class="paragraph">Selecciona tus plantillas</p>
            </div>
            <div class="how">
                <div class="circle two" ></div>
                <p class="paragraph">Nosotros nos encargamos de editarlas y de diagramar la información</p>
            </div>
            <div class="how">
                <div class="circle three"></div>
                <p class="paragraph">Te brindamos soporte técnico</p>
            </div>
        </div>
        <div id="title">
        ...
        <div class="bloqcontainer">
            <div class="bloqs">
                ...
                <div class="what">
                    ...
                    <p class="paragraph description">Hasta 8 páginas internas con lenguaje HTML 5 y
CSS 3 de nuestra biblioteca que
podrás seleccionar de acuerdo a
tus necesidades.</p>
                </div>
                <div class="what">
                    <div class="small_circle six"></div>
                    <p class="paragraph description">10 fotos de stock.</p>
                </div>
                <div class="what">
                    <div class="small_circle seven"></div>
                    <p class="paragraph description">Una animación de NW animate
entendida como una transición de
imagenes.</p>
                </div>
                <div class="what">
                    <div class="small_circle eight" ></div>
                    <p class="paragraph description">Soporte técnico para ayudarte a
manejar tu sitio web.</p>
                </div>
            </div>
            <div class="bloqs">
                <div class="what">
                    <div class="small_circle nine"></div>
                    <p class="paragraph description">hasta 3 módulos NW.</p>
                </div>
                <div class="what">
...
<div id="contenedor1">
    ...
    <div id="contenedor2">
        <div class="bloqcontainer">
            ...
            <div id="title">
                <h2 class="alltitles mod">¿Cuales son los módulos disponibles de NW?</h2>
            </div>
            <div class="boxes">
                <div class="what">
                    <div class="smallbox icon1"></div>
                    <p class="paragraph description">catálogo de productos</p>
                </div>
                <div class="what">
                    <div class="smallbox icon2" ></div>
                    <p class="paragraph description">blog/ noticias</p>
                </div>
                <div class="what">
                    <div class="smallbox icon3"></div>
                    <p class="paragraph description">galería de imagenes</p>
                </div>
                <div class="what">
                    <div class="smallbox icon4"></div>
                    <p class="paragraph description">galería de videos</p>
                </div>
            </div>
            <div class="boxes">
                <div class="what">
                    <div class="smallbox icon5" ></div>
                    <p class="paragraph description">calendario de eventos</p>
                </div>
                <div class="what">
                    <div class="smallbox icon6"></div>
                    <p class="paragraph description">suscripción a noticias (newsletter)</p>
                </div>
                <div class="what">
                    <div class="smallbox icon7"></div>
                    <p class="paragraph description">chat soporte</p>
                </div>
                <div class="what">
                    <div class="smallbox icon8" ></div>
                    <p class="paragraph description">slider</p>
                </div>
            </div>
            <div class="boxes">
                <div class="what">
                    <div class="smallbox icon9" ></div>
                    <p class="paragraph description">formulario de contacto</p>
                </div>
                <div class="what">
                    <div class="smallbox icon10"></div>
                    <p class="paragraph description">herramienta para crear encuestas</p>
                </div>
                <div class="what">
                    <div class="smallbox icon11"></div>
                    <p class="paragraph description">mapas</p>
                </div>
            </div>
            <div id="title">
