...
<div id="contenedor1">
    <div id="contenedor2">
        ...
        <?php
        $sql = "select a.id, a.usuario, b.firma, b.usuario as nom_usuario, b.nombre, b.email, b.celular, b.cargo from propuestas a join usuarios b on (a.usuario = b.usuario)
        where a.id = " . $_GET["cliente"];
        echo $sql;
    ...
    <div id="contenedor2">
        <div class="bloq">
            ...
            <div class="how">
                ...
                <p class="paragraph">Nosotros diseñamos
                    la totalidad de tu página</p>
            </div>
            <div class="how">
                <div class="circle two" ></div>
                <p class="paragraph">Nosotros nos
                    encargamos de
                    diagramar la
                    información</p>
            </div>
        ...
        <div class="bloqcontainer">
            <div class="bloqs">
                ...
                <div class="what">
                    ...
                    <p class="paragraph description">Hasta 20 páginas internas con lenguaje HTML 5 y
                        CSS 3</p>
                </div>
                <div class="what">
                    <div class="small_circle six"></div>
                    <p class="paragraph description">20 fotos de stock.</p>
                </div>
                <div class="what">
            ...
            <div class="bloqs">
                <div class="what">
                    ...
                    <p class="paragraph description">Hasta 6 módulos NW.</p>
                </div>
                <div class="what">
