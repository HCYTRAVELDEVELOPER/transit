...
<div id="contenedor1">
    <div id="contenedor2">
        ...
        <div class="divTitleEnc">
            ...
            <img src="/<?php echo "nwlib{$cfg["nwlibVersion"]}"; ?>/modulos/propuestas/imagenes/img_inicial_pla_maestro.jpg" style="float: left;width: 500px;" />
    ...
    <div id="contenedor2">
        ...
        <div class="bloques_text_center">
            ...
            <ul>
                ...
                <li>Incluye módulos  creados por netwoods.</li>
...
<div id="contenedor1">
    ...
    <div id="contenedor2">
        <div class="bloques_text_center">
            <img src="/<?php echo "nwlib{$cfg["nwlibVersion"]}"; ?>/modulos/propuestas/imagenes/maestro/banner_diseno_web_2013.png" style="float: left;" />
            <p>
                <br />
                <br />
            ...
            <div style="position: relative; overflow: hidden;width: 100%;">            
                ...
                <ul class="ul_imgtext">
                    <li>
                        <div>
                            <img src="/<?php echo "nwlib{$cfg["nwlibVersion"]}"; ?>/modulos/propuestas/imagenes/maestro/foto_icono.png" />
                        </div>
                        <p>
                    ...
                    <li>
                        <div>
                            <img src="/<?php echo "nwlib{$cfg["nwlibVersion"]}"; ?>/modulos/propuestas/imagenes/maestro/papel_icono.png" />
                        </div>
                        <p>
                    ...
                    <li>
                        <div>
                            <img src="/<?php echo "nwlib{$cfg["nwlibVersion"]}"; ?>/modulos/propuestas/imagenes/maestro/diseno1.png" />
                        </div>
                        <p>
                    ...
                    <li>
                        <div>
                            <img src="/<?php echo "nwlib{$cfg["nwlibVersion"]}"; ?>/modulos/propuestas/imagenes/maestro/icon_nwproject.png" />
                        </div>
                        <p>
                    ...
                    <li>
                        <div>
                            <img src="/<?php echo "nwlib{$cfg["nwlibVersion"]}"; ?>/modulos/propuestas/imagenes/maestro/html5_css3_bogota_home.png" />
                        </div>
                        <p>
                            HTML5, CSS3
                        </p>
                    ...
                    <li>
                        <div>
                            <img src="/<?php echo "nwlib{$cfg["nwlibVersion"]}"; ?>/modulos/propuestas/imagenes/maestro/icons_home_cloud_servers.png" />
                        </div>
                        <p>
                            Hosting y Dominio
                        </p>
                    ...
                    <li>
                        <div>
                            <img src="/<?php echo "nwlib{$cfg["nwlibVersion"]}"; ?>/modulos/propuestas/imagenes/maestro/icon_inhouse.png" />
                        </div>
                        <p>
                    ...
                    <li>
                        <div>
                            <img src="/<?php echo "nwlib{$cfg["nwlibVersion"]}"; ?>/modulos/propuestas/imagenes/maestro/icons_home_software_pants.png" />
                        </div>
                        <p>
                    ...
                    <li>
                        <div>
                            <img src="/<?php echo "nwlib{$cfg["nwlibVersion"]}"; ?>/modulos/propuestas/imagenes/maestro/icons_home_responsive.png" />
                        </div>
                        <p>
            ...
            <img src="/<?php echo "nwlib{$cfg["nwlibVersion"]}"; ?>/modulos/propuestas/imagenes/maestro/img3.png" style="float: right;width: 300px; top: 50px;" />
            <h1>Diseño único</h1>
            <ul>
            ...
            <br />
            <br />
            <img src="/<?php echo "nwlib{$cfg["nwlibVersion"]}"; ?>/modulos/propuestas/imagenes/maestro/img7.png" style="float: left;width: 300px; " />
            <h1>Animación e interactividad</h1>
            <ul>
                <li>Transición entre imágenes (máximo 3),  animaciones en banners en html5, CSS3, javascript, no usamos flash ya que no es  compatible con celulares. Las animaciones no son videos y no pueden tener línea de tiempo ni durar más de 7 segundos.
...
<div id="contenedor1">
    ...
    <div id="contenedor2">
        <div class="bloques_text_center">
            <img src="/<?php echo "nwlib{$cfg["nwlibVersion"]}"; ?>/modulos/propuestas/imagenes/maestro/img8.png" style="width: 100%; " />
            ...
            <div style="position: relative;overflow: hidden;">
                <img src="/<?php echo "nwlib{$cfg["nwlibVersion"]}"; ?>/modulos/propuestas/imagenes/maestro/img2.png" style="float: left;width: 400px;" />
                <div>
            ...
            <ul class="ulModules">
                <li>
                    <img src="/<?php echo "nwlib{$cfg["nwlibVersion"]}"; ?>/modulos/propuestas/imagenes/maestro/img2.png"  />
                    <h3>
                ...
                <li>
                    <img src="/<?php echo "nwlib{$cfg["nwlibVersion"]}"; ?>/modulos/propuestas/imagenes/news1.png"  />
                    <h3>
                        Módulo Blog, Noticias
                    </h3>
                </li>
                <li>
                    <img src="/<?php echo "nwlib{$cfg["nwlibVersion"]}"; ?>/modulos/propuestas/imagenes/video1.png"  />
                    <h3>
                        Galería de Videos
                    </h3>
                </li>
                <li>
                    <img src="/<?php echo "nwlib{$cfg["nwlibVersion"]}"; ?>/modulos/propuestas/imagenes/calendar1.png"  />
                    <h3>
                        Calendario de Eventos
                    </h3>
                </li>
                <li>
                    <img src="/<?php echo "nwlib{$cfg["nwlibVersion"]}"; ?>/modulos/propuestas/imagenes/news_subscribe1.png"  />
                    <h3>
                        Suscripción a noticias, newsletter
                    </h3>
                </li>
                <li>
                    <img src="/<?php echo "nwlib{$cfg["nwlibVersion"]}"; ?>/icons/chat8.png"  />
                    <h3>
                        Chat Soporte:
                    </h3>
                </li>
                <li>
                    <img src="/<?php echo "nwlib{$cfg["nwlibVersion"]}"; ?>/modulos/propuestas/imagenes/slide1.png"  />
                    <h3>
                        Módulo Slider
                    </h3>
                </li>
                <li>
                    <img src="/<?php echo "nwlib{$cfg["nwlibVersion"]}"; ?>/modulos/propuestas/imagenes/contact1.png"  />
                    <h3>
                        Formulario contacto
                    </h3>
                </li>
                <li>
                    <img src="/<?php echo "nwlib{$cfg["nwlibVersion"]}"; ?>/modulos/propuestas/imagenes/survey1.png"  />
                    <h3>
                        Herramienta para crear  encuestas
                    </h3>
                </li>
                <li>
                    <img src="/<?php echo "nwlib{$cfg["nwlibVersion"]}"; ?>/modulos/propuestas/imagenes/nwmaps.png"  />
                    <h3>
                        Mapas
                    </h3>
                </li>
...
<div id="contenedor1">
    ...
    <div id="contenedor2">
        <div class="bloques_text_center">
            <h2>Especificaciones técnicas NwProject:</h2>
...
<div id="contenedor1">
    ...
    <div id="contenedor2">
        <div class="bloques_text_center">
            <img src="/<?php echo "nwlib{$cfg["nwlibVersion"]}"; ?>/modulos/propuestas/imagenes/maestro/img5.png" />
            <ul>
                <li>
            ...
            <p>&nbsp;</p>
            <img src="/<?php echo "nwlib{$cfg["nwlibVersion"]}"; ?>/modulos/propuestas/imagenes/maestro/img1.png" style="float: left;" />
            <h1>
                Posicionamiento Orgánico Natural
            </h1>
            <ul>
            ...
            <p>&nbsp;</p>
            <p>&nbsp;</p>
            <img src="/<?php echo "nwlib{$cfg["nwlibVersion"]}"; ?>/modulos/propuestas/imagenes/maestro/img6_1.png" style="float: right;" />
    ...
    <div id="contenedor2">
        <div class="bloques_text_center">
            ...
            <div class="bloques_textos bloquesFlotantes" style="text-align: center;">
                ...
                <p>
                    QXNW, NWPHP, HTML5, CSS3, JAVASCRIPT
                    <br />
                    <br />
                    <br />
                </p>
