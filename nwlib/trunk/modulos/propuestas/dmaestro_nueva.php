    ...
    <div id="contenedor2">
        <div class="bloq">
            ...
            <div class="how">
                ...
                <p class="paragraph">Tu decides que necesitas y armas tu propio plan</p>
            </div>
            <div class="how">
                <div class="circle two" ></div>
                <p class="paragraph">Nosotros nos encargamos de hacerlo realidad</p>
            </div>
            <div class="how">
                <div class="circle three"></div>
                <p class="paragraph">Te brindamos soporte técnico que necesites</p>
            </div>
        </div>
        <div id="title">
        ...
        <div class="bloqcontainer">
            <div class="bloqs">
                ...
                <div class="what">
                    ...
                    <p class="paragraph description">Las páginas internas que necesites.</p>
                </div>
                <div class="what">
                    <div class="small_circle six"></div>
                    <p class="paragraph description">Las fotos de stock que necesites.</p>
                </div>
                <div class="what">
                    <div class="small_circle seven"></div>
                    <p class="paragraph description">Las animaciones de NW animate entendidas como una transición de imagenes.</p>
                </div>
                <div class="what">
            ...
            <div class="bloqs">
                <div class="what">
                    ...
                    <p class="paragraph description">Los módulos NW que necesites.</p>
                </div>
                <div class="what">
