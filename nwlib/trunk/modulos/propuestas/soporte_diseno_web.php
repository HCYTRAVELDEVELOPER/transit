    ...
    <div id="contenedor2">
        <div class="bloques_text_center">
            ...
            <div class="bloque1">
                ...
                <br /><br />
                <p>
                    La modificación de una página dentro del sitio contempla una 
                    duración máxima de una hora para realizar el cambio, esto quiere decir que si la modificación de una 
                    página requiere más de una hora entonces se cobra el tiempo adicional invertido.
                </p>
                ...
                <p>
                    CADA EDICIÓN POR PÁGINA TIENE UNA DURACIÓN DE 1 HORA MÁXIMO. SI LA EDICIÓN SUPERA EL TIEMPO LÍMITE SE COBRARÁ EL TIEMPO ADICIONAL INVERTIDO.
                    <br />
                    <br />
    ...
    <div id="contenedor2">
        <div class="bloques_text_center">
            ...
            <p style="text-align: center;">
                <img src="/<?php echo "nwlib{$cfg["nwlibVersion"]}"; ?>/modulos/propuestas/imagenes/logos_clientes.png" />
            </p>
            <p align="center">
