...
function R(c,e,f,g){
    var i=a('<span class="bx-next"></span>');
    var j=a('<span class="bx-prev"></span>');
    if(c=="text"){
        i.html(e)
        }else{
        i.html('<img src="'+e+'" />')
...
if(b.buildPager){
    ...
    for(var i=1;i<=e;i++){
        //TODO: andresf, se cambia para no generar error con el href vacío
        f+='<span class="pager-link pager-'+i+'">'+i+"</span>"
