...
$PHPTHUMB_CONFIG['cache_directory'] = dirname(__FILE__).'/../../../tmp/';                            // set the cache directory relative to the phpThumb() installation
...
$PHPTHUMB_CONFIG['cache_maxage'] = 86400 * 365;        // delete cached thumbnails that haven't been accessed in more than [30 days] (value is maximum time since last access in seconds to avoid deletion)
...
$PHPTHUMB_CONFIG['cache_source_directory'] = dirname(__FILE__).'/../../../tmp/source';  // set the cache directory for unprocessed source images
...
$PHPTHUMB_CONFIG['error_message_image_default'] = '../../icons/support2.png';       // Set this to the name of a generic error image (e.g. '/images/error.png') that you want displayed in place of any error message that may occur. This setting is overridden by the 'err' parameter, which does the same thing.
