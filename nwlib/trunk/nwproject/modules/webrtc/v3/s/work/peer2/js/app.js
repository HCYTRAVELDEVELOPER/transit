...
//        }
    ...
    initialize: function () {
        ...
        //TODO :: MARTIN SE HACE LA VALIDACION DE URL, YA QUE SI SE ENVIAN PARAMETROS DE LA URL GENERAL  NO LOS TOMA COMO TAL
        if (utils.evalueData(get.myID)) {
            get.myID = decodeURI(get.myID);
        }
