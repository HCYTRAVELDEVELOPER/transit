...
//                self.saveOrUpdateContinue(dat, callback);
        ...
        oReq.onload = reqListener;
        oReq.onerror = reqError;
        oReq.open('POST', self.domain + '/nwlib6/nwproject/modules/webrtc/v5/s/work/peer2/srv/saveOrUpdate.php', true);
        oReq.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
        oReq.send(data);
    },
...
//            self.tokens = [];
    ...
    readMsgCall: function (type) {
        ...
        oReq.onload = reqListener;
        oReq.onerror = reqError;
        oReq.open('POST', self.domain + '/nwlib6/nwproject/modules/webrtc/v5/s/work/peer2/srv/readMsgCall.php', true);
        oReq.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
        oReq.send(data);
    },
