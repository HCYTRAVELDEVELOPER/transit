var srv = {
    ...
    createInstance: function () {
        ...
        self.is_group = false;
        if (typeof get.is_group !== "undefined") {
            self.is_group = get.is_group;
        }
    ...
    loadAllMessagesServer: function () {
        ...
        console.log("LOAD MESSAGES SERVER");
...
//                self.createWritten(self.heName, 3000);
        ...
        self.saveOrUpdate(function (r) {
            ...
            rtcNw.onSendMessage = function (elemen) {
                ...
                } else if (self.evalueData(user) && document[hidden] && !self.inWindow) {
                    var theBody = msg;
                    var theIcon = "";
...
//        if (rtcNw.isAssesor === false) {
        ...
        console.log(data);
        var oReq = new NWMRpc('/nwlib6/nwproject/modules/webrtc/v5/s/work/peer2/srv/saveMsgSrv.php');
        oReq.constructor();
//        var oReq = new XMLHttpRequest();
        oReq.exec(data, function (r) {
            var data = r;
            console.log("saveMsgSrv", data);
            console.log("SAVE:", data);
            if (r.error != null) {
                NWMUtils.error(r.error, 5000, true);
                return;
            }
            if (data === "true") {
    ...
    saveOrUpdate: function (callback) {
        ...
        var oReq = new NWMRpc('/nwlib6/nwproject/modules/webrtc/v5/s/work/peer2/srv/saveOrUpdate.php');
        oReq.constructor();
        oReq.exec(data, function (r) {
            console.log(r);
            if (r.error != null) {
                NWMUtils.error(r.error, 10000, true);
                return;
            }
            self.saveOrUpdateContinue(r, callback);
...
//            self.tokens = [];
    ...
    changeStatusCall: function (status, type, callback) {
        ...
        oReq.open('POST', self.domain + '/nwlib6/nwproject/modules/webrtc/v5/s/work/peer2/srv/changeStatusCall.php', true);
    ...
    searchCallEnded: function () {
        ...
        oReq.onload = reqListener;
        oReq.onerror = reqError;
        oReq.open('POST', self.domain + '/nwlib6/nwproject/modules/webrtc/v5/s/work/peer2/srv/searchCallEnded.php', true);
        oReq.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
        oReq.send(data);
    },
    sendEmailCallEnded: function () {
        ...
        oReq.onload = reqListener;
        oReq.onerror = reqError;
        oReq.open('POST', self.domain + '/nwlib6/nwproject/modules/webrtc/v5/s/work/peer2/srv/sendEmailCallEnded.php', true);
        oReq.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
        oReq.send(data);
    },
    ...
    readMsgCall: function (type) {
        ...
        var oReq = new NWMRpc('/nwlib6/nwproject/modules/webrtc/v5/s/work/peer2/srv/readMsgCall.php');
        oReq.constructor();
        oReq.exec(data, function (r) {
