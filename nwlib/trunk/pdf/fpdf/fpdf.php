...
define('FPDF_FONTPATH', $_SERVER["DOCUMENT_ROOT"] . '/nwlib' . master::getNwlibVersion() . '/pdf/fpdf/font/');
...
class PDF_Code39 extends PDF_Rotate {
...
class PDF_Final extends PDF_Code39 {
    
}

class PDF_EAN13 extends PDF_Final {
