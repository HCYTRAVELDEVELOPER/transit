...
//                                return {seriesIndex: s.index, pointIndex: j, gridData: null, data: s.data[j]};
    ...
    $.fn.jqplotToImageCanvas = function (options) {
        ...
        function writeWrappedText(el, context, text, left, top, canvasWidth) {
            ...
            for (var i = 0; i < wl; i++) {
                w += words[i];
                //TODO: se mejora según el bug https://bitbucket.org/cleonello/jqplot/pull-requests/69/fixing-infinite-loop/diff#Lsrc/jqplot.toImage.jsF1T1
//                if (Math.floor(context.measureText(w).width) > tagwidth) {
