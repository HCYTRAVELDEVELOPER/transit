...
qx.Class.define("qxnw.nw_sync.forms.f_addConnection", {
    extend: qxnw.forms,
    construct: function () {
        var self = this;
        this.base(arguments);
    ...
    members: {
        ...
        setParamRecordTable: function setParamRecordTable(table, enc) {
            ...
            self.enc = enc;
            self.table = table;
            qxnw.utils.populateSelectAsync(self.ui.camposDisponibles, "nw_exp", "searchFieldsByTable", table.nombre);
        ...
        save: function save() {
            ...
            r.tabla = self.table.nombre;
            r.enc = self.enc.model;
            var func = function () {
